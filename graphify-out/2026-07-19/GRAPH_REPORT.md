...
Cohesion: 0.38
Nodes (5): build(), inject_charts(), make_charts(), Render at-a-glance SVGs from a report's meta. Returns md image lines., Insert chart images after the intro blockquote of a generated report.
...
Cohesion: 0.40
Nodes (3): fmt(), MD_COMPONENTS, ReportCard()
