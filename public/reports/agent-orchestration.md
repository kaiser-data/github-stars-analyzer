...
| [agentscope-ai/agentscope](https://github.com/agentscope-ai/agentscope) | 29,831 | Python | 82 | very active | Mature | 2 |
| [huggingface/smolagents](https://github.com/huggingface/smolagents) | 29,022 | Python | 60 | active | Mature | 1 |
| [openai/openai-agents-python](https://github.com/openai/openai-agents-python) | 29,014 | Python | 85 | very active | Hot | 2 |
| [microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel) | 28,507 | C# | 82 | very active | Classic | 2 |
| [google/adk-python](https://github.com/google/adk-python) | 21,310 | Python | 79 | very active | Hot | 1 |
| [camel-ai/camel](https://github.com/camel-ai/camel) | 17,650 | Python | 85 | very active | Classic | 3 |
| [microsoft/agent-framework](https://github.com/microsoft/agent-framework) | 13,155 | Python | 98 | very active | Hot | 7 |
| [VoltAgent/voltagent](https://github.com/VoltAgent/voltagent) | 10,433 | TypeScript | 77 | very active | Hot | 2 |
| [strands-agents/harness-sdk](https://github.com/strands-agents/harness-sdk) | 7,033 | Python | 96 | very active | Hot | 5 |
| [i-am-bee/beeai-framework](https://github.com/i-am-bee/beeai-framework) | 3,384 | Python | 96 | very active | Mature | 5 |
| [liquidos-ai/AutoAgents](https://github.com/liquidos-ai/AutoAgents) | 745 | Rust | 70 | very active | Hot | 1 |

### Visual / low-code platforms

| Tool | ★ | Lang | Health | Activity | Lifecycle | Bus factor |
|---|---|---|---|---|---|---|
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | 202,638 | TypeScript | 100 | very active | Classic | 12 |
| [langflow-ai/langflow](https://github.com/langflow-ai/langflow) | 153,747 | Python | 79 | very active | Classic | 1 |
| [langgenius/dify](https://github.com/langgenius/dify) | 153,692 | TypeScript | 95 | very active | Classic | 4 |
| [simstudioai/sim](https://github.com/simstudioai/sim) | 29,479 | TypeScript | 77 | very active | Hot | 1 |

### Coding-agent orchestration

| Tool | ★ | Lang | Health | Activity | Lifecycle | Bus factor |
|---|---|---|---|---|---|---|
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | 81,018 | Python | 84 | very active | Hot | 12 |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | 69,568 | TypeScript | 76 | very active | Hot | 1 |
| [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | 68,449 | TypeScript | 78 | very active | Hot | 1 |
| [wshobson/agents](https://github.com/wshobson/agents) | 39,201 | Python | 64 | very active | Hot | 1 |
| [Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode) | 38,828 | TypeScript | 80 | very active | Rising | 1 |
| [getpaseo/paseo](https://github.com/getpaseo/paseo) | 15,264 | TypeScript | 76 | very active | Hot | 1 |
| [eigent-ai/eigent](https://github.com/eigent-ai/eigent) | 15,145 | TypeScript | 83 | very active | Hot | 3 |
| [Untrivial-ai/agent-orchestrator](https://github.com/Untrivial-ai/agent-orchestrator) | 10,141 | Go | 97 | very active | Hot | 5 |
...
| Tool | ★ | Lang | Health | Activity | Lifecycle | Bus factor |
|---|---|---|---|---|---|---|
| [elizaOS/eliza](https://github.com/elizaOS/eliza) | 19,190 | TypeScript | 89 | very active | Mature | 3 |

### Durable / production infra

| Tool | ★ | Lang | Health | Activity | Lifecycle | Bus factor |
|---|---|---|---|---|---|---|
| [flyteorg/flyte](https://github.com/flyteorg/flyte) | 7,281 | Go | 90 | very active | Classic | 3 |
...
| Tool | ★ | Lang | Health | Activity | Lifecycle | Bus factor |
|---|---|---|---|---|---|---|
| [TauricResearch/TradingAgents](https://github.com/TauricResearch/TradingAgents) | 101,235 | Python | 69 | active | Mature | 1 |
| [assafelovic/gpt-researcher](https://github.com/assafelovic/gpt-researcher) | 29,175 | Python | 84 | very active | Classic | 2 |

### Protocols & meta-frameworks

| Tool | ★ | Lang | Health | Activity | Lifecycle | Bus factor |
|---|---|---|---|---|---|---|
| [sentient-agi/ROMA](https://github.com/sentient-agi/ROMA) | 5,174 | Python | 26 | stale | Declining | 0 |
| [TinyAGI/tinyagi](https://github.com/TinyAGI/tinyagi) | 3,610 | TypeScript | 37 | slowing | Declining | 0 |
...
- **[strands-agents/harness-sdk](https://github.com/strands-agents/harness-sdk)** · 7,033★ · Python · Hot · health 96  
...
- **[simstudioai/sim](https://github.com/simstudioai/sim)** · 29,479★ · TypeScript · Hot · health 77  
...
- **[getpaseo/paseo](https://github.com/getpaseo/paseo)** · 15,264★ · TypeScript · Hot · health 76  
...
**Community clustering.** These 38 tools span **17 of the graph's 37 communities**.

- **Community 19** (7): `langchain-ai/langgraph`, `agentscope-ai/agentscope`, `i-am-bee/beeai-framework`, `FoundationAgents/MetaGPT`, `assafelovic/gpt-researcher`, `langflow-ai/langflow`, `TauricResearch/TradingAgents`
- **Community 10** (6): `liquidos-ai/AutoAgents`, `crewAIInc/crewAI`, `agno-agi/agno`, `n8n-io/n8n`, `inngest/agent-kit`, `veegee82/agent-workflow-protocol`
- **Community 12** (4): `VoltAgent/voltagent`, `wshobson/agents`, `Yeachan-Heo/oh-my-claudecode`, `getpaseo/paseo`
- **Community 5** (3): `microsoft/semantic-kernel`, `microsoft/agent-framework`, `microsoft/autogen`
- **Community 16** (3): `camel-ai/camel`, `eigent-ai/eigent`, `flyteorg/flyte`
- **Community 17** (2): `langgenius/dify`, `simstudioai/sim`
- **Community 1** (2): `bytedance/deer-flow`, `sentient-agi/ROMA`
- **Community 24** (2): `vercel-labs/coding-agent-template`, `elizaOS/eliza`
