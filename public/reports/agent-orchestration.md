...
>
> Generated 2026-09-13 by `scripts/reports/agent_orchestration.py` (regenerate any time — no API cost).
...
| Tool | ★ | Lang | Health | Activity | Lifecycle | Bus factor |
|---|---|---|---|---|---|---|
| [sentient-agi/ROMA](https://github.com/sentient-agi/ROMA) | 5,178 | Python | 22 | stale | Declining | 0 |
| [TinyAGI/tinyagi](https://github.com/TinyAGI/tinyagi) | 3,611 | TypeScript | 36 | slowing | Declining | 0 |
...
- **[FoundationAgents/MetaGPT](https://github.com/FoundationAgents/MetaGPT)** · 70,234★ · Python · Declining · health 20  
...
- **[agno-agi/agno](https://github.com/agno-agi/agno)** · 42,068★ · Python · Classic · health 92  
...
- **[langchain-ai/langgraph](https://github.com/langchain-ai/langgraph)** · 41,111★ · Python · Classic · health 76  
...
- **[stanfordnlp/dspy](https://github.com/stanfordnlp/dspy)** · 37,796★ · Python · Classic · health 82  
...
- **[openai/openai-agents-python](https://github.com/openai/openai-agents-python)** · 29,215★ · Python · Hot · health 79  
...
- **[huggingface/smolagents](https://github.com/huggingface/smolagents)** · 29,184★ · Python · Mature · health 56  
  Minimalist code-agent framework — agents that write & run Python to act.  
  <sub>topics: —</sub>
- **[microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel)** · 28,537★ · C# · Classic · health 81  
...
- **[camel-ai/camel](https://github.com/camel-ai/camel)** · 17,673★ · Python · Classic · health 84  
...
- **[i-am-bee/beeai-framework](https://github.com/i-am-bee/beeai-framework)** · 3,390★ · Python · Mature · health 96  
...
- **[n8n-io/n8n](https://github.com/n8n-io/n8n)** · 203,505★ · TypeScript · Classic · health 99  
...
- **[langgenius/dify](https://github.com/langgenius/dify)** · 154,575★ · TypeScript · Classic · health 94  
...
- **[simstudioai/sim](https://github.com/simstudioai/sim)** · 29,557★ · TypeScript · Hot · health 77  
...
- **[code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent)** · 68,739★ · TypeScript · Hot · health 77  
...
- **[wshobson/agents](https://github.com/wshobson/agents)** · 39,450★ · Python · Hot · health 63  
...
- **[Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode)** · 39,030★ · TypeScript · Hot · health 79  
...
- **[Untrivial-ai/agent-orchestrator](https://github.com/Untrivial-ai/agent-orchestrator)** · 10,983★ · Go · Hot · health 97  
...
- **[elizaOS/eliza](https://github.com/elizaOS/eliza)** · 19,261★ · TypeScript · Mature · health 83  
...
- **[flyteorg/flyte](https://github.com/flyteorg/flyte)** · 7,407★ · Go · Classic · health 84  
...
- **[TauricResearch/TradingAgents](https://github.com/TauricResearch/TradingAgents)** · 102,649★ · Python · Mature · health 72  
...
- **[sentient-agi/ROMA](https://github.com/sentient-agi/ROMA)** · 5,178★ · Python · Declining · health 22  
  Recursive meta-agent framework to build multi-agent systems; declining/low health.  
  <sub>topics: —</sub>
- **[TinyAGI/tinyagi](https://github.com/TinyAGI/tinyagi)** · 3,611★ · TypeScript · Declining · health 36  
...
**Community clustering.** These 38 tools span **16 of the graph's 41 communities**.

- **Community 5** (7): `langchain-ai/langgraph`, `i-am-bee/beeai-framework`, `assafelovic/gpt-researcher`, `langgenius/dify`, `simstudioai/sim`, `langflow-ai/langflow`, `elizaOS/eliza`
- **Community 13** (5): `VoltAgent/voltagent`, `wshobson/agents`, `Yeachan-Heo/oh-my-claudecode`, `Untrivial-ai/agent-orchestrator`, `getpaseo/paseo`
- **Community 20** (5): `liquidos-ai/AutoAgents`, `crewAIInc/crewAI`, `agno-agi/agno`, `n8n-io/n8n`, `inngest/agent-kit`
- **Community 16** (4): `agentscope-ai/agentscope`, `strands-agents/harness-sdk`, `FoundationAgents/MetaGPT`, `TauricResearch/TradingAgents`
- **Community 33** (3): `microsoft/semantic-kernel`, `microsoft/agent-framework`, `microsoft/autogen`
- **Community 7** (3): `camel-ai/camel`, `eigent-ai/eigent`, `flyteorg/flyte`
- **Community 1** (2): `google/adk-python`, `veegee82/agent-workflow-protocol`
...
- `langgenius/dify` — PageRank 0.0008
...
|---|---|---|---|---|---|
| n8n-io/n8n | Visual / low-code platforms | 99 | Classic | very active | 12 |
...
| elizaOS/eliza | Agent OS / long-horizon harness | 83 | Mature | very active | 2 |
...
| openai/openai-agents-python | Code-first agent frameworks | 79 | Hot | very active | 1 |
| langflow-ai/langflow | Visual / low-code platforms | 79 | Classic | very active | 1 |
| Yeachan-Heo/oh-my-claudecode | Coding-agent orchestration | 79 | Hot | very active | 1 |
...
| code-yeongyu/oh-my-openagent | Coding-agent orchestration | 77 | Hot | very active | 1 |
...
<sub>Tools covered: 38 across 7 approaches · Snapshot: 2026-09-12T16:25:05.965Z</sub>
