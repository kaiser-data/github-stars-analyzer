...
> Derived from **kaiser-data**'s 1,857 starred repos (snapshot `2026-08-29T15:31:31.780Z`), cross-referenced with the repo-similarity graph (1,857 nodes / 6,041 edges, 37 communities). Pros/cons and task rankings are additionally backed by external evidence (Terminal-Bench 2.1, 2026 head-to-head comparisons) — see Methodology.
>
...
- **30 terminal-AI-coding tools** in your stars (**1,280,471★** combined), split into the agents themselves and the terminal ecosystem around them:
...
|---|---|---|---|---|---|---|---|---|---|---|
| [anomalyco/opencode](https://github.com/anomalyco/opencode) | Terminal coding agent | TypeScript | MIT | 202,317 (▲345) | Hot | 83 | very active | 0d ago | 1.3y | 15 |
| [anthropics/claude-code](https://github.com/anthropics/claude-code) | Terminal coding agent | Python | — | 143,373 (▲171) | Hot | 76 | very active | 1d ago | 1.5y | 6 |
| [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | Multi-CLI glue | Rust | MIT | 130,062 (▲301) | Hot | 77 | very active | 0d ago | 1.1y | 14 |
| [openai/codex](https://github.com/openai/codex) | Terminal coding agent | Rust | Apache-2.0 | 119,746 (▲539) | Hot | 94 | very active | 0d ago | 1.4y | 40 |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | Terminal coding agent | TypeScript | Apache-2.0 | 106,741 (▲22) | Hot | 90 | very active | 1d ago | 1.4y | 13 |
| [earendil-works/pi](https://github.com/earendil-works/pi) | Terminal coding agent | TypeScript | MIT | 99,005 (▲694) | Hot | 85 | very active | 0d ago | 1.1y | 13 |
| [rtk-ai/rtk](https://github.com/rtk-ai/rtk) | Session / token ops | Rust | Apache-2.0 | 77,794 (▲159) | Hot | 78 | very active | 0d ago | 7mo | 10 |
| [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | Terminal coding agent | TypeScript | NOASSERTION | 68,499 (▲50) | Hot | 78 | very active | 0d ago | 9mo | 5 |
| [aaif-goose/goose](https://github.com/aaif-goose/goose) | Terminal coding agent | Rust | Apache-2.0 | 53,646 (▲64) | Mature | 89 | very active | 0d ago | 2.0y | 28 |
| [Alishahryar1/free-claude-code](https://github.com/Alishahryar1/free-claude-code) | Multi-CLI glue | Python | MIT | 51,335 (▲479) | Hot | 62 | very active | 0d ago | 7mo | 10 |
| [Aider-AI/aider](https://github.com/Aider-AI/aider) | Terminal coding agent | Python | Apache-2.0 | 48,571 (▲35) | Mature | 29 | slowing | 3mo ago | 3.3y | 0 |
| [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) | TUI building blocks | Go | MIT | 44,667 (▲63) | Classic | 72 | active | 10d ago | 6.6y | 11 |
| [charmbracelet/crush](https://github.com/charmbracelet/crush) | Terminal coding agent | Go | NOASSERTION | 27,780 (▲37) | Hot | 87 | very active | 0d ago | 1.3y | 13 |
| [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) | Terminal coding agent | TypeScript | Apache-2.0 | 27,480 (▲45) | Hot | 88 | very active | 0d ago | 1.2y | 23 |
| [mksglu/context-mode](https://github.com/mksglu/context-mode) | Session / token ops | TypeScript | NOASSERTION | 20,240 (▲45) | Rising | 78 | very active | 0d ago | 6mo | 1 |
| [CodebuffAI/freebuff](https://github.com/CodebuffAI/freebuff) | Terminal coding agent | TypeScript | Apache-2.0 | 11,154 (▲160) | Mature | 73 | very active | 0d ago | 2.1y | 1 |
| [github/copilot-cli](https://github.com/github/copilot-cli) | Terminal coding agent | Shell | NOASSERTION | 11,123 (▲1) | Classic | 67 | very active | 1d ago | 3.6y | 4 |
| [getagentseal/codeburn](https://github.com/getagentseal/codeburn) | Session / token ops | TypeScript | MIT | 9,717 (▲26) | Hot | 79 | very active | 0d ago | 4mo | 5 |
| [charmbracelet/bubbles](https://github.com/charmbracelet/bubbles) | TUI building blocks | Go | MIT | 8,852 (▲10) | Classic | 70 | active | 5d ago | 6.6y | 7 |
| [UfoMiao/zcf](https://github.com/UfoMiao/zcf) | Multi-CLI glue | TypeScript | MIT | 6,079 (▲1) | Hot | 72 | very active | 6d ago | 1.1y | 6 |
| [dagger/container-use](https://github.com/dagger/container-use) | Safety / isolation | Go | Apache-2.0 | 4,022 (▲1) | Mature | 46 | active | 12d ago | 1.3y | 3 |
| [sheeki03/tirith](https://github.com/sheeki03/tirith) | Safety / isolation | Rust | AGPL-3.0 | 2,692 (▲8) | Rising | 80 | very active | 1d ago | 6mo | 2 |
| [kenryu42/cc-safety-net](https://github.com/kenryu42/cc-safety-net) | Safety / isolation | TypeScript | MIT | 1,512 (▲4) | Rising | 80 | very active | 0d ago | 8mo | 2 |
| [affaan-m/agentshield](https://github.com/affaan-m/agentshield) | Safety / isolation | TypeScript | MIT | 1,102 (▲5) | Declining | 47 | active | 1mo ago | 6mo | 1 |
| [ctxrs/ctx](https://github.com/ctxrs/ctx) | Session / token ops | Rust | Apache-2.0 | 1,050 (▲3) | Hot | 80 | very active | 0d ago | 6mo | 9 |
...
|---|---|---|---|
| **[claude-code](https://github.com/anthropics/claude-code)** | 143,373 | Best-in-class multi-file refactoring and reasoning depth (SWE-bench Pro 69.2%); asks clarifying questions; subagents/hooks/skills/MCP ecosystem is the deepest; 83.1% Terminal-Bench 2.1 with Fable 5 | Not open source (no OSS license in repo); Anthropic-models only; subscription/usage costs add up on heavy agentic use |
| **[opencode](https://github.com/anomalyco/opencode)** | 202,317 | Most-starred OSS agent, MIT license; provider-neutral — 75+ endpoints incl. Bedrock, OpenRouter, local Ollama; strong TUI; no vendor lock-in | Bring-your-own-model means quality varies with the model you pick; harness benchmark scores trail the vendor-tuned agents |
| **[codex](https://github.com/openai/codex)** | 119,746 | #1 named CLI agent on Terminal-Bench 2.1 (83.4% w/ GPT-5.5); fast single-binary Rust TUI; excels at intent-driven, pattern-following edits | OpenAI-models only; less transparent reasoning than Claude Code on big refactors; ecosystem (hooks/plugins) thinner |
| **[gemini-cli](https://github.com/google-gemini/gemini-cli)** | 106,741 | 1M-token context — holds a monorepo in one window; Apache-2.0; was the best free tier in the field | Deprecated June 2026: replaced by closed-source Antigravity CLI (agy), free tier cut from ~1,000 to ~20 requests/day — adopt with exit plan |
| **[goose](https://github.com/aaif-goose/goose)** | 53,646 | MCP-first and extensible beyond coding (install/execute/test); any-LLM incl. local; Block-backed, health 99 in this snapshot | Less specialized for pure code-editing loops; leaderboard results modest — team optimizes for failure-pattern fixes, not benchmark rank |
| **[aider](https://github.com/Aider-AI/aider)** | 48,571 | Best git discipline (clean auto-commits); precise file-scoped edits; provider-resilient; the safest 'pair programmer' rather than autonomous agent | Not autonomous — no system-wide orchestration; no MCP support; momentum slowing (52d since push, health 50 in snapshot) |
| **[crush](https://github.com/charmbracelet/crush)** | 27,780 | The most polished TUI aesthetics in the field; multi-model; Charm's Bubble Tea expertise shows in UX | Youngest of the majors — no public benchmark record; non-standard license; smaller ecosystem |
| **[qwen-code](https://github.com/QwenLM/qwen-code)** | 27,480 | Competitive Qwen3-Coder models; best-in-class on Chinese-language briefs and Alibaba-cloud ecosystem; Apache-2.0 | OAuth free tier discontinued 2026-04 — headline value now requires paid API; less strong outside the Qwen model family |
| **[copilot-cli](https://github.com/github/copilot-cli)** | 11,123 | Copilot agent with native GitHub integration (issues, PRs, Actions); familiar billing for Copilot shops | Premium-request pricing — one debugging session can eat a week's free allocation; value collapses off-GitHub (GitLab/Bitbucket) |
| **[pi](https://github.com/earendil-works/pi)** | 99,005 | Minimal, hackable toolkit (API + agent loop + TUI + CLI) — ideal base for building your own agent; MIT | A toolkit, not a turnkey product — you assemble the workflow yourself; smaller community than the big four |
| **[oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent)** | 68,499 | Token-efficiency-first harness (the 'tokenmaxxer' pick) layered on Codex/OpenCode for complex codebases | Depends on underlying agents; opinionated workflow; no OSS license declared |
| **[freebuff](https://github.com/CodebuffAI/freebuff)** | 11,154 | Simple terminal codegen with low setup friction; Apache-2.0 | Far smaller scope and community than the majors; fewer agentic features (no deep hooks/MCP story) |
...
- **[Aider-AI/aider](https://github.com/Aider-AI/aider)** · 48,571★ · Python · Mature  
...
- **[charmbracelet/crush](https://github.com/charmbracelet/crush)** · 27,780★ · Go · Hot  
...
- **[QwenLM/qwen-code](https://github.com/QwenLM/qwen-code)** · 27,480★ · TypeScript · Hot  
...
- **[CodebuffAI/freebuff](https://github.com/CodebuffAI/freebuff)** · 11,154★ · TypeScript · Mature  
  Codegen from the terminal — smaller, focused alternative.  
  <sub>topics: —</sub>
- **[github/copilot-cli](https://github.com/github/copilot-cli)** · 11,123★ · Shell · Classic  
...
- **[mksglu/context-mode](https://github.com/mksglu/context-mode)** · 20,240★ · TypeScript · Rising  
...
- **[ctxrs/ctx](https://github.com/ctxrs/ctx)** · 1,050★ · Rust · Hot  
...
- **[dagger/container-use](https://github.com/dagger/container-use)** · 4,022★ · Go · Mature  
  ...
  <sub>topics: —</sub>
- **[sheeki03/tirith](https://github.com/sheeki03/tirith)** · 2,692★ · Rust · Rising  
...
- **[kenryu42/cc-safety-net](https://github.com/kenryu42/cc-safety-net)** · 1,512★ · TypeScript · Rising  
...
- **[affaan-m/agentshield](https://github.com/affaan-m/agentshield)** · 1,102★ · TypeScript · Declining  
...
- **[Alishahryar1/free-claude-code](https://github.com/Alishahryar1/free-claude-code)** · 51,335★ · Python · Hot  
  Run claude code, codex or pi free in terminal/VSCode/discord — proxy-style access layer.  
  <sub>topics: —</sub>
- **[UfoMiao/zcf](https://github.com/UfoMiao/zcf)** · 6,079★ · TypeScript · Hot  
...
- **[charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea)** · 44,667★ · Go · Classic  
...
- **[charmbracelet/bubbles](https://github.com/charmbracelet/bubbles)** · 8,852★ · Go · Classic  
...
- **Community 8** (7): `earendil-works/pi`, `code-yeongyu/oh-my-openagent`, `CodebuffAI/freebuff`, `mksglu/context-mode`, `sheeki03/tirith`, `kenryu42/cc-safety-net`, `farion1231/cc-switch`
- **Community 11** (5): `rtk-ai/rtk`, `ctxrs/ctx`, `terryso/claude-auto-resume`, `affaan-m/agentshield`, `UfoMiao/zcf`
- **Community 12** (3): `google-gemini/gemini-cli`, `aaif-goose/goose`, `github/copilot-cli`
- **Community 17** (3): `charmbracelet/crush`, `charmbracelet/bubbletea`, `charmbracelet/bubbles`
- **Community 3** (2): `getagentseal/codeburn`, `Alishahryar1/free-claude-code`
- **Community 23** (2): `dagger/container-use`, `zamalali/langchain-code`

**Centrality (PageRank in the full 1,857-repo graph)** — most 'hub-like' terminal-coding tools in your ecosystem:

- `mksglu/context-mode` — PageRank 0.0062
- `CodebuffAI/freebuff` — PageRank 0.0044
- `kenryu42/cc-safety-net` — PageRank 0.0014
- `code-yeongyu/oh-my-openagent` — PageRank 0.0011
- `charmbracelet/bubbles` — PageRank 0.0011
...
- `charmbracelet/bubbles` ⇄ `charmbracelet/crush` (w=1.050) — authors: andrinoff, dependabot[bot], meowgorithm
...
- `charmbracelet/bubbletea` ⇄ `charmbracelet/crush` (w=0.836) — authors: meowgorithm, andrinoff, charmcli
- `code-yeongyu/oh-my-openagent` ⇄ `kenryu42/cc-safety-net` (w=0.550) — topics: opencode, claude, cursor, ai-agents; authors: github-actions[bot]
- `mksglu/context-mode` ⇄ `code-yeongyu/oh-my-openagent` (w=0.544) — topics: claude, codex, opencode; authors: github-actions[bot]
- `mksglu/context-mode` ⇄ `github/copilot-cli` (w=0.500) — authors: github-actions[bot]
- `mksglu/context-mode` ⇄ `earendil-works/pi` (w=0.204) — authors: github-actions[bot]
- `earendil-works/pi` ⇄ `CodebuffAI/freebuff` (w=0.204) — authors: github-actions[bot]
...
| QwenLM/qwen-code | 88 | Hot | very active | 3 | 27% | 674 |
| charmbracelet/crush | 87 | Hot | very active | 3 | 23% | 184 |
| earendil-works/pi | 85 | Hot | very active | 2 | 33% | 257 |
| anomalyco/opencode | 83 | Hot | very active | 2 | 33% | 867 |
| ctxrs/ctx | 80 | Hot | very active | 1 | 83% | 32 |
| sheeki03/tirith | 80 | Rising | very active | 1 | 93% | 88 |
| kenryu42/cc-safety-net | 80 | Rising | very active | 1 | 91% | 40 |
...
| github/copilot-cli | 67 | Classic | very active | 1 | 78% | 408 |
| Alishahryar1/free-claude-code | 62 | Hot | very active | 1 | 81% | 0 |
...
- **cline/cline** (67,115★) — primarily an IDE extension (CLI mode is secondary) — not a TUI-first agent
- **continuedev/continue** (35,677★) — same: IDE-first open-source coding agent
- **OpenHands/OpenHands** (85,544★) — AI-dev *platform* (web/headless), not a terminal UI
- **langchain-ai/open-swe** (10,629★) — asynchronous *cloud* coding agent — no terminal in the loop
- **NousResearch/hermes-agent** (237,998★) — covered in the *hermes-vs-openclaw* and *agent-harnesses* reports
- **affaan-m/ECC** (244,094★) — harness/config framework on top of coding TUIs — see *claude-code-setups*
- **SuperClaude-Org/SuperClaude_Framework** (23,848★) — config framework — see *claude-code-setups* (retired upstream 2026-07)
- **BloopAI/vibe-kanban** (27,949★) — GUI orchestrator *over* coding agents, not a TUI
- **iOfficeAI/AionUi** (32,392★) — GUI wrapper over the CLIs, not a TUI
- **winfunc/opcode** (22,383★) — GUI toolkit for Claude Code
- **jesseduffield/lazygit** (81,751★) — beloved git TUI, but no AI
...
<sub>Tools covered: 30 · Snapshot: 2026-08-29T15:31:31.780Z</sub>
