...
> Derived from **kaiser-data**'s 1,341 starred repos (snapshot `2026-07-19T22:39:07.967Z`), cross-referenced with the repo-similarity graph (1,341 nodes / 4,341 edges, 28 communities). Pros/cons and task rankings are additionally backed by external evidence (Terminal-Bench 2.1, 2026 head-to-head comparisons) — see Methodology.
>
...
- **31 terminal-AI-coding tools** in your stars (**1,171,096★** combined), split into the agents themselves and the terminal ecosystem around them:
...
|---|---|---|---|---|---|---|---|---|---|---|
| [anomalyco/opencode](https://github.com/anomalyco/opencode) | Terminal coding agent | TypeScript | MIT | 187,502 (▲2,262) | Hot | 83 | very active | 0d ago | 1.2y | 15 |
| [anthropics/claude-code](https://github.com/anthropics/claude-code) | Terminal coding agent | Python | — | 138,330 (▲695) | Hot | 77 | very active | 0d ago | 1.4y | 9 |
| [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | Multi-CLI glue | Rust | MIT | 118,938 (▲2,393) | Hot | 76 | very active | 1d ago | 11mo | 25 |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | Terminal coding agent | TypeScript | Apache-2.0 | 106,073 (▲126) | Hot | 99 | very active | 1d ago | 1.3y | 29 |
| [openai/codex](https://github.com/openai/codex) | Terminal coding agent | Rust | Apache-2.0 | 99,672 (▲2,128) | Hot | 90 | very active | 0d ago | 1.3y | 35 |
| [earendil-works/pi](https://github.com/earendil-works/pi) | Terminal coding agent | TypeScript | MIT | 72,748 (▲2,560) | Hot | 85 | very active | 0d ago | 11mo | 12 |
| [rtk-ai/rtk](https://github.com/rtk-ai/rtk) | Session / token ops | Rust | Apache-2.0 | 71,867 (▲1,205) | Hot | 78 | very active | 1d ago | 5mo | 12 |
| [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | Terminal coding agent | TypeScript | NOASSERTION | 66,173 (▲518) | Hot | 78 | very active | 0d ago | 7mo | 5 |
| [aaif-goose/goose](https://github.com/aaif-goose/goose) | Terminal coding agent | Rust | Apache-2.0 | 51,295 (▲157) | Hot | 99 | very active | 1d ago | 1.9y | 42 |
| [Aider-AI/aider](https://github.com/Aider-AI/aider) | Terminal coding agent | Python | Apache-2.0 | 47,514 (▲188) | Classic | 49 | active | 1mo ago | 3.2y | 3 |
| [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) | TUI building blocks | Go | MIT | 43,833 (▲120) | Mature | 64 | active | 7d ago | 6.5y | 3 |
| [Alishahryar1/free-claude-code](https://github.com/Alishahryar1/free-claude-code) | Multi-CLI glue | Python | MIT | 40,920 (▲1,061) | Hot | 61 | very active | 1d ago | 5mo | 8 |
| [charmbracelet/crush](https://github.com/charmbracelet/crush) | Terminal coding agent | Go | NOASSERTION | 26,637 (▲134) | Hot | 77 | very active | 0d ago | 1.2y | 12 |
| [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) | Terminal coding agent | TypeScript | Apache-2.0 | 26,119 (▲131) | Hot | 88 | very active | 0d ago | 1.1y | 21 |
| [mksglu/context-mode](https://github.com/mksglu/context-mode) | Session / token ops | TypeScript | NOASSERTION | 19,094 (▲233) | Hot | 84 | very active | 0d ago | 4mo | 5 |
| [github/copilot-cli](https://github.com/github/copilot-cli) | Terminal coding agent | Shell | NOASSERTION | 10,985 (▲46) | Mature | 68 | very active | 2d ago | 3.5y | 1 |
| [getagentseal/codeburn](https://github.com/getagentseal/codeburn) | Session / token ops | TypeScript | MIT | 8,756 (▲120) | Hot | 79 | very active | 1d ago | 3mo | 5 |
| [charmbracelet/bubbles](https://github.com/charmbracelet/bubbles) | TUI building blocks | Go | MIT | 8,687 (▲28) | Mature | 58 | active | 8d ago | 6.5y | 3 |
| [CodebuffAI/codebuff](https://github.com/CodebuffAI/codebuff) | Terminal coding agent | TypeScript | Apache-2.0 | 7,816 (▲508) | Mature | 74 | very active | 0d ago | 2.0y | 1 |
| [UfoMiao/zcf](https://github.com/UfoMiao/zcf) | Multi-CLI glue | TypeScript | MIT | 6,080 (▲10) | Hot | 71 | very active | 0d ago | 11mo | 5 |
| [dagger/container-use](https://github.com/dagger/container-use) | Safety / isolation | Go | Apache-2.0 | 3,914 (▲3) | Declining | 44 | active | 1mo ago | 1.2y | 1 |
| [sheeki03/tirith](https://github.com/sheeki03/tirith) | Safety / isolation | Rust | AGPL-3.0 | 2,608 (▲13) | Rising | 80 | very active | 1d ago | 5mo | 2 |
| [kenryu42/cc-safety-net](https://github.com/kenryu42/cc-safety-net) | Safety / isolation | TypeScript | MIT | 1,452 (▲12) | Hot | 77 | very active | 20d ago | 6mo | 3 |
| [affaan-m/agentshield](https://github.com/affaan-m/agentshield) | Safety / isolation | TypeScript | MIT | 998 (▲30) | Hot | 65 | very active | 27d ago | 5mo | 4 |
| [ctxrs/ctx](https://github.com/ctxrs/ctx) | Session / token ops | Rust | Apache-2.0 | 906 (▲58) | Hot | 78 | very active | 2d ago | 4mo | 3 |
| [terryso/claude-auto-resume](https://github.com/terryso/claude-auto-resume) | Session / token ops | Shell | MIT | 797 (▲4) | Declining | 36 | slowing | 2mo ago | 1.0y | 2 |
...
| [aniketkarne/ClaudeNightsWatch](https://github.com/aniketkarne/ClaudeNightsWatch) | Session / token ops | Shell | MIT | 368 (▼1) | Declining | 21 | stale | 6mo ago | 1.0y | 0 |
| [evrendom/rudel](https://github.com/evrendom/rudel) | Session / token ops | TypeScript | MIT | 288 (▲1) | Hot | 68 | slowing | 2mo ago | 5mo | 5 |
...
|---|---|---|---|
| **[claude-code](https://github.com/anthropics/claude-code)** | 138,330 | Best-in-class multi-file refactoring and reasoning depth (SWE-bench Pro 69.2%); asks clarifying questions; subagents/hooks/skills/MCP ecosystem is the deepest; 83.1% Terminal-Bench 2.1 with Fable 5 | Not open source (no OSS license in repo); Anthropic-models only; subscription/usage costs add up on heavy agentic use |
| **[opencode](https://github.com/anomalyco/opencode)** | 187,502 | Most-starred OSS agent, MIT license; provider-neutral — 75+ endpoints incl. Bedrock, OpenRouter, local Ollama; strong TUI; no vendor lock-in | Bring-your-own-model means quality varies with the model you pick; harness benchmark scores trail the vendor-tuned agents |
| **[codex](https://github.com/openai/codex)** | 99,672 | #1 named CLI agent on Terminal-Bench 2.1 (83.4% w/ GPT-5.5); fast single-binary Rust TUI; excels at intent-driven, pattern-following edits | OpenAI-models only; less transparent reasoning than Claude Code on big refactors; ecosystem (hooks/plugins) thinner |
| **[gemini-cli](https://github.com/google-gemini/gemini-cli)** | 106,073 | 1M-token context — holds a monorepo in one window; Apache-2.0; was the best free tier in the field | Deprecated June 2026: replaced by closed-source Antigravity CLI (agy), free tier cut from ~1,000 to ~20 requests/day — adopt with exit plan |
| **[goose](https://github.com/aaif-goose/goose)** | 51,295 | MCP-first and extensible beyond coding (install/execute/test); any-LLM incl. local; Block-backed, health 99 in this snapshot | Less specialized for pure code-editing loops; leaderboard results modest — team optimizes for failure-pattern fixes, not benchmark rank |
| **[aider](https://github.com/Aider-AI/aider)** | 47,514 | Best git discipline (clean auto-commits); precise file-scoped edits; provider-resilient; the safest 'pair programmer' rather than autonomous agent | Not autonomous — no system-wide orchestration; no MCP support; momentum slowing (52d since push, health 50 in snapshot) |
| **[crush](https://github.com/charmbracelet/crush)** | 26,637 | The most polished TUI aesthetics in the field; multi-model; Charm's Bubble Tea expertise shows in UX | Youngest of the majors — no public benchmark record; non-standard license; smaller ecosystem |
| **[qwen-code](https://github.com/QwenLM/qwen-code)** | 26,119 | Competitive Qwen3-Coder models; best-in-class on Chinese-language briefs and Alibaba-cloud ecosystem; Apache-2.0 | OAuth free tier discontinued 2026-04 — headline value now requires paid API; less strong outside the Qwen model family |
| **[copilot-cli](https://github.com/github/copilot-cli)** | 10,985 | Copilot agent with native GitHub integration (issues, PRs, Actions); familiar billing for Copilot shops | Premium-request pricing — one debugging session can eat a week's free allocation; value collapses off-GitHub (GitLab/Bitbucket) |
| **[pi](https://github.com/earendil-works/pi)** | 72,748 | Minimal, hackable toolkit (API + agent loop + TUI + CLI) — ideal base for building your own agent; MIT | A toolkit, not a turnkey product — you assemble the workflow yourself; smaller community than the big four |
| **[oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent)** | 66,173 | Token-efficiency-first harness (the 'tokenmaxxer' pick) layered on Codex/OpenCode for complex codebases | Depends on underlying agents; opinionated workflow; no OSS license declared |
| **[codebuff](https://github.com/CodebuffAI/codebuff)** | 7,816 | Simple terminal codegen with low setup friction; Apache-2.0 | Far smaller scope and community than the majors; fewer agentic features (no deep hooks/MCP story) |
...
- **[Aider-AI/aider](https://github.com/Aider-AI/aider)** · 47,514★ · Python · Classic  
...
- **[charmbracelet/crush](https://github.com/charmbracelet/crush)** · 26,637★ · Go · Hot  
...
- **[QwenLM/qwen-code](https://github.com/QwenLM/qwen-code)** · 26,119★ · TypeScript · Hot  
  Qwen team's terminal agent — strong with Qwen3-Coder and Chinese-language briefs; OAuth free tier ended 2026-04.  
  <sub>topics: —</sub>
- **[github/copilot-cli](https://github.com/github/copilot-cli)** · 10,985★ · Shell · Mature  
  Copilot coding agent in the terminal — deep GitHub integration, premium-request pricing model.  
  <sub>topics: —</sub>
- **[CodebuffAI/codebuff](https://github.com/CodebuffAI/codebuff)** · 7,816★ · TypeScript · Mature  
...
- **[ctxrs/ctx](https://github.com/ctxrs/ctx)** · 906★ · Rust · Hot  
...
- **[affaan-m/agentshield](https://github.com/affaan-m/agentshield)** · 998★ · TypeScript · Hot  
...
- **[Alishahryar1/free-claude-code](https://github.com/Alishahryar1/free-claude-code)** · 40,920★ · Python · Hot  
...
- **[charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea)** · 43,833★ · Go · Mature  
...
- **[charmbracelet/bubbles](https://github.com/charmbracelet/bubbles)** · 8,687★ · Go · Mature  
...
**Community clustering.** These 31 tools span **11 of the graph's 28 communities**.

- **Community 8** (9): `github/copilot-cli`, `earendil-works/pi`, `code-yeongyu/oh-my-openagent`, `CodebuffAI/codebuff`, `mksglu/context-mode`, `evrendom/rudel`, `sheeki03/tirith`, `kenryu42/cc-safety-net`, `UfoMiao/zcf`
- **Community 2** (8): `anomalyco/opencode`, `Aider-AI/aider`, `rtk-ai/rtk`, `getagentseal/codeburn`, `ctxrs/ctx`, `terryso/claude-auto-resume`, `affaan-m/agentshield`, `BA-CalderonMorales/terminal-jarvis`
- **Community 16** (5): `charmbracelet/crush`, `Alishahryar1/free-claude-code`, `zamalali/langchain-code`, `charmbracelet/bubbletea`, `charmbracelet/bubbles`
- **Community 1** (2): `google-gemini/gemini-cli`, `aaif-goose/goose`

**Centrality (PageRank in the full 1,341-repo graph)** — most 'hub-like' terminal-coding tools in your ecosystem:

- `CodebuffAI/codebuff` — PageRank 0.0058
...
- `earendil-works/pi` ⇄ `CodebuffAI/codebuff` (w=0.217) — authors: github-actions[bot]
...
| QwenLM/qwen-code | 88 | Hot | very active | 3 | 33% | 546 |
...
| sheeki03/tirith | 80 | Rising | very active | 1 | 65% | 86 |
...
| UfoMiao/zcf | 71 | Hot | very active | 1 | 69% | 93 |
...
- **cline/cline** (64,814★) — primarily an IDE extension (CLI mode is secondary) — not a TUI-first agent
- **continuedev/continue** (34,970★) — same: IDE-first open-source coding agent
- **OpenHands/OpenHands** (81,317★) — AI-dev *platform* (web/headless), not a terminal UI
- **langchain-ai/open-swe** (10,354★) — asynchronous *cloud* coding agent — no terminal in the loop
- **NousResearch/hermes-agent** (217,226★) — covered in the *hermes-vs-openclaw* and *agent-harnesses* reports
- **affaan-m/ECC** (231,210★) — harness/config framework on top of coding TUIs — see *claude-code-setups*
- **SuperClaude-Org/SuperClaude_Framework** (23,578★) — config framework — see *claude-code-setups* (retired upstream 2026-07)
- **BloopAI/vibe-kanban** (27,449★) — GUI orchestrator *over* coding agents, not a TUI
- **iOfficeAI/AionUi** (30,447★) — GUI wrapper over the CLIs, not a TUI
- **winfunc/opcode** (22,188★) — GUI toolkit for Claude Code
- **jesseduffield/lazygit** (80,521★) — beloved git TUI, but no AI
...
<sub>Tools covered: 31 · Snapshot: 2026-07-19T22:39:07.967Z</sub>
