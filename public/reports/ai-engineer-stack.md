...
> Derived from **kaiser-data**'s 1,859 starred repos (snapshot `2026-08-29T23:54:34.573Z`), cross-referenced with the repo-similarity graph (1,859 nodes / 6,070 edges, 37 communities) and the 2026 AI-engineering landscape.
>
> Generated 2026-08-30 by `scripts/reports/ai_engineer_stack.py` (regenerate any time — no API cost).
...
| [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | Must-have | Orchestration & agents | Python | 145,151 | Classic | 89 | very active | 2d ago | 3.9y |
...
| [unclecode/crawl4ai](https://github.com/unclecode/crawl4ai) | Must-have | Data & ingestion | Python | 79,574 | Mature | 81 | very active | 5d ago | 2.3y |
...
| [hiyouga/LlamaFactory](https://github.com/hiyouga/LlamaFactory) | Must-have | Fine-tuning | Python | 74,403 | Classic | 83 | very active | 3d ago | 3.3y |
...
| [Lightning-AI/pytorch-lightning](https://github.com/Lightning-AI/pytorch-lightning) | Fundamental | Base & training | Python | 31,313 | Classic | 73 | very active | 4d ago | 7.4y |
...
- **Community 19** (8): `firecrawl/firecrawl`, `langchain-ai/langchain`, `TauricResearch/TradingAgents`, `OpenHands/OpenHands`, `mem0ai/mem0`, `MemPalace/mempalace`, `Aider-AI/aider`, `langchain-ai/langgraph`
...
- **Community 10** (6): `obra/superpowers`, `browser-use/browser-use`, `dair-ai/Prompt-Engineering-Guide`, `crewAIInc/crewAI`, `agno-agi/agno`, `chroma-core/chroma`
- **Community 16** (5): `rasbt/LLMs-from-scratch`, `labmlai/annotated_deep_learning_paper_implementations`, `deepspeedai/DeepSpeed`, `facebookresearch/faiss`, `Lightning-AI/pytorch-lightning`
- **Community 14** (5): `mlabonne/llm-course`, `BerriAI/litellm`, `langfuse/langfuse`, `comet-ml/opik`, `Arize-ai/phoenix`
- **Community 8** (5): `infiniflow/ragflow`, `milvus-io/milvus`, `VectifyAI/PageIndex`, `qdrant/qdrant`, `NirDiamant/RAG_Techniques`
- **Community 13** (4): `github/spec-kit`, `google-gemini/gemini-cli`, `punkpeye/awesome-mcp-servers`, `modelcontextprotocol/servers`
- **Community 11** (3): `openai/whisper`, `unclecode/crawl4ai`, `unslothai/unsloth`
- **Community 5** (3): `microsoft/generative-ai-for-beginners`, `microsoft/playwright-mcp`, `microsoft/graphrag`

**Centrality (PageRank in the full 1,859-repo graph)** — the most 'hub-like' AI-eng repos in your stars (good signal for *foundational*):
...
| langchain-ai/langchain | Must-have | 89 | Classic | very active | 3 | 31% |
...
<sub>Repos covered: 56 · Snapshot: 2026-08-29T23:54:34.573Z</sub>
