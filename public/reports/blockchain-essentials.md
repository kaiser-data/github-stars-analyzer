...
2. **Autonomous AI trading.** `TauricResearch/TradingAgents` (82k★) and `HKUDS/AI-Trader` are high-momentum, and `elizaOS/eliza` ships at enormous velocity (20,079 commits/90d).
...
|---|---|---|---|---|---|
| [solidity](https://github.com/argotorg/solidity) | 25,717 (▲24) | 🔵 Classic | 84 | C++ | The Solidity compiler & language (ex ethereum/solidity). |
| [vyper](https://github.com/vyperlang/vyper) | 5,180 (▲3) | 🔵 Classic | 75 | Python | Pythonic contract language; security-minded alternative. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [foundry](https://github.com/foundry-rs/foundry) | 10,570 (▲20) | 🔵 Classic | 85 | Rust | Forge/Cast/Anvil — the dominant Rust-based Solidity toolchain. |
| [hardhat](https://github.com/NomicFoundation/hardhat) | 8,505 (▲6) | 🔵 Classic | 78 | TypeScript | The established JS/TS dev environment. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [openzeppelin-contracts](https://github.com/OpenZeppelin/openzeppelin-contracts) | 27,236 (▲30) | 🔵 Classic | 81 | Solidity | The standard audited token/access/proxy library. |
| [solmate](https://github.com/transmissions11/solmate) | 4,288 (▼1) | ⚫ Abandoned | 6 | Solidity | Minimalist, modern contract primitives. |
| [solady](https://github.com/Vectorized/solady) | 3,368 (▲22) | 🟢 Mature | 46 | Solidity | Gas-optimized Solidity building blocks. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [slither](https://github.com/crytic/slither) | 6,353 (▲15) | 🔵 Classic | 63 | Python | The go-to static analyzer for contract vulnerabilities. |
| [echidna](https://github.com/crytic/echidna) | 3,171 (▲5) | 🔵 Classic | 75 | Haskell | Property-based fuzzer for smart contracts. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [ethers.js](https://github.com/ethers-io/ethers.js) | 8,718 (▲14) | 🟢 Mature | 49 | TypeScript | The long-time standard JS/TS library. |
| [wagmi](https://github.com/wevm/wagmi) | 6,744 (▲3) | 🔵 Classic | 75 | TypeScript | React hooks for Ethereum (pairs with viem). |
| [viem](https://github.com/wevm/viem) | 3,545 (▲18) | 🔵 Classic | 85 | TypeScript | Modern, type-safe Ethereum client — default for new TS apps. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [go-ethereum](https://github.com/ethereum/go-ethereum) | 51,314 (▲41) | 🔵 Classic | 90 | Go | geth — the reference Ethereum node (Go). |
| [reth](https://github.com/paradigmxyz/reth) | 5,753 (▲19) | 🔵 Classic | 85 | Rust | Modern, fast Rust client (rising alternative). |
| [nethermind](https://github.com/NethermindEth/nethermind) | 1,588 (▲3) | 🔵 Classic | 94 | C# | High-perf .NET client, strong on tooling. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [chainlink](https://github.com/smartcontractkit/chainlink) | 8,236 (▲5) | 🔵 Classic | 98 | Go | Price feeds you need to value positions. |
| [safe-smart-account](https://github.com/safe-fndn/safe-smart-account) | 2,175 (▲4) | 🟢 Mature | 46 | TypeScript | Safe multisig — treasury/custody standard. |
| [account-abstraction](https://github.com/eth-infinitism/account-abstraction) | 1,937 (▲7) | 🟠 Declining | 24 | TypeScript | Reference ERC-4337 account-abstraction. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [blockscout](https://github.com/blockscout/blockscout) | 4,651 (▲24) | 🔵 Classic | 80 | Elixir | Open EVM explorer; exposes an MCP server for agents. |
| [graph-node](https://github.com/graphprotocol/graph-node) | 3,146 (▼1) | 🔵 Classic | 74 | Rust | The Graph — index chains into queryable subgraphs. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [v3-core](https://github.com/Uniswap/v3-core) | 5,025 (▲8) | 🟢 Mature | 35 | TypeScript | The concentrated-liquidity AMM still everywhere. |
| [v4-core](https://github.com/Uniswap/v4-core) | 2,527 (▲1) | 🟢 Mature | 29 | Solidity | Latest AMM/DEX core (hooks). |
| [comet](https://github.com/compound-finance/comet) | 312 (▼1) | 🟢 Mature | 40 | TypeScript | Compound III lending. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [anchor](https://github.com/otter-sec/anchor) | 5,122 (▲14) | 🔵 Classic | 82 | Rust | The standard Solana smart-contract framework. |
| [solana-web3.js](https://github.com/solana-foundation/solana-web3.js) | 2,749 | 🟢 Mature | 46 | TypeScript | JS SDK for Solana. |
| [agave](https://github.com/anza-xyz/agave) | 1,895 (▲23) | 🟢 Mature | 97 | Rust | The Solana validator client. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [risc0](https://github.com/risc0/risc0) | 2,181 (▲6) | 🟢 Mature | 52 | C++ | General-purpose zkVM. |
| [sp1](https://github.com/succinctlabs/sp1) | 1,732 (▲9) | 🟢 Mature | 84 | Rust | Performant RISC-V zkVM. |
| [circom](https://github.com/iden3/circom) | 1,688 (▲5) | 🟢 Mature | 33 | WebAssembly | Circuit compiler for zk-SNARKs. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [ClawRouter](https://github.com/BlockRunAI/ClawRouter) | 6,573 (▼109) | 🔥 Hot | 78 | TypeScript | Agent LLM router with USDC payments on Base & Solana via x402. |
| [x402scan](https://github.com/Merit-Systems/x402scan) | 382 (▲14) | 🔥 Hot | 81 | TypeScript | x402 ecosystem explorer. |
| [x402](https://github.com/coinbase/x402) | 149 (▲12) | 🟠 Declining | 35 | TypeScript | The payments-over-HTTP protocol everyone's building on. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 101,235 (▲5,162) | 🟢 Mature | 69 | Python | Multi-agent LLM trading framework. |
| [OpenBB](https://github.com/OpenBB-finance/OpenBB) | 72,386 (▲830) | 🔵 Classic | 66 | Python | Financial data platform 'for analysts, quants & AI agents'. |
| [AI-Trader](https://github.com/HKUDS/AI-Trader) | 21,667 (▲472) | 📈 Rising | 50 | Python | Fully-automated agent-native trading. |
| [eliza](https://github.com/elizaOS/eliza) | 19,190 (▲263) | 🟢 Mature | 89 | TypeScript | Crypto-native agent OS (wallet/chain plugins). |
