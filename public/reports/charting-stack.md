...
> Derived from **kaiser-data**'s 2,087 starred repos (snapshot `2026-09-07T10:42:15.216Z`), cross-referenced with the repo-similarity graph (2,087 nodes / 6,821 edges, 38 communities). The advantages/disadvantages column is editorial judgement grounded in the dataset's own health metrics plus external comparisons — see Methodology.
>
> Generated 2026-09-07 by `scripts/reports/charting_stack.py` (regenerate any time — no API cost).
...
- **61 charting and visualization tools** in your stars (**1,333,244★** combined), grouped into 10 layers:
...
| Tool | ★ | ✅ Advantages | ⚠️ Disadvantages | 🎯 Best for |
|---|---|---|---|---|
| **[matplotlib/matplotlib](https://github.com/matplotlib/matplotlib)** | 23,198 (▲29) | Can draw literally anything; the publication standard for scientific figures; vector output (PDF/SVG/EPS); enormous documentation and 20 years of StackOverflow answers; PSF-style licence. | Two competing APIs (pyplot state machine vs. object-oriented) confuse newcomers; verbose for anything non-trivial; dated defaults; no real interactivity; slow on large datasets. | Publication figures and any plot that must be exactly right. |
...
| **[rilldata/rill](https://github.com/rilldata/rill)** | 2,868 (▲1) | Genuinely fast exploratory slicing (embedded DuckDB); dashboards-as-YAML; local-first development loop; deliberately designed to be driven by agents as well as humans. | Young project with a narrower feature set than Superset/Metabase; opinionated metrics-layer model; open-source core alongside a commercial cloud. | Fast metric exploration for teams comfortable defining dashboards in code. |

### Data-app framework

| Tool | ★ | ✅ Advantages | ⚠️ Disadvantages | 🎯 Best for |
|---|---|---|---|---|
| **[streamlit/streamlit](https://github.com/streamlit/streamlit)** | 45,703 (▲4) | Lowest possible friction (a script becomes an app); enormous component ecosystem; free Community Cloud hosting; renders matplotlib/Plotly/Altair/Vega directly. | The rerun-on-every-interaction model becomes a correctness and performance problem as apps grow; state management is bolted on; limited layout control; not built for high traffic or multi-user production. | Internal prototypes and demos that will stay simple. |
| **[gradio-app/gradio](https://github.com/gradio-app/gradio)** | 43,484 (▲3) | Purpose-built for model demos (image/audio/chat components are excellent); instant public share links; deep Hugging Face Spaces integration; auto-generated REST API. | Charting is an afterthought compared to Streamlit; not designed for traffic or complex multi-page apps; layout control is limited; app structure gets messy past a few screens. | ML model demos, chat UIs, and Hugging Face Spaces. |
...
|---|---|---|---|---|---|---|---|---|---|---|
| [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | Diagrams & AI charts | TypeScript | MIT | 131,304 (▲78) | Classic | 60 | very active | 0d ago | 6.7y | 18 |
| [d3/d3](https://github.com/d3/d3) | Low-level / high-performance | Shell | ISC | 113,666 (▲15) | Mature | 31 | slowing | 3mo ago | 16.0y | 0 |
| [grafana/grafana](https://github.com/grafana/grafana) | BI & dashboard platform | TypeScript | AGPL-3.0 | 76,650 (▲34) | Classic | 99 | very active | 0d ago | 12.7y | 55 |
| [apache/superset](https://github.com/apache/superset) | BI & dashboard platform | Python | Apache-2.0 | 74,670 (▲8) | Classic | 85 | very active | 0d ago | 11.1y | 24 |
| [chartjs/Chart.js](https://github.com/chartjs/Chart.js) | Web charting library | JavaScript | MIT | 67,684 (▲2) | Mature | 33 | slowing | 3mo ago | 13.5y | 0 |
| [apache/echarts](https://github.com/apache/echarts) | Web charting library | TypeScript | Apache-2.0 | 67,261 (▲10) | Classic | 64 | active | 3d ago | 13.4y | 3 |
| [jgraph/drawio-desktop](https://github.com/jgraph/drawio-desktop) | Diagrams & AI charts | JavaScript | Apache-2.0 | 62,969 (▲14) | Classic | 79 | very active | 1d ago | 9.3y | 3 |
| [metabase/metabase](https://github.com/metabase/metabase) | BI & dashboard platform | Clojure | NOASSERTION | 49,117 (▲15) | Classic | 99 | very active | 0d ago | 11.6y | 32 |
| [streamlit/streamlit](https://github.com/streamlit/streamlit) | Data-app framework | Python | Apache-2.0 | 45,703 (▲4) | Classic | 83 | very active | 0d ago | 7.0y | 8 |
| [gradio-app/gradio](https://github.com/gradio-app/gradio) | Data-app framework | Python | Apache-2.0 | 43,484 (▲3) | Classic | 85 | very active | 0d ago | 7.7y | 5 |
| [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) | BI & dashboard platform | JavaScript | AGPL-3.0 | 40,857 (▲8) | Classic | 84 | very active | 0d ago | 5.4y | 18 |
| [reflex-dev/reflex](https://github.com/reflex-dev/reflex) | Data-app framework | Python | Apache-2.0 | 28,882 (▲2) | Classic | 84 | very active | 0d ago | 3.9y | 12 |
| [getredash/redash](https://github.com/getredash/redash) | BI & dashboard platform | Python | BSD-2-Clause | 28,780 (▼1) | Classic | 64 | active | 4d ago | 12.9y | 9 |
| [recharts/recharts](https://github.com/recharts/recharts) | React charting library | TypeScript | MIT | 27,545 | Classic | 84 | very active | 0d ago | 11.1y | 20 |
| [plotly/dash](https://github.com/plotly/dash) | Data-app framework | Python | MIT | 24,398 (▼1) | Classic | 77 | very active | 3d ago | 11.4y | 8 |
| [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) | Python plotting | Python | — | 23,198 (▲29) | Classic | 93 | very active | 0d ago | 15.6y | 24 |
| [openobserve/openobserve](https://github.com/openobserve/openobserve) | BI & dashboard platform | TypeScript | AGPL-3.0 | 21,670 (▲10) | Classic | 89 | very active | 0d ago | 3.6y | 26 |
| [elastic/kibana](https://github.com/elastic/kibana) | BI & dashboard platform | TypeScript | NOASSERTION | 21,284 (▲1) | Classic | 99 | very active | 0d ago | 13.6y | 56 |
| [airbnb/visx](https://github.com/airbnb/visx) | React charting library | TypeScript | MIT | 21,035 (▲1) | Classic | 53 | slowing | 2mo ago | 9.5y | 3 |
| [bokeh/bokeh](https://github.com/bokeh/bokeh) | Python plotting | Python | BSD-3-Clause | 20,445 | Classic | 69 | very active | 1d ago | 14.5y | 17 |
| [Avaiga/taipy](https://github.com/Avaiga/taipy) | Data-app framework | Python | Apache-2.0 | 19,433 (▼1) | Mature | 51 | active | 28d ago | 4.6y | 0 |
| [plotly/plotly.py](https://github.com/plotly/plotly.py) | Python plotting | Python | MIT | 18,765 | Classic | 78 | very active | 3d ago | 12.8y | 8 |
| [plotly/plotly.js](https://github.com/plotly/plotly.js) | Web charting library | JavaScript | MIT | 18,318 (▲1) | Classic | 78 | very active | 2d ago | 10.8y | 6 |
| [Canner/WrenAI](https://github.com/Canner/WrenAI) | BI & dashboard platform | Python | NOASSERTION | 17,521 (▲14) | Mature | 86 | very active | 0d ago | 2.5y | 17 |
| [tradingview/lightweight-charts](https://github.com/tradingview/lightweight-charts) | Low-level / high-performance | TypeScript | Apache-2.0 | 17,195 (▲9) | Classic | 73 | very active | 0d ago | 7.3y | 7 |
| [Kanaries/pygwalker](https://github.com/Kanaries/pygwalker) | Python plotting | Python | Apache-2.0 | 15,957 | Classic | 64 | very active | 2d ago | 3.6y | 2 |
| [apexcharts/apexcharts.js](https://github.com/apexcharts/apexcharts.js) | Web charting library | JavaScript | NOASSERTION | 15,149 | Classic | 79 | very active | 1d ago | 8.1y | 6 |
...
| [visgl/deck.gl](https://github.com/visgl/deck.gl) | Low-level / high-performance | TypeScript | MIT | 14,561 (▲3) | Classic | 84 | very active | 0d ago | 10.7y | 12 |
| [plouc/nivo](https://github.com/plouc/nivo) | React charting library | TypeScript | MIT | 14,092 (▲1) | Classic | 48 | active | 1mo ago | 10.4y | 4 |
| [antvis/G2](https://github.com/antvis/G2) | Web charting library | TypeScript | MIT | 12,605 (▲1) | Mature | 62 | active | 4d ago | 10.3y | 2 |
| [highcharts/highcharts](https://github.com/highcharts/highcharts) | Web charting library | TypeScript | NOASSERTION | 12,488 (▲1) | Classic | 70 | very active | 0d ago | 16.3y | 9 |
| [keplergl/kepler.gl](https://github.com/keplergl/kepler.gl) | Low-level / high-performance | TypeScript | MIT | 11,995 (▼1) | Classic | 77 | very active | 0d ago | 8.5y | 5 |
| [vega/vega](https://github.com/vega/vega) | Grammar of graphics | JavaScript | BSD-3-Clause | 11,984 (▲2) | Classic | 72 | very active | 0d ago | 13.6y | 14 |
| [perspective-dev/perspective](https://github.com/perspective-dev/perspective) | Low-level / high-performance | Rust | Apache-2.0 | 11,171 (▲2) | Classic | 78 | very active | 2d ago | 8.9y | 4 |
| [lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid) | Diagrams & AI charts | TypeScript | MIT | 11,043 (▲5) | Declining | 35 | slowing | 4mo ago | 7mo | 0 |
| [leeoniya/uPlot](https://github.com/leeoniya/uPlot) | Low-level / high-performance | JavaScript | MIT | 10,476 (▲1) | Mature | 27 | slowing | 4mo ago | 7.0y | 0 |
| [vega/altair](https://github.com/vega/altair) | Grammar of graphics | Python | BSD-3-Clause | 10,469 (▲1) | Classic | 71 | very active | 2d ago | 11.0y | 13 |
| [c3js/c3](https://github.com/c3js/c3) | Web charting library | JavaScript | MIT | 9,349 | Classic | 48 | active | 1mo ago | 13.1y | 2 |
| [evidence-dev/evidence](https://github.com/evidence-dev/evidence) | BI & dashboard platform | TypeScript | MIT | 6,911 | Classic | 77 | very active | 3d ago | 5.3y | 4 |
| [ScottPlot/ScottPlot](https://github.com/ScottPlot/ScottPlot) | Native / systems charting | C# | MIT | 6,733 (▲2) | Classic | 61 | very active | 23d ago | 8.7y | 8 |
| [holoviz/panel](https://github.com/holoviz/panel) | Python plotting | Python | BSD-3-Clause | 5,769 | Classic | 80 | very active | 0d ago | 8.0y | 18 |
| [vega/vega-lite](https://github.com/vega/vega-lite) | Grammar of graphics | TypeScript | BSD-3-Clause | 5,477 (▲1) | Classic | 66 | very active | 4d ago | 11.8y | 6 |
| [observablehq/plot](https://github.com/observablehq/plot) | Web charting library | HTML | ISC | 5,368 (▲2) | Mature | 44 | active | 6d ago | 5.9y | 1 |
...
| [has2k1/plotnine](https://github.com/has2k1/plotnine) | Grammar of graphics | Python | MIT | 4,758 | Mature | 79 | very active | 3d ago | 9.4y | 1 |
| [tremorlabs/tremor](https://github.com/tremorlabs/tremor) | React charting library | TypeScript | Apache-2.0 | 3,601 (▲2) | Declining | 9 | stale | 11mo ago | 2.5y | 0 |
| [gonum/plot](https://github.com/gonum/plot) | Native / systems charting | Go | BSD-3-Clause | 2,968 | Mature | 26 | slowing | 4mo ago | 13.1y | 0 |
| [holoviz/holoviews](https://github.com/holoviz/holoviews) | Python plotting | Python | BSD-3-Clause | 2,909 | Classic | 71 | very active | 0d ago | 12.3y | 8 |
| [rilldata/rill](https://github.com/rilldata/rill) | BI & dashboard platform | Go | Apache-2.0 | 2,868 (▲1) | Classic | 84 | very active | 0d ago | 4.7y | 12 |
...
| [posit-dev/great-tables](https://github.com/posit-dev/great-tables) | Python plotting | Python | MIT | 2,726 | Classic | 73 | very active | 14d ago | 4.3y | 2 |
| [weaveworks/grafanalib](https://github.com/weaveworks/grafanalib) | Dashboards as code | Python | Apache-2.0 | 1,974 (▲1) | Declining | 14 | stale | 9mo ago | 9.8y | 0 |
| [reflex-dev/xy](https://github.com/reflex-dev/xy) | Python plotting | Python | Apache-2.0 | 1,826 (▲1) | Hot | 74 | very active | 4d ago | 2mo | 11 |
...
| [hustcc/mcp-mermaid](https://github.com/hustcc/mcp-mermaid) | Diagrams & AI charts | TypeScript | MIT | 630 (▲1) | Declining | 40 | slowing | 3mo ago | 1.3y | 0 |
...
| [deliveryhero/grafyaml](https://github.com/deliveryhero/grafyaml) | Dashboards as code | Python | Apache-2.0 | 44 | Mature | 50 | active | 21d ago | 6.1y | 3 |
...
- **[chartjs/Chart.js](https://github.com/chartjs/Chart.js)** · 67,684★ · JavaScript · Mature  
...
- **[apache/echarts](https://github.com/apache/echarts)** · 67,261★ · TypeScript · Classic  
...
- **[plotly/plotly.js](https://github.com/plotly/plotly.js)** · 18,318★ · JavaScript · Classic  
...
- **[antvis/G2](https://github.com/antvis/G2)** · 12,605★ · TypeScript · Mature  
...
- **[highcharts/highcharts](https://github.com/highcharts/highcharts)** · 12,488★ · TypeScript · Classic  
...
- **[observablehq/plot](https://github.com/observablehq/plot)** · 5,368★ · HTML · Mature  
...
- **[airbnb/visx](https://github.com/airbnb/visx)** · 21,035★ · TypeScript · Classic  
...
- **[tremorlabs/tremor](https://github.com/tremorlabs/tremor)** · 3,601★ · TypeScript · Declining  
...
- **[d3/d3](https://github.com/d3/d3)** · 113,666★ · Shell · Mature  
...
- **[tradingview/lightweight-charts](https://github.com/tradingview/lightweight-charts)** · 17,195★ · TypeScript · Classic  
...
- **[visgl/deck.gl](https://github.com/visgl/deck.gl)** · 14,561★ · TypeScript · Classic  
...
- **[keplergl/kepler.gl](https://github.com/keplergl/kepler.gl)** · 11,995★ · TypeScript · Classic  
...
- **[perspective-dev/perspective](https://github.com/perspective-dev/perspective)** · 11,171★ · Rust · Classic  
...
- **[leeoniya/uPlot](https://github.com/leeoniya/uPlot)** · 10,476★ · JavaScript · Mature  
...
- **[vega/vega](https://github.com/vega/vega)** · 11,984★ · JavaScript · Classic  
...
- **[vega/altair](https://github.com/vega/altair)** · 10,469★ · Python · Classic  
  The Python API over Vega-Lite — statistical charts as method chains on a DataFrame.  
  <sub>topics: —</sub>
- **[vega/vega-lite](https://github.com/vega/vega-lite)** · 5,477★ · TypeScript · Classic  
...
- **[matplotlib/matplotlib](https://github.com/matplotlib/matplotlib)** · 23,198★ · Python · Classic  
...
- **[reflex-dev/xy](https://github.com/reflex-dev/xy)** · 1,826★ · Python · Hot  
...
- **[grafana/grafana](https://github.com/grafana/grafana)** · 76,650★ · TypeScript · Classic  
...
- **[apache/superset](https://github.com/apache/superset)** · 74,670★ · Python · Classic  
...
- **[metabase/metabase](https://github.com/metabase/metabase)** · 49,117★ · Clojure · Classic  
...
- **[ToolJet/ToolJet](https://github.com/ToolJet/ToolJet)** · 40,857★ · JavaScript · Classic  
...
- **[getredash/redash](https://github.com/getredash/redash)** · 28,780★ · Python · Classic  
...
- **[openobserve/openobserve](https://github.com/openobserve/openobserve)** · 21,670★ · TypeScript · Classic  
...
- **[elastic/kibana](https://github.com/elastic/kibana)** · 21,284★ · TypeScript · Classic  
...
- **[Canner/WrenAI](https://github.com/Canner/WrenAI)** · 17,521★ · Python · Mature  
...
- **[rilldata/rill](https://github.com/rilldata/rill)** · 2,868★ · Go · Classic  
...
- **[streamlit/streamlit](https://github.com/streamlit/streamlit)** · 45,703★ · Python · Classic  
...
- **[gradio-app/gradio](https://github.com/gradio-app/gradio)** · 43,484★ · Python · Classic  
...
- **[plotly/dash](https://github.com/plotly/dash)** · 24,398★ · Python · Classic  
...
- **[Avaiga/taipy](https://github.com/Avaiga/taipy)** · 19,433★ · Python · Mature  
...
- **[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw)** · 131,304★ · TypeScript · Classic  
...
- **[jgraph/drawio-desktop](https://github.com/jgraph/drawio-desktop)** · 62,969★ · JavaScript · Classic  
...
- **[lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid)** · 11,043★ · TypeScript · Declining  
  A polished renderer for Mermaid diagrams — Mermaid's text-to-diagram syntax with far better typography and theming.  
  <sub>topics: —</sub>
- **[hustcc/mcp-mermaid](https://github.com/hustcc/mcp-mermaid)** · 630★ · TypeScript · Declining  
...
- **[ScottPlot/ScottPlot](https://github.com/ScottPlot/ScottPlot)** · 6,733★ · C# · Classic  
...
- **Community 14** (24): `apache/echarts`, `plotly/plotly.js`, `apexcharts/apexcharts.js`, `highcharts/highcharts`, `antvis/G2`, `observablehq/plot`, `plouc/nivo`, `airbnb/visx`, `d3/d3`, `leeoniya/uPlot`, `perspective-dev/perspective`, `visgl/deck.gl`, `keplergl/kepler.gl`, `vega/vega-lite`, `vega/vega`, `vega/altair`, `JetBrains/lets-plot`, `plotly/plotly.py`, `apache/superset`, `plotly/dash`, `excalidraw/excalidraw`, `ScottPlot/ScottPlot`, `AAChartModel/AAChartKit`, `alandefreitas/matplotplusplus`
- **Community 17** (8): `has2k1/plotnine`, `matplotlib/matplotlib`, `man-group/dtale`, `reflex-dev/xy`, `streamlit/streamlit`, `gradio-app/gradio`, `reflex-dev/reflex`, `Avaiga/taipy`
- **Community 6** (7): `grafana/grafana`, `elastic/kibana`, `openobserve/openobserve`, `evidence-dev/evidence`, `grafana/grafana-foundation-sdk`, `weaveworks/grafanalib`, `K-Phoen/grabana`
- **Community 7** (6): `chartjs/Chart.js`, `c3js/c3`, `frappe/charts`, `tradingview/lightweight-charts`, `ToolJet/ToolJet`, `deliveryhero/grafyaml`
- **Community 4** (5): `bokeh/bokeh`, `holoviz/holoviews`, `holoviz/panel`, `Kanaries/pygwalker`, `posit-dev/great-tables`
- **Community 15** (5): `metabase/metabase`, `getredash/redash`, `rilldata/rill`, `Canner/WrenAI`, `jgraph/drawio-desktop`
- **Community 0** (3): `recharts/recharts`, `tremorlabs/tremor`, `lukilabs/beautiful-mermaid`

**Centrality (PageRank in the full 2,087-repo graph)** — most 'hub-like' visualization tools in your ecosystem:
...
- `observablehq/plot` — PageRank 0.0008
...
- `apache/superset` ⇄ `apache/echarts` (w=0.702) — topics: apache, data-visualization, data-viz; authors: dependabot[bot]
...
|---|---|---|---|---|---|---|
| grafana/grafana | 99 | Classic | very active | 13 | 14% | 644 |
| metabase/metabase | 99 | Classic | very active | 9 | 13% | 833 |
| elastic/kibana | 99 | Classic | very active | 12 | 13% | 265 |
| matplotlib/matplotlib | 93 | Classic | very active | 4 | 19% | 102 |
| openobserve/openobserve | 89 | Classic | very active | 3 | 23% | 220 |
| Canner/WrenAI | 86 | Mature | very active | 3 | 30% | 200 |
| apache/superset | 85 | Classic | very active | 2 | 47% | 268 |
| gradio-app/gradio | 85 | Classic | very active | 2 | 44% | 5095 |
| recharts/recharts | 84 | Classic | very active | 2 | 48% | 93 |
| visgl/deck.gl | 84 | Classic | very active | 2 | 38% | 313 |
| rilldata/rill | 84 | Classic | very active | 2 | 33% | 331 |
| ToolJet/ToolJet | 84 | Classic | very active | 2 | 43% | 611 |
| reflex-dev/reflex | 84 | Classic | very active | 2 | 46% | 272 |
| streamlit/streamlit | 83 | Classic | very active | 2 | 42% | 127 |
| holoviz/panel | 80 | Classic | very active | 2 | 32% | 102 |
| apexcharts/apexcharts.js | 79 | Classic | very active | 1 | 86% | 156 |
| has2k1/plotnine | 79 | Mature | very active | 1 | 100% | 40 |
| jgraph/drawio-desktop | 79 | Classic | very active | 1 | 81% | 191 |
...
| keplergl/kepler.gl | 77 | Classic | very active | 1 | 84% | 60 |
...
| tradingview/lightweight-charts | 73 | Classic | very active | 2 | 45% | 48 |
| posit-dev/great-tables | 73 | Classic | very active | 1 | 99% | 36 |
| vega/vega | 72 | Classic | very active | 1 | 50% | 154 |
| vega/altair | 71 | Classic | very active | 2 | 46% | 36 |
| holoviz/holoviews | 71 | Classic | very active | 1 | 59% | 90 |
| highcharts/highcharts | 70 | Classic | very active | 2 | 36% | 0 |
| JetBrains/lets-plot | 70 | Classic | slowing | 2 | 32% | 109 |
...
- **prometheus/prometheus** (65,988★) — a time-series *database* and the data source behind most Grafana panels — storage, not charting
- **plausible/analytics** (28,932★) — a fixed-purpose web-analytics product; its dashboard isn't reusable for your own data
...
- **voxel51/fiftyone** (11,061★) — visualizes *datasets and model predictions* for computer vision — a data-curation app, not a chart library
- **jessevig/bertviz** (8,171★) — visualizes transformer attention specifically — a model-interpretability tool
- **OpenSpace/OpenSpace** (1,246★) — astrovisualization of space data — scientific rendering, not general charting
- **originalankur/maptoposter** (14,091★) — turns city maps into poster art — cartographic design, not data visualization
- **unhappychoice/gitlogue** (4,961★) — animated replay of git history in the terminal — a novelty visualizer
- **patoles/agent-flow** (1,625★) — real-time visualization of agent orchestration — see the *Agent orchestration* report
- **vivekchand/clawmetry** (407★) — agent-runtime observability dashboards — routed to the agent reports
- **williamngan/pts** (5,341★) — creative-coding and generative visuals rather than charts; reads as abandoned in this snapshot
- **GraphiteEditor/Graphite** (27,152★) — a 2D vector graphics editor — design tooling, not data charting
...
- **jakevdp/PythonDataScienceHandbook** (49,803★) — a book (notebooks) that teaches matplotlib — learning material, not a tool
...
<sub>Tools covered: 61 · Snapshot: 2026-09-07T10:42:15.216Z</sub>
