...
> Derived from **kaiser-data**'s 1,900 starred repos (snapshot `2026-08-31T12:10:08.018Z`), cross-referenced with the repo-similarity graph (1,900 nodes / 6,181 edges, 37 communities). The advantages/disadvantages column is editorial judgement grounded in the dataset's own health metrics plus external comparisons — see Methodology.
>
> Generated 2026-08-31 by `scripts/reports/charting_stack.py` (regenerate any time — no API cost).
...
- **61 charting and visualization tools** in your stars (**1,331,429★** combined), grouped into 10 layers:
...
| Tool | ★ | ✅ Advantages | ⚠️ Disadvantages | 🎯 Best for |
|---|---|---|---|---|
| **[matplotlib/matplotlib](https://github.com/matplotlib/matplotlib)** | 23,131 (▲14) | Can draw literally anything; the publication standard for scientific figures; vector output (PDF/SVG/EPS); enormous documentation and 20 years of StackOverflow answers; PSF-style licence. | Two competing APIs (pyplot state machine vs. object-oriented) confuse newcomers; verbose for anything non-trivial; dated defaults; no real interactivity; slow on large datasets. | Publication figures and any plot that must be exactly right. |
...
| **[Avaiga/taipy](https://github.com/Avaiga/taipy)** | 19,438 (▲4) | Per-user state isolation and an async backend (unlike Streamlit's rerun model); built-in scenario/pipeline management for what-if analysis; designed for business-facing apps. | More code and more concepts than Streamlit for a simple app; smaller community and component ecosystem; the orchestration half is wasted if you only want a dashboard. | Business-facing Python apps with scenario/what-if workflows. |

### Dashboards as code

| Tool | ★ | ✅ Advantages | ⚠️ Disadvantages | 🎯 Best for |
|---|---|---|---|---|
| **[weaveworks/grafanalib](https://github.com/weaveworks/grafanalib)** | 1,972 (▲1) | Pythonic dashboard construction with reusable functions; large body of existing examples; simple to integrate into Python CI. | **Declining in this dataset** — Weaveworks shut down and maintenance has stalled; lags current Grafana panel schemas; superseded by grafana-foundation-sdk. | Legacy Python dashboard pipelines — migrate new work to the Foundation SDK. |
...
|---|---|---|---|---|---|---|---|---|---|---|
| [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | Diagrams & AI charts | TypeScript | MIT | 130,853 (▲193) | Classic | 60 | very active | 0d ago | 6.7y | 18 |
| [d3/d3](https://github.com/d3/d3) | Low-level / high-performance | Shell | ISC | 113,584 (▲12) | Mature | 32 | slowing | 3mo ago | 15.9y | 0 |
| [grafana/grafana](https://github.com/grafana/grafana) | BI & dashboard platform | TypeScript | AGPL-3.0 | 76,531 (▲73) | Classic | 99 | very active | 0d ago | 12.7y | 53 |
| [apache/superset](https://github.com/apache/superset) | BI & dashboard platform | Python | Apache-2.0 | 74,558 (▲67) | Classic | 95 | very active | 0d ago | 11.1y | 32 |
| [chartjs/Chart.js](https://github.com/chartjs/Chart.js) | Web charting library | JavaScript | MIT | 67,676 (▲8) | Mature | 33 | slowing | 3mo ago | 13.5y | 0 |
| [apache/echarts](https://github.com/apache/echarts) | Web charting library | TypeScript | Apache-2.0 | 67,203 (▲37) | Classic | 61 | active | 27d ago | 13.4y | 3 |
| [jgraph/drawio-desktop](https://github.com/jgraph/drawio-desktop) | Diagrams & AI charts | JavaScript | Apache-2.0 | 62,869 (▲40) | Classic | 77 | very active | 5d ago | 9.3y | 3 |
| [metabase/metabase](https://github.com/metabase/metabase) | BI & dashboard platform | Clojure | NOASSERTION | 49,012 (▲45) | Classic | 99 | very active | 0d ago | 11.6y | 35 |
| [streamlit/streamlit](https://github.com/streamlit/streamlit) | Data-app framework | Python | Apache-2.0 | 45,651 (▲27) | Classic | 83 | very active | 0d ago | 7.0y | 8 |
| [gradio-app/gradio](https://github.com/gradio-app/gradio) | Data-app framework | Python | Apache-2.0 | 43,440 (▲8) | Classic | 85 | very active | 0d ago | 7.7y | 5 |
| [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) | BI & dashboard platform | JavaScript | AGPL-3.0 | 40,802 (▲17) | Classic | 84 | very active | 0d ago | 5.4y | 15 |
| [reflex-dev/reflex](https://github.com/reflex-dev/reflex) | Data-app framework | Python | Apache-2.0 | 28,863 (▲5) | Classic | 84 | very active | 1d ago | 3.9y | 11 |
| [getredash/redash](https://github.com/getredash/redash) | BI & dashboard platform | Python | BSD-2-Clause | 28,771 (▲5) | Classic | 63 | active | 2d ago | 12.8y | 8 |
| [recharts/recharts](https://github.com/recharts/recharts) | React charting library | TypeScript | MIT | 27,528 (▲9) | Classic | 79 | very active | 3d ago | 11.1y | 17 |
| [plotly/dash](https://github.com/plotly/dash) | Data-app framework | Python | MIT | 24,388 | Classic | 77 | very active | 3d ago | 11.4y | 10 |
| [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) | Python plotting | Python | — | 23,131 (▲14) | Classic | 93 | very active | 0d ago | 15.5y | 28 |
| [openobserve/openobserve](https://github.com/openobserve/openobserve) | BI & dashboard platform | TypeScript | AGPL-3.0 | 21,582 (▲70) | Classic | 94 | very active | 0d ago | 3.6y | 23 |
| [elastic/kibana](https://github.com/elastic/kibana) | BI & dashboard platform | TypeScript | NOASSERTION | 21,276 (▲11) | Classic | 99 | very active | 0d ago | 13.6y | 63 |
| [airbnb/visx](https://github.com/airbnb/visx) | React charting library | TypeScript | MIT | 21,028 (▲1) | Classic | 53 | slowing | 2mo ago | 9.5y | 3 |
| [bokeh/bokeh](https://github.com/bokeh/bokeh) | Python plotting | Python | BSD-3-Clause | 20,436 | Classic | 68 | very active | 0d ago | 14.4y | 18 |
| [Avaiga/taipy](https://github.com/Avaiga/taipy) | Data-app framework | Python | Apache-2.0 | 19,438 (▲4) | Mature | 51 | active | 21d ago | 4.5y | 0 |
| [plotly/plotly.py](https://github.com/plotly/plotly.py) | Python plotting | Python | MIT | 18,763 (▲8) | Classic | 78 | very active | 4d ago | 12.8y | 8 |
| [plotly/plotly.js](https://github.com/plotly/plotly.js) | Web charting library | JavaScript | MIT | 18,310 (▲7) | Classic | 78 | very active | 1d ago | 10.8y | 3 |
| [Canner/WrenAI](https://github.com/Canner/WrenAI) | BI & dashboard platform | Python | NOASSERTION | 17,430 (▲21) | Mature | 81 | very active | 0d ago | 2.5y | 14 |
| [tradingview/lightweight-charts](https://github.com/tradingview/lightweight-charts) | Low-level / high-performance | TypeScript | Apache-2.0 | 17,132 (▲35) | Classic | 68 | very active | 10d ago | 7.3y | 8 |
| [Kanaries/pygwalker](https://github.com/Kanaries/pygwalker) | Python plotting | Python | Apache-2.0 | 15,953 (▲4) | Classic | 63 | very active | 21d ago | 3.5y | 2 |
| [apexcharts/apexcharts.js](https://github.com/apexcharts/apexcharts.js) | Web charting library | JavaScript | NOASSERTION | 15,146 (▲6) | Classic | 79 | very active | 0d ago | 8.1y | 2 |
| [frappe/charts](https://github.com/frappe/charts) | Web charting library | JavaScript | MIT | 15,081 (▲2) | Abandoned | 5 | stale | 1.2y ago | 8.9y | 0 |
| [visgl/deck.gl](https://github.com/visgl/deck.gl) | Low-level / high-performance | TypeScript | MIT | 14,539 (▲9) | Classic | 84 | very active | 0d ago | 10.7y | 14 |
| [plouc/nivo](https://github.com/plouc/nivo) | React charting library | TypeScript | MIT | 14,091 (▼1) | Classic | 49 | active | 1mo ago | 10.4y | 4 |
| [antvis/G2](https://github.com/antvis/G2) | Web charting library | TypeScript | MIT | 12,598 (▲2) | Mature | 62 | active | 0d ago | 10.3y | 2 |
| [highcharts/highcharts](https://github.com/highcharts/highcharts) | Web charting library | TypeScript | NOASSERTION | 12,483 (▲2) | Classic | 70 | very active | 0d ago | 16.2y | 10 |
| [keplergl/kepler.gl](https://github.com/keplergl/kepler.gl) | Low-level / high-performance | TypeScript | MIT | 11,994 (▲5) | Classic | 77 | very active | 0d ago | 8.5y | 4 |
| [vega/vega](https://github.com/vega/vega) | Grammar of graphics | JavaScript | BSD-3-Clause | 11,979 (▲2) | Classic | 71 | very active | 9d ago | 13.6y | 13 |
| [perspective-dev/perspective](https://github.com/perspective-dev/perspective) | Low-level / high-performance | Rust | Apache-2.0 | 11,148 (▲12) | Classic | 77 | very active | 2d ago | 8.8y | 4 |
| [lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid) | Diagrams & AI charts | TypeScript | MIT | 10,998 (▲18) | Declining | 35 | slowing | 3mo ago | 7mo | 0 |
| [leeoniya/uPlot](https://github.com/leeoniya/uPlot) | Low-level / high-performance | JavaScript | MIT | 10,461 (▲7) | Mature | 28 | slowing | 4mo ago | 6.9y | 0 |
| [vega/altair](https://github.com/vega/altair) | Grammar of graphics | Python | BSD-3-Clause | 10,461 (▲1) | Classic | 69 | very active | 15d ago | 11.0y | 14 |
| [c3js/c3](https://github.com/c3js/c3) | Web charting library | JavaScript | MIT | 9,350 (▲1) | Classic | 49 | active | 26d ago | 13.1y | 2 |
| [evidence-dev/evidence](https://github.com/evidence-dev/evidence) | BI & dashboard platform | TypeScript | MIT | 6,896 (▲10) | Classic | 71 | very active | 5d ago | 5.3y | 4 |
| [ScottPlot/ScottPlot](https://github.com/ScottPlot/ScottPlot) | Native / systems charting | C# | MIT | 6,726 (▲6) | Classic | 62 | very active | 16d ago | 8.7y | 8 |
| [holoviz/panel](https://github.com/holoviz/panel) | Python plotting | Python | BSD-3-Clause | 5,765 (▲2) | Classic | 85 | very active | 0d ago | 8.0y | 19 |
| [vega/vega-lite](https://github.com/vega/vega-lite) | Grammar of graphics | TypeScript | BSD-3-Clause | 5,466 (▲3) | Classic | 66 | very active | 1d ago | 11.8y | 7 |
| [observablehq/plot](https://github.com/observablehq/plot) | Web charting library | HTML | ISC | 5,362 (▲1) | Mature | 33 | active | 1mo ago | 5.8y | 0 |
| [man-group/dtale](https://github.com/man-group/dtale) | Python plotting | TypeScript | LGPL-2.1 | 5,215 (▲1) | Mature | 42 | active | 1mo ago | 7.1y | 0 |
| [alandefreitas/matplotplusplus](https://github.com/alandefreitas/matplotplusplus) | Native / systems charting | C++ | MIT | 4,924 (▲1) | Mature | 22 | slowing | 5mo ago | 6.0y | 0 |
...
| [has2k1/plotnine](https://github.com/has2k1/plotnine) | Grammar of graphics | Python | MIT | 4,757 | Mature | 78 | very active | 16d ago | 9.4y | 1 |
| [tremorlabs/tremor](https://github.com/tremorlabs/tremor) | React charting library | TypeScript | Apache-2.0 | 3,590 (▲7) | Declining | 10 | stale | 10mo ago | 2.4y | 0 |
| [gonum/plot](https://github.com/gonum/plot) | Native / systems charting | Go | BSD-3-Clause | 2,967 (▲1) | Mature | 27 | slowing | 4mo ago | 13.1y | 0 |
| [holoviz/holoviews](https://github.com/holoviz/holoviews) | Python plotting | Python | BSD-3-Clause | 2,907 | Classic | 70 | very active | 0d ago | 12.3y | 10 |
| [rilldata/rill](https://github.com/rilldata/rill) | BI & dashboard platform | Go | Apache-2.0 | 2,853 (▲5) | Classic | 84 | very active | 0d ago | 4.7y | 12 |
...
| [posit-dev/great-tables](https://github.com/posit-dev/great-tables) | Python plotting | Python | MIT | 2,724 (▲1) | Classic | 74 | very active | 7d ago | 4.3y | 2 |
| [weaveworks/grafanalib](https://github.com/weaveworks/grafanalib) | Dashboards as code | Python | Apache-2.0 | 1,972 (▲1) | Declining | 14 | stale | 8mo ago | 9.8y | 0 |
| [reflex-dev/xy](https://github.com/reflex-dev/xy) | Python plotting | Python | Apache-2.0 | 1,807 (▲15) | Hot | 74 | very active | 4d ago | 1mo | 11 |
| [JetBrains/lets-plot](https://github.com/JetBrains/lets-plot) | Grammar of graphics | Kotlin | MIT | 1,778 | Classic | 71 | active | 2mo ago | 7.5y | 5 |
| [K-Phoen/grabana](https://github.com/K-Phoen/grabana) | Dashboards as code | Go | MIT | 728 | Abandoned | 6 | stale | 1.3y ago | 6.6y | 0 |
| [hustcc/mcp-mermaid](https://github.com/hustcc/mcp-mermaid) | Diagrams & AI charts | TypeScript | MIT | 626 (▼2) | Declining | 41 | slowing | 3mo ago | 1.3y | 0 |
| [grafana/grafana-foundation-sdk](https://github.com/grafana/grafana-foundation-sdk) | Dashboards as code | PHP | Apache-2.0 | 256 (▲1) | Mature | 58 | very active | 0d ago | 2.8y | 5 |
| [deliveryhero/grafyaml](https://github.com/deliveryhero/grafyaml) | Dashboards as code | Python | Apache-2.0 | 44 | Mature | 51 | active | 14d ago | 6.1y | 3 |
...
- **[chartjs/Chart.js](https://github.com/chartjs/Chart.js)** · 67,676★ · JavaScript · Mature  
...
- **[apache/echarts](https://github.com/apache/echarts)** · 67,203★ · TypeScript · Classic  
...
- **[plotly/plotly.js](https://github.com/plotly/plotly.js)** · 18,310★ · JavaScript · Classic  
...
- **[apexcharts/apexcharts.js](https://github.com/apexcharts/apexcharts.js)** · 15,146★ · JavaScript · Classic  
...
- **[frappe/charts](https://github.com/frappe/charts)** · 15,081★ · JavaScript · Abandoned  
...
- **[antvis/G2](https://github.com/antvis/G2)** · 12,598★ · TypeScript · Mature  
...
- **[highcharts/highcharts](https://github.com/highcharts/highcharts)** · 12,483★ · TypeScript · Classic  
  ...
  <sub>topics: —</sub>
- **[c3js/c3](https://github.com/c3js/c3)** · 9,350★ · JavaScript · Classic  
...
- **[observablehq/plot](https://github.com/observablehq/plot)** · 5,362★ · HTML · Mature  
...
- **[recharts/recharts](https://github.com/recharts/recharts)** · 27,528★ · TypeScript · Classic  
...
- **[airbnb/visx](https://github.com/airbnb/visx)** · 21,028★ · TypeScript · Classic  
...
- **[tremorlabs/tremor](https://github.com/tremorlabs/tremor)** · 3,590★ · TypeScript · Declining  
...
- **[d3/d3](https://github.com/d3/d3)** · 113,584★ · Shell · Mature  
...
- **[tradingview/lightweight-charts](https://github.com/tradingview/lightweight-charts)** · 17,132★ · TypeScript · Classic  
...
- **[visgl/deck.gl](https://github.com/visgl/deck.gl)** · 14,539★ · TypeScript · Classic  
...
- **[keplergl/kepler.gl](https://github.com/keplergl/kepler.gl)** · 11,994★ · TypeScript · Classic  
...
- **[perspective-dev/perspective](https://github.com/perspective-dev/perspective)** · 11,148★ · Rust · Classic  
...
- **[leeoniya/uPlot](https://github.com/leeoniya/uPlot)** · 10,461★ · JavaScript · Mature  
...
- **[vega/vega](https://github.com/vega/vega)** · 11,979★ · JavaScript · Classic  
...
- **[vega/altair](https://github.com/vega/altair)** · 10,461★ · Python · Classic  
  The Python API over Vega-Lite — statistical charts as method chains on a DataFrame.  
  <sub>topics: —</sub>
- **[vega/vega-lite](https://github.com/vega/vega-lite)** · 5,466★ · TypeScript · Classic  
...
- **[matplotlib/matplotlib](https://github.com/matplotlib/matplotlib)** · 23,131★ · Python · Classic  
...
- **[plotly/plotly.py](https://github.com/plotly/plotly.py)** · 18,763★ · Python · Classic  
...
- **[Kanaries/pygwalker](https://github.com/Kanaries/pygwalker)** · 15,953★ · Python · Classic  
...
- **[holoviz/panel](https://github.com/holoviz/panel)** · 5,765★ · Python · Classic  
...
- **[man-group/dtale](https://github.com/man-group/dtale)** · 5,215★ · TypeScript · Mature  
...
- **[posit-dev/great-tables](https://github.com/posit-dev/great-tables)** · 2,724★ · Python · Classic  
...
- **[reflex-dev/xy](https://github.com/reflex-dev/xy)** · 1,807★ · Python · Hot  
...
- **[grafana/grafana](https://github.com/grafana/grafana)** · 76,531★ · TypeScript · Classic  
...
- **[apache/superset](https://github.com/apache/superset)** · 74,558★ · Python · Classic  
...
- **[metabase/metabase](https://github.com/metabase/metabase)** · 49,012★ · Clojure · Classic  
...
- **[ToolJet/ToolJet](https://github.com/ToolJet/ToolJet)** · 40,802★ · JavaScript · Classic  
...
- **[getredash/redash](https://github.com/getredash/redash)** · 28,771★ · Python · Classic  
...
- **[openobserve/openobserve](https://github.com/openobserve/openobserve)** · 21,582★ · TypeScript · Classic  
...
- **[elastic/kibana](https://github.com/elastic/kibana)** · 21,276★ · TypeScript · Classic  
...
- **[Canner/WrenAI](https://github.com/Canner/WrenAI)** · 17,430★ · Python · Mature  
...
- **[evidence-dev/evidence](https://github.com/evidence-dev/evidence)** · 6,896★ · TypeScript · Classic  
...
- **[rilldata/rill](https://github.com/rilldata/rill)** · 2,853★ · Go · Classic  
...
- **[streamlit/streamlit](https://github.com/streamlit/streamlit)** · 45,651★ · Python · Classic  
...
- **[gradio-app/gradio](https://github.com/gradio-app/gradio)** · 43,440★ · Python · Classic  
...
- **[reflex-dev/reflex](https://github.com/reflex-dev/reflex)** · 28,863★ · Python · Classic  
...
- **[Avaiga/taipy](https://github.com/Avaiga/taipy)** · 19,438★ · Python · Mature  
...
- **[weaveworks/grafanalib](https://github.com/weaveworks/grafanalib)** · 1,972★ · Python · Declining  
...
- **[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw)** · 130,853★ · TypeScript · Classic  
...
- **[jgraph/drawio-desktop](https://github.com/jgraph/drawio-desktop)** · 62,869★ · JavaScript · Classic  
...
- **[lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid)** · 10,998★ · TypeScript · Declining  
...
- **[ScottPlot/ScottPlot](https://github.com/ScottPlot/ScottPlot)** · 6,726★ · C# · Classic  
...
- **[gonum/plot](https://github.com/gonum/plot)** · 2,967★ · Go · Mature  
...
**Community clustering.** These 61 tools span **10 of the graph's 37 communities** — a wide spread, because charting cuts across the frontend, Python-data, and observability clusters rather than forming one of its own.

- **Community 11** (34): `apache/echarts`, `chartjs/Chart.js`, `plotly/plotly.js`, `apexcharts/apexcharts.js`, `frappe/charts`, `observablehq/plot`, `plouc/nivo`, `airbnb/visx`, `d3/d3`, `leeoniya/uPlot`, `tradingview/lightweight-charts`, `vega/vega-lite`, `vega/vega`, `vega/altair`, `has2k1/plotnine`, `matplotlib/matplotlib`, `plotly/plotly.py`, `bokeh/bokeh`, `holoviz/holoviews`, `holoviz/panel`, `Kanaries/pygwalker`, `man-group/dtale`, `reflex-dev/xy`, `apache/superset`, `evidence-dev/evidence`, `rilldata/rill`, `streamlit/streamlit`, `gradio-app/gradio`, `plotly/dash`, `reflex-dev/reflex`, `Avaiga/taipy`, `ScottPlot/ScottPlot`, `AAChartModel/AAChartKit`, `alandefreitas/matplotplusplus`
- **Community 2** (9): `grafana/grafana`, `metabase/metabase`, `getredash/redash`, `elastic/kibana`, `openobserve/openobserve`, `Canner/WrenAI`, `ToolJet/ToolJet`, `grafana/grafana-foundation-sdk`, `jgraph/drawio-desktop`
- **Community 14** (7): `highcharts/highcharts`, `antvis/G2`, `perspective-dev/perspective`, `visgl/deck.gl`, `keplergl/kepler.gl`, `JetBrains/lets-plot`, `excalidraw/excalidraw`
- **Community 9** (3): `c3js/c3`, `deliveryhero/grafyaml`, `gonum/plot`
- **Community 1** (3): `recharts/recharts`, `tremorlabs/tremor`, `lukilabs/beautiful-mermaid`

**Centrality (PageRank in the full 1,900-repo graph)** — most 'hub-like' visualization tools in your ecosystem:

- `c3js/c3` — PageRank 0.0017
- `streamlit/streamlit` — PageRank 0.0017
- `apache/echarts` — PageRank 0.0014
- `reflex-dev/xy` — PageRank 0.0011
- `antvis/G2` — PageRank 0.0011
- `keplergl/kepler.gl` — PageRank 0.0010
- `observablehq/plot` — PageRank 0.0009
- `tremorlabs/tremor` — PageRank 0.0009
- `d3/d3` — PageRank 0.0009
...
- `reflex-dev/xy` ⇄ `reflex-dev/reflex` (w=1.608) — topics: data-analysis, data-science, data-visualization, python; authors: Alek99, masenf, FarhanAliRaza
...
- `holoviz/panel` ⇄ `holoviz/holoviews` (w=1.205) — topics: holoviz, holoviews; authors: hoxbro, Kkkakania, MarcSkovMadsen
...
- `vega/altair` ⇄ `vega/vega-lite` (w=0.711) — authors: joelostblom, dependabot[bot]
...
- `keplergl/kepler.gl` ⇄ `antvis/G2` (w=0.521) — topics: visualization; authors: Copilot
- `streamlit/streamlit` ⇄ `reflex-dev/reflex` (w=0.518) — topics: python, data-science, data-visualization, data-analysis; authors: github-actions[bot]
- …and 94 more.
...
|---|---|---|---|---|---|---|
| grafana/grafana | 99 | Classic | very active | 12 | 12% | 640 |
| metabase/metabase | 99 | Classic | very active | 7 | 8% | 827 |
| elastic/kibana | 99 | Classic | very active | 17 | 8% | 262 |
| apache/superset | 95 | Classic | very active | 4 | 28% | 267 |
| openobserve/openobserve | 94 | Classic | very active | 4 | 24% | 219 |
| matplotlib/matplotlib | 93 | Classic | very active | 4 | 20% | 102 |
| holoviz/panel | 85 | Classic | very active | 3 | 27% | 102 |
| gradio-app/gradio | 85 | Classic | very active | 2 | 40% | 5095 |
| visgl/deck.gl | 84 | Classic | very active | 2 | 29% | 309 |
| rilldata/rill | 84 | Classic | very active | 2 | 38% | 330 |
| ToolJet/ToolJet | 84 | Classic | very active | 2 | 46% | 602 |
| reflex-dev/reflex | 84 | Classic | very active | 2 | 39% | 264 |
| streamlit/streamlit | 83 | Classic | very active | 2 | 44% | 126 |
| Canner/WrenAI | 81 | Mature | very active | 2 | 35% | 197 |
| apexcharts/apexcharts.js | 79 | Classic | very active | 1 | 98% | 156 |
| recharts/recharts | 79 | Classic | very active | 1 | 53% | 93 |
...
| perspective-dev/perspective | 77 | Classic | very active | 1 | 95% | 63 |
| keplergl/kepler.gl | 77 | Classic | very active | 1 | 77% | 58 |
| plotly/dash | 77 | Classic | very active | 1 | 55% | 109 |
...
| observablehq/plot | 33 | Mature | active | 0 | 0% | 39 |
...
- **prometheus/prometheus** (65,919★) — a time-series *database* and the data source behind most Grafana panels — storage, not charting
- **plausible/analytics** (28,811★) — a fixed-purpose web-analytics product; its dashboard isn't reusable for your own data
- **bluewave-labs/Checkmate** (10,765★) — uptime/infrastructure monitoring with built-in status charts — a monitoring product, not a charting tool
- **voxel51/fiftyone** (11,049★) — visualizes *datasets and model predictions* for computer vision — a data-curation app, not a chart library
- **jessevig/bertviz** (8,161★) — visualizes transformer attention specifically — a model-interpretability tool
- **OpenSpace/OpenSpace** (1,242★) — astrovisualization of space data — scientific rendering, not general charting
- **originalankur/maptoposter** (14,058★) — turns city maps into poster art — cartographic design, not data visualization
- **unhappychoice/gitlogue** (4,947★) — animated replay of git history in the terminal — a novelty visualizer
- **patoles/agent-flow** (1,610★) — real-time visualization of agent orchestration — see the *Agent orchestration* report
- **vivekchand/clawmetry** (402★) — agent-runtime observability dashboards — routed to the agent reports
- **williamngan/pts** (5,341★) — creative-coding and generative visuals rather than charts; reads as abandoned in this snapshot
- **GraphiteEditor/Graphite** (27,015★) — a 2D vector graphics editor — design tooling, not data charting
- **mosra/magnum** (5,199★) — C++ graphics middleware used *for* visualization, but a rendering engine at heart
...
- **jakevdp/PythonDataScienceHandbook** (49,748★) — a book (notebooks) that teaches matplotlib — learning material, not a tool
...
<sub>Tools covered: 61 · Snapshot: 2026-08-31T12:10:08.018Z</sub>
