...
| [opendatalab/MinerU](https://github.com/opendatalab/MinerU) | Conversion framework | Python | NOASSERTION | 78,635 | Mature | 80 | very active | 3d ago | 2.5y | 2 |
...
| [datalab-to/marker](https://github.com/datalab-to/marker) | Conversion framework | Python | Apache-2.0 | 39,333 | Mature | 67 | very active | 3d ago | 2.8y | 2 |
...
| [xberg-io/xberg](https://github.com/xberg-io/xberg) | Conversion framework | Rust | MIT | 9,228 | Hot | 80 | very active | 3d ago | 1.6y | 4 |
...
| [docling-project/docling-mcp](https://github.com/docling-project/docling-mcp) | Format-specific / serving | Python | MIT | 722 | Mature | 72 | very active | 6d ago | 1.5y | 6 |
...
- **Community 1** (11): `opendatalab/MinerU`, `PaddlePaddle/PaddleOCR`, `opendatalab/DocLayout-YOLO`, `allenai/olmocr`, `getomni-ai/zerox`, `bytedance/Dolphin`, `studio-dots-ai/dots.ocr`, `Yuliang-Liu/MonkeyOCR`, `landing-ai/ade-python`, `python-openxml/python-docx`, `JoshData/pdf-redactor`
- **Community 0** (3): `docling-project/docling`, `Unstructured-IO/unstructured`, `docling-project/docling-mcp`
- **Community 5** (2): `microsoft/markitdown`, `tesseract-ocr/tesseract`
- **Community 9** (2): `datalab-to/marker`, `run-llama/semtools`
- **Community 20** (2): `deepseek-ai/DeepSeek-OCR`, `deepseek-ai/DeepSeek-OCR-2`
- **Community 16** (2): `facebookresearch/nougat`, `adithya-s-k/marker-api`

**Centrality (PageRank in the full 1,859-repo graph)** — most 'hub-like' extraction tools in your ecosystem:
...
<sub>Tools covered: 26 · Snapshot: 2026-08-29T23:54:34.573Z</sub>
