...
> Derived from **kaiser-data**'s 1,341 starred repos (snapshot `2026-07-19T22:39:07.967Z`), cross-referenced with the repo-similarity graph (1,341 nodes / 4,341 edges, 28 communities). Task rankings are additionally backed by external 2026 framework comparisons and agent-RL surveys — see Methodology.
>
> Generated 2026-07-19 by `scripts/reports/finetuning_stack.py` (regenerate any time — no API cost).
...
- **27 fine-tuning / post-training tools** in your stars (**747,847★** combined), organized along the training ladder:
...
|---|---|---|---|---|---|---|---|---|---|---|
| [huggingface/transformers](https://github.com/huggingface/transformers) | Full-stack fine-tuning framework | Python | Apache-2.0 | 162,739 (▲178) | Classic | 99 | very active | 2d ago | 7.7y | 48 |
| [rasbt/LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch) | Learn-by-building | Jupyter Notebook | NOASSERTION | 99,378 (▲378) | Mature | 52 | active | 8d ago | 3.0y | 5 |
| [hiyouga/LlamaFactory](https://github.com/hiyouga/LlamaFactory) | Full-stack fine-tuning framework | Python | Apache-2.0 | 73,374 (▲149) | Classic | 84 | very active | 2d ago | 3.1y | 34 |
| [unslothai/unsloth](https://github.com/unslothai/unsloth) | Full-stack fine-tuning framework | Python | Apache-2.0 | 68,426 (▲350) | Mature | 88 | very active | 0d ago | 2.6y | 20 |
| [labmlai/annotated_deep_learning_paper_implementations](https://github.com/labmlai/annotated_deep_learning_paper_implementations) | Learn-by-building | Python | MIT | 67,181 (▲100) | Mature | 23 | slowing | 5mo ago | 5.9y | 0 |
| [karpathy/nanoGPT](https://github.com/karpathy/nanoGPT) | Learn-by-building | Python | MIT | 61,321 (▲210) | Declining | 12 | stale | 8mo ago | 3.6y | 0 |
| [Lightning-AI/pytorch-lightning](https://github.com/Lightning-AI/pytorch-lightning) | Full-stack fine-tuning framework | Python | Apache-2.0 | 31,240 (▲5) | Classic | 78 | very active | 3d ago | 7.3y | 14 |
| [AlexsJones/llmfit](https://github.com/AlexsJones/llmfit) | Hardware fit & serving | Rust | MIT | 29,715 (▲356) | Hot | 78 | very active | 0d ago | 5mo | 9 |
| [lyogavin/airllm](https://github.com/lyogavin/airllm) | Hardware fit & serving | Jupyter Notebook | Apache-2.0 | 23,604 (▲1,143) | Mature | 57 | very active | 3d ago | 3.1y | 1 |
| [huggingface/peft](https://github.com/huggingface/peft) | PEFT & alignment library | Python | Apache-2.0 | 21,415 (▲26) | Classic | 86 | very active | 5d ago | 3.7y | 38 |
| [huggingface/trl](https://github.com/huggingface/trl) | PEFT & alignment library | Python | Apache-2.0 | 18,880 (▲52) | Classic | 84 | very active | 1d ago | 6.3y | 15 |
| [PaddlePaddle/PaddleNLP](https://github.com/PaddlePaddle/PaddleNLP) | Full-stack fine-tuning framework | Python | Apache-2.0 | 12,956 (▲2) | Mature | 43 | active | 1mo ago | 5.5y | 1 |
| [axolotl-ai-cloud/axolotl](https://github.com/axolotl-ai-cloud/axolotl) | Full-stack fine-tuning framework | Python | Apache-2.0 | 12,215 (▲27) | Classic | 84 | very active | 2d ago | 3.3y | 15 |
| [OpenPipe/ART](https://github.com/OpenPipe/ART) | RL post-training for agents | Python | Apache-2.0 | 10,494 (▲38) | Hot | 79 | very active | 2d ago | 1.4y | 10 |
| [roboflow/rf-detr](https://github.com/roboflow/rf-detr) | Domain & on-device tuning | Python | Apache-2.0 | 8,604 (▲110) | Hot | 79 | very active | 1d ago | 1.3y | 18 |
| [yandexdataschool/Practical_RL](https://github.com/yandexdataschool/Practical_RL) | Learn-by-building | Jupyter Notebook | Unlicense | 6,543 (▲7) | Mature | 29 | slowing | 3mo ago | 9.5y | 0 |
| [Gen-Verse/OpenClaw-RL](https://github.com/Gen-Verse/OpenClaw-RL) | RL post-training for agents | Python | Apache-2.0 | 5,588 (▲25) | Rising | 45 | active | 1mo ago | 4mo | 1 |
| [unslothai/notebooks](https://github.com/unslothai/notebooks) | Learn-by-building | Jupyter Notebook | LGPL-3.0 | 5,518 (▲7) | Hot | 52 | very active | 2d ago | 1.6y | 4 |
| [Blaizzy/mlx-vlm](https://github.com/Blaizzy/mlx-vlm) | Domain & on-device tuning | Python | MIT | 5,175 (▲19) | Mature | 84 | very active | 0d ago | 2.3y | 7 |
| [transformerlab/transformerlab-app](https://github.com/transformerlab/transformerlab-app) | Hardware fit & serving | Python | AGPL-3.0 | 5,162 (▲16) | Mature | 80 | very active | 1d ago | 2.6y | 4 |
...
| [huggingface/distil-whisper](https://github.com/huggingface/distil-whisper) | Domain & on-device tuning | Python | MIT | 4,091 (▲4) | Abandoned | 4 | stale | 1.5y ago | 2.7y | 0 |
| [predibase/lorax](https://github.com/predibase/lorax) | Hardware fit & serving | Python | Apache-2.0 | 3,816 (▲6) | Mature | 38 | active | 1mo ago | 2.7y | 1 |
| [Memento-Teams/Memento](https://github.com/Memento-Teams/Memento) | RL post-training for agents | Python | MIT | 2,531 (▲6) | Declining | 11 | stale | 9mo ago | 1.1y | 0 |
| [huggingface/OpenEnv](https://github.com/huggingface/OpenEnv) | RL post-training for agents | Python | BSD-3-Clause | 2,431 (▲15) | Hot | 75 | very active | 2d ago | 9mo | 14 |
...
| [VectorInstitute/fed-rag](https://github.com/VectorInstitute/fed-rag) | Domain & on-device tuning | Python | Apache-2.0 | 150 (▼1) | Declining | 35 | active | 28d ago | 1.5y | 0 |
...
- **[huggingface/transformers](https://github.com/huggingface/transformers)** · 162,739★ · Python · Classic  
...
- **[hiyouga/LlamaFactory](https://github.com/hiyouga/LlamaFactory)** · 73,374★ · Python · Classic  
...
- **[unslothai/unsloth](https://github.com/unslothai/unsloth)** · 68,426★ · Python · Mature  
...
- **[PaddlePaddle/PaddleNLP](https://github.com/PaddlePaddle/PaddleNLP)** · 12,956★ · Python · Mature  
...
- **[axolotl-ai-cloud/axolotl](https://github.com/axolotl-ai-cloud/axolotl)** · 12,215★ · Python · Classic  
...
- **[huggingface/peft](https://github.com/huggingface/peft)** · 21,415★ · Python · Classic  
...
- **[huggingface/trl](https://github.com/huggingface/trl)** · 18,880★ · Python · Classic  
...
- **[OpenPipe/ART](https://github.com/OpenPipe/ART)** · 10,494★ · Python · Hot  
...
- **[Memento-Teams/Memento](https://github.com/Memento-Teams/Memento)** · 2,531★ · Python · Declining  
  ...
  <sub>topics: —</sub>
- **[huggingface/OpenEnv](https://github.com/huggingface/OpenEnv)** · 2,431★ · Python · Hot  
...
- **[rasbt/LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch)** · 99,378★ · Jupyter Notebook · Mature  
...
- **[labmlai/annotated_deep_learning_paper_implementations](https://github.com/labmlai/annotated_deep_learning_paper_implementations)** · 67,181★ · Python · Mature  
...
- **[karpathy/nanoGPT](https://github.com/karpathy/nanoGPT)** · 61,321★ · Python · Declining  
  The simplest, fastest repo for training/finetuning mid-sized GPTs — frozen by design, still the canonical teaching codebase.  
  <sub>topics: —</sub>
- **[yandexdataschool/Practical_RL](https://github.com/yandexdataschool/Practical_RL)** · 6,543★ · Jupyter Notebook · Mature  
...
- **[roboflow/rf-detr](https://github.com/roboflow/rf-detr)** · 8,604★ · Python · Hot  
...
- **[Blaizzy/mlx-vlm](https://github.com/Blaizzy/mlx-vlm)** · 5,175★ · Python · Mature  
...
- **[AlexsJones/llmfit](https://github.com/AlexsJones/llmfit)** · 29,715★ · Rust · Hot  
...
- **[lyogavin/airllm](https://github.com/lyogavin/airllm)** · 23,604★ · Jupyter Notebook · Mature  
...
- **[predibase/lorax](https://github.com/predibase/lorax)** · 3,816★ · Python · Mature  
...
- **Community 7** (2): `Memento-Teams/Memento`, `pico-lm/pico-train`

**Centrality (PageRank in the full 1,341-repo graph)** — most 'hub-like' training tools in your ecosystem:

- `Lightning-AI/pytorch-lightning` — PageRank 0.0033
- `huggingface/peft` — PageRank 0.0017
- `axolotl-ai-cloud/axolotl` — PageRank 0.0017
- `huggingface/transformers` — PageRank 0.0015
- `huggingface/trl` — PageRank 0.0015
...
- `unslothai/notebooks` ⇄ `unslothai/unsloth` (w=0.838) — topics: unsloth; authors: danielhanchen, Etherll, shimmyshimmer
- `huggingface/trl` ⇄ `huggingface/OpenEnv` (w=0.781) — authors: sergiopaniego, dependabot[bot], mishig25
- `huggingface/peft` ⇄ `huggingface/transformers` (w=0.713) — topics: llm, python, pytorch; authors: kaixuanliu, jiqing-feng
- `huggingface/peft` ⇄ `huggingface/trl` (w=0.670) — authors: dependabot[bot], Strongich, mishig25
- `huggingface/distil-whisper` ⇄ `huggingface/transformers` (w=0.650) — topics: audio, speech-recognition
- `huggingface/trl` ⇄ `huggingface/transformers` (w=0.650) — authors: albertvillanova, kashif, michaelbenayoun
...
- `hiyouga/LlamaFactory` ⇄ `unslothai/unsloth` (w=0.346) — topics: fine-tuning, llama, llm, qwen; authors: lxcxjxhx
...
| unslothai/unsloth | 88 | Mature | very active | 3 | 22% | 43 |
| huggingface/peft | 86 | Classic | very active | 3 | 36% | 32 |
| hiyouga/LlamaFactory | 84 | Classic | very active | 7 | 13% | 36 |
...
| Gen-Verse/OpenClaw-RL | 45 | Rising | active | 1 | 100% | 0 |
...
- **vllm-project/vllm** (86,648★) — the serving standard for *finished* models — covered in the local-vs-infra-stack report
- **ollama/ollama** (176,458★) — local inference runtime, not a trainer — see local-vs-infra-stack
- **flyteorg/flyte** (7,146★) — general ML/data orchestration — schedules training, doesn't implement it
- **beam-cloud/beta9** (1,707★) — serverless GPU substrate *where* you train, not *how*
- **zai-org/GLM-V** (2,356★) — open model weights trained with scalable RL — a result of this stack, not a tool in it
- **openai/CLIP** (34,025★) — landmark pretraining research, effectively frozen — read it, don't build on the repo
- **NVIDIA/physicsnemo** (3,066★) — training framework for physics/simulation models, out of LLM post-training scope
- **facebookresearch/BenchMARL** (642★) — multi-agent RL *benchmarking* research, not LLM post-training
- **microsoft/generative-ai-for-beginners** (113,247★) — general GenAI curriculum — broader than training
...
<sub>Tools covered: 27 · Snapshot: 2026-07-19T22:39:07.967Z</sub>
