...
>
> Generated 2026-06-13 by `scripts/reports/hermes_vs_openclaw.py` (regenerate any time — no API cost).
...
- **Communities:** OpenClaw is in community 8, Hermes in 18 (different clusters). PageRank — OpenClaw 0.0009 vs Hermes 0.0010.
