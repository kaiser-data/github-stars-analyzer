...
**Community clustering.** These 39 tools span **13 of the graph's 32 communities** — the stack cuts across the inference, RAG/vector, and agent neighborhoods rather than forming one cluster.
...
- **Community 11** (6): `BerriAI/litellm`, `Portkey-AI/gateway`, `axolotl-ai-cloud/axolotl`, `langfuse/langfuse`, `Arize-ai/phoenix`, `promptfoo/promptfoo`
- **Community 18** (6): `lancedb/lancedb`, `pgvector/pgvector`, `alibaba/zvec`, `qdrant/qdrant`, `weaviate/weaviate`, `milvus-io/milvus`
- **Community 1** (4): `nomic-ai/gpt4all`, `chroma-core/chroma`, `crewAIInc/crewAI`, `pydantic/pydantic-ai`
- **Community 13** (4): `open-webui/open-webui`, `Mintplex-Labs/anything-llm`, `neuml/txtai`, `langchain-ai/langgraph`
- **Community 6** (3): `skypilot-org/skypilot`, `facebookresearch/faiss`, `marqo-ai/marqo`
- **Community 12** (2): `mozilla-ai/llamafile`, `microsoft/Foundry-Local`
