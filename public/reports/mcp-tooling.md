...
**Community clustering.** These 37 projects span **12 of the graph's 32 communities** — MCP tooling is woven through the whole agent-infra landscape rather than sitting in one bucket.

- **Community 15** (8): `bytebase/dbhub`, `github/github-mcp-server`, `getsentry/sentry-mcp`, `SonarSource/sonarqube-mcp-server`, `czlonkowski/n8n-mcp`, `storybookjs/mcp`, `upstash/context7`, `hustcc/mcp-mermaid`
- **Community 1** (7): `PrefectHQ/fastmcp`, `tadata-org/fastapi_mcp`, `Klavis-AI/klavis`, `aipotheosis-labs/gate22`, `Coding-Solo/godot-mcp`, `mobile-next/mobile-mcp`, `punkpeye/awesome-mcp-servers`
- **Community 17** (5): `mcp-use/mcp-use`, `ravitemer/mcphub.nvim`, `browserbase/mcp-server-browserbase`, `mksglu/context-mode`, `blazickjp/arxiv-mcp-server`
- **Community 22** (4): `shaneholloman/mcp-knowledge-graph`, `modelcontextprotocol/servers`, `modelcontextprotocol/typescript-sdk`, `modelcontextprotocol/inspector`
- **Community 12** (3): `microsoft/playwright-mcp`, `brightdata/brightdata-mcp`, `microsoft/mcp-for-beginners`
- **Community 23** (2): `Kochava-Studios/witsy`, `neo4j/mcp`
- **Community 0** (2): `reading-plus-ai/mcp-server-data-exploration`, `CoderGamester/mcp-unity`
- **Community 19** (2): `oraios/serena`, `yvgude/lean-ctx`
