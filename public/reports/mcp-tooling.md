...
**Community clustering.** These 37 projects span **13 of the graph's 26 communities** — MCP tooling is woven through the whole agent-infra landscape rather than sitting in one bucket.

- **Community 1** (9): `PrefectHQ/fastmcp`, `tadata-org/fastapi_mcp`, `Klavis-AI/klavis`, `aipotheosis-labs/gate22`, `browserbase/mcp-server-browserbase`, `bytebase/dbhub`, `blazickjp/arxiv-mcp-server`, `Coding-Solo/godot-mcp`, `punkpeye/awesome-mcp-servers`
- **Community 15** (7): `brightdata/brightdata-mcp`, `github/github-mcp-server`, `getsentry/sentry-mcp`, `SonarSource/sonarqube-mcp-server`, `czlonkowski/n8n-mcp`, `upstash/context7`, `hustcc/mcp-mermaid`
- **Community 16** (4): `mcp-use/mcp-use`, `ravitemer/mcphub.nvim`, `mksglu/context-mode`, `mobile-next/mobile-mcp`
...
- **Community 8** (3): `hangwin/mcp-chrome`, `storybookjs/mcp`, `yvgude/lean-ctx`
- **Community 9** (2): `Kochava-Studios/witsy`, `neo4j/mcp`
- **Community 19** (2): `microsoft/playwright-mcp`, `microsoft/mcp-for-beginners`
