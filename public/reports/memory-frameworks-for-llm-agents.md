...
>
> Generated 2026-07-13 by `scripts/reports/memory_frameworks.py` (regenerate any time — no API cost).
...
- Combined reach: **378,593★**. The space is overwhelmingly **Python** (10/21 projects).
...
|---|---|---|---|---|---|---|---|---|---|---|
| [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) | Coding-agent memory | JavaScript | Apache-2.0 | 87,012 (▲5,194) | Rising | 79 | very active | 0d ago | 10mo | 1 |
| [mem0ai/mem0](https://github.com/mem0ai/mem0) | General memory layer | TypeScript | Apache-2.0 | 60,706 (▲2,345) | Classic | 89 | very active | 2d ago | 3.1y | 37 |
| [MemPalace/mempalace](https://github.com/MemPalace/mempalace) | General memory layer | Python | MIT | 57,268 (▲1,884) | Hot | 81 | very active | 3d ago | 3mo | 22 |
| [getzep/graphiti](https://github.com/getzep/graphiti) | General memory layer | Python | Apache-2.0 | 28,658 (▲1,352) | Hot | 76 | very active | 4d ago | 1.9y | 10 |
| [topoteretes/cognee](https://github.com/topoteretes/cognee) | General memory layer | Python | Apache-2.0 | 27,704 (▲9,912) | Mature | 77 | very active | 1d ago | 2.9y | 8 |
| [gastownhall/beads](https://github.com/gastownhall/beads) | Coding-agent memory | Go | MIT | 25,262 (▲791) | Hot | 88 | very active | 0d ago | 9mo | 17 |
| [letta-ai/letta](https://github.com/letta-ai/letta) | General memory layer | Python | Apache-2.0 | 23,766 (▲496) | Mature | 63 | active | 10d ago | 2.8y | 2 |
| [memvid/memvid](https://github.com/memvid/memvid) | General memory layer | Rust | Apache-2.0 | 15,750 (▲108) | Declining | 63 | active | 2d ago | 1.1y | 2 |
| [MemoriLabs/Memori](https://github.com/MemoriLabs/Memori) | General memory layer | Python | NOASSERTION | 15,577 (▲309) | Hot | 82 | very active | 27d ago | 11mo | 13 |
| [andrewyng/context-hub](https://github.com/andrewyng/context-hub) | Coding-agent memory | JavaScript | MIT | 13,778 (▲222) | Hot | 56 | active | 1mo ago | 8mo | 8 |
| [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | General memory layer | Python | AGPL-3.0 | 5,934 (▲863) | Mature | 74 | very active | 0d ago | 2.8y | 25 |
| [campfirein/byterover-cli](https://github.com/campfirein/byterover-cli) | Coding-agent memory | TypeScript | NOASSERTION | 4,916 (▲72) | Hot | 83 | very active | 18d ago | 1.1y | 8 |
| [memodb-io/Acontext](https://github.com/memodb-io/Acontext) | General memory layer | JavaScript | Apache-2.0 | 3,575 (▲51) | Declining | 60 | active | 13d ago | 12mo | 1 |
| [Einsia/OpenChronicle](https://github.com/Einsia/OpenChronicle) | General memory layer | Python | MIT | 2,795 (▲17) | Hot | 50 | slowing | 2mo ago | 2mo | 9 |
| [trustgraph-ai/trustgraph](https://github.com/trustgraph-ai/trustgraph) | Knowledge-graph memory | Python | Apache-2.0 | 2,282 (▲122) | Mature | 63 | very active | 1d ago | 2.0y | 8 |
| [semantica-agi/semantica](https://github.com/semantica-agi/semantica) | Knowledge-graph memory | Python | MIT | 1,403 (▲193) | Hot | 80 | very active | 1d ago | 1.0y | 5 |
| [shaneholloman/mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph) | Knowledge-graph memory | JavaScript | MIT | 875 (▲11) | Declining | 59 | active | 1mo ago | 1.6y | 1 |
| [supermemoryai/openclaw-supermemory](https://github.com/supermemoryai/openclaw-supermemory) | General memory layer | TypeScript | — | 788 (▼3) | Hot | 58 | very active | 22d ago | 5mo | 8 |
| [zmedelis/bosquet](https://github.com/zmedelis/bosquet) | LLM framework w/ memory | Clojure | EPL-1.0 | 375 (▲2) | Mature | 45 | active | 1mo ago | 3.5y | 2 |
| [needle-ai/needle-mcp](https://github.com/needle-ai/needle-mcp) | Knowledge-graph memory | Python | MIT | 99 (▼1) | Declining | 11 | stale | 11mo ago | 1.6y | 0 |
| [ActiveMemory/ctx](https://github.com/ActiveMemory/ctx) | General memory layer | HTML | NOASSERTION | 70 (▲1) | Hot | 76 | very active | 0d ago | 5mo | 4 |
...
- **[letta-ai/letta](https://github.com/letta-ai/letta)** · 23,766★ · Python · Mature  
...
- **[MemoriLabs/Memori](https://github.com/MemoriLabs/Memori)** · 15,577★ · Python · Hot  
...
- **[plastic-labs/honcho](https://github.com/plastic-labs/honcho)** · 5,934★ · Python · Mature  
...
- **[Einsia/OpenChronicle](https://github.com/Einsia/OpenChronicle)** · 2,795★ · Python · Hot  
  Local-first memory for any tool-capable LLM agent.  
  <sub>topics: —</sub>
- **[supermemoryai/openclaw-supermemory](https://github.com/supermemoryai/openclaw-supermemory)** · 788★ · TypeScript · Hot  
...
- **[gastownhall/beads](https://github.com/gastownhall/beads)** · 25,262★ · Go · Hot  
  Distributed graph issue-tracker as durable agent memory (Dolt-backed).  
  <sub>topics: agents, claude-code, coding</sub>
- **[andrewyng/context-hub](https://github.com/andrewyng/context-hub)** · 13,778★ · JavaScript · Hot  
...
- **[trustgraph-ai/trustgraph](https://github.com/trustgraph-ai/trustgraph)** · 2,282★ · Python · Mature  
  Agent runtime platform powered by context graphs + ontology.  
  <sub>topics: open-source, ai-infra, ontology, agent, graph, rdf, sparql, context</sub>
- **[semantica-agi/semantica](https://github.com/semantica-agi/semantica)** · 1,403★ · Python · Hot  
...
**Community clustering.** The 21 frameworks fall into **11 of the graph's 27 communities** — meaning memory tooling does *not* form one tight cluster but is spread across the AI-infra landscape (each tends to cluster with its neighbors: vector DBs, agent frameworks, or MCP tooling).

- **Community 7** (6): `mem0ai/mem0`, `topoteretes/cognee`, `MemoriLabs/Memori`, `plastic-labs/honcho`, `memodb-io/Acontext`, `Einsia/OpenChronicle`
- **Community 1** (3): `letta-ai/letta`, `MemPalace/mempalace`, `zmedelis/bosquet`
- **Community 9** (3): `ActiveMemory/ctx`, `trustgraph-ai/trustgraph`, `semantica-agi/semantica`
...
- `semantica-agi/semantica` — PageRank 0.0009
- `mem0ai/mem0` — PageRank 0.0009
- `MemoriLabs/Memori` — PageRank 0.0009
...
- `trustgraph-ai/trustgraph` ⇄ `topoteretes/cognee` (w=0.164) — topics: open-source, knowledge-graph, agent-memory, graph-database
- `trustgraph-ai/trustgraph` ⇄ `semantica-agi/semantica` (w=0.161) — topics: ontology, knowledge-graph, agent-memory, explainable-ai
...
| gastownhall/beads | 88 | Hot | very active | 3 | 29% | 93 |
| campfirein/byterover-cli | 83 | Hot | very active | 2 | 27% | 27 |
| MemoriLabs/Memori | 82 | Hot | very active | 2 | 41% | 38 |
| MemPalace/mempalace | 81 | Hot | very active | 2 | 46% | 12 |
| semantica-agi/semantica | 80 | Hot | very active | 1 | 50% | 18 |
...
| plastic-labs/honcho | 74 | Mature | very active | 4 | 20% | 0 |
| letta-ai/letta | 63 | Mature | active | 1 | 75% | 177 |
| memvid/memvid | 63 | Declining | active | 1 | 75% | 12 |
| trustgraph-ai/trustgraph | 63 | Mature | very active | 1 | 69% | 0 |
| memodb-io/Acontext | 60 | Declining | active | 1 | 100% | 279 |
| shaneholloman/mcp-knowledge-graph | 59 | Declining | active | 1 | 100% | 8 |
| supermemoryai/openclaw-supermemory | 58 | Hot | very active | 2 | 49% | 0 |
| andrewyng/context-hub | 56 | Hot | active | 1 | 88% | 1 |
| Einsia/OpenChronicle | 50 | Hot | slowing | 2 | 32% | 0 |
| zmedelis/bosquet | 45 | Mature | active | 1 | 50% | 14 |
| needle-ai/needle-mcp | 11 | Declining | stale | 0 | 0% | 0 |
...
|---|---|---|---|
| [redis/redis](https://github.com/redis/redis) | 75,437 (▲608) | C | In-memory data store; common KV/vector backing for memory layers. |
| [facebookresearch/faiss](https://github.com/facebookresearch/faiss) | 40,500 (▲234) | C++ | Dense-vector similarity search library; embedding index substrate. |
| [chroma-core/chroma](https://github.com/chroma-core/chroma) | 28,777 (▲390) | Rust | AI-native search/vector DB used as memory storage. |
| [alibaba/zvec](https://github.com/alibaba/zvec) | 14,835 (▲5,059) | C++ | Lightweight in-process vector database. |
| [FalkorDB/FalkorDB](https://github.com/FalkorDB/FalkorDB) | 4,757 (▲210) | C | Fast graph database (GraphBLAS) for graph-shaped memory. |
...
<sub>Frameworks covered: 21 · Snapshot: 2026-07-13T08:42:30.177Z</sub>
