...
>
> Generated 2026-08-30 by `scripts/reports/notebooklm_stack.py` (regenerate any time — no API cost).
...
| [opendatalab/MinerU](https://github.com/opendatalab/MinerU) | Source ingestion & parsing | Python | NOASSERTION | 78,635 | Mature | 80 | very active | 3d ago | 2.5y | 2 |
...
| [OpenBMB/VoxCPM](https://github.com/OpenBMB/VoxCPM) | Audio Overview (TTS / podcast) | Python | Apache-2.0 | 36,187 | Rising | 77 | active | 4d ago | 11mo | 7 |
...
| [SYSTRAN/faster-whisper](https://github.com/SYSTRAN/faster-whisper) | Audio/video understanding (STT) | Python | MIT | 25,117 | Declining | 15 | stale | 9mo ago | 3.6y | 0 |
...
| [teng-lin/notebooklm-py](https://github.com/teng-lin/notebooklm-py) | Clone / reference app | Python | MIT | 18,965 | Hot | 79 | very active | 3d ago | 7mo | 3 |
...
**Community clustering.** These 34 tools span **17 of the graph's 37 communities**.

- **Community 8** (5): `Mintplex-Labs/anything-llm`, `alexpinel/Dot`, `VectifyAI/PageIndex`, `StarTrail-org/LEANN`, `lancedb/lancedb`
- **Community 16** (4): `feyninc/chonkie`, `OpenBMB/VoxCPM`, `coqui-ai/TTS`, `gradio-app/fastrtc`
- **Community 10** (4): `pipecat-ai/pipecat`, `livekit/agents`, `getzep/graphiti`, `screenpipe/screenpipe`
- **Community 1** (3): `opendatalab/MinerU`, `resemble-ai/chatterbox`, `bytedance/deer-flow`
- **Community 15** (2): `HKUDS/DeepTutor`, `HKUDS/LightRAG`
- **Community 5** (2): `microsoft/markitdown`, `microsoft/graphrag`
- **Community 0** (2): `docling-project/docling`, `Unstructured-IO/unstructured`
- **Community 11** (2): `openai/whisper`, `KoljaB/RealtimeSTT`
- **Community 2** (2): `SYSTRAN/faster-whisper`, `m-bain/whisperX`

**Centrality (PageRank in the full 1,859-repo graph)** — most 'hub-like' picks in your ecosystem:
...
<sub>Tools covered: 34 · Snapshot: 2026-08-29T23:54:34.573Z</sub>
