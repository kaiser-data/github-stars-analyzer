...
**Community clustering.** These 28 projects span **12 of the graph's 32 communities** — the OpenClaw ecosystem is spread across agent-infra rather than forming one isolated cluster.

- **Community 19** (6): `HKUDS/nanobot`, `NousResearch/hermes-agent`, `BlockRunAI/ClawRouter`, `iOfficeAI/AionUi`, `HKUDS/DeepTutor`, `HKUDS/ClawWork`
- **Community 7** (5): `openclaw/openclaw`, `openclaw/clawhub`, `abhi1693/openclaw-mission-control`, `crshdn/mission-control`, `hydro13/tandem-browser`
- **Community 17** (5): `nanocoai/nanoclaw`, `cloudflare/moltworker`, `hesamsheikh/awesome-openclaw-usecases`, `farion1231/cc-switch`, `CherryHQ/cherry-studio`
- **Community 11** (2): `supermemoryai/openclaw-supermemory`, `comet-ml/opik-openclaw`
- **Community 20** (2): `vivekchand/clawmetry`, `Gen-Verse/OpenClaw-RL`
- **Community 4** (2): `aiming-lab/AutoResearchClaw`, `SafeRL-Lab/cheetahclaws`
