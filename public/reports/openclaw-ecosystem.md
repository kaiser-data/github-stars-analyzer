...
**Community clustering.** These 28 projects span **13 of the graph's 39 communities** — the OpenClaw ecosystem is spread across agent-infra rather than forming one isolated cluster.

- **Community 18** (4): `zeroclaw-labs/zeroclaw`, `NousResearch/hermes-agent`, `BlockRunAI/ClawRouter`, `aiming-lab/AutoResearchClaw`
- **Community 8** (4): `nanocoai/nanoclaw`, `vivekchand/clawmetry`, `farion1231/cc-switch`, `iOfficeAI/AionUi`
...
- **Community 25** (2): `openclaw/openclaw`, `openclaw/clawhub`
- **Community 2** (2): `nearai/ironclaw`, `hydro13/tandem-browser`
- **Community 5** (2): `RightNow-AI/openfang`, `NVIDIA/NemoClaw`
- **Community 11** (2): `rohitg00/awesome-openclaw`, `CherryHQ/cherry-studio`
...
<sub>Projects covered: 28 · Snapshot: 2026-08-29T14:32:27.250Z</sub>
