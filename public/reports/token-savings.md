...
- **15 token-savings tools** in your stars (**448,379★**), organized by workload:
...
- **The one integration-free win:** `rtk` (a CLI proxy) claims 60–90% with no per-agent setup — and it's the most-starred here (77,794★).
...
|---|---|---|---|---|---|
| [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) | 101,716 (▲276) | 75 | very active | Prompt-style skill | ~65% |
| [rtk-ai/rtk](https://github.com/rtk-ai/rtk) | 77,794 (▲159) | 78 | very active | Wire-level proxy | 60–90% on dev cmds |
| [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) | 68,579 (▲193) | 77 | very active | Code index/graph | ~70% |
| [mksglu/context-mode](https://github.com/mksglu/context-mode) | 20,240 (▲45) | 78 | very active | Tool-output sandbox | 98% on tool output |
| [getagentseal/codeburn](https://github.com/getagentseal/codeburn) | 9,717 (▲26) | 79 | very active | Measurement / observability | — (measures) |
| [MinishLab/semble](https://github.com/MinishLab/semble) | 5,969 (▲5) | 73 | very active | Semantic code search | ~98% vs grep+read |
| [yvgude/lean-ctx](https://github.com/yvgude/lean-ctx) | 3,675 (▲13) | 80 | very active | Context layer | qualitative |
| [HKUDS/FastCode](https://github.com/HKUDS/FastCode) | 2,293 (▲1) | 41 | active | Code understanding | qualitative |

### Generation & structured prompting

| Tool | ★ | Health | Activity | Mechanism | Claimed saving |
|---|---|---|---|---|---|
| [toon-format/toon](https://github.com/toon-format/toon) | 25,272 (▲5) | 79 | very active | Compact data format | ~30–50% on structured data |

### Retrieval, RAG & documents

| Tool | ★ | Health | Activity | Mechanism | Claimed saving |
|---|---|---|---|---|---|
| [deepseek-ai/DeepSeek-OCR](https://github.com/deepseek-ai/DeepSeek-OCR) | 23,861 (▲6) | 13 | stale | Optical context compression | research |
| [bytebase/dbhub](https://github.com/bytebase/dbhub) | 3,425 (▲8) | 76 | very active | Token-efficient DB access | qualitative |
...
| Tool | ★ | Health | Activity | Mechanism | Claimed saving |
|---|---|---|---|---|---|
| [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) | 92,556 (▲276) | 80 | very active | Session compression | qualitative |

### Model & inference level

| Tool | ★ | Health | Activity | Mechanism | Claimed saving |
|---|---|---|---|---|---|
| [vllm-project/llm-compressor](https://github.com/vllm-project/llm-compressor) | 3,736 (▲2) | 89 | very active | Model weight compression | n/a (inference, not prompt) |

### Methodology / cross-cutting

| Tool | ★ | Health | Activity | Mechanism | Claimed saving |
|---|---|---|---|---|---|
| [jasontang-ai/Context-Engineering](https://github.com/jasontang-ai/Context-Engineering) | 9,233 (▲5) | 23 | stale | Methodology / guide | — (educational) |
...
- **[JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman)** · 101,716★ · Go · Hot · health 75 · _Prompt-style skill_ · **~65%**  
...
- **[rtk-ai/rtk](https://github.com/rtk-ai/rtk)** · 77,794★ · Rust · Hot · health 78 · _Wire-level proxy_ · **60–90% on dev cmds**  
...
- **[colbymchenry/codegraph](https://github.com/colbymchenry/codegraph)** · 68,579★ · C · Hot · health 77 · _Code index/graph_ · **~70%**  
  Pre-indexed code knowledge graph for Claude Code/Codex/Cursor/OpenCode/Hermes — query instead of read.  
  <sub>topics: —</sub>
- **[mksglu/context-mode](https://github.com/mksglu/context-mode)** · 20,240★ · TypeScript · Rising · health 78 · _Tool-output sandbox_ · **98% on tool output**  
...
- **[getagentseal/codeburn](https://github.com/getagentseal/codeburn)** · 9,717★ · TypeScript · Hot · health 79 · _Measurement / observability_ · **— (measures)**  
...
- **[MinishLab/semble](https://github.com/MinishLab/semble)** · 5,969★ · Python · Hot · health 73 · _Semantic code search_ · **~98% vs grep+read**  
...
- **[yvgude/lean-ctx](https://github.com/yvgude/lean-ctx)** · 3,675★ · Rust · Rising · health 80 · _Context layer_ · **qualitative**  
...
- **[HKUDS/FastCode](https://github.com/HKUDS/FastCode)** · 2,293★ · Python · Declining · health 41 · _Code understanding_ · **qualitative**  
...
- **[toon-format/toon](https://github.com/toon-format/toon)** · 25,272★ · TypeScript · Hot · health 79 · _Compact data format_ · **~30–50% on structured data**  
...
- **[deepseek-ai/DeepSeek-OCR](https://github.com/deepseek-ai/DeepSeek-OCR)** · 23,861★ · Python · Declining · health 13 · _Optical context compression_ · **research**  
  'Contexts Optical Compression' — renders document context to images to fit more in window; low health & stale.  
  <sub>topics: —</sub>
- **[bytebase/dbhub](https://github.com/bytebase/dbhub)** · 3,425★ · TypeScript · Hot · health 76 · _Token-efficient DB access_ · **qualitative**  
...
- **[thedotmack/claude-mem](https://github.com/thedotmack/claude-mem)** · 92,556★ · JavaScript · Rising · health 80 · _Session compression_ · **qualitative**  
...
- **[vllm-project/llm-compressor](https://github.com/vllm-project/llm-compressor)** · 3,736★ · Python · Mature · health 89 · _Model weight compression_ · **n/a (inference, not prompt)**  
...
- **[jasontang-ai/Context-Engineering](https://github.com/jasontang-ai/Context-Engineering)** · 9,233★ · Python · Declining · health 23 · _Methodology / guide_ · **— (educational)**  
...
1. `rtk-ai/rtk` — best general, integration-free reduction (60–90%, 77,794★, health 78).
...
| [HKUDS/FastCode](https://github.com/HKUDS/FastCode) | Coding agents & codebases | 41 | Declining | 1mo ago |
...
<sub>Tools covered: 15 across 6 workloads · Snapshot: 2026-08-29T15:31:31.780Z</sub>
