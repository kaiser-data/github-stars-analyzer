...
>
> Generated 2026-09-21 by `scripts/reports/voice_agents.py` (regenerate any time — no API cost).
...
- **27 voice-AI projects** in your stars (**652,566★** combined), organized along the voice-agent loop:
...
|---|---|---|---|---|---|---|---|---|---|---|
| [openai/whisper](https://github.com/openai/whisper) | Speech-to-text / ASR | Python | MIT | 109,424 (▲355) | Mature | 47 | active | 21d ago | 4.0y | 3 |
| [CorentinJ/Real-Time-Voice-Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning) | Voice cloning / studio | Python | NOASSERTION | 60,142 (▲12) | Declining | 22 | stale | 6mo ago | 7.3y | 0 |
| [jamiepine/voicebox](https://github.com/jamiepine/voicebox) | Voice cloning / studio | TypeScript | MIT | 55,333 (▲2,164) | Hot | 84 | active | 1mo ago | 7mo | 32 |
| [ggml-org/whisper.cpp](https://github.com/ggml-org/whisper.cpp) | Speech-to-text / ASR | C++ | MIT | 53,824 (▲170) | Classic | 99 | very active | 0d ago | 4.0y | 53 |
| [mudler/LocalAI](https://github.com/mudler/LocalAI) | Voice-capable runtime / serving | Go | MIT | 49,203 (▲98) | Classic | 79 | very active | 0d ago | 3.5y | 9 |
| [coqui-ai/TTS](https://github.com/coqui-ai/TTS) | Text-to-speech / TTS | Python | MPL-2.0 | 46,037 (▲29) | Abandoned | 10 | stale | 2.1y ago | 6.3y | 0 |
| [suno-ai/bark](https://github.com/suno-ai/bark) | Text-to-speech / TTS | Jupyter Notebook | MIT | 39,272 (▲5) | Abandoned | 5 | stale | 2.1y ago | 3.5y | 0 |
| [OpenBMB/VoxCPM](https://github.com/OpenBMB/VoxCPM) | Text-to-speech / TTS | Python | Apache-2.0 | 37,839 (▲645) | Mature | 70 | very active | 19d ago | 1.0y | 6 |
| [debpalash/VoiceStudio](https://github.com/debpalash/VoiceStudio) | Voice cloning / studio | Python | AGPL-3.0 | 33,726 (▲5,716) | Hot | 80 | very active | 1d ago | 5mo | 3 |
| [resemble-ai/chatterbox](https://github.com/resemble-ai/chatterbox) | Text-to-speech / TTS | Python | MIT | 26,501 (▲91) | Declining | 33 | slowing | 2mo ago | 1.4y | 1 |
| [SYSTRAN/faster-whisper](https://github.com/SYSTRAN/faster-whisper) | Speech-to-text / ASR | Python | MIT | 25,496 (▲105) | Declining | 13 | stale | 10mo ago | 3.6y | 0 |
| [m-bain/whisperX](https://github.com/m-bain/whisperX) | Speech-to-text / ASR | Python | BSD-2-Clause | 24,162 (▲134) | Mature | 59 | active | 22d ago | 3.8y | 2 |
| [pipecat-ai/pipecat](https://github.com/pipecat-ai/pipecat) | Realtime voice-agent framework | Python | BSD-2-Clause | 15,722 (▲196) | Mature | 84 | very active | 0d ago | 2.7y | 7 |
| [livekit/agents](https://github.com/livekit/agents) | Realtime voice-agent framework | Python | Apache-2.0 | 14,296 (▲109) | Mature | 99 | very active | 0d ago | 2.9y | 44 |
| [QwenLM/Qwen3-TTS](https://github.com/QwenLM/Qwen3-TTS) | Text-to-speech / TTS | Python | Apache-2.0 | 13,481 (▲97) | Declining | 23 | stale | 6mo ago | 8mo | 0 |
| [TEN-framework/ten-framework](https://github.com/TEN-framework/ten-framework) | Realtime voice-agent framework | Python | NOASSERTION | 11,137 (▲13) | Mature | 84 | very active | 0d ago | 2.3y | 19 |
| [KoljaB/RealtimeSTT](https://github.com/KoljaB/RealtimeSTT) | Speech-to-text / ASR | Python | MIT | 10,138 (▲11) | Classic | 68 | very active | 4d ago | 3.1y | 3 |
| [neuphonic/neutts](https://github.com/neuphonic/neutts) | Text-to-speech / TTS | Python | NOASSERTION | 6,288 (▲9) | Rising | 46 | active | 1mo ago | 11mo | 2 |
| [gradio-app/fastrtc](https://github.com/gradio-app/fastrtc) | Realtime voice-agent framework | JavaScript | MIT | 4,626 (▲3) | Declining | 18 | stale | 8mo ago | 2.0y | 0 |
| [QwenLM/Qwen3-Omni](https://github.com/QwenLM/Qwen3-Omni) | Speech-LLM / omni model | Jupyter Notebook | Apache-2.0 | 4,021 (▲12) | Declining | 27 | slowing | 5mo ago | 1.0y | 0 |
| [Azure-Samples/cognitive-services-speech-sdk](https://github.com/Azure-Samples/cognitive-services-speech-sdk) | Voice-capable runtime / serving | C# | MIT | 3,447 (▲1) | Mature | 57 | active | 2d ago | 8.4y | 4 |
| [microsoft/foundry-local](https://github.com/microsoft/foundry-local) | Voice-capable runtime / serving | C++ | NOASSERTION | 2,555 (▲7) | Hot | 87 | very active | 0d ago | 1.5y | 21 |
| [DigitalPhonetics/IMS-Toucan](https://github.com/DigitalPhonetics/IMS-Toucan) | Text-to-speech / TTS | Python | Apache-2.0 | 2,209 (▲1) | Declining | 20 | stale | 7mo ago | 5.1y | 0 |
| [alexpinel/Dot](https://github.com/alexpinel/Dot) | Voice-capable runtime / serving | JavaScript | GPL-3.0 | 1,914 (▲1) | Abandoned | 1 | stale | 1.8y ago | 2.5y | 0 |
...
| [lucidrains/voicebox-pytorch](https://github.com/lucidrains/voicebox-pytorch) | Text-to-speech / TTS | Python | MIT | 704 | Abandoned | 6 | stale | 2.0y ago | 3.1y | 0 |
| [Picovoice/picollm](https://github.com/Picovoice/picollm) | Voice-capable runtime / serving | Python | Apache-2.0 | 318 (▲1) | Mature | 58 | active | 10d ago | 2.5y | 2 |
...
- **[pipecat-ai/pipecat](https://github.com/pipecat-ai/pipecat)** · 15,722★ · Python · Mature  
...
- **[livekit/agents](https://github.com/livekit/agents)** · 14,296★ · Python · Mature  
...
- **[TEN-framework/ten-framework](https://github.com/TEN-framework/ten-framework)** · 11,137★ · Python · Mature  
...
- **[gradio-app/fastrtc](https://github.com/gradio-app/fastrtc)** · 4,626★ · JavaScript · Declining  
...
- **[coqui-ai/TTS](https://github.com/coqui-ai/TTS)** · 46,037★ · Python · Abandoned  
...
- **[suno-ai/bark](https://github.com/suno-ai/bark)** · 39,272★ · Jupyter Notebook · Abandoned  
  Generative audio model — expressive, prompt-driven speech (laughs, music, SFX), not just plain narration.  
  <sub>topics: —</sub>
- **[OpenBMB/VoxCPM](https://github.com/OpenBMB/VoxCPM)** · 37,839★ · Python · Mature  
...
- **[resemble-ai/chatterbox](https://github.com/resemble-ai/chatterbox)** · 26,501★ · Python · Declining  
  SoTA open-source TTS with emotion/exaggeration control — a credible ElevenLabs-class voice.  
  <sub>topics: —</sub>
- **[QwenLM/Qwen3-TTS](https://github.com/QwenLM/Qwen3-TTS)** · 13,481★ · Python · Declining  
  Qwen team's open TTS series — high-quality multilingual synthesis from a frontier-model lab.  
  <sub>topics: —</sub>
- **[neuphonic/neutts](https://github.com/neuphonic/neutts)** · 6,288★ · Python · Rising  
...
- **[CorentinJ/Real-Time-Voice-Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning)** · 60,142★ · Python · Declining  
...
- **[jamiepine/voicebox](https://github.com/jamiepine/voicebox)** · 55,333★ · TypeScript · Hot  
...
- **[debpalash/VoiceStudio](https://github.com/debpalash/VoiceStudio)** · 33,726★ · Python · Hot  
...
- **[QwenLM/Qwen3-Omni](https://github.com/QwenLM/Qwen3-Omni)** · 4,021★ · Jupyter Notebook · Declining  
...
- **[mudler/LocalAI](https://github.com/mudler/LocalAI)** · 49,203★ · Go · Classic  
...
- **[Azure-Samples/cognitive-services-speech-sdk](https://github.com/Azure-Samples/cognitive-services-speech-sdk)** · 3,447★ · C# · Mature  
  Reference samples for Azure's hosted Speech SDK — STT/TTS/translation if you prefer a managed cloud.  
  <sub>topics: —</sub>
- **[microsoft/foundry-local](https://github.com/microsoft/foundry-local)** · 2,555★ · C++ · Hot  
...
- **[pipecat-ai/pipecat](https://github.com/pipecat-ai/pipecat)** · 15,722★ · Python — Open-source framework for voice & multimodal conversational AI; wires STT→LLM→TTS with interruptions, VAD, and pluggable vendors.
- **[livekit/agents](https://github.com/livekit/agents)** · 14,296★ · Python — Realtime voice-AI agent framework on LiveKit's WebRTC transport — turn detection, telephony (SIP), and tool calling built in.
- **[TEN-framework/ten-framework](https://github.com/TEN-framework/ten-framework)** · 11,137★ · Python — Low-latency framework for conversational voice-AI agents; graph of multimodal extensions for real-time pipelines.
- **[gradio-app/fastrtc](https://github.com/gradio-app/fastrtc)** · 4,626★ · JavaScript — Python real-time audio/video (WebRTC) library — the browser transport layer that turns a model into a live voice app.
...
- **Community 2** (8): `gradio-app/fastrtc`, `coqui-ai/TTS`, `OpenBMB/VoxCPM`, `DigitalPhonetics/IMS-Toucan`, `lucidrains/voicebox-pytorch`, `CorentinJ/Real-Time-Voice-Cloning`, `jamiepine/voicebox`, `debpalash/VoiceStudio`
- **Community 17** (4): `ggml-org/whisper.cpp`, `SYSTRAN/faster-whisper`, `m-bain/whisperX`, `Macoron/whisper.unity`
- **Community 11** (3): `pipecat-ai/pipecat`, `livekit/agents`, `TEN-framework/ten-framework`
- **Community 27** (3): `QwenLM/Qwen3-TTS`, `QwenLM/Qwen3-Omni`, `alexpinel/Dot`
- **Community 10** (2): `openai/whisper`, `KoljaB/RealtimeSTT`
- **Community 1** (2): `resemble-ai/chatterbox`, `neuphonic/neutts`

**Centrality (PageRank in the full 2,211-repo graph)** — most 'hub-like' voice tools in your ecosystem:
...
- `livekit/agents` ⇄ `TEN-framework/ten-framework` (w=0.654) — topics: ai, real-time, voice, video; authors: 3DRX
...
- `livekit/agents` ⇄ `pipecat-ai/pipecat` (w=0.423) — topics: ai, real-time, voice; authors: dlange-aai
...
|---|---|---|---|---|---|---|
| livekit/agents | 99 | Mature | very active | 6 | 16% | 373 |
| ggml-org/whisper.cpp | 99 | Classic | very active | 11 | 10% | 43 |
| microsoft/foundry-local | 87 | Hot | very active | 3 | 29% | 23 |
| pipecat-ai/pipecat | 84 | Mature | very active | 2 | 43% | 121 |
| TEN-framework/ten-framework | 84 | Mature | very active | 3 | 28% | 122 |
| jamiepine/voicebox | 84 | Hot | active | 8 | 22% | 25 |
| debpalash/VoiceStudio | 80 | Hot | very active | 1 | 98% | 40 |
| mudler/LocalAI | 79 | Classic | very active | 1 | 83% | 137 |
| OpenBMB/VoxCPM | 70 | Mature | very active | 2 | 36% | 14 |
...
- **Chainlit/chainlit** (12,464★) — conversational-AI *chat UI* (audio is secondary) — not a voice-pipeline framework
- **mastra-ai/mastra** (28,231★) — general TS agent framework with a TTS module — covered by the agent-orchestration report
- **VoltAgent/voltagent** (10,654★) — general TS agent platform that *can* do TTS — not voice-specific
- **Fosowl/agenticSeek** (27,269★) — autonomous local agent with an optional voice front-end — general agent, not a voice stack
- **mozilla-ai/llamafile** (26,012★) — single-file LLM runner that bundles whisper.cpp — general runtime, see inference reports
- **huggingface/transformers** (166,455★) — hosts most of these speech models, but far too broad to list as a 'voice' tool
- **unslothai/unsloth** (76,526★) — fine-tunes TTS/audio models among many others — a training tool, not a voice agent
