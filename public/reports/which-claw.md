...
> Derived from **kaiser-data**'s 1,857 starred repos (snapshot `2026-08-29T15:31:31.780Z`), cross-referenced with the repo-similarity graph.
>
...
**As a pragmatic default, [`openclaw/openclaw`](https://github.com/openclaw/openclaw) (composite 0.776, #3).** The score above *deliberately excludes the ecosystem network effect* — and that's OpenClaw's real edge: every accessory you've already starred (`clawhub`, `ClawRouter`, `clawmetry`, `opik-openclaw`, `openclaw-supermemory`, `NemoClaw`, `moltworker`) targets OpenClaw, not zeroclaw. That's a genuine switching cost in its favour.
...
|---|---|---|---|---|---|---|---|---|---|
| 🥇 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) † | General assistant | **0.879** | 237,998 (▲660) | 85 | 37,675 | 0d ago | 3 | Python |
| 🥈 | [zeroclaw-labs/zeroclaw](https://github.com/zeroclaw-labs/zeroclaw) | General assistant | **0.842** | 32,671 (▲4) | 88 | 12,421 | 0d ago | 3 | Rust |
| 🥉 | [openclaw/openclaw](https://github.com/openclaw/openclaw) | General assistant | **0.776** | 387,982 (▲136) | 79 | 104,589 | 0d ago | 1 | TypeScript |
| 4 | [HKUDS/nanobot](https://github.com/HKUDS/nanobot) † | General assistant | **0.745** | 47,520 (▲49) | 84 | 17,025 | 0d ago | 2 | Python |
| 5 | [elizaOS/eliza](https://github.com/elizaOS/eliza) † | General assistant | **0.732** | 19,206 (▲16) | 84 | 1,291 | 0d ago | 2 | TypeScript |
| 6 | [sipeed/picoclaw](https://github.com/sipeed/picoclaw) | General assistant | **0.730** | 29,919 (▲5) | 85 | 10,886 | 2d ago | 2 | Go |
| 7 | [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) † | Coding agent | **0.718** | 68,499 (▲50) | 78 | 19,057 | 0d ago | 1 | TypeScript |
| 8 | [NVIDIA/NemoClaw](https://github.com/NVIDIA/NemoClaw) | Secure runtime | **0.713** | 22,304 (▲8) | 74 | 10,021 | 0d ago | 3 | TypeScript |
| 9 | [nearai/ironclaw](https://github.com/nearai/ironclaw) | Secure runtime | **0.706** | 12,602 (▼1) | 80 | 4,558 | 0d ago | 2 | Rust |
| 10 | [nanocoai/nanoclaw](https://github.com/nanocoai/nanoclaw) | Secure runtime | **0.706** | 30,644 (▲18) | 80 | 10,945 | 0d ago | 2 | TypeScript |
| 11 | [ultraworkers/claw-code](https://github.com/ultraworkers/claw-code) | Coding agent | **0.619** | 195,147 (▲13) | 64 | 61,921 | 13d ago | 1 | Rust |
| 12 | [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) | General assistant | **0.573** | 8,052 (▲2) | 67 | 1,247 | 1mo ago | 1 | Zig |
| 13 | [RightNow-AI/openfang](https://github.com/RightNow-AI/openfang) | General assistant | **0.507** | 18,147 (▲8) | 49 | 2,932 | 1mo ago | 0 | Rust |

**Where's Hermes?** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) lands **#1** (composite 0.879) — the **strongest functional claw** and it leads OpenClaw (#3). Health 85, bus factor 3 (vs OpenClaw's 1 — more resilient), 237,998★, very active.
...
Other functional claws (†): `nanobot` #4, `eliza` #5, `oh-my-openagent` #7.
...
| elizaOS/eliza | 0.84 | 0.77 | 0.67 | 0.69 | 0.62 | **0.732** |
...
|---|---|---|---|---|---|---|---|---|
| hermes-agent † | **1** | **1** | 2 | 2 | **1** | 2 | 1.5 | #1–#2 |
| zeroclaw | 2 | 2 | **1** | 3 | 2 | 6 | 2.7 | #1–#6 |
| openclaw | 3 | 3 | 7 | **1** | 9 | **1** | 4.0 | #1–#9 |
| nanobot † | 4 | 4 | 4 | 5 | 5 | 5 | 4.5 | #4–#5 |
| eliza † | 5 | 5 | 3 | 9 | 3 | 11 | 6.0 | #3–#11 |
| picoclaw | 6 | 7 | 5 | 7 | 7 | 7 | 6.5 | #5–#7 |
| oh-my-openagent † | 7 | 6 | 10 | 4 | 10 | 4 | 6.8 | #4–#10 |
| ironclaw | 9 | 8 | 6 | 10 | 6 | 10 | 8.2 | #6–#10 |
| NemoClaw | 8 | 10 | 8 | 11 | 4 | 9 | 8.3 | #4–#11 |
| nanoclaw | 10 | 9 | 9 | 8 | 8 | 8 | 8.7 | #8–#10 |
| claw-code | 11 | 11 | 12 | 6 | 12 | 3 | 9.2 | #3–#12 |
| nullclaw | 12 | 12 | 11 | 13 | 11 | 13 | 12.0 | #11–#13 |
| openfang | 13 | 13 | 13 | 12 | 13 | 12 | 12.7 | #12–#13 |

**Read-out.**
- **`hermes-agent` is the robust #1** — first under 3 of 6 profiles, mean rank 1.5, never below #2. The top spot is *not* an artifact of the chosen weights.
- **Hermes is the stability champion of the top tier** — mean 1.5, range #1–#2; it never leaves the podium under any weighting. The most *weighting-proof* pick.
...
**Pareto-optimal (8):** `hermes-agent`, `zeroclaw`, `openclaw`, `picoclaw`, `oh-my-openagent`, `claw-code`, `nullclaw`, `openfang`.

**Dominated — only justified by fit, not metrics:**

| Claw | Dominated by | Survives only if you need… |
|---|---|---|
| `nanobot` | `hermes-agent` | a minimal embeddable Python agent |
| `eliza` | `zeroclaw`, `picoclaw`, `hermes-agent`, `nanobot` | autonomous social/web3 swarm bots |
...
In the repo-similarity graph (1,138 nodes / 6,041 edges), the claws **don't form one cluster** — they scatter across **7 of 25 communities**. There is no single 'claw' neighbourhood; these are genuinely different projects that happen to share a role.

- **Centrality (PageRank).** Most hub-like claws: `oh-my-openagent` (0.0011), `hermes-agent` (0.0007), `openclaw` (0.0007). Note PageRank tracks *similarity* connectivity, not quality — a claw is central when many neighbours resemble it.
...
- **The honest network-effect caveat.** The similarity graph measures shared topics/authors, **not** 'plugs-into' dependency — so it does *not* by itself prove OpenClaw lock-in. The one direct graph signal that does is **`openclaw` ⇄ `clawhub` (its official skill directory) at w=0.68** — the strongest accessory tie of any claw. The broader lock-in argument below rests on real-world integration, which the graph under-counts, not over-counts.
...
| **Fastest-growing right now** | [`openclaw/openclaw`](https://github.com/openclaw/openclaw) | ~104,589 est. stars/30d |
...
| **Most-adopted / most battle-tested** | [`openclaw/openclaw`](https://github.com/openclaw/openclaw) | 387,982★ |
...
<sub>Claws ranked: 13 · Snapshot: 2026-08-29T15:31:31.780Z · regenerate via scripts/reports/which_claw.py</sub>
