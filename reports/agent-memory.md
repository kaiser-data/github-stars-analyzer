...
> Derived from **kaiser-data**'s 2,140 starred repos (snapshot `2026-09-12T16:25:05.965Z`), cross-referenced with the repo-similarity graph (2,140 nodes / 7,036 edges, 41 communities). The primitive-coverage matrix is additionally backed by documentation and source-code evidence gathered 2026-08-12 — see Methodology.
>
> Generated 2026-09-13 by `scripts/reports/agent_memory.py` (regenerate any time — no API cost).
...
- **37 tools** across the memory stack (**735,046★** combined):
...
|---|---|---|---|---|---|---|---|---|---|---|
| [mem0ai/mem0](https://github.com/mem0ai/mem0) | Vector-first memory | Python | Apache-2.0 | 64,763 (▼64) | Classic | 78 | very active | 8d ago | 3.2y | 24 |
| [MemPalace/mempalace](https://github.com/MemPalace/mempalace) | Vector-first memory | Python | MIT | 58,865 (▼30) | Hot | 75 | very active | 7d ago | 5mo | 9 |
| [milvus-io/milvus](https://github.com/milvus-io/milvus) | Vector & graph stores | Go | Apache-2.0 | 45,994 (▼17) | Classic | 99 | very active | 8d ago | 7.0y | 32 |
| [HKUDS/LightRAG](https://github.com/HKUDS/LightRAG) | Extraction & ontology | Python | MIT | 39,429 (▼24) | Hot | 78 | very active | 6d ago | 1.9y | 7 |
| [microsoft/graphrag](https://github.com/microsoft/graphrag) | Extraction & ontology | Python | MIT | 35,850 (▼23) | Mature | 70 | very active | 11d ago | 2.5y | 4 |
| [qdrant/qdrant](https://github.com/qdrant/qdrant) | Vector & graph stores | Rust | Apache-2.0 | 34,404 (▼13) | Classic | 92 | very active | 7d ago | 6.3y | 22 |
| [onyx-dot-app/onyx](https://github.com/onyx-dot-app/onyx) | Chat & workspace connectors | Python | NOASSERTION | 31,942 (▼13) | Classic | 94 | very active | 6d ago | 3.4y | 12 |
| [nanocoai/nanoclaw](https://github.com/nanocoai/nanoclaw) | Chat & workspace connectors | TypeScript | MIT | 30,708 (▼5) | Hot | 79 | very active | 6d ago | 7mo | 10 |
| [getzep/graphiti](https://github.com/getzep/graphiti) | Graph-native memory | Python | Apache-2.0 | 30,624 (▼34) | Mature | 73 | very active | 8d ago | 2.1y | 23 |
| [topoteretes/cognee](https://github.com/topoteretes/cognee) | Graph-native memory | Python | Apache-2.0 | 30,502 (▼42) | Classic | 77 | very active | 7d ago | 3.1y | 9 |
| [Zackriya-Solutions/meetily](https://github.com/Zackriya-Solutions/meetily) | Meeting & transcript capture | Rust | MIT | 30,401 (▼36) | Declining | 43 | active | 6d ago | 1.7y | 0 |
| [TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory) | Vector-first memory | TypeScript | NOASSERTION | 25,983 (▼67) | Rising | 71 | very active | 10d ago | 5mo | 11 |
| [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) | Memory evaluation | TypeScript | MIT | 24,848 (▼37) | Classic | 84 | very active | 6d ago | 3.4y | 14 |
| [letta-ai/letta](https://github.com/letta-ai/letta) | Vector-first memory | — | Apache-2.0 | 24,626 (▼14) | Mature | 65 | active | 20d ago | 2.9y | 2 |
| [pgvector/pgvector](https://github.com/pgvector/pgvector) | Vector & graph stores | C | NOASSERTION | 22,924 (▼10) | Classic | 63 | very active | 24d ago | 5.4y | 3 |
| [vectorize-io/hindsight](https://github.com/vectorize-io/hindsight) | Vector-first memory | Python | MIT | 22,712 (▼424) | Hot | 79 | very active | 7d ago | 10mo | 14 |
| [comet-ml/opik](https://github.com/comet-ml/opik) | Memory evaluation | Python | Apache-2.0 | 21,823 (▼23) | Classic | 93 | very active | 7d ago | 3.3y | 26 |
| [screenpipe/screenpipe](https://github.com/screenpipe/screenpipe) | Meeting & transcript capture | Rust | NOASSERTION | 21,433 (▼29) | Mature | 79 | very active | 6d ago | 2.2y | 5 |
| [elizaOS/eliza](https://github.com/elizaOS/eliza) | Chat & workspace connectors | TypeScript | MIT | 19,261 (▼14) | Mature | 83 | very active | 6d ago | 2.2y | 11 |
| [weaviate/weaviate](https://github.com/weaviate/weaviate) | Vector & graph stores | Go | BSD-3-Clause | 16,785 (▼2) | Classic | 78 | very active | 7d ago | 10.5y | 5 |
| [memvid/memvid](https://github.com/memvid/memvid) | Vector-first memory | Rust | Apache-2.0 | 16,489 (▼3) | Declining | 56 | active | 2mo ago | 1.3y | 1 |
| [MemoriLabs/Memori](https://github.com/MemoriLabs/Memori) | Vector-first memory | Python | NOASSERTION | 16,443 (▼26) | Mature | 72 | active | 9d ago | 1.1y | 4 |
| [semantica-agi/semantica](https://github.com/semantica-agi/semantica) | Graph-native memory | Python | MIT | 12,126 (▼114) | Hot | 83 | very active | 7d ago | 1.2y | 20 |
| [cocoindex-io/cocoindex](https://github.com/cocoindex-io/cocoindex) | Extraction & ontology | Rust | Apache-2.0 | 11,491 (▼6) | Hot | 83 | very active | 7d ago | 1.5y | 21 |
| [lancedb/lancedb](https://github.com/lancedb/lancedb) | Vector & graph stores | Rust | Apache-2.0 | 11,362 (▼7) | Classic | 86 | very active | 7d ago | 3.5y | 14 |
| [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | Vector-first memory | Python | AGPL-3.0 | 7,036 (▼9) | Classic | 76 | very active | 7d ago | 3.0y | 25 |
| [FalkorDB/FalkorDB](https://github.com/FalkorDB/FalkorDB) | Vector & graph stores | Rust | NOASSERTION | 5,904 (▼21) | Classic | 79 | very active | 6d ago | 3.2y | 10 |
| [HelixDB/helix-db](https://github.com/HelixDB/helix-db) | Vector & graph stores | Rust | Apache-2.0 | 5,889 (▼1) | Hot | 79 | very active | 7d ago | 1.8y | 6 |
| [MemMachine/MemMachine](https://github.com/MemMachine/MemMachine) | Graph-native memory | Python | Apache-2.0 | 3,214 (▼2) | Mature | 74 | active | 8d ago | 1.1y | 6 |
| [Vexa-ai/vexa](https://github.com/Vexa-ai/vexa) | Meeting & transcript capture | Python | Apache-2.0 | 2,752 (▼3) | Hot | 75 | very active | 7d ago | 1.6y | 7 |
| [trustgraph-ai/trustgraph](https://github.com/trustgraph-ai/trustgraph) | Graph-native memory | Python | Apache-2.0 | 2,677 (▼8) | Mature | 63 | very active | 9d ago | 2.2y | 11 |
| [zilliztech/memsearch](https://github.com/zilliztech/memsearch) | Vector-first memory | Python | MIT | 2,568 (▼2) | Hot | 75 | very active | 8d ago | 7mo | 13 |
| [FalkorDB/GraphRAG-SDK](https://github.com/FalkorDB/GraphRAG-SDK) | Extraction & ontology | Python | Apache-2.0 | 995 (▲1) | Mature | 78 | very active | 6d ago | 2.6y | 8 |
| [shaneholloman/mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph) | Graph-native memory | JavaScript | MIT | 889 | Declining | 42 | slowing | 3mo ago | 1.8y | 0 |
| [cyrusagents/cyrus](https://github.com/cyrusagents/cyrus) | Chat & workspace connectors | TypeScript | Apache-2.0 | 796 | Hot | 71 | very active | 6d ago | 1.4y | 9 |
| [fabio-rovai/open-ontologies](https://github.com/fabio-rovai/open-ontologies) | Extraction & ontology | Rust | MIT | 479 (▼1) | Hot | 79 | very active | 7d ago | 6mo | 3 |
| [HKUDS/MGP](https://github.com/HKUDS/MGP) | Graph-native memory | Python | MIT | 59 | Declining | 28 | active | 1mo ago | 5mo | 0 |
...
- **[getzep/graphiti](https://github.com/getzep/graphiti)** · 30,624★ · Python · Mature  
...
- **[topoteretes/cognee](https://github.com/topoteretes/cognee)** · 30,502★ · Python · Classic  
...
- **[semantica-agi/semantica](https://github.com/semantica-agi/semantica)** · 12,126★ · Python · Hot  
...
- **[MemMachine/MemMachine](https://github.com/MemMachine/MemMachine)** · 3,214★ · Python · Mature  
...
- **[trustgraph-ai/trustgraph](https://github.com/trustgraph-ai/trustgraph)** · 2,677★ · Python · Mature  
...
- **[TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory)** · 25,983★ · TypeScript · Rising  
...
- **[letta-ai/letta](https://github.com/letta-ai/letta)** · 24,626★ · — · Mature  
...
- **[vectorize-io/hindsight](https://github.com/vectorize-io/hindsight)** · 22,712★ · Python · Hot  
...
- **[MemoriLabs/Memori](https://github.com/MemoriLabs/Memori)** · 16,443★ · Python · Mature  
...
- **[plastic-labs/honcho](https://github.com/plastic-labs/honcho)** · 7,036★ · Python · Classic  
...
- **[zilliztech/memsearch](https://github.com/zilliztech/memsearch)** · 2,568★ · Python · Hot  
...
- **[HelixDB/helix-db](https://github.com/HelixDB/helix-db)** · 5,889★ · Rust · Hot  
...
- **[cocoindex-io/cocoindex](https://github.com/cocoindex-io/cocoindex)** · 11,491★ · Rust · Hot  
...
- **[fabio-rovai/open-ontologies](https://github.com/fabio-rovai/open-ontologies)** · 479★ · Rust · Hot  
...
- **[onyx-dot-app/onyx](https://github.com/onyx-dot-app/onyx)** · 31,942★ · Python · Classic  
...
- **[nanocoai/nanoclaw](https://github.com/nanocoai/nanoclaw)** · 30,708★ · TypeScript · Hot  
...
- **[elizaOS/eliza](https://github.com/elizaOS/eliza)** · 19,261★ · TypeScript · Mature  
...
- **[cyrusagents/cyrus](https://github.com/cyrusagents/cyrus)** · 796★ · TypeScript · Hot  
...
- **[Zackriya-Solutions/meetily](https://github.com/Zackriya-Solutions/meetily)** · 30,401★ · Rust · Declining  
...
- **[screenpipe/screenpipe](https://github.com/screenpipe/screenpipe)** · 21,433★ · Rust · Mature  
...
- **[Vexa-ai/vexa](https://github.com/Vexa-ai/vexa)** · 2,752★ · Python · Hot  
...
**Community clustering.** These 37 tools span **15 of the graph's 41 communities** — a wide spread for one report, which is itself the finding: 'agent memory' is not one community in your stars, it is a theme cutting across several.

- **Community 16** (8): `MemMachine/MemMachine`, `semantica-agi/semantica`, `mem0ai/mem0`, `memvid/memvid`, `MemoriLabs/Memori`, `plastic-labs/honcho`, `zilliztech/memsearch`, `cocoindex-io/cocoindex`
- **Community 22** (6): `shaneholloman/mcp-knowledge-graph`, `qdrant/qdrant`, `milvus-io/milvus`, `weaviate/weaviate`, `pgvector/pgvector`, `lancedb/lancedb`
- **Community 20** (3): `getzep/graphiti`, `letta-ai/letta`, `screenpipe/screenpipe`
- **Community 9** (3): `trustgraph-ai/trustgraph`, `HelixDB/helix-db`, `fabio-rovai/open-ontologies`
- **Community 5** (3): `MemPalace/mempalace`, `onyx-dot-app/onyx`, `elizaOS/eliza`
- **Community 10** (2): `HKUDS/MGP`, `HKUDS/LightRAG`
- **Community 17** (2): `vectorize-io/hindsight`, `TencentCloud/TencentDB-Agent-Memory`
- **Community 25** (2): `FalkorDB/FalkorDB`, `FalkorDB/GraphRAG-SDK`
- **Community 6** (2): `Zackriya-Solutions/meetily`, `Vexa-ai/vexa`

**Centrality (PageRank in the full 2,140-repo graph)** — the most hub-like memory tools in your ecosystem:
...
- `semantica-agi/semantica` ⇄ `cocoindex-io/cocoindex` (w=0.212) — topics: ai, context-engineering, knowledge-graph, llm
...
|---|---|---|---|---|---|
| `HKUDS/LightRAG` | 39,429 | Extraction & ontology | very active | 6 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `onyx-dot-app/onyx` | 31,942 | Chat & workspace connectors | very active | 6 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `nanocoai/nanoclaw` | 30,708 | Chat & workspace connectors | very active | 8 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `getzep/graphiti` | 30,624 | Graph-native memory | very active | 5 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `TencentCloud/TencentDB-Agent-Memory` | 25,983 | Vector-first memory | very active | 7 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `letta-ai/letta` | 24,626 | Vector-first memory | active | 11 | **Watch** — connected elsewhere, but its own activity is fading. The risk is maintenance, not obscurity. |
| `vectorize-io/hindsight` | 22,712 | Vector-first memory | very active | 8 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `HelixDB/helix-db` | 5,889 | Vector & graph stores | very active | 6 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `zilliztech/memsearch` | 2,568 | Vector-first memory | very active | 5 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `shaneholloman/mcp-knowledge-graph` | 889 | Graph-native memory | slowing | 5 | **Watch** — connected elsewhere, but its own activity is fading. The risk is maintenance, not obscurity. |
| `fabio-rovai/open-ontologies` | 479 | Extraction & ontology | very active | 4 | **Genuinely peripheral, still moving** — few edges anywhere but actively developed. Early or idiosyncratic; the one shape worth a look. |
| `HKUDS/MGP` | 59 | Graph-native memory | active | 11 | **Watch** — connected elsewhere, but its own activity is fading. The risk is maintenance, not obscurity. |

**My read, and a correction to the obvious one.** The tempting story — *isolated in a crowded category means unexploited angle* — does not survive contact with the data here. Every isolated tool above still has 4–11 edges in the full graph. They are not isolated in the ecosystem; they are isolated *in this report's slice of it*, because this graph's edges come from shared topics and shared contributors, and a Microsoft research repo simply does not share either with a single-maintainer MCP server. `microsoft/graphrag` is the proof: the most-copied approach in the whole category, and it shows up here with zero in-report edges. Calling that an unexploited angle would be a metric artifact dressed up as an insight.
...
|---|---|---|---|---|---|---|---|
| `HKUDS/MGP` | Graph-native memory | 28 | Declining | active | 1mo ago | 0 | 0% |
| `shaneholloman/mcp-knowledge-graph` | Graph-native memory | 42 | Declining | slowing | 3mo ago | 0 | 0% |
| `Zackriya-Solutions/meetily` | Meeting & transcript capture | 43 | Declining | active | 6d ago | 0 | 0% |
| `memvid/memvid` | Vector-first memory | 56 | Declining | active | 2mo ago | 1 | 100% |
| `trustgraph-ai/trustgraph` | Graph-native memory | 63 | Mature | very active | 9d ago | 1 | 64% |
| `pgvector/pgvector` | Vector & graph stores | 63 | Classic | very active | 24d ago | 1 | 98% |
| `letta-ai/letta` | Vector-first memory | 65 | Mature | active | 20d ago | 1 | 63% |
| `microsoft/graphrag` | Extraction & ontology | 70 | Mature | very active | 11d ago | 1 | 65% |
| `cyrusagents/cyrus` | Chat & workspace connectors | 71 | Hot | very active | 6d ago | 1 | 77% |
| `TencentCloud/TencentDB-Agent-Memory` | Vector-first memory | 71 | Rising | very active | 10d ago | 2 | 29% |
| `MemoriLabs/Memori` | Vector-first memory | 72 | Mature | active | 9d ago | 2 | 43% |
| `getzep/graphiti` | Graph-native memory | 73 | Mature | very active | 8d ago | 1 | 61% |
| `MemMachine/MemMachine` | Graph-native memory | 74 | Mature | active | 8d ago | 3 | 17% |
| `zilliztech/memsearch` | Vector-first memory | 75 | Hot | very active | 8d ago | 1 | 78% |
| `Vexa-ai/vexa` | Meeting & transcript capture | 75 | Hot | very active | 7d ago | 1 | 92% |
| `MemPalace/mempalace` | Vector-first memory | 75 | Hot | very active | 7d ago | 1 | 65% |
| `plastic-labs/honcho` | Vector-first memory | 76 | Classic | very active | 7d ago | 4 | 20% |
| `topoteretes/cognee` | Graph-native memory | 77 | Classic | very active | 7d ago | 1 | 69% |
| `FalkorDB/GraphRAG-SDK` | Extraction & ontology | 78 | Mature | very active | 6d ago | 2 | 28% |
| `weaviate/weaviate` | Vector & graph stores | 78 | Classic | very active | 7d ago | 1 | 65% |
| `HKUDS/LightRAG` | Extraction & ontology | 78 | Hot | very active | 6d ago | 1 | 74% |
| `mem0ai/mem0` | Vector-first memory | 78 | Classic | very active | 8d ago | 1 | 55% |
| `fabio-rovai/open-ontologies` | Extraction & ontology | 79 | Hot | very active | 7d ago | 1 | 92% |
| `HelixDB/helix-db` | Vector & graph stores | 79 | Hot | very active | 7d ago | 1 | 86% |
| `FalkorDB/FalkorDB` | Vector & graph stores | 79 | Classic | very active | 6d ago | 2 | 38% |
| `screenpipe/screenpipe` | Meeting & transcript capture | 79 | Mature | very active | 6d ago | 1 | 54% |
| `vectorize-io/hindsight` | Vector-first memory | 79 | Hot | very active | 7d ago | 1 | 69% |
| `nanocoai/nanoclaw` | Chat & workspace connectors | 79 | Hot | very active | 6d ago | 2 | 40% |
| `cocoindex-io/cocoindex` | Extraction & ontology | 83 | Hot | very active | 7d ago | 2 | 32% |
| `semantica-agi/semantica` | Graph-native memory | 83 | Hot | very active | 7d ago | 2 | 46% |
| `elizaOS/eliza` | Chat & workspace connectors | 83 | Mature | very active | 6d ago | 2 | 28% |
| `promptfoo/promptfoo` | Memory evaluation | 84 | Classic | very active | 6d ago | 2 | 33% |
| `lancedb/lancedb` | Vector & graph stores | 86 | Classic | very active | 7d ago | 3 | 23% |
| `qdrant/qdrant` | Vector & graph stores | 92 | Classic | very active | 7d ago | 4 | 18% |
| `comet-ml/opik` | Memory evaluation | 93 | Classic | very active | 7d ago | 4 | 23% |
| `onyx-dot-app/onyx` | Chat & workspace connectors | 94 | Classic | very active | 6d ago | 4 | 18% |
| `milvus-io/milvus` | Vector & graph stores | 99 | Classic | very active | 8d ago | 8 | 10% |

**Slowing or stale (1):** `shaneholloman/mcp-knowledge-graph`. 
**Single-maintainer risk (16 above 1k★):** `HKUDS/LightRAG`, `HelixDB/helix-db`, `MemPalace/mempalace`, `Vexa-ai/vexa`, `getzep/graphiti`, `letta-ai/letta`, `mem0ai/mem0`, `memvid/memvid`, `microsoft/graphrag`, `pgvector/pgvector`, `screenpipe/screenpipe`, `topoteretes/cognee`, `trustgraph-ai/trustgraph`, `vectorize-io/hindsight`, `weaviate/weaviate`, `zilliztech/memsearch`.
...
- **vllm-project/vllm** (91,060★) — 'memory-efficient' inference — a pure keyword collision, nothing to do with agent memory
- **redis/redis** (76,226★) — a general datastore frequently used *as* a memory backend, but not itself a memory system
- **Memento-Teams/Memento** (2,570★) — 'teams' here means agent teams, not Microsoft Teams — collision
- **infiniflow/ragflow** (90,113★) — general-purpose RAG engine — covered by the RAG tooling report
- **deepset-ai/haystack** (26,430★) — orchestration framework; memory is one component among many — see RAG tooling
- **run-llama/llama_index** (52,031★) — document/RAG platform rather than a conversational memory layer
- **thedotmack/claude-mem** (93,309★) — coding-agent *session* memory — see the Memory Frameworks report
- **gastownhall/beads** (26,937★) — coding-agent memory upgrade, not conversational
- **ctxrs/ctx** (1,078★) — searches local coding-agent history — adjacent, but the corpus is agent transcripts, not human chat
- **colbymchenry/codegraph** (69,783★) — code knowledge graph — same technique, entirely different corpus
- **vitali87/code-graph-rag** (5,012★) — GraphRAG over monorepos, not conversations
- **DeusData/codebase-memory-mcp** (42,385★) — codebase intelligence graph, not chat
- **Graphify-Labs/graphify** (115,151★) — codebase → knowledge graph (and the tooling this very repo is indexed with)
- **usememos/memos** (62,790★) — human note-taking, no agent memory API
- **eugeniughelbur/obsidian-second-brain** (4,339★) — PKM-backed agent memory over an Obsidian vault — close, but the substrate is notes, not conversation
- **agentscope-ai/ReMe** (3,418★) — memory management kit; overlaps the vector-first tier without adding a distinct conversational angle
- **mudler/LocalRecall** (971★) — local memory/knowledge base for agents — generic document recall rather than chat-native
- **HKUDS/CatchMe** (493★) — agent personalisation; memory is implicit rather than the product
- **matrixorigin/memoria** (593★) — secure memory management — security framing, thin conversational story
- **supermemoryai/openclaw-supermemory** (799★) — long-term memory for one specific agent harness
- **rishikanthc/Scriberr** (3,028★) — self-hosted transcription — see the Meeting Transcription report
...
<sub>Tools covered: 37 · Matrix rows: 16 · Evidence date: 2026-08-12 · Snapshot: 2026-09-12T16:25:05.965Z</sub>
