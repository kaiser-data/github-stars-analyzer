...
> Derived from **kaiser-data**'s 2,087 starred repos (snapshot `2026-09-07T10:42:15.216Z`), cross-referenced with the repo-similarity graph (2,087 nodes / 6,821 edges, 38 communities). The primitive-coverage matrix is additionally backed by documentation and source-code evidence gathered 2026-08-12 — see Methodology.
>
> Generated 2026-09-07 by `scripts/reports/agent_memory.py` (regenerate any time — no API cost).
...
- **37 tools** across the memory stack (**736,169★** combined):
...
|---|---|---|---|---|---|---|---|---|---|---|
| [mem0ai/mem0](https://github.com/mem0ai/mem0) | Vector-first memory | Python | Apache-2.0 | 64,827 (▲64) | Classic | 78 | very active | 3d ago | 3.2y | 24 |
| [MemPalace/mempalace](https://github.com/MemPalace/mempalace) | Vector-first memory | Python | MIT | 58,895 (▲30) | Hot | 76 | very active | 2d ago | 5mo | 9 |
| [milvus-io/milvus](https://github.com/milvus-io/milvus) | Vector & graph stores | Go | Apache-2.0 | 46,011 (▲17) | Classic | 99 | very active | 0d ago | 7.0y | 33 |
| [HKUDS/LightRAG](https://github.com/HKUDS/LightRAG) | Extraction & ontology | Python | MIT | 39,453 (▲24) | Hot | 79 | very active | 0d ago | 1.9y | 7 |
| [microsoft/graphrag](https://github.com/microsoft/graphrag) | Extraction & ontology | Python | MIT | 35,873 (▲23) | Mature | 71 | very active | 0d ago | 2.4y | 4 |
| [qdrant/qdrant](https://github.com/qdrant/qdrant) | Vector & graph stores | Rust | Apache-2.0 | 34,417 (▲13) | Classic | 93 | very active | 0d ago | 6.3y | 22 |
| [onyx-dot-app/onyx](https://github.com/onyx-dot-app/onyx) | Chat & workspace connectors | Python | NOASSERTION | 31,955 (▲13) | Classic | 94 | very active | 0d ago | 3.4y | 12 |
| [nanocoai/nanoclaw](https://github.com/nanocoai/nanoclaw) | Chat & workspace connectors | TypeScript | MIT | 30,713 (▲5) | Hot | 80 | very active | 0d ago | 7mo | 11 |
| [getzep/graphiti](https://github.com/getzep/graphiti) | Graph-native memory | Python | Apache-2.0 | 30,658 (▲34) | Mature | 73 | very active | 1d ago | 2.1y | 22 |
| [topoteretes/cognee](https://github.com/topoteretes/cognee) | Graph-native memory | Python | Apache-2.0 | 30,544 (▲42) | Classic | 78 | very active | 0d ago | 3.1y | 10 |
| [Zackriya-Solutions/meetily](https://github.com/Zackriya-Solutions/meetily) | Meeting & transcript capture | Rust | MIT | 30,437 (▲36) | Declining | 43 | active | 0d ago | 1.7y | 0 |
| [TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory) | Vector-first memory | TypeScript | NOASSERTION | 26,050 (▲67) | Rising | 71 | very active | 4d ago | 5mo | 11 |
| [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) | Memory evaluation | TypeScript | MIT | 24,885 (▲37) | Classic | 84 | very active | 0d ago | 3.4y | 13 |
| [letta-ai/letta](https://github.com/letta-ai/letta) | Vector-first memory | — | Apache-2.0 | 24,640 (▲14) | Mature | 65 | active | 15d ago | 2.9y | 2 |
| [vectorize-io/hindsight](https://github.com/vectorize-io/hindsight) | Vector-first memory | Python | MIT | 23,136 (▲424) | Hot | 80 | very active | 0d ago | 10mo | 14 |
| [pgvector/pgvector](https://github.com/pgvector/pgvector) | Vector & graph stores | C | NOASSERTION | 22,934 (▲10) | Classic | 63 | very active | 18d ago | 5.4y | 3 |
| [comet-ml/opik](https://github.com/comet-ml/opik) | Memory evaluation | Python | Apache-2.0 | 21,846 (▲23) | Classic | 93 | very active | 0d ago | 3.3y | 24 |
| [screenpipe/screenpipe](https://github.com/screenpipe/screenpipe) | Meeting & transcript capture | Rust | NOASSERTION | 21,462 (▲29) | Mature | 80 | very active | 0d ago | 2.2y | 5 |
| [elizaOS/eliza](https://github.com/elizaOS/eliza) | Chat & workspace connectors | TypeScript | MIT | 19,275 (▲14) | Mature | 84 | very active | 0d ago | 2.2y | 5 |
| [weaviate/weaviate](https://github.com/weaviate/weaviate) | Vector & graph stores | Go | BSD-3-Clause | 16,787 (▲2) | Classic | 78 | very active | 0d ago | 10.4y | 5 |
| [memvid/memvid](https://github.com/memvid/memvid) | Vector-first memory | Rust | Apache-2.0 | 16,492 (▲3) | Declining | 57 | active | 1mo ago | 1.3y | 1 |
| [MemoriLabs/Memori](https://github.com/MemoriLabs/Memori) | Vector-first memory | Python | NOASSERTION | 16,469 (▲26) | Mature | 72 | active | 4d ago | 1.1y | 4 |
| [semantica-agi/semantica](https://github.com/semantica-agi/semantica) | Graph-native memory | Python | MIT | 12,240 (▲114) | Hot | 84 | very active | 0d ago | 1.2y | 25 |
| [cocoindex-io/cocoindex](https://github.com/cocoindex-io/cocoindex) | Extraction & ontology | Rust | Apache-2.0 | 11,497 (▲6) | Hot | 83 | very active | 1d ago | 1.5y | 21 |
| [lancedb/lancedb](https://github.com/lancedb/lancedb) | Vector & graph stores | Rust | Apache-2.0 | 11,369 (▲7) | Classic | 87 | very active | 1d ago | 3.5y | 14 |
| [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | Vector-first memory | Python | AGPL-3.0 | 7,045 (▲9) | Mature | 76 | very active | 2d ago | 3.0y | 25 |
| [FalkorDB/FalkorDB](https://github.com/FalkorDB/FalkorDB) | Vector & graph stores | Rust | NOASSERTION | 5,925 (▲21) | Classic | 80 | very active | 0d ago | 3.1y | 10 |
| [HelixDB/helix-db](https://github.com/HelixDB/helix-db) | Vector & graph stores | Rust | Apache-2.0 | 5,890 (▲1) | Hot | 80 | very active | 1d ago | 1.8y | 7 |
| [MemMachine/MemMachine](https://github.com/MemMachine/MemMachine) | Graph-native memory | Python | Apache-2.0 | 3,216 (▲2) | Mature | 74 | active | 3d ago | 1.1y | 6 |
| [Vexa-ai/vexa](https://github.com/Vexa-ai/vexa) | Meeting & transcript capture | Python | Apache-2.0 | 2,755 (▲3) | Hot | 76 | very active | 0d ago | 1.6y | 7 |
| [trustgraph-ai/trustgraph](https://github.com/trustgraph-ai/trustgraph) | Graph-native memory | Python | Apache-2.0 | 2,685 (▲8) | Mature | 63 | very active | 4d ago | 2.2y | 11 |
| [zilliztech/memsearch](https://github.com/zilliztech/memsearch) | Vector-first memory | Python | MIT | 2,570 (▲2) | Hot | 76 | very active | 0d ago | 7mo | 12 |
| [FalkorDB/GraphRAG-SDK](https://github.com/FalkorDB/GraphRAG-SDK) | Extraction & ontology | Python | Apache-2.0 | 994 (▼1) | Mature | 79 | very active | 0d ago | 2.6y | 8 |
| [shaneholloman/mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph) | Graph-native memory | JavaScript | MIT | 889 | Declining | 42 | slowing | 3mo ago | 1.7y | 0 |
| [cyrusagents/cyrus](https://github.com/cyrusagents/cyrus) | Chat & workspace connectors | TypeScript | Apache-2.0 | 796 | Hot | 72 | very active | 1d ago | 1.4y | 9 |
| [fabio-rovai/open-ontologies](https://github.com/fabio-rovai/open-ontologies) | Extraction & ontology | Rust | MIT | 480 (▲1) | Hot | 79 | very active | 2d ago | 6mo | 3 |
...
- **[MemMachine/MemMachine](https://github.com/MemMachine/MemMachine)** · 3,216★ · Python · Mature  
...
- **[vectorize-io/hindsight](https://github.com/vectorize-io/hindsight)** · 23,136★ · Python · Hot  
...
- **[zilliztech/memsearch](https://github.com/zilliztech/memsearch)** · 2,570★ · Python · Hot  
...
- **[HelixDB/helix-db](https://github.com/HelixDB/helix-db)** · 5,890★ · Rust · Hot  
...
- **[cocoindex-io/cocoindex](https://github.com/cocoindex-io/cocoindex)** · 11,497★ · Rust · Hot  
...
- **[fabio-rovai/open-ontologies](https://github.com/fabio-rovai/open-ontologies)** · 480★ · Rust · Hot  
...
- **[onyx-dot-app/onyx](https://github.com/onyx-dot-app/onyx)** · 31,955★ · Python · Classic  
...
- **[nanocoai/nanoclaw](https://github.com/nanocoai/nanoclaw)** · 30,713★ · TypeScript · Hot  
...
- **[elizaOS/eliza](https://github.com/elizaOS/eliza)** · 19,275★ · TypeScript · Mature  
...
- **[Zackriya-Solutions/meetily](https://github.com/Zackriya-Solutions/meetily)** · 30,437★ · Rust · Declining  
...
- **[screenpipe/screenpipe](https://github.com/screenpipe/screenpipe)** · 21,462★ · Rust · Mature  
...
- **[Vexa-ai/vexa](https://github.com/Vexa-ai/vexa)** · 2,755★ · Python · Hot  
...
- **[promptfoo/promptfoo](https://github.com/promptfoo/promptfoo)** · 24,885★ · TypeScript · Classic  
...
**Community clustering.** These 37 tools span **13 of the graph's 38 communities** — a wide spread for one report, which is itself the finding: 'agent memory' is not one community in your stars, it is a theme cutting across several.

- **Community 22** (11): `getzep/graphiti`, `MemMachine/MemMachine`, `mem0ai/mem0`, `MemPalace/mempalace`, `letta-ai/letta`, `vectorize-io/hindsight`, `TencentCloud/TencentDB-Agent-Memory`, `MemoriLabs/Memori`, `plastic-labs/honcho`, `zilliztech/memsearch`, `screenpipe/screenpipe`
- **Community 11** (9): `semantica-agi/semantica`, `memvid/memvid`, `qdrant/qdrant`, `milvus-io/milvus`, `weaviate/weaviate`, `pgvector/pgvector`, `lancedb/lancedb`, `cocoindex-io/cocoindex`, `nanocoai/nanoclaw`
- **Community 7** (4): `trustgraph-ai/trustgraph`, `HelixDB/helix-db`, `fabio-rovai/open-ontologies`, `promptfoo/promptfoo`
- **Community 30** (2): `HKUDS/MGP`, `HKUDS/LightRAG`
- **Community 1** (2): `FalkorDB/FalkorDB`, `FalkorDB/GraphRAG-SDK`
- **Community 28** (2): `elizaOS/eliza`, `comet-ml/opik`

**Centrality (PageRank in the full 2,087-repo graph)** — the most hub-like memory tools in your ecosystem:
...
- `semantica-agi/semantica` ⇄ `cocoindex-io/cocoindex` (w=0.257) — topics: ai, context-engineering, knowledge-graph, llm; authors: dependabot[bot]
...
- `MemMachine/MemMachine` ⇄ `zilliztech/memsearch` (w=0.251) — topics: memory, agent, ai-agents; authors: zc277584121
- `lancedb/lancedb` ⇄ `pgvector/pgvector` (w=0.250) — topics: approximate-nearest-neighbor-search, nearest-neighbor-search
- `promptfoo/promptfoo` ⇄ `comet-ml/opik` (w=0.248) — topics: llm, prompt-engineering, llmops, evaluation; authors: dependabot[bot]
- …and 7 more.
...
|---|---|---|---|---|---|
| `HKUDS/LightRAG` | 39,453 | Extraction & ontology | very active | 5 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `onyx-dot-app/onyx` | 31,955 | Chat & workspace connectors | very active | 6 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `nanocoai/nanoclaw` | 30,713 | Chat & workspace connectors | very active | 6 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `getzep/graphiti` | 30,658 | Graph-native memory | very active | 5 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `TencentCloud/TencentDB-Agent-Memory` | 26,050 | Vector-first memory | very active | 7 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `letta-ai/letta` | 24,640 | Vector-first memory | active | 11 | **Watch** — connected elsewhere, but its own activity is fading. The risk is maintenance, not obscurity. |
| `vectorize-io/hindsight` | 23,136 | Vector-first memory | very active | 8 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
| `HelixDB/helix-db` | 5,890 | Vector & graph stores | very active | 5 | **Artifact, not a signal** — well connected in the wider graph, just not to these 38. Different neighbourhood, not a dead end. |
...
| `fabio-rovai/open-ontologies` | 480 | Extraction & ontology | very active | 4 | **Genuinely peripheral, still moving** — few edges anywhere but actively developed. Early or idiosyncratic; the one shape worth a look. |
...
| `trustgraph-ai/trustgraph` | Graph-native memory | 63 | Mature | very active | 4d ago | 1 | 64% |
| `pgvector/pgvector` | Vector & graph stores | 63 | Classic | very active | 18d ago | 1 | 98% |
| `letta-ai/letta` | Vector-first memory | 65 | Mature | active | 15d ago | 1 | 63% |
| `TencentCloud/TencentDB-Agent-Memory` | Vector-first memory | 71 | Rising | very active | 4d ago | 2 | 29% |
| `microsoft/graphrag` | Extraction & ontology | 71 | Mature | very active | 0d ago | 1 | 65% |
| `cyrusagents/cyrus` | Chat & workspace connectors | 72 | Hot | very active | 1d ago | 1 | 77% |
| `MemoriLabs/Memori` | Vector-first memory | 72 | Mature | active | 4d ago | 2 | 46% |
| `getzep/graphiti` | Graph-native memory | 73 | Mature | very active | 1d ago | 1 | 65% |
| `MemMachine/MemMachine` | Graph-native memory | 74 | Mature | active | 3d ago | 3 | 17% |
| `zilliztech/memsearch` | Vector-first memory | 76 | Hot | very active | 0d ago | 1 | 79% |
| `Vexa-ai/vexa` | Meeting & transcript capture | 76 | Hot | very active | 0d ago | 1 | 92% |
| `plastic-labs/honcho` | Vector-first memory | 76 | Mature | very active | 2d ago | 4 | 20% |
| `MemPalace/mempalace` | Vector-first memory | 76 | Hot | very active | 2d ago | 1 | 65% |
| `weaviate/weaviate` | Vector & graph stores | 78 | Classic | very active | 0d ago | 1 | 65% |
| `topoteretes/cognee` | Graph-native memory | 78 | Classic | very active | 0d ago | 1 | 68% |
| `mem0ai/mem0` | Vector-first memory | 78 | Classic | very active | 3d ago | 1 | 55% |
| `fabio-rovai/open-ontologies` | Extraction & ontology | 79 | Hot | very active | 2d ago | 1 | 92% |
| `FalkorDB/GraphRAG-SDK` | Extraction & ontology | 79 | Mature | very active | 0d ago | 2 | 28% |
| `HKUDS/LightRAG` | Extraction & ontology | 79 | Hot | very active | 0d ago | 1 | 79% |
| `HelixDB/helix-db` | Vector & graph stores | 80 | Hot | very active | 1d ago | 1 | 82% |
| `FalkorDB/FalkorDB` | Vector & graph stores | 80 | Classic | very active | 0d ago | 2 | 39% |
| `screenpipe/screenpipe` | Meeting & transcript capture | 80 | Mature | very active | 0d ago | 1 | 54% |
| `vectorize-io/hindsight` | Vector-first memory | 80 | Hot | very active | 0d ago | 1 | 66% |
| `nanocoai/nanoclaw` | Chat & workspace connectors | 80 | Hot | very active | 0d ago | 2 | 34% |
| `cocoindex-io/cocoindex` | Extraction & ontology | 83 | Hot | very active | 1d ago | 2 | 32% |
| `semantica-agi/semantica` | Graph-native memory | 84 | Hot | very active | 0d ago | 2 | 40% |
| `elizaOS/eliza` | Chat & workspace connectors | 84 | Mature | very active | 0d ago | 2 | 46% |
| `promptfoo/promptfoo` | Memory evaluation | 84 | Classic | very active | 0d ago | 2 | 42% |
| `lancedb/lancedb` | Vector & graph stores | 87 | Classic | very active | 1d ago | 3 | 20% |
| `comet-ml/opik` | Memory evaluation | 93 | Classic | very active | 0d ago | 4 | 27% |
...
| `milvus-io/milvus` | Vector & graph stores | 99 | Classic | very active | 0d ago | 8 | 9% |
...
- **vllm-project/vllm** (91,148★) — 'memory-efficient' inference — a pure keyword collision, nothing to do with agent memory
- **redis/redis** (76,263★) — a general datastore frequently used *as* a memory backend, but not itself a memory system
- **Memento-Teams/Memento** (2,569★) — 'teams' here means agent teams, not Microsoft Teams — collision
- **infiniflow/ragflow** (90,194★) — general-purpose RAG engine — covered by the RAG tooling report
- **deepset-ai/haystack** (26,437★) — orchestration framework; memory is one component among many — see RAG tooling
- **run-llama/llama_index** (52,049★) — document/RAG platform rather than a conversational memory layer
- **thedotmack/claude-mem** (93,375★) — coding-agent *session* memory — see the Memory Frameworks report
- **gastownhall/beads** (26,957★) — coding-agent memory upgrade, not conversational
- **ctxrs/ctx** (1,081★) — searches local coding-agent history — adjacent, but the corpus is agent transcripts, not human chat
- **colbymchenry/codegraph** (69,902★) — code knowledge graph — same technique, entirely different corpus
- **vitali87/code-graph-rag** (5,056★) — GraphRAG over monorepos, not conversations
- **DeusData/codebase-memory-mcp** (42,524★) — codebase intelligence graph, not chat
- **Graphify-Labs/graphify** (115,475★) — codebase → knowledge graph (and the tooling this very repo is indexed with)
- **usememos/memos** (62,821★) — human note-taking, no agent memory API
- **eugeniughelbur/obsidian-second-brain** (4,356★) — PKM-backed agent memory over an Obsidian vault — close, but the substrate is notes, not conversation
- **agentscope-ai/ReMe** (3,421★) — memory management kit; overlaps the vector-first tier without adding a distinct conversational angle
- **mudler/LocalRecall** (971★) — local memory/knowledge base for agents — generic document recall rather than chat-native
- **HKUDS/CatchMe** (496★) — agent personalisation; memory is implicit rather than the product
...
- **rishikanthc/Scriberr** (3,030★) — self-hosted transcription — see the Meeting Transcription report
...
<sub>Tools covered: 37 · Matrix rows: 16 · Evidence date: 2026-08-12 · Snapshot: 2026-09-07T10:42:15.216Z</sub>
