...
>
> Generated 2026-07-13 by `scripts/reports/agent_orchestration.py` (regenerate any time — no API cost).
...
**Community clustering.** These 37 tools span **13 of the graph's 27 communities**.

- **Community 2** (7): `VoltAgent/voltagent`, `FoundationAgents/MetaGPT`, `wshobson/agents`, `Yeachan-Heo/oh-my-claudecode`, `vercel-labs/coding-agent-template`, `TauricResearch/TradingAgents`, `TinyAGI/tinyagi`
...
- **Community 7** (4): `langchain-ai/langgraph`, `i-am-bee/beeai-framework`, `langflow-ai/langflow`, `bytedance/deer-flow`
- **Community 19** (4): `agentscope-ai/agentscope`, `huggingface/smolagents`, `camel-ai/camel`, `eigent-ai/eigent`
- **Community 18** (3): `microsoft/semantic-kernel`, `microsoft/agent-framework`, `microsoft/autogen`
- **Community 16** (3): `langgenius/dify`, `FlowiseAI/Flowise`, `simstudioai/sim`
- **Community 5** (3): `code-yeongyu/oh-my-openagent`, `ruvnet/ruflo`, `getpaseo/paseo`
- **Community 12** (2): `openai/openai-agents-python`, `flyteorg/flyte`
