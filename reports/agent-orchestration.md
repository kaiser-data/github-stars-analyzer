...
>
> Generated 2026-06-13 by `scripts/reports/agent_orchestration.py` (regenerate any time — no API cost).
...
- **37 agent-orchestration tools** in your stars (**1,468,632★**), organized by *how you express coordination*:
...
|---|---|---|---|---|---|---|
| [FoundationAgents/MetaGPT](https://github.com/FoundationAgents/MetaGPT) | 68,727 | Python | 28 | slowing | Mature | 0 |
| [microsoft/autogen](https://github.com/microsoft/autogen) | 58,879 | Python | 55 | active | Mature | 1 |
| [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | 53,280 | Python | 85 | very active | Mature | 2 |
| [agno-agi/agno](https://github.com/agno-agi/agno) | 40,646 | Python | 98 | very active | Classic | 6 |
| [stanfordnlp/dspy](https://github.com/stanfordnlp/dspy) | 34,990 | Python | 83 | very active | Classic | 2 |
| [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | 34,458 | Python | 83 | very active | Mature | 2 |
| [microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel) | 28,106 | C# | 87 | very active | Classic | 3 |
| [huggingface/smolagents](https://github.com/huggingface/smolagents) | 27,817 | Python | 66 | active | Mature | 1 |
| [openai/openai-agents-python](https://github.com/openai/openai-agents-python) | 27,084 | Python | 90 | very active | Hot | 3 |
| [agentscope-ai/agentscope](https://github.com/agentscope-ai/agentscope) | 26,704 | Python | 80 | very active | Mature | 2 |
| [google/adk-python](https://github.com/google/adk-python) | 20,074 | Python | 98 | very active | Hot | 5 |
| [camel-ai/camel](https://github.com/camel-ai/camel) | 17,161 | Python | 81 | very active | Classic | 2 |
| [microsoft/agent-framework](https://github.com/microsoft/agent-framework) | 11,261 | Python | 98 | very active | Hot | 5 |
| [VoltAgent/voltagent](https://github.com/VoltAgent/voltagent) | 9,545 | TypeScript | 80 | very active | Hot | 2 |
| [i-am-bee/beeai-framework](https://github.com/i-am-bee/beeai-framework) | 3,290 | Python | 73 | very active | Hot | 1 |
| [liquidos-ai/AutoAgents](https://github.com/liquidos-ai/AutoAgents) | 673 | Rust | 67 | very active | Hot | 1 |

### Visual / low-code platforms

| Tool | ★ | Lang | Health | Activity | Lifecycle | Bus factor |
|---|---|---|---|---|---|---|
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | 192,095 | TypeScript | 100 | very active | Classic | 13 |
| [langflow-ai/langflow](https://github.com/langflow-ai/langflow) | 149,552 | Python | 84 | very active | Classic | 2 |
| [langgenius/dify](https://github.com/langgenius/dify) | 144,875 | TypeScript | 100 | very active | Classic | 7 |
| [FlowiseAI/Flowise](https://github.com/FlowiseAI/Flowise) | 53,487 | TypeScript | 92 | very active | Classic | 4 |
| [simstudioai/sim](https://github.com/simstudioai/sim) | 28,750 | TypeScript | 78 | very active | Hot | 1 |

### Coding-agent orchestration

| Tool | ★ | Lang | Health | Activity | Lifecycle | Bus factor |
|---|---|---|---|---|---|---|
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | 70,988 | Python | 81 | very active | Hot | 5 |
| [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | 61,925 | TypeScript | 78 | very active | Hot | 1 |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | 58,993 | TypeScript | 77 | very active | Hot | 1 |
| [wshobson/agents](https://github.com/wshobson/agents) | 36,637 | Python | 69 | very active | Hot | 2 |
| [Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode) | 36,221 | TypeScript | 80 | very active | Hot | 1 |
| [eigent-ai/eigent](https://github.com/eigent-ai/eigent) | 14,261 | TypeScript | 77 | very active | Hot | 2 |
| [getpaseo/paseo](https://github.com/getpaseo/paseo) | 8,363 | TypeScript | 73 | very active | Hot | 1 |
| [vercel-labs/coding-agent-template](https://github.com/vercel-labs/coding-agent-template) | 1,726 | TypeScript | 30 | active | Declining | 0 |

### Agent OS / long-horizon harness

| Tool | ★ | Lang | Health | Activity | Lifecycle | Bus factor |
|---|---|---|---|---|---|---|
| [elizaOS/eliza](https://github.com/elizaOS/eliza) | 18,558 | TypeScript | 80 | very active | Hot | 1 |

### Durable / production infra

| Tool | ★ | Lang | Health | Activity | Lifecycle | Bus factor |
|---|---|---|---|---|---|---|
| [flyteorg/flyte](https://github.com/flyteorg/flyte) | 7,079 | Go | 89 | very active | Classic | 3 |
| [inngest/agent-kit](https://github.com/inngest/agent-kit) | 886 | TypeScript | 55 | active | Declining | 1 |

### Vertical / domain systems

| Tool | ★ | Lang | Health | Activity | Lifecycle | Bus factor |
|---|---|---|---|---|---|---|
| [TauricResearch/TradingAgents](https://github.com/TauricResearch/TradingAgents) | 85,230 | Python | 70 | very active | Hot | 1 |
| [assafelovic/gpt-researcher](https://github.com/assafelovic/gpt-researcher) | 27,645 | Python | 77 | very active | Classic | 2 |

### Protocols & meta-frameworks

| Tool | ★ | Lang | Health | Activity | Lifecycle | Bus factor |
|---|---|---|---|---|---|---|
| [sentient-agi/ROMA](https://github.com/sentient-agi/ROMA) | 5,072 | Python | 32 | slowing | Declining | 0 |
| [TinyAGI/tinyagi](https://github.com/TinyAGI/tinyagi) | 3,576 | TypeScript | 66 | slowing | Rising | 1 |
| [veegee82/agent-workflow-protocol](https://github.com/veegee82/agent-workflow-protocol) | 18 | Python | 58 | very active | Rising | 1 |
...
- **[FoundationAgents/MetaGPT](https://github.com/FoundationAgents/MetaGPT)** · 68,727★ · Python · Mature · health 28  
  Multi-agent 'software company' — assigns SOPs/roles (PM, architect, engineer).  
  <sub>topics: agent, gpt, llm, metagpt, multi-agent</sub>
- **[microsoft/autogen](https://github.com/microsoft/autogen)** · 58,879★ · Python · Mature · health 55  
...
- **[crewAIInc/crewAI](https://github.com/crewAIInc/crewAI)** · 53,280★ · Python · Mature · health 85  
...
- **[agno-agi/agno](https://github.com/agno-agi/agno)** · 40,646★ · Python · Classic · health 98  
...
- **[stanfordnlp/dspy](https://github.com/stanfordnlp/dspy)** · 34,990★ · Python · Classic · health 83  
  Programmatic prompt/pipeline optimization — compile agent behavior instead of hand-prompting.  
  <sub>topics: —</sub>
- **[langchain-ai/langgraph](https://github.com/langchain-ai/langgraph)** · 34,458★ · Python · Mature · health 83  
...
- **[microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel)** · 28,106★ · C# · Classic · health 87  
...
- **[huggingface/smolagents](https://github.com/huggingface/smolagents)** · 27,817★ · Python · Mature · health 66  
  Minimalist code-agent framework — agents that write & run Python to act.  
  <sub>topics: —</sub>
- **[openai/openai-agents-python](https://github.com/openai/openai-agents-python)** · 27,084★ · Python · Hot · health 90  
...
- **[agentscope-ai/agentscope](https://github.com/agentscope-ai/agentscope)** · 26,704★ · Python · Mature · health 80  
...
- **[google/adk-python](https://github.com/google/adk-python)** · 20,074★ · Python · Hot · health 98  
...
- **[camel-ai/camel](https://github.com/camel-ai/camel)** · 17,161★ · Python · Classic · health 81  
...
- **[microsoft/agent-framework](https://github.com/microsoft/agent-framework)** · 11,261★ · Python · Hot · health 98  
...
- **[VoltAgent/voltagent](https://github.com/VoltAgent/voltagent)** · 9,545★ · TypeScript · Hot · health 80  
  TypeScript agent-engineering platform + open-source framework.  
  <sub>topics: agents, ai, chatbots, llm, mcp, nodejs</sub>
- **[i-am-bee/beeai-framework](https://github.com/i-am-bee/beeai-framework)** · 3,290★ · Python · Hot · health 73  
  Production-ready agents in both Python and TypeScript.  
  <sub>topics: agents, ai, framework, ai-agent, llm, multiagent</sub>
- **[liquidos-ai/AutoAgents](https://github.com/liquidos-ai/AutoAgents)** · 673★ · Rust · Hot · health 67  
...
- **[n8n-io/n8n](https://github.com/n8n-io/n8n)** · 192,095★ · TypeScript · Classic · health 100  
...
- **[langflow-ai/langflow](https://github.com/langflow-ai/langflow)** · 149,552★ · Python · Classic · health 84  
...
- **[langgenius/dify](https://github.com/langgenius/dify)** · 144,875★ · TypeScript · Classic · health 100  
  Production-ready platform for agentic workflow development (health 100).  
  <sub>topics: ai, gpt, llm, openai, python, rag</sub>
- **[FlowiseAI/Flowise](https://github.com/FlowiseAI/Flowise)** · 53,487★ · TypeScript · Classic · health 92  
...
- **[simstudioai/sim](https://github.com/simstudioai/sim)** · 28,750★ · TypeScript · Hot · health 78  
...
- **[bytedance/deer-flow](https://github.com/bytedance/deer-flow)** · 70,988★ · Python · Hot · health 81  
...
- **[code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent)** · 61,925★ · TypeScript · Hot · health 78  
...
- **[ruvnet/ruflo](https://github.com/ruvnet/ruflo)** · 58,993★ · TypeScript · Hot · health 77  
...
- **[wshobson/agents](https://github.com/wshobson/agents)** · 36,637★ · Python · Hot · health 69  
...
- **[Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode)** · 36,221★ · TypeScript · Hot · health 80  
  Teams-first multi-agent orchestration for Claude Code.  
  <sub>topics: agentic-coding, ai-agents, claude, claude-code, oh-my-opencode, opencode</sub>
- **[eigent-ai/eigent](https://github.com/eigent-ai/eigent)** · 14,261★ · TypeScript · Hot · health 77  
...
- **[getpaseo/paseo](https://github.com/getpaseo/paseo)** · 8,363★ · TypeScript · Hot · health 73  
  Run & coordinate coding agents from phone, desktop and CLI.  
  <sub>topics: agents, claude-code, codex, opencode, ade, copilot</sub>
- **[vercel-labs/coding-agent-template](https://github.com/vercel-labs/coding-agent-template)** · 1,726★ · TypeScript · Declining · health 30  
...
- **[elizaOS/eliza](https://github.com/elizaOS/eliza)** · 18,558★ · TypeScript · Hot · health 80  
...
- **[flyteorg/flyte](https://github.com/flyteorg/flyte)** · 7,079★ · Go · Classic · health 89  
...
- **[inngest/agent-kit](https://github.com/inngest/agent-kit)** · 886★ · TypeScript · Declining · health 55  
...
- **[TauricResearch/TradingAgents](https://github.com/TauricResearch/TradingAgents)** · 85,230★ · Python · Hot · health 70  
...
- **[assafelovic/gpt-researcher](https://github.com/assafelovic/gpt-researcher)** · 27,645★ · Python · Classic · health 77  
...
- **[sentient-agi/ROMA](https://github.com/sentient-agi/ROMA)** · 5,072★ · Python · Declining · health 32  
  Recursive meta-agent framework to build multi-agent systems; declining/low health.  
  <sub>topics: —</sub>
- **[TinyAGI/tinyagi](https://github.com/TinyAGI/tinyagi)** · 3,576★ · TypeScript · Rising · health 66  
  Agent-teams orchestrator aimed at one-person companies.  
  <sub>topics: —</sub>
- **[veegee82/agent-workflow-protocol](https://github.com/veegee82/agent-workflow-protocol)** · 18★ · Python · Rising · health 58  
...
**Community clustering.** These 37 tools span **13 of the graph's 31 communities**.

- **Community 7** (10): `langchain-ai/langgraph`, `google/adk-python`, `VoltAgent/voltagent`, `i-am-bee/beeai-framework`, `langgenius/dify`, `FlowiseAI/Flowise`, `simstudioai/sim`, `langflow-ai/langflow`, `bytedance/deer-flow`, `veegee82/agent-workflow-protocol`
- **Community 1** (6): `agentscope-ai/agentscope`, `liquidos-ai/AutoAgents`, `crewAIInc/crewAI`, `agno-agi/agno`, `n8n-io/n8n`, `inngest/agent-kit`
- **Community 19** (5): `FoundationAgents/MetaGPT`, `assafelovic/gpt-researcher`, `vercel-labs/coding-agent-template`, `elizaOS/eliza`, `TauricResearch/TradingAgents`
- **Community 13** (3): `microsoft/semantic-kernel`, `microsoft/agent-framework`, `microsoft/autogen`
- **Community 18** (3): `wshobson/agents`, `Yeachan-Heo/oh-my-claudecode`, `getpaseo/paseo`
- **Community 6** (2): `camel-ai/camel`, `eigent-ai/eigent`
...
- `langchain-ai/langgraph` — PageRank 0.0028
...
- `inngest/agent-kit` — PageRank 0.0016
- `openai/openai-agents-python` — PageRank 0.0016
- `langgenius/dify` — PageRank 0.0013
- `huggingface/smolagents` — PageRank 0.0013

**Direct links between orchestration tools** (top similarity edges where both endpoints are in this report):

- `microsoft/agent-framework` ⇄ `microsoft/semantic-kernel` (w=0.979) — topics: ai, sdk; authors: westey-m, giles17, moonbox3
- `microsoft/autogen` ⇄ `microsoft/agent-framework` (w=0.726) — topics: agents, ai; authors: chetantoshniwal
...
- `camel-ai/camel` ⇄ `eigent-ai/eigent` (w=0.383) — topics: multi-agent-systems; authors: Wendong-Fan, fengju0213, octo-patch
...
- `FlowiseAI/Flowise` ⇄ `langgenius/dify` (w=0.278) — topics: low-code, no-code, openai, rag; authors: github-actions[bot]
- …and 7 more.
...
|---|---|---|---|---|---|
| n8n-io/n8n | Visual / low-code platforms | 100 | Classic | very active | 13 |
| langgenius/dify | Visual / low-code platforms | 100 | Classic | very active | 7 |
...
| flyteorg/flyte | Durable / production infra | 89 | Classic | very active | 3 |
...
| camel-ai/camel | Code-first agent frameworks | 81 | Classic | very active | 2 |
...
| VoltAgent/voltagent | Code-first agent frameworks | 80 | Hot | very active | 2 |
...
| assafelovic/gpt-researcher | Vertical / domain systems | 77 | Classic | very active | 2 |
| ruvnet/ruflo | Coding-agent orchestration | 77 | Hot | very active | 1 |
| eigent-ai/eigent | Coding-agent orchestration | 77 | Hot | very active | 2 |
| i-am-bee/beeai-framework | Code-first agent frameworks | 73 | Hot | very active | 1 |
| getpaseo/paseo | Coding-agent orchestration | 73 | Hot | very active | 1 |
| TauricResearch/TradingAgents | Vertical / domain systems | 70 | Hot | very active | 1 |
...
| TinyAGI/tinyagi | Protocols & meta-frameworks | 66 | Rising | slowing | 1 |
| veegee82/agent-workflow-protocol | Protocols & meta-frameworks | 58 | Rising | very active | 1 |
| microsoft/autogen | Code-first agent frameworks | 55 | Mature | active | 1 |
| inngest/agent-kit | Durable / production infra | 55 | Declining | active | 1 |
...
| FoundationAgents/MetaGPT | Code-first agent frameworks | 28 | Mature | slowing | 0 |
...
<sub>Tools covered: 37 across 7 approaches · Snapshot: 2026-06-11T21:58:33.384Z</sub>
