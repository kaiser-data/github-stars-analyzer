...
> Derived from **kaiser-data**'s 2,087 starred repos (snapshot `2026-09-07T10:42:15.216Z`), cross-referenced with the repo-similarity graph (2,087 nodes / 6,821 edges, 38 communities). The OS matrix, gap table, and scorecard are backed by external evidence gathered 2026-08-23 (GitHub API + 2026 head-to-head comparisons) — see Methodology.
>
> Generated 2026-09-07 by `scripts/reports/agentic_terminals.py` (regenerate any time — no API cost).
...
- **The structural gap this report was written about is now closed.** The terminal layer is **52 repos (1,411,852★)** against **7 relevant apps (34,747★) still missing** — where earlier editions of this report catalogued 45 absent terminal apps against 14 held. Coding *agents* were always covered exhaustively (31 tools, 1.2M★ in `ai-coding-tuis`); the terminal they live in has caught up.
- **Agent-aware terminals are represented now** (3): the category 2026 actually produced — terminals that know an agent is running and surface its state — is `warp` (64,846★), `cmux` (26,858★), `waveterm` (22,229★). This was the report's headline gap and is the one to re-check first if the gap table ever looks stale again.
...
|---|---|---|---|---|---|---|---|---|---|---|
| [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) | Shell & history | Shell | MIT | 189,607 (▲36) | Classic | 83 | very active | 0d ago | 17.0y | 58 |
| [microsoft/terminal](https://github.com/microsoft/terminal) | Emulator | C++ | MIT | 104,830 (▲13) | Classic | 85 | very active | 2d ago | 9.1y | 30 |
| [junegunn/fzf](https://github.com/junegunn/fzf) | Shell & history | Go | MIT | 82,851 (▲16) | Classic | 77 | very active | 0d ago | 12.9y | 7 |
| [Eugeny/tabby](https://github.com/Eugeny/tabby) | Emulator | TypeScript | MIT | 74,375 (▲27) | Classic | 75 | very active | 0d ago | 9.7y | 14 |
| [alacritty/alacritty](https://github.com/alacritty/alacritty) | Emulator | Rust | Apache  2.0 | 65,642 (▲11) | Mature | 72 | active | 7d ago | 10.6y | 6 |
| [warpdotdev/warp](https://github.com/warpdotdev/warp) | Agent-aware terminal | Rust | GNU Affero General Public  v3.0 | 64,846 (▲23) | Classic | 76 | very active | 0d ago | 5.2y | 26 |
| [ghostty-org/ghostty](https://github.com/ghostty-org/ghostty) | Emulator | Zig | MIT | 60,801 (▲42) | Classic | 69 | very active | 0d ago | 4.4y | 15 |
| [starship/starship](https://github.com/starship/starship) | Shell & history | Rust | ISC | 59,809 (▲10) | Classic | 73 | very active | 0d ago | 7.4y | 15 |
| [tmux/tmux](https://github.com/tmux/tmux) | Multiplexer / session | C | ISC | 49,112 (▲26) | Classic | 79 | very active | 0d ago | 11.3y | 3 |
| [nushell/nushell](https://github.com/nushell/nushell) | Shell & history | Rust | MIT | 40,433 (▲14) | Classic | 88 | very active | 1d ago | 7.3y | 28 |
| [ajeetdsouza/zoxide](https://github.com/ajeetdsouza/zoxide) | Shell & history | Rust | MIT | 39,201 (▲16) | Classic | 60 | very active | 7d ago | 6.5y | 5 |
| [herdrdev/herdr](https://github.com/herdrdev/herdr) | Multiplexer / session | Rust | Apache  2.0 | 35,958 (▲345) | Hot | 84 | very active | 0d ago | 5mo | 10 |
| [zellij-org/zellij](https://github.com/zellij-org/zellij) | Multiplexer / session | Rust | MIT | 35,302 (▲4) | Classic | 69 | very active | 7d ago | 6.0y | 26 |
| [kovidgoyal/kitty](https://github.com/kovidgoyal/kitty) | Emulator | Python | GNU General Public  v3.0 | 34,805 (▲31) | Classic | 80 | very active | 0d ago | 9.9y | 10 |
| [fish-shell/fish-shell](https://github.com/fish-shell/fish-shell) | Shell & history | Rust | Other | 34,150 (▲10) | Classic | 79 | very active | 0d ago | 14.3y | 8 |
| [microsoft/WSL](https://github.com/microsoft/WSL) | Windows & shells | C++ | MIT | 33,627 (▲5) | Classic | 89 | very active | 0d ago | 10.4y | 19 |
| [atuinsh/atuin](https://github.com/atuinsh/atuin) | Shell & history | Rust | MIT | 31,558 (▲11) | Classic | 83 | very active | 2d ago | 5.9y | 16 |
| [wezterm/wezterm](https://github.com/wezterm/wezterm) | Emulator | Rust | Other | 28,797 (▲26) | Classic | 65 | very active | 1d ago | 8.6y | 33 |
| [mbadolato/iTerm2-Color-Schemes](https://github.com/mbadolato/iTerm2-Color-Schemes) | Terminal capability / reference | Shell | Other | 27,177 | Classic | 82 | very active | 7d ago | 15.4y | 23 |
| [cmderdev/cmder](https://github.com/cmderdev/cmder) | Windows & shells | PowerShell | MIT | 27,000 | Classic | 58 | very active | 7d ago | 13.2y | 4 |
| [manaflow-ai/cmux](https://github.com/manaflow-ai/cmux) | Agent-aware terminal | Swift | Other | 26,858 (▲24) | Hot | 80 | very active | 0d ago | 7mo | 4 |
| [gpakosz/.tmux](https://github.com/gpakosz/.tmux) | Multiplexer / session | Shell | MIT | 25,370 (▲4) | Classic | 62 | very active | 1mo ago | 14.0y | 4 |
| [wavetermdev/waveterm](https://github.com/wavetermdev/waveterm) | Agent-aware terminal | Go | Apache  2.0 | 22,229 (▲14) | Classic | 67 | very active | 4d ago | 4.3y | 2 |
| [pranshuparmar/witr](https://github.com/pranshuparmar/witr) | Shell & history | Go | Apache  2.0 | 22,117 (▲9) | Hot | 75 | very active | 22d ago | 8mo | 6 |
| [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js) | Remote & web sessions | TypeScript | MIT | 21,150 (▲8) | Classic | 68 | very active | 0d ago | 12.5y | 17 |
| [rothgar/awesome-tuis](https://github.com/rothgar/awesome-tuis) | Terminal capability / reference | — | — | 20,506 (▲16) | Classic | 71 | very active | 27d ago | 7.4y | 29 |
| [gnachman/iTerm2](https://github.com/gnachman/iTerm2) | Emulator | Objective-C | GNU General Public  v2.0 | 18,021 (▲4) | Classic | 60 | very active | 0d ago | 15.4y | 8 |
| [tmux-plugins/tpm](https://github.com/tmux-plugins/tpm) | Multiplexer / session | Shell | MIT | 15,058 (▲6) | Mature | 26 | slowing | 3mo ago | 12.3y | 0 |
| [mobile-shell/mosh](https://github.com/mobile-shell/mosh) | Remote & web sessions | C++ | GNU General Public  v3.0 | 14,454 (▲2) | Mature | 24 | slowing | 5mo ago | 15.7y | 0 |
| [tsl0922/ttyd](https://github.com/tsl0922/ttyd) | Remote & web sessions | C | MIT | 12,319 (▲7) | Mature | 44 | active | 26d ago | 10.0y | 2 |
| [Untrivial-ai/agent-orchestrator](https://github.com/Untrivial-ai/agent-orchestrator) | Parallel-agent orchestration | Go | Apache  2.0 | 11,026 (▲43) | Hot | 98 | very active | 0d ago | 6mo | 26 |
| [smtg-ai/claude-squad](https://github.com/smtg-ai/claude-squad) | Parallel-agent orchestration | Go | GNU Affero General Public  v3.0 | 8,441 (▲7) | Mature | 60 | active | 18d ago | 1.5y | 4 |
| [raphamorim/rio](https://github.com/raphamorim/rio) | Emulator | Rust | MIT | 7,462 (▲4) | Classic | 78 | very active | 0d ago | 3.9y | 3 |
| [blinksh/blink](https://github.com/blinksh/blink) | Remote & web sessions | Swift | GNU General Public  v3.0 | 6,928 | Mature | 32 | slowing | 2mo ago | 10.4y | 0 |
| [tmate-io/tmate](https://github.com/tmate-io/tmate) | Remote & web sessions | C | Other | 6,124 (▼1) | Mature | 39 | active | 1mo ago | 13.2y | 1 |
| [gnunn1/tilix](https://github.com/gnunn1/tilix) | Emulator | D | Mozilla Public  2.0 | 5,718 (▲1) | Mature | 41 | slowing | 2mo ago | 10.7y | 3 |
| [butlerx/wetty](https://github.com/butlerx/wetty) | Remote & web sessions | TypeScript | MIT | 5,425 (▼1) | Classic | 74 | very active | 3d ago | 12.5y | 4 |
| [hpjansson/chafa](https://github.com/hpjansson/chafa) | Terminal capability / reference | C | GNU Lesser General Public  v3.0 | 5,220 (▲4) | Mature | 68 | very active | 1d ago | 8.4y | 1 |
| [x-cmd/x-cmd](https://github.com/x-cmd/x-cmd) | Shell & history | Awk | Apache  2.0 | 4,643 (▲3) | Classic | 73 | very active | 2d ago | 3.9y | 3 |
| [hackerb9/lsix](https://github.com/hackerb9/lsix) | Terminal capability / reference | Shell | GNU General Public  v3.0 | 4,175 (▼1) | Abandoned | 5 | stale | 2.2y ago | 9.3y | 0 |
| [dagger/container-use](https://github.com/dagger/container-use) | Terminal hardening | Go | Apache  2.0 | 4,035 (▲2) | Mature | 45 | active | 21d ago | 1.3y | 3 |
| [MisterTea/EternalTerminal](https://github.com/MisterTea/EternalTerminal) | Remote & web sessions | C++ | Apache  2.0 | 3,870 (▲1) | Classic | 57 | very active | 2d ago | 9.8y | 12 |
| [contour-terminal/contour](https://github.com/contour-terminal/contour) | Emulator | C++ | Apache  2.0 | 3,017 | Classic | 69 | very active | 1d ago | 7.1y | 4 |
| [omnara-ai/omnara](https://github.com/omnara-ai/omnara) | Parallel-agent orchestration | Go | Apache  2.0 | 2,821 (▲3) | Hot | 85 | very active | 0d ago | 1.2y | 5 |
| [joshmedeski/sesh](https://github.com/joshmedeski/sesh) | Multiplexer / session | Go | MIT | 2,816 (▲3) | Mature | 74 | very active | 3d ago | 2.7y | 11 |
| [pvolok/dekit](https://github.com/pvolok/dekit) | Parallel-agent orchestration | Rust | MIT | 2,712 (▲2) | Classic | 70 | very active | 2d ago | 5.0y | 4 |
| [sheeki03/tirith](https://github.com/sheeki03/tirith) | Terminal hardening | Rust | GNU Affero General Public  v3.0 | 2,705 (▲2) | Rising | 79 | very active | 0d ago | 7mo | 2 |
| [sorenisanerd/gotty](https://github.com/sorenisanerd/gotty) | Remote & web sessions | Go | MIT | 2,545 (▲1) | Mature | 44 | active | 1mo ago | 5.4y | 0 |
| [nimbalyst/nimbalyst](https://github.com/nimbalyst/nimbalyst) | Parallel-agent orchestration | TypeScript | MIT | 1,668 (▲11) | Rising | 75 | very active | 2d ago | 10mo | 2 |
| [tmux-python/libtmux](https://github.com/tmux-python/libtmux) | Multiplexer / session | Python | MIT | 1,206 | Mature | 75 | very active | 1d ago | 10.3y | 1 |
| [ghostty-org/ghostling](https://github.com/ghostty-org/ghostling) | Emulator | C | MIT | 1,112 (▲2) | Declining | 42 | active | 29d ago | 5mo | 2 |
| [caarlos0/dotfiles](https://github.com/caarlos0/dotfiles) | Shell & history | Shell | MIT | 220 | Mature | 80 | very active | 0d ago | 3.5y | 1 |

**Agent-aware terminal**

- **warpdotdev/warp** (64,846★) — Markets itself as an 'agentic development environment': per-tab git/PR metadata, reusable `.toml` tab configs, unified agent notifications. Proprietary rendering engine, opinionated conventions, reported CJK IME issues.
- **manaflow-ai/cmux** (26,858★) — Purpose-built for running several coding agents in parallel: Ghostty rendering engine, vertical tabs with per-tab git branch / worktree / PR status, notification rings and unread badges per pane, session restore, embedded browser, and a Unix-socket API agents can call to drive the UI. Codex CLI's sandbox can block the socket.
- **wavetermdev/waveterm** (22,229★) — Open-source, cross-platform, AI-integrated terminal with graphical blocks — the non-proprietary answer to Warp, and the only genuinely tri-platform option in this layer.

**Emulator**

- **microsoft/terminal** (104,830★) — The default answer on Windows, where Ghostty and cmux simply don't run. Pairs with WSL for a POSIX agent environment.
- **Eugeny/tabby** (74,375★) — Cross-platform with first-class SSH/serial profile management — useful when agents live on several remote boxes and you want saved profiles per host.
- **alacritty/alacritty** (65,642★) — Long cited at ~30 MB resident against 60–100 MB for Kitty/Ghostty — the pick when the agent fleet, not the terminal, should own the RAM. That gap has closed: Ghostty 1.3.1 measures 23 MB settled on an M2 (see Methodology), so the memory argument for Alacritty no longer holds. No tabs or splits by design — which stops being a loss when paired with `herdr` or tmux, since those supply the tabs. Homebrew's cask was disabled 2026-09-01 for failing the macOS Gatekeeper check, so this is not currently installable that way.
- **ghostty-org/ghostty** (60,801★) — Fastest sustained-output rendering on macOS in published 2026 comparisons; native Shift+Enter; `macos-option-as-alt = true` needed for Alt+, / Alt+. reasoning controls. Measured here at 23 MB resident / 33 MB phys_footprint settled and idle on an M2 running 1.3.1 — roughly 3× lighter than the 60–100 MB figure earlier editions of this report carried, and lighter than Alacritty's cited ~30 MB. On Linux it's GTK4 + optional libadwaita. Windows is planned post-1.0 with no timeline; WSL2 works but is explicitly unsupported.
- **kovidgoyal/kitty** (34,805★) — The Kitty graphics protocol is the de-facto standard for inline images from agent output; built-in multiplexing; deep keyboard control. No Windows build.
- **wezterm/wezterm** (28,797★) — Broadest graphics-protocol support (Kitty + sixel + iTerm2), built-in multiplexer with its own persistence, Lua config. The only first-tier emulator that is genuinely equal on all three desktop OSes. Rendering trails Ghostty.
- **gnachman/iTerm2** (18,021★) — The long-standing macOS emulator — and the one Claude Code integrates with by name: `claude --worktree --tmux` uses iTerm2 native panes when available. Objective-C, single-maintainer, macOS only.
- **raphamorim/rio** (7,462★) — Newer GPU emulator that also targets the browser — interesting for agent sessions surfaced over the web.
- **gnunn1/tilix** (5,718★) — GTK3 tiling emulator with saved session layouts — the Linux-native way to get a fixed multi-agent pane grid without a multiplexer.
- **contour-terminal/contour** (3,017★) — Standards-focused emulator; a reference implementation for VT and sixel behaviour.
- **ghostty-org/ghostling** (1,112★) — A minimum-viable emulator demonstrating the libghostty C API — a reference consumer of Ghostty's embeddable core, not the core and not Ghostty itself.

**Multiplexer / session**

- **tmux/tmux** (49,112★) — The 2007 multiplexer that became agent infrastructure — process isolation, detach/reattach, and a stable `send-keys` API orchestrators target. Runs anywhere POSIX.
- **herdrdev/herdr** (35,958★) — A background server the terminals live inside: agents survive a closed lid, a dropped network, and a reboot, and reattach from any terminal or over SSH. Marks every pane working/blocked/idle, and its socket API is the same surface agents drive. One Rust binary, macOS/Linux with Windows in beta.
- **zellij-org/zellij** (35,302★) — Better out-of-the-box UX than tmux (floating panes, visible keybindings) but no `send-keys`-equivalent with comparable API stability, and native session persistence is still roadmap — which is why orchestrators keep targeting tmux.
- **gpakosz/.tmux** (25,370★) — The widely-used opinionated tmux config — the fastest path from bare tmux to a usable multi-agent cockpit.
- **tmux-plugins/tpm** (15,058★) — tmux plugin manager — the prerequisite for everything below.
- **joshmedeski/sesh** (2,816★) — Smart tmux session manager — one keystroke from repo to a named agent session, which is the actual bottleneck once you run one session per worktree.
...
- **Untrivial-ai/agent-orchestrator** (11,026★) — Agent IDE over tmux + git worktrees — plans tasks, spawns fleets, handles CI fixes and merge conflicts autonomously.
- **smtg-ai/claude-squad** (8,441★) — Manages multiple terminal agents (Claude Code, Codex, OpenCode, Amp) in isolated worktrees from one TUI — the cheapest way to get past four concurrent agents without adopting a new terminal.
- **omnara-ai/omnara** (2,821★) — Command-centre view over agents running elsewhere, including from a phone — the answer to 'which agent is stuck' when you're away from the machine.
- **pvolok/dekit** (2,712★) — Runs many commands in parallel with per-process panes — the generic, OS-portable version of agent multiplexing.
- **nimbalyst/nimbalyst** (1,668★) — Visual workspace for Claude Code/Codex/OpenCode: an agent kanban where each card is a task, branch, or running session showing active / blocked / awaiting-review / ready-to-merge — plus a native iPhone app for reviewing and resuming.

**Remote & web sessions**

- **xtermjs/xterm.js** (21,150★) — The terminal component inside browsers and Electron apps — what you'd build on to give an agent fleet a web UI.
- **mobile-shell/mosh** (14,454★) — UDP-based roaming shell that survives IP changes and sleep — the layer that stops a laptop lid closing from killing an SSH-attached agent run. Pair with tmux; mosh has no scrollback of its own.
- **tsl0922/ttyd** (12,319★) — Shares a terminal over the web — the simplest way to look in on a long agent run from a phone or another machine without an app.
...
- **tmate-io/tmate** (6,124★) — Instant shared tmux session over a relay — useful for pairing a colleague into a running agent session.
- **butlerx/wetty** (5,425★) — Terminal over HTTP/HTTPS with auth — the self-hosted variant of the same idea as ttyd.
- **MisterTea/EternalTerminal** (3,870★) — Reconnecting SSH replacement that keeps the session alive across network changes, with native scrollback (unlike mosh).
- **sorenisanerd/gotty** (2,545★) — The maintained fork of the original gotty — share a command's output as a web page.

**Windows & shells**

- **microsoft/WSL** (33,627★) — The thing that actually makes agentic coding viable on Windows — a real Linux userland for the agent's shell commands. Most agent tooling assumes POSIX.
- **cmderdev/cmder** (27,000★) — Portable console emulator bundle for Windows — the pre-WSL answer, still widely used.

**Shell & history**

- **ohmyzsh/ohmyzsh** (189,607★) — The default zsh framework; mostly ergonomics, some startup-time cost — which multiplies when you spawn a shell per agent pane.
- **junegunn/fzf** (82,851★) — Fuzzy selection is what makes 'jump to the right session/worktree/file' cheap for a human supervising agents.
- **starship/starship** (59,809★) — Cross-shell prompt; carries git/worktree/branch state that tells you which agent's pane you're looking at — genuinely useful at 6+ sessions.
- **nushell/nushell** (40,433★) — Structured-data shell — pipelines return tables, which is markedly easier for an agent to parse than ad-hoc text. Also one of the few shells equally native on Windows.
- **ajeetdsouza/zoxide** (39,201★) — Frecency-based `cd` — trivial, and saves real time across many worktrees.
- **fish-shell/fish-shell** (34,150★) — Best interactive defaults; non-POSIX, so agent-generated shell snippets can break.
- **atuinsh/atuin** (31,558★) — Searchable, synced shell history — the audit trail for what an agent actually ran, and the only practical way to reconstruct it across many machines and sessions.
- **pranshuparmar/witr** (22,117★) — 'Why is this running?' — traces any process, port, container, or file back to its origin; the triage tool for a pane you no longer recognise.
- **x-cmd/x-cmd** (4,643★) — 'Shell superpowers for AI agents' — POSIX-portable command toolkit agents can call without installing a language runtime.
...
- **dagger/container-use** (4,035★) — Containerized dev environments so parallel agents can't collide — the isolation half of running fleets safely.
- **sheeki03/tirith** (2,705★) — Terminal security for devs and agents — intercepts homograph URLs, pipe-to-shell, ANSI injection, and exfiltration before execution.
...
- **rothgar/awesome-tuis** (20,506★) — The canonical index of terminal user interfaces — the discovery surface for the layer this report says you're under-invested in.
- **hpjansson/chafa** (5,220★) — Terminal graphics for any emulator (sixel, Kitty, iTerm2 protocols) — how agent-generated images render where no native protocol exists.
...
**Community clustering.** These 52 tools span **14 of the graph's 38 communities** — a scatter, not a cluster, which is itself the finding: the terminal layer has no centre of gravity in your stars the way the agent layer does.

- **Community 12** (23): `herdrdev/herdr`, `x-cmd/x-cmd`, `hpjansson/chafa`, `hackerb9/lsix`, `mbadolato/iTerm2-Color-Schemes`, `warpdotdev/warp`, `manaflow-ai/cmux`, `alacritty/alacritty`, `wezterm/wezterm`, `contour-terminal/contour`, `zellij-org/zellij`, `gpakosz/.tmux`, `joshmedeski/sesh`, `smtg-ai/claude-squad`, `pvolok/dekit`, `nimbalyst/nimbalyst`, `ohmyzsh/ohmyzsh`, `junegunn/fzf`, `starship/starship`, `nushell/nushell`, `ajeetdsouza/zoxide`, `fish-shell/fish-shell`, `atuinsh/atuin`
- **Community 7** (9): `ghostty-org/ghostling`, `wavetermdev/waveterm`, `Eugeny/tabby`, `ghostty-org/ghostty`, `kovidgoyal/kitty`, `gnunn1/tilix`, `omnara-ai/omnara`, `xtermjs/xterm.js`, `tsl0922/ttyd`
- **Community 15** (4): `Untrivial-ai/agent-orchestrator`, `sheeki03/tirith`, `pranshuparmar/witr`, `raphamorim/rio`
- **Community 9** (3): `gnachman/iTerm2`, `mobile-shell/mosh`, `blinksh/blink`
- **Community 14** (3): `butlerx/wetty`, `MisterTea/EternalTerminal`, `cmderdev/cmder`
- **Community 20** (2): `microsoft/terminal`, `microsoft/WSL`

**Centrality (PageRank in the full 2,087-repo graph)** — the most hub-like terminal-layer repos you hold:
...
- `ajeetdsouza/zoxide` — PageRank 0.0007
- `cmderdev/cmder` — PageRank 0.0007
...
- `ghostty-org/ghostty` ⇄ `ghostty-org/ghostling` (w=0.625) — authors: mitchellh
...
- `atuinsh/atuin` ⇄ `nushell/nushell` (w=0.382) — topics: shell, rust; authors: dependabot[bot]
- …and 42 more.
...
|---|---|---|---|---|---|---|
| Untrivial-ai/agent-orchestrator | 98 | Hot | very active | 5 | 20% | 179 |
...
| herdrdev/herdr | 84 | Hot | very active | 2 | 36% | 85 |
| ohmyzsh/ohmyzsh | 83 | Classic | very active | 11 | 20% | 0 |
| atuinsh/atuin | 83 | Classic | very active | 2 | 43% | 91 |
| mbadolato/iTerm2-Color-Schemes | 82 | Classic | very active | 3 | 30% | 27 |
| caarlos0/dotfiles | 80 | Mature | very active | 1 | 100% | 42 |
| manaflow-ai/cmux | 80 | Hot | very active | 2 | 48% | 55 |
| kovidgoyal/kitty | 80 | Classic | very active | 1 | 76% | 143 |
| tmux/tmux | 79 | Classic | very active | 1 | 69% | 44 |
| sheeki03/tirith | 79 | Rising | very active | 1 | 84% | 89 |
| fish-shell/fish-shell | 79 | Classic | very active | 1 | 60% | 70 |
| raphamorim/rio | 78 | Classic | very active | 1 | 97% | 142 |
| junegunn/fzf | 77 | Classic | very active | 1 | 73% | 84 |
| warpdotdev/warp | 76 | Classic | very active | 1 | 67% | 56 |
| pranshuparmar/witr | 75 | Hot | very active | 1 | 68% | 21 |
| Eugeny/tabby | 75 | Classic | very active | 2 | 32% | 209 |
...
| ghostty-org/ghostty | 69 | Classic | very active | 2 | 49% | 1 |
...
| wezterm/wezterm | 65 | Classic | very active | 2 | 39% | 64 |
...
- **anthropics/claude-code** (144,324★) — The agent, not the terminal — see the `ai-coding-tuis` report.
- **openai/codex** (122,130★) — Same: agent layer. This report is about what it runs inside.
- **Untrivial-ai/agent-orchestrator** (11,026★) — Also covered by `agent-orchestration` and `agent-harnesses`; listed here for its tmux dependency.
- **sheeki03/tirith** (2,705★) — Also in `ai-coding-tuis` as a safety tool; kept here because the attack surface is the terminal itself.
- **BloopAI/vibe-kanban** (28,028★) — Parallel-agent management, but a web UI rather than a terminal surface.
- **getagentseal/codeburn** (10,880★) — Token/cost tracking — `token-savings` and `ai-coding-tuis` cover it.
- **charmbracelet/bubbletea** (44,830★) — How TUIs are built, not where agents run — `ai-coding-tuis`.
- **zed-industries/zed** (89,881★) — Has a terminal, but it's an editor; out of scope.
- **gravitational/teleport** (20,891★) — Access control for infrastructure — relevant to remote agents, but an infra product, not a terminal.
...
<sub>In-dataset tools: 52 · Missing tools catalogued: 7 · Snapshot: 2026-09-07T10:42:15.216Z</sub>
