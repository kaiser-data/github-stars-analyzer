...
> Derived from **kaiser-data**'s 2,159 starred repos (snapshot `2026-09-14T11:08:08.535Z`), cross-referenced with the repo-similarity graph (2,159 nodes / 7,086 edges, 37 communities). Pros/cons and task rankings are additionally backed by external evidence (Terminal-Bench 2.1, 2026 head-to-head comparisons) — see Methodology.
>
> Generated 2026-09-14 by `scripts/reports/ai_coding_tuis.py` (regenerate any time — no API cost).
...
- **31 terminal-AI-coding tools** in your stars (**1,313,872★** combined), split into the agents themselves and the terminal ecosystem around them:
...
|---|---|---|---|---|---|---|---|---|---|---|
| [anomalyco/opencode](https://github.com/anomalyco/opencode) | Terminal coding agent | TypeScript | MIT | 207,256 (▲2,419) | Hot | 88 | very active | 0d ago | 1.4y | 23 |
| [anthropics/claude-code](https://github.com/anthropics/claude-code) | Terminal coding agent | Python | — | 144,971 (▲761) | Hot | 79 | very active | 0d ago | 1.6y | 4 |
| [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | Multi-CLI glue | Rust | MIT | 132,771 (▲1,513) | Hot | 82 | very active | 0d ago | 1.1y | 37 |
| [openai/codex](https://github.com/openai/codex) | Terminal coding agent | Rust | Apache-2.0 | 124,012 (▲2,172) | Hot | 94 | very active | 0d ago | 1.4y | 35 |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | Terminal coding agent | TypeScript | Apache-2.0 | 106,969 (▲143) | Hot | 90 | very active | 0d ago | 1.4y | 17 |
| [earendil-works/pi](https://github.com/earendil-works/pi) | Terminal coding agent | TypeScript | MIT | 104,948 (▲2,733) | Hot | 90 | very active | 0d ago | 1.1y | 16 |
| [rtk-ai/rtk](https://github.com/rtk-ai/rtk) | Session / token ops | Rust | Apache-2.0 | 80,272 (▲1,282) | Hot | 80 | very active | 0d ago | 7mo | 6 |
| [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | Terminal coding agent | TypeScript | NOASSERTION | 69,029 (▲290) | Rising | 78 | very active | 0d ago | 9mo | 1 |
| [Alishahryar1/free-claude-code](https://github.com/Alishahryar1/free-claude-code) | Multi-CLI glue | Python | MIT | 54,859 (▲1,440) | Hot | 62 | very active | 0d ago | 7mo | 4 |
| [aaif-goose/goose](https://github.com/aaif-goose/goose) | Terminal coding agent | Rust | Apache-2.0 | 54,246 (▲293) | Mature | 89 | very active | 0d ago | 2.1y | 27 |
| [Aider-AI/aider](https://github.com/Aider-AI/aider) | Terminal coding agent | Python | Apache-2.0 | 48,949 (▲171) | Mature | 27 | slowing | 3mo ago | 3.4y | 0 |
| [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) | TUI building blocks | Go | MIT | 44,934 (▲117) | Classic | 81 | active | 5d ago | 6.7y | 11 |
| [charmbracelet/crush](https://github.com/charmbracelet/crush) | Terminal coding agent | Go | NOASSERTION | 28,067 (▲141) | Hot | 87 | very active | 0d ago | 1.3y | 14 |
| [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) | Terminal coding agent | TypeScript | Apache-2.0 | 27,830 (▲157) | Hot | 83 | very active | 0d ago | 1.2y | 21 |
| [mksglu/context-mode](https://github.com/mksglu/context-mode) | Session / token ops | TypeScript | NOASSERTION | 22,748 (▲2,311) | Rising | 78 | very active | 1d ago | 6mo | 1 |
| [CodebuffAI/freebuff](https://github.com/CodebuffAI/freebuff) | Terminal coding agent | TypeScript | Apache-2.0 | 12,059 (▲340) | Mature | 76 | very active | 0d ago | 2.2y | 1 |
| [github/copilot-cli](https://github.com/github/copilot-cli) | Terminal coding agent | Shell | NOASSERTION | 11,169 (▲32) | Classic | 68 | very active | 1d ago | 3.7y | 7 |
| [getagentseal/codeburn](https://github.com/getagentseal/codeburn) | Session / token ops | TypeScript | MIT | 10,998 (▲136) | Rising | 79 | very active | 0d ago | 5mo | 2 |
| [charmbracelet/bubbles](https://github.com/charmbracelet/bubbles) | TUI building blocks | Go | MIT | 8,906 (▲18) | Classic | 70 | active | 8d ago | 6.7y | 7 |
| [UfoMiao/zcf](https://github.com/UfoMiao/zcf) | Multi-CLI glue | TypeScript | MIT | 6,085 | Hot | 71 | very active | 14d ago | 1.1y | 5 |
| [dagger/container-use](https://github.com/dagger/container-use) | Safety / isolation | Go | Apache-2.0 | 4,042 (▲9) | Mature | 46 | active | 7d ago | 1.3y | 2 |
| [sheeki03/tirith](https://github.com/sheeki03/tirith) | Safety / isolation | Rust | AGPL-3.0 | 2,720 (▲17) | Rising | 80 | very active | 0d ago | 7mo | 2 |
| [kenryu42/cc-safety-net](https://github.com/kenryu42/cc-safety-net) | Safety / isolation | TypeScript | MIT | 1,539 (▲15) | Hot | 80 | very active | 0d ago | 8mo | 3 |
| [affaan-m/agentshield](https://github.com/affaan-m/agentshield) | Safety / isolation | TypeScript | MIT | 1,180 (▲43) | Hot | 69 | very active | 4d ago | 7mo | 7 |
| [ctxrs/ctx](https://github.com/ctxrs/ctx) | Session / token ops | Rust | Apache-2.0 | 1,106 (▲28) | Hot | 79 | very active | 0d ago | 6mo | 5 |
| [terryso/claude-auto-resume](https://github.com/terryso/claude-auto-resume) | Session / token ops | Shell | MIT | 820 (▲2) | Declining | 23 | slowing | 4mo ago | 1.2y | 0 |
...
| [aniketkarne/ClaudeNightsWatch](https://github.com/aniketkarne/ClaudeNightsWatch) | Session / token ops | Shell | MIT | 370 | Declining | 43 | active | 4d ago | 1.2y | 1 |
| [opalinehq/cli](https://github.com/opalinehq/cli) | Session / token ops | TypeScript | MIT | 289 (▼1) | Hot | 74 | very active | 1d ago | 7mo | 3 |
| [rsrohan99/tig](https://github.com/rsrohan99/tig) | Terminal coding agent | Python | — | 153 | Abandoned | 5 | stale | 1.4y ago | 1.4y | 0 |
| [BA-CalderonMorales/terminal-jarvis](https://github.com/BA-CalderonMorales/terminal-jarvis) | Multi-CLI glue | Rust | MIT | 136 (▲2) | Hot | 79 | very active | 5d ago | 1.1y | 4 |
...
|---|---|---|---|
| **[claude-code](https://github.com/anthropics/claude-code)** | 144,971 | Best-in-class multi-file refactoring and reasoning depth (SWE-bench Pro 69.2%); asks clarifying questions; subagents/hooks/skills/MCP ecosystem is the deepest; 83.1% Terminal-Bench 2.1 with Fable 5 | Not open source (no OSS license in repo); Anthropic-models only; subscription/usage costs add up on heavy agentic use |
| **[opencode](https://github.com/anomalyco/opencode)** | 207,256 | Most-starred OSS agent, MIT license; provider-neutral — 75+ endpoints incl. Bedrock, OpenRouter, local Ollama; strong TUI; no vendor lock-in | Bring-your-own-model means quality varies with the model you pick; harness benchmark scores trail the vendor-tuned agents |
| **[codex](https://github.com/openai/codex)** | 124,012 | #1 named CLI agent on Terminal-Bench 2.1 (83.4% w/ GPT-5.5); fast single-binary Rust TUI; excels at intent-driven, pattern-following edits | OpenAI-models only; less transparent reasoning than Claude Code on big refactors; ecosystem (hooks/plugins) thinner |
| **[gemini-cli](https://github.com/google-gemini/gemini-cli)** | 106,969 | 1M-token context — holds a monorepo in one window; Apache-2.0; was the best free tier in the field | Deprecated June 2026: replaced by closed-source Antigravity CLI (agy), free tier cut from ~1,000 to ~20 requests/day — adopt with exit plan |
| **[goose](https://github.com/aaif-goose/goose)** | 54,246 | MCP-first and extensible beyond coding (install/execute/test); any-LLM incl. local; Block-backed, health 99 in this snapshot | Less specialized for pure code-editing loops; leaderboard results modest — team optimizes for failure-pattern fixes, not benchmark rank |
| **[aider](https://github.com/Aider-AI/aider)** | 48,949 | Best git discipline (clean auto-commits); precise file-scoped edits; provider-resilient; the safest 'pair programmer' rather than autonomous agent | Not autonomous — no system-wide orchestration; no MCP support; momentum slowing (52d since push, health 50 in snapshot) |
| **[crush](https://github.com/charmbracelet/crush)** | 28,067 | The most polished TUI aesthetics in the field; multi-model; Charm's Bubble Tea expertise shows in UX | Youngest of the majors — no public benchmark record; non-standard license; smaller ecosystem |
| **[qwen-code](https://github.com/QwenLM/qwen-code)** | 27,830 | Competitive Qwen3-Coder models; best-in-class on Chinese-language briefs and Alibaba-cloud ecosystem; Apache-2.0 | OAuth free tier discontinued 2026-04 — headline value now requires paid API; less strong outside the Qwen model family |
| **[copilot-cli](https://github.com/github/copilot-cli)** | 11,169 | Copilot agent with native GitHub integration (issues, PRs, Actions); familiar billing for Copilot shops | Premium-request pricing — one debugging session can eat a week's free allocation; value collapses off-GitHub (GitLab/Bitbucket) |
| **[pi](https://github.com/earendil-works/pi)** | 104,948 | Minimal, hackable toolkit (API + agent loop + TUI + CLI) — ideal base for building your own agent; MIT | A toolkit, not a turnkey product — you assemble the workflow yourself; smaller community than the big four |
| **[oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent)** | 69,029 | Token-efficiency-first harness (the 'tokenmaxxer' pick) layered on Codex/OpenCode for complex codebases | Depends on underlying agents; opinionated workflow; no OSS license declared |
| **[freebuff](https://github.com/CodebuffAI/freebuff)** | 12,059 | Simple terminal codegen with low setup friction; Apache-2.0 | Far smaller scope and community than the majors; fewer agentic features (no deep hooks/MCP story) |
...
- **[Aider-AI/aider](https://github.com/Aider-AI/aider)** · 48,949★ · Python · Mature  
...
- **[charmbracelet/crush](https://github.com/charmbracelet/crush)** · 28,067★ · Go · Hot  
...
- **[QwenLM/qwen-code](https://github.com/QwenLM/qwen-code)** · 27,830★ · TypeScript · Hot  
...
- **[CodebuffAI/freebuff](https://github.com/CodebuffAI/freebuff)** · 12,059★ · TypeScript · Mature  
  Codegen from the terminal — smaller, focused alternative.  
  <sub>topics: —</sub>
- **[github/copilot-cli](https://github.com/github/copilot-cli)** · 11,169★ · Shell · Classic  
...
- **[ctxrs/ctx](https://github.com/ctxrs/ctx)** · 1,106★ · Rust · Hot  
...
- **[terryso/claude-auto-resume](https://github.com/terryso/claude-auto-resume)** · 820★ · Shell · Declining  
...
- **[aniketkarne/ClaudeNightsWatch](https://github.com/aniketkarne/ClaudeNightsWatch)** · 370★ · Shell · Declining  
  ...
  <sub>topics: —</sub>
- **[opalinehq/cli](https://github.com/opalinehq/cli)** · 289★ · TypeScript · Hot  
...
- **[dagger/container-use](https://github.com/dagger/container-use)** · 4,042★ · Go · Mature  
  ...
  <sub>topics: —</sub>
- **[sheeki03/tirith](https://github.com/sheeki03/tirith)** · 2,720★ · Rust · Rising  
...
- **[kenryu42/cc-safety-net](https://github.com/kenryu42/cc-safety-net)** · 1,539★ · TypeScript · Hot  
...
- **[affaan-m/agentshield](https://github.com/affaan-m/agentshield)** · 1,180★ · TypeScript · Hot  
...
- **[Alishahryar1/free-claude-code](https://github.com/Alishahryar1/free-claude-code)** · 54,859★ · Python · Hot  
...
- **[charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea)** · 44,934★ · Go · Classic  
...
- **[charmbracelet/bubbles](https://github.com/charmbracelet/bubbles)** · 8,906★ · Go · Classic  
...
- **Community 10** (6): `charmbracelet/crush`, `getagentseal/codeburn`, `opalinehq/cli`, `Alishahryar1/free-claude-code`, `charmbracelet/bubbletea`, `charmbracelet/bubbles`
- **Community 5** (6): `earendil-works/pi`, `CodebuffAI/freebuff`, `mksglu/context-mode`, `sheeki03/tirith`, `kenryu42/cc-safety-net`, `farion1231/cc-switch`
- **Community 16** (5): `code-yeongyu/oh-my-openagent`, `rtk-ai/rtk`, `ctxrs/ctx`, `aniketkarne/ClaudeNightsWatch`, `affaan-m/agentshield`
- **Community 3** (4): `google-gemini/gemini-cli`, `aaif-goose/goose`, `Aider-AI/aider`, `terryso/claude-auto-resume`
- **Community 24** (2): `UfoMiao/zcf`, `zamalali/langchain-code`

**Centrality (PageRank in the full 2,159-repo graph)** — most 'hub-like' terminal-coding tools in your ecosystem:

- `mksglu/context-mode` — PageRank 0.0039
- `CodebuffAI/freebuff` — PageRank 0.0028
- `kenryu42/cc-safety-net` — PageRank 0.0011
- `sheeki03/tirith` — PageRank 0.0010
- `opalinehq/cli` — PageRank 0.0010
...
- `QwenLM/qwen-code` — PageRank 0.0006
...
- `affaan-m/agentshield` ⇄ `opalinehq/cli` (w=0.356) — topics: claude-code; authors: dependabot[bot]
...
| charmbracelet/crush | 87 | Hot | very active | 3 | 27% | 187 |
| QwenLM/qwen-code | 83 | Hot | very active | 2 | 39% | 703 |
...
| kenryu42/cc-safety-net | 80 | Hot | very active | 1 | 52% | 47 |
| anthropics/claude-code | 79 | Hot | very active | 1 | 62% | 216 |
| getagentseal/codeburn | 79 | Rising | very active | 1 | 64% | 67 |
| ctxrs/ctx | 79 | Hot | very active | 1 | 95% | 39 |
| BA-CalderonMorales/terminal-jarvis | 79 | Hot | very active | 1 | 73% | 53 |
...
| opalinehq/cli | 74 | Hot | very active | 1 | 98% | 19 |
| UfoMiao/zcf | 71 | Hot | very active | 1 | 73% | 96 |
| charmbracelet/bubbles | 70 | Classic | active | 2 | 33% | 38 |
| affaan-m/agentshield | 69 | Hot | very active | 1 | 80% | 6 |
| github/copilot-cli | 68 | Classic | very active | 1 | 57% | 423 |
| Alishahryar1/free-claude-code | 62 | Hot | very active | 1 | 97% | 0 |
| dagger/container-use | 46 | Mature | active | 1 | 86% | 14 |
| aniketkarne/ClaudeNightsWatch | 43 | Declining | active | 1 | 100% | 0 |
| Aider-AI/aider | 27 | Mature | slowing | 0 | 0% | 93 |
...
- **cline/cline** (67,967★) — primarily an IDE extension (CLI mode is secondary) — not a TUI-first agent
- **continuedev/continue** (35,900★) — same: IDE-first open-source coding agent
- **OpenHands/OpenHands** (87,845★) — AI-dev *platform* (web/headless), not a terminal UI
- **langchain-ai/open-swe** (10,711★) — asynchronous *cloud* coding agent — no terminal in the loop
- **NousResearch/hermes-agent** (245,317★) — covered in the *hermes-vs-openclaw* and *agent-harnesses* reports
- **affaan-m/ECC** (258,025★) — harness/config framework on top of coding TUIs — see *claude-code-setups*
- **SuperClaude-Org/SuperClaude_Framework** (23,891★) — config framework — see *claude-code-setups* (retired upstream 2026-07)
- **BloopAI/vibe-kanban** (28,078★) — GUI orchestrator *over* coding agents, not a TUI
- **iOfficeAI/AionUi** (32,806★) — GUI wrapper over the CLIs, not a TUI
- **winfunc/opcode** (22,399★) — GUI toolkit for Claude Code
- **jesseduffield/lazygit** (82,320★) — beloved git TUI, but no AI
