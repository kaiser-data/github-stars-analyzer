...
> Derived from **kaiser-data**'s 1,900 starred repos (snapshot `2026-08-31T12:10:08.018Z`), cross-referenced with the repo-similarity graph (1,900 nodes / 6,181 edges, 37 communities). Pros/cons and task rankings are additionally backed by external evidence (Terminal-Bench 2.1, 2026 head-to-head comparisons) — see Methodology.
>
> Generated 2026-08-31 by `scripts/reports/ai_coding_tuis.py` (regenerate any time — no API cost).
...
- **31 terminal-AI-coding tools** in your stars (**1,284,618★** combined), split into the agents themselves and the terminal ecosystem around them:
...
|---|---|---|---|---|---|---|---|---|---|---|
| [anomalyco/opencode](https://github.com/anomalyco/opencode) | Terminal coding agent | TypeScript | MIT | 202,719 (▲747) | Hot | 83 | very active | 0d ago | 1.3y | 15 |
| [anthropics/claude-code](https://github.com/anthropics/claude-code) | Terminal coding agent | Python | — | 143,538 (▲336) | Hot | 76 | very active | 3d ago | 1.5y | 6 |
| [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | Multi-CLI glue | Rust | MIT | 130,340 (▲579) | Hot | 77 | very active | 0d ago | 1.1y | 14 |
| [openai/codex](https://github.com/openai/codex) | Terminal coding agent | Rust | Apache-2.0 | 120,352 (▲1,145) | Hot | 94 | very active | 0d ago | 1.4y | 38 |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | Terminal coding agent | TypeScript | Apache-2.0 | 106,751 (▲32) | Hot | 90 | very active | 0d ago | 1.4y | 13 |
| [earendil-works/pi](https://github.com/earendil-works/pi) | Terminal coding agent | TypeScript | MIT | 99,809 (▲1,498) | Hot | 85 | very active | 0d ago | 1.1y | 13 |
| [rtk-ai/rtk](https://github.com/rtk-ai/rtk) | Session / token ops | Rust | Apache-2.0 | 78,015 (▲380) | Hot | 78 | very active | 0d ago | 7mo | 9 |
| [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | Terminal coding agent | TypeScript | NOASSERTION | 68,547 (▲98) | Hot | 78 | very active | 0d ago | 9mo | 4 |
| [aaif-goose/goose](https://github.com/aaif-goose/goose) | Terminal coding agent | Rust | Apache-2.0 | 53,732 (▲150) | Mature | 89 | very active | 0d ago | 2.0y | 29 |
| [Alishahryar1/free-claude-code](https://github.com/Alishahryar1/free-claude-code) | Multi-CLI glue | Python | MIT | 52,128 (▲1,272) | Hot | 62 | very active | 0d ago | 7mo | 8 |
| [Aider-AI/aider](https://github.com/Aider-AI/aider) | Terminal coding agent | Python | Apache-2.0 | 48,621 (▲85) | Mature | 28 | slowing | 3mo ago | 3.3y | 0 |
| [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) | TUI building blocks | Go | MIT | 44,714 (▲110) | Classic | 82 | active | 0d ago | 6.6y | 11 |
| [charmbracelet/crush](https://github.com/charmbracelet/crush) | Terminal coding agent | Go | NOASSERTION | 27,827 (▲84) | Hot | 87 | very active | 0d ago | 1.3y | 14 |
| [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) | Terminal coding agent | TypeScript | Apache-2.0 | 27,518 (▲83) | Hot | 88 | very active | 0d ago | 1.2y | 27 |
| [mksglu/context-mode](https://github.com/mksglu/context-mode) | Session / token ops | TypeScript | NOASSERTION | 20,272 (▲77) | Rising | 78 | very active | 0d ago | 6mo | 1 |
| [CodebuffAI/freebuff](https://github.com/CodebuffAI/freebuff) | Terminal coding agent | TypeScript | Apache-2.0 | 11,302 (▲308) | Mature | 75 | very active | 0d ago | 2.1y | 1 |
| [github/copilot-cli](https://github.com/github/copilot-cli) | Terminal coding agent | Shell | NOASSERTION | 11,131 (▲9) | Classic | 67 | very active | 2d ago | 3.7y | 4 |
| [getagentseal/codeburn](https://github.com/getagentseal/codeburn) | Session / token ops | TypeScript | MIT | 9,761 (▲70) | Hot | 79 | very active | 0d ago | 4mo | 5 |
| [charmbracelet/bubbles](https://github.com/charmbracelet/bubbles) | TUI building blocks | Go | MIT | 8,862 (▲20) | Classic | 70 | active | 2d ago | 6.6y | 7 |
| [UfoMiao/zcf](https://github.com/UfoMiao/zcf) | Multi-CLI glue | TypeScript | MIT | 6,079 (▲1) | Hot | 73 | very active | 0d ago | 1.1y | 6 |
| [dagger/container-use](https://github.com/dagger/container-use) | Safety / isolation | Go | Apache-2.0 | 4,028 (▲7) | Mature | 46 | active | 14d ago | 1.3y | 3 |
| [sheeki03/tirith](https://github.com/sheeki03/tirith) | Safety / isolation | Rust | AGPL-3.0 | 2,695 (▲11) | Rising | 80 | very active | 0d ago | 7mo | 2 |
| [kenryu42/cc-safety-net](https://github.com/kenryu42/cc-safety-net) | Safety / isolation | TypeScript | MIT | 1,517 (▲9) | Rising | 80 | very active | 0d ago | 8mo | 2 |
| [affaan-m/agentshield](https://github.com/affaan-m/agentshield) | Safety / isolation | TypeScript | MIT | 1,104 (▲7) | Declining | 46 | active | 1mo ago | 6mo | 1 |
| [ctxrs/ctx](https://github.com/ctxrs/ctx) | Session / token ops | Rust | Apache-2.0 | 1,052 (▲5) | Hot | 79 | very active | 0d ago | 6mo | 8 |
| [terryso/claude-auto-resume](https://github.com/terryso/claude-auto-resume) | Session / token ops | Shell | MIT | 818 (▲2) | Declining | 25 | slowing | 3mo ago | 1.2y | 0 |
...
| [opalinehq/cli](https://github.com/opalinehq/cli) | Session / token ops | TypeScript | MIT | 290 (▲2) | Hot | 73 | very active | 3d ago | 6mo | 3 |
| [rsrohan99/tig](https://github.com/rsrohan99/tig) | Terminal coding agent | Python | — | 153 | Abandoned | 5 | stale | 1.3y ago | 1.4y | 0 |
| [BA-CalderonMorales/terminal-jarvis](https://github.com/BA-CalderonMorales/terminal-jarvis) | Multi-CLI glue | Rust | MIT | 133 | Hot | 79 | very active | 9d ago | 1.1y | 3 |
...
|---|---|---|---|
| **[claude-code](https://github.com/anthropics/claude-code)** | 143,538 | Best-in-class multi-file refactoring and reasoning depth (SWE-bench Pro 69.2%); asks clarifying questions; subagents/hooks/skills/MCP ecosystem is the deepest; 83.1% Terminal-Bench 2.1 with Fable 5 | Not open source (no OSS license in repo); Anthropic-models only; subscription/usage costs add up on heavy agentic use |
| **[opencode](https://github.com/anomalyco/opencode)** | 202,719 | Most-starred OSS agent, MIT license; provider-neutral — 75+ endpoints incl. Bedrock, OpenRouter, local Ollama; strong TUI; no vendor lock-in | Bring-your-own-model means quality varies with the model you pick; harness benchmark scores trail the vendor-tuned agents |
| **[codex](https://github.com/openai/codex)** | 120,352 | #1 named CLI agent on Terminal-Bench 2.1 (83.4% w/ GPT-5.5); fast single-binary Rust TUI; excels at intent-driven, pattern-following edits | OpenAI-models only; less transparent reasoning than Claude Code on big refactors; ecosystem (hooks/plugins) thinner |
| **[gemini-cli](https://github.com/google-gemini/gemini-cli)** | 106,751 | 1M-token context — holds a monorepo in one window; Apache-2.0; was the best free tier in the field | Deprecated June 2026: replaced by closed-source Antigravity CLI (agy), free tier cut from ~1,000 to ~20 requests/day — adopt with exit plan |
| **[goose](https://github.com/aaif-goose/goose)** | 53,732 | MCP-first and extensible beyond coding (install/execute/test); any-LLM incl. local; Block-backed, health 99 in this snapshot | Less specialized for pure code-editing loops; leaderboard results modest — team optimizes for failure-pattern fixes, not benchmark rank |
| **[aider](https://github.com/Aider-AI/aider)** | 48,621 | Best git discipline (clean auto-commits); precise file-scoped edits; provider-resilient; the safest 'pair programmer' rather than autonomous agent | Not autonomous — no system-wide orchestration; no MCP support; momentum slowing (52d since push, health 50 in snapshot) |
| **[crush](https://github.com/charmbracelet/crush)** | 27,827 | The most polished TUI aesthetics in the field; multi-model; Charm's Bubble Tea expertise shows in UX | Youngest of the majors — no public benchmark record; non-standard license; smaller ecosystem |
| **[qwen-code](https://github.com/QwenLM/qwen-code)** | 27,518 | Competitive Qwen3-Coder models; best-in-class on Chinese-language briefs and Alibaba-cloud ecosystem; Apache-2.0 | OAuth free tier discontinued 2026-04 — headline value now requires paid API; less strong outside the Qwen model family |
| **[copilot-cli](https://github.com/github/copilot-cli)** | 11,131 | Copilot agent with native GitHub integration (issues, PRs, Actions); familiar billing for Copilot shops | Premium-request pricing — one debugging session can eat a week's free allocation; value collapses off-GitHub (GitLab/Bitbucket) |
| **[pi](https://github.com/earendil-works/pi)** | 99,809 | Minimal, hackable toolkit (API + agent loop + TUI + CLI) — ideal base for building your own agent; MIT | A toolkit, not a turnkey product — you assemble the workflow yourself; smaller community than the big four |
| **[oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent)** | 68,547 | Token-efficiency-first harness (the 'tokenmaxxer' pick) layered on Codex/OpenCode for complex codebases | Depends on underlying agents; opinionated workflow; no OSS license declared |
| **[freebuff](https://github.com/CodebuffAI/freebuff)** | 11,302 | Simple terminal codegen with low setup friction; Apache-2.0 | Far smaller scope and community than the majors; fewer agentic features (no deep hooks/MCP story) |
...
- **[Aider-AI/aider](https://github.com/Aider-AI/aider)** · 48,621★ · Python · Mature  
...
- **[charmbracelet/crush](https://github.com/charmbracelet/crush)** · 27,827★ · Go · Hot  
...
- **[QwenLM/qwen-code](https://github.com/QwenLM/qwen-code)** · 27,518★ · TypeScript · Hot  
...
- **[CodebuffAI/freebuff](https://github.com/CodebuffAI/freebuff)** · 11,302★ · TypeScript · Mature  
  Codegen from the terminal — smaller, focused alternative.  
  <sub>topics: —</sub>
- **[github/copilot-cli](https://github.com/github/copilot-cli)** · 11,131★ · Shell · Classic  
...
- **[ctxrs/ctx](https://github.com/ctxrs/ctx)** · 1,052★ · Rust · Hot  
...
- **[dagger/container-use](https://github.com/dagger/container-use)** · 4,028★ · Go · Mature  
  ...
  <sub>topics: —</sub>
- **[sheeki03/tirith](https://github.com/sheeki03/tirith)** · 2,695★ · Rust · Rising  
...
- **[kenryu42/cc-safety-net](https://github.com/kenryu42/cc-safety-net)** · 1,517★ · TypeScript · Rising  
...
- **[affaan-m/agentshield](https://github.com/affaan-m/agentshield)** · 1,104★ · TypeScript · Declining  
...
- **[Alishahryar1/free-claude-code](https://github.com/Alishahryar1/free-claude-code)** · 52,128★ · Python · Hot  
...
- **[charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea)** · 44,714★ · Go · Classic  
...
- **[charmbracelet/bubbles](https://github.com/charmbracelet/bubbles)** · 8,862★ · Go · Classic  
...
**Community clustering.** These 31 tools span **16 of the graph's 37 communities**.

- **Community 2** (6): `earendil-works/pi`, `CodebuffAI/freebuff`, `mksglu/context-mode`, `sheeki03/tirith`, `kenryu42/cc-safety-net`, `farion1231/cc-switch`
- **Community 18** (3): `google-gemini/gemini-cli`, `aaif-goose/goose`, `github/copilot-cli`
- **Community 8** (3): `charmbracelet/crush`, `charmbracelet/bubbletea`, `charmbracelet/bubbles`
- **Community 15** (3): `code-yeongyu/oh-my-openagent`, `rtk-ai/rtk`, `affaan-m/agentshield`
- **Community 9** (3): `getagentseal/codeburn`, `opalinehq/cli`, `Alishahryar1/free-claude-code`
- **Community 1** (2): `anomalyco/opencode`, `ctxrs/ctx`
- **Community 7** (2): `Aider-AI/aider`, `terryso/claude-auto-resume`

**Centrality (PageRank in the full 1,900-repo graph)** — most 'hub-like' terminal-coding tools in your ecosystem:

- `mksglu/context-mode` — PageRank 0.0060
- `CodebuffAI/freebuff` — PageRank 0.0045
- `opalinehq/cli` — PageRank 0.0012
...
- `charmbracelet/bubbles` ⇄ `charmbracelet/crush` (w=1.021) — authors: andrinoff, dependabot[bot], meowgorithm
...
- `charmbracelet/bubbletea` ⇄ `charmbracelet/crush` (w=0.823) — authors: andrinoff, meowgorithm, charmcli
...
| QwenLM/qwen-code | 88 | Hot | very active | 3 | 29% | 674 |
| charmbracelet/crush | 87 | Hot | very active | 3 | 22% | 183 |
| earendil-works/pi | 85 | Hot | very active | 2 | 33% | 257 |
| anomalyco/opencode | 83 | Hot | very active | 2 | 32% | 867 |
| charmbracelet/bubbletea | 82 | Classic | active | 4 | 20% | 80 |
| sheeki03/tirith | 80 | Rising | very active | 1 | 91% | 88 |
| kenryu42/cc-safety-net | 80 | Rising | very active | 1 | 91% | 41 |
| getagentseal/codeburn | 79 | Hot | very active | 1 | 77% | 63 |
| ctxrs/ctx | 79 | Hot | very active | 1 | 83% | 33 |
...
| UfoMiao/zcf | 73 | Hot | very active | 1 | 70% | 96 |
| charmbracelet/bubbles | 70 | Classic | active | 2 | 33% | 38 |
| github/copilot-cli | 67 | Classic | very active | 1 | 78% | 410 |
| Alishahryar1/free-claude-code | 62 | Hot | very active | 1 | 85% | 0 |
...
- **cline/cline** (67,216★) — primarily an IDE extension (CLI mode is secondary) — not a TUI-first agent
- **continuedev/continue** (35,711★) — same: IDE-first open-source coding agent
- **OpenHands/OpenHands** (85,738★) — AI-dev *platform* (web/headless), not a terminal UI
- **langchain-ai/open-swe** (10,637★) — asynchronous *cloud* coding agent — no terminal in the loop
- **NousResearch/hermes-agent** (238,749★) — covered in the *hermes-vs-openclaw* and *agent-harnesses* reports
- **affaan-m/ECC** (244,938★) — harness/config framework on top of coding TUIs — see *claude-code-setups*
- **SuperClaude-Org/SuperClaude_Framework** (23,852★) — config framework — see *claude-code-setups* (retired upstream 2026-07)
- **BloopAI/vibe-kanban** (27,964★) — GUI orchestrator *over* coding agents, not a TUI
- **iOfficeAI/AionUi** (32,457★) — GUI wrapper over the CLIs, not a TUI
- **winfunc/opcode** (22,387★) — GUI toolkit for Claude Code
- **jesseduffield/lazygit** (81,801★) — beloved git TUI, but no AI
