...
> Derived from **kaiser-data**'s 1,243 starred repos (snapshot `2026-06-11T21:58:33.384Z`), cross-referenced with the repo-similarity graph (1,243 nodes / 4,017 edges, 32 communities) and the 2026 AI-engineering landscape.
>
...
**Community clustering.** These 56 repos span **20 of the graph's 32 communities** — the AI-engineering stack is genuinely cross-cutting, not one tidy neighborhood.

- **Community 1** (8): `google-gemini/gemini-cli`, `browser-use/browser-use`, `punkpeye/awesome-mcp-servers`, `dair-ai/Prompt-Engineering-Guide`, `MemPalace/mempalace`, `crewAIInc/crewAI`, `agno-agi/agno`, `chroma-core/chroma`
...
- **Community 13** (6): `langchain-ai/langchain`, `infiniflow/ragflow`, `bytedance/deer-flow`, `mem0ai/mem0`, `langchain-ai/langgraph`, `VectifyAI/PageIndex`
...
- **Community 11** (5): `mlabonne/llm-course`, `BerriAI/litellm`, `langfuse/langfuse`, `comet-ml/opik`, `Arize-ai/phoenix`
- **Community 12** (4): `firecrawl/firecrawl`, `microsoft/generative-ai-for-beginners`, `microsoft/playwright-mcp`, `microsoft/graphrag`
- **Community 3** (3): `google/langextract`, `HKUDS/LightRAG`, `NirDiamant/RAG_Techniques`
- **Community 10** (3): `TauricResearch/TradingAgents`, `OpenHands/OpenHands`, `vercel-labs/agent-browser`
