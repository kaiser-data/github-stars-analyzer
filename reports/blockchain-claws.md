...
> Derived from **kaiser-data**'s 1,185 starred repos (snapshot `2026-06-04T15:28:30.136Z`).
>
> Generated 2026-06-04 by `scripts/reports/blockchain_claws.py` (regenerate any time — no API cost).
...
| [openfang](https://github.com/RightNow-AI/openfang) | 🟡 Medium | — | ✅ | — | 17,706 | Rust | 77 | **MCP-native Agent-OS** (Rust) — a clean backbone for plugging chain-data MCP servers, if you don't need crypto-specific plugins out of the box. |
...
- **[TradingAgents](https://github.com/TauricResearch/TradingAgents)** · 82,281★ · Python · health 71 — Multi-agent LLM trading framework — orchestrate it *from* a claw for strategy/execution.
...
- **[ClawRouter](https://github.com/BlockRunAI/ClawRouter)** · 6,538★ · TypeScript · health 76 — Agent-native LLM router with **USDC payments on Base & Solana via x402** — settle agent spend on-chain. Built for OpenClaw.
...
- **[awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills)** · 62,959★ · Python · health 65 — Curated Claude skills — reusable capabilities to bolt onto a claw.
...
<sub>Snapshot: 2026-06-04T15:28:30.136Z · regenerate via scripts/reports/blockchain_claws.py</sub>
