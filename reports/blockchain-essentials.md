...
> Derived from **kaiser-data**'s 2,087 starred repos (snapshot `2026-09-07T10:42:15.216Z`), cross-referenced with the repo-similarity graph (2,087 nodes / 6,821 edges).
>
> Generated 2026-09-07 by `scripts/reports/blockchain_essentials.py` (regenerate any time — no API cost).
...
|---|---|---|---|---|---|
| [eliza](https://github.com/elizaOS/eliza) | 🔥 AI × finance / trading | 19,275 | 🟢 Mature | 1,281 | 21,839 |
| [x402scan](https://github.com/Merit-Systems/x402scan) | 🔥 Agentic payments (x402) | 385 | 🔥 Hot | 83 | 170 |
| [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 🔥 AI × finance / trading | 102,808 | 🟢 Mature | 10,600 | 74 |
| [hardhat](https://github.com/NomicFoundation/hardhat) | Dev toolkits | 8,505 | 🔵 Classic | 104 | 538 |
| [go-ethereum](https://github.com/ethereum/go-ethereum) | Execution clients (nodes) | 51,334 | 🔵 Classic | 415 | 235 |
| [solana-web3.js](https://github.com/solana-foundation/solana-web3.js) | Solana | 2,754 | 🟢 Mature | 35 | 3 |
| [ClawRouter](https://github.com/BlockRunAI/ClawRouter) | 🔥 Agentic payments (x402) | 6,580 | 🔥 Hot | 2,288 | 180 |
| [vyper](https://github.com/vyperlang/vyper) | Languages & compilers | 5,181 | 🔵 Classic | 54 | 83 |
...
2. **Autonomous AI trading.** `TauricResearch/TradingAgents` (82k★) and `HKUDS/AI-Trader` are high-momentum, and `elizaOS/eliza` ships at enormous velocity (21,839 commits/90d).
...
|---|---|---|---|---|---|
| [solidity](https://github.com/argotorg/solidity) | 25,725 (▲3) | 🔵 Classic | 84 | C++ | The Solidity compiler & language (ex ethereum/solidity). |
| [vyper](https://github.com/vyperlang/vyper) | 5,181 | 🔵 Classic | 78 | Python | Pythonic contract language; security-minded alternative. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [foundry](https://github.com/foundry-rs/foundry) | 10,582 (▲3) | 🔵 Classic | 90 | Rust | Forge/Cast/Anvil — the dominant Rust-based Solidity toolchain. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [openzeppelin-contracts](https://github.com/OpenZeppelin/openzeppelin-contracts) | 27,232 (▲1) | 🔵 Classic | 82 | Solidity | The standard audited token/access/proxy library. |
| [solmate](https://github.com/transmissions11/solmate) | 4,285 | ⚫ Abandoned | 6 | Solidity | Minimalist, modern contract primitives. |
| [solady](https://github.com/Vectorized/solady) | 3,368 (▼1) | 🟢 Mature | 52 | Solidity | Gas-optimized Solidity building blocks. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [ethers.js](https://github.com/ethers-io/ethers.js) | 8,716 (▲2) | 🟢 Mature | 47 | TypeScript | The long-time standard JS/TS library. |
| [wagmi](https://github.com/wevm/wagmi) | 6,745 (▲1) | 🔵 Classic | 75 | TypeScript | React hooks for Ethereum (pairs with viem). |
| [viem](https://github.com/wevm/viem) | 3,551 (▲2) | 🔵 Classic | 85 | TypeScript | Modern, type-safe Ethereum client — default for new TS apps. |
| [rainbowkit](https://github.com/rainbow-me/rainbowkit) | 2,836 | 🟢 Mature | 45 | MDX | Drop-in wallet-connection UX for dApps. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [go-ethereum](https://github.com/ethereum/go-ethereum) | 51,334 (▲5) | 🔵 Classic | 95 | Go | geth — the reference Ethereum node (Go). |
| [reth](https://github.com/paradigmxyz/reth) | 5,766 (▲1) | 🔵 Classic | 80 | Rust | Modern, fast Rust client (rising alternative). |
| [nethermind](https://github.com/NethermindEth/nethermind) | 1,592 | 🔵 Classic | 89 | C# | High-perf .NET client, strong on tooling. |
...
| [safe-smart-account](https://github.com/safe-fndn/safe-smart-account) | 2,177 | 🟢 Mature | 48 | TypeScript | Safe multisig — treasury/custody standard. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [blockscout](https://github.com/blockscout/blockscout) | 4,669 (▲1) | 🔵 Classic | 85 | Elixir | Open EVM explorer; exposes an MCP server for agents. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [anchor](https://github.com/otter-sec/anchor) | 5,128 (▲1) | 🔵 Classic | 83 | Rust | The standard Solana smart-contract framework. |
| [solana-web3.js](https://github.com/solana-foundation/solana-web3.js) | 2,754 (▲1) | 🟢 Mature | 58 | TypeScript | JS SDK for Solana. |
| [agave](https://github.com/anza-xyz/agave) | 1,909 (▲5) | 🟢 Mature | 97 | Rust | The Solana validator client. |
...
| [circom](https://github.com/iden3/circom) | 1,690 | 🟢 Mature | 38 | WebAssembly | Circuit compiler for zk-SNARKs. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [ClawRouter](https://github.com/BlockRunAI/ClawRouter) | 6,580 (▼1) | 🔥 Hot | 80 | TypeScript | Agent LLM router with USDC payments on Base & Solana via x402. |
| [x402scan](https://github.com/Merit-Systems/x402scan) | 385 | 🔥 Hot | 80 | TypeScript | x402 ecosystem explorer. |
| [x402](https://github.com/coinbase/x402) | 150 | 🟠 Declining | 35 | TypeScript | The payments-over-HTTP protocol everyone's building on. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 102,808 (▲159) | 🟢 Mature | 73 | Python | Multi-agent LLM trading framework. |
| [OpenBB](https://github.com/OpenBB-finance/OpenBB) | 72,730 (▲23) | 🔵 Classic | 65 | Python | Financial data platform 'for analysts, quants & AI agents'. |
| [AI-Trader](https://github.com/HKUDS/AI-Trader) | 22,191 (▲13) | 📈 Rising | 44 | Python | Fully-automated agent-native trading. |
| [eliza](https://github.com/elizaOS/eliza) | 19,275 (▲14) | 🟢 Mature | 84 | TypeScript | Crypto-native agent OS (wallet/chain plugins). |
...
<sub>Essential repos mapped: 37 across 13 layers · Snapshot: 2026-09-07T10:42:15.216Z · regenerate via scripts/reports/blockchain_essentials.py</sub>
