...
> Derived from **kaiser-data**'s 1,172 starred repos (snapshot `2026-06-02T22:59:34.535Z`), cross-referenced with the repo-similarity graph (1,172 nodes / 3,814 edges).
>
> Generated 2026-06-02 by `scripts/reports/blockchain_essentials.py` (regenerate any time — no API cost).
...
|---|---|---|---|---|---|
| [eliza](https://github.com/elizaOS/eliza) | 🔥 AI × finance / trading | 18,501 | 🔥 Hot | 1,700 | 12,896 |
| [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 🔥 AI × finance / trading | 82,281 | 🔥 Hot | 10,052 | 113 |
| [ClawRouter](https://github.com/BlockRunAI/ClawRouter) | 🔥 Agentic payments (x402) | 6,538 | 🔥 Hot | 4,113 | 377 |
| [AI-Trader](https://github.com/HKUDS/AI-Trader) | 🔥 AI × finance / trading | 19,092 | 🔥 Hot | 6,438 | 96 |
| [x402](https://github.com/coinbase/x402) | 🔥 Agentic payments (x402) | 88 | 🔥 Hot | 108 | 108 |
| [solidity](https://github.com/argotorg/solidity) | Languages & compilers | 25,644 | 🔵 Classic | 244 | 309 |
| [viem](https://github.com/wevm/viem) | Client libraries (TS/JS) | 3,484 | 🔵 Classic | 93 | 300 |
| [x402scan](https://github.com/Merit-Systems/x402scan) | 🔥 Agentic payments (x402) | 345 | 📈 Rising | 103 | 583 |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [openzeppelin-contracts](https://github.com/OpenZeppelin/openzeppelin-contracts) | 27,117 | 🔵 Classic | 76 | Solidity | The standard audited token/access/proxy library. |
...
| [echidna](https://github.com/crytic/echidna) | 3,145 | 🔵 Classic | 75 | Haskell | Property-based fuzzer for smart contracts. |
...
| [safe-smart-account](https://github.com/safe-fndn/safe-smart-account) | 2,152 | 🟢 Mature | 55 | TypeScript | Safe multisig — treasury/custody standard. |
...
| [graph-node](https://github.com/graphprotocol/graph-node) | 3,135 | 🔵 Classic | 84 | Rust | The Graph — index chains into queryable subgraphs. |
...
| [comet](https://github.com/compound-finance/comet) | 309 | 🟢 Mature | 44 | TypeScript | Compound III lending. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [anchor](https://github.com/otter-sec/anchor) | 5,079 | 🔵 Classic | 90 | Rust | The standard Solana smart-contract framework. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [ClawRouter](https://github.com/BlockRunAI/ClawRouter) | 6,538 | 🔥 Hot | 77 | TypeScript | Agent LLM router with USDC payments on Base & Solana via x402. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 82,281 | 🔥 Hot | 72 | Python | Multi-agent LLM trading framework. |
...
<sub>Essential repos mapped: 37 across 13 layers · Snapshot: 2026-06-02T22:59:34.535Z · regenerate via scripts/reports/blockchain_essentials.py</sub>
