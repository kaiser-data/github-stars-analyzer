...
|---|---|---|---|---|---|
| [solidity](https://github.com/argotorg/solidity) | 25,693 (▲9) | 🔵 Classic | 79 | C++ | The Solidity compiler & language (ex ethereum/solidity). |
| [vyper](https://github.com/vyperlang/vyper) | 5,177 (▲1) | 🔵 Classic | 71 | Python | Pythonic contract language; security-minded alternative. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [foundry](https://github.com/foundry-rs/foundry) | 10,550 (▲30) | 🔵 Classic | 85 | Rust | Forge/Cast/Anvil — the dominant Rust-based Solidity toolchain. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [openzeppelin-contracts](https://github.com/OpenZeppelin/openzeppelin-contracts) | 27,206 (▲9) | 🔵 Classic | 80 | Solidity | The standard audited token/access/proxy library. |
| [solmate](https://github.com/transmissions11/solmate) | 4,289 (▲4) | ⚫ Abandoned | 6 | Solidity | Minimalist, modern contract primitives. |
| [solady](https://github.com/Vectorized/solady) | 3,346 | 🔵 Classic | 53 | Solidity | Gas-optimized Solidity building blocks. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [slither](https://github.com/crytic/slither) | 6,338 (▲9) | 🔵 Classic | 63 | Python | The go-to static analyzer for contract vulnerabilities. |
| [echidna](https://github.com/crytic/echidna) | 3,166 (▲4) | 🔵 Classic | 73 | Haskell | Property-based fuzzer for smart contracts. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [ethers.js](https://github.com/ethers-io/ethers.js) | 8,704 (▼1) | 🟢 Mature | 54 | TypeScript | The long-time standard JS/TS library. |
| [wagmi](https://github.com/wevm/wagmi) | 6,741 (▲8) | 🔵 Classic | 77 | TypeScript | React hooks for Ethereum (pairs with viem). |
| [viem](https://github.com/wevm/viem) | 3,527 (▲5) | 🔵 Classic | 85 | TypeScript | Modern, type-safe Ethereum client — default for new TS apps. |
| [rainbowkit](https://github.com/rainbow-me/rainbowkit) | 2,834 (▲2) | 🟢 Mature | 47 | MDX | Drop-in wallet-connection UX for dApps. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [go-ethereum](https://github.com/ethereum/go-ethereum) | 51,273 (▲42) | 🔵 Classic | 90 | Go | geth — the reference Ethereum node (Go). |
| [reth](https://github.com/paradigmxyz/reth) | 5,734 (▲17) | 🔵 Classic | 95 | Rust | Modern, fast Rust client (rising alternative). |
| [nethermind](https://github.com/NethermindEth/nethermind) | 1,585 (▲2) | 🔵 Classic | 94 | C# | High-perf .NET client, strong on tooling. |
...
| [account-abstraction](https://github.com/eth-infinitism/account-abstraction) | 1,930 (▲3) | 🟠 Declining | 26 | TypeScript | Reference ERC-4337 account-abstraction. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [blockscout](https://github.com/blockscout/blockscout) | 4,627 (▲3) | 🔵 Classic | 85 | Elixir | Open EVM explorer; exposes an MCP server for agents. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [v3-core](https://github.com/Uniswap/v3-core) | 5,017 (▼2) | 🟢 Mature | 37 | TypeScript | The concentrated-liquidity AMM still everywhere. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [anchor](https://github.com/otter-sec/anchor) | 5,108 (▲1) | 🔵 Classic | 85 | Rust | The standard Solana smart-contract framework. |
| [solana-web3.js](https://github.com/solana-foundation/solana-web3.js) | 2,749 (▼2) | 🟢 Mature | 51 | TypeScript | JS SDK for Solana. |
| [agave](https://github.com/anza-xyz/agave) | 1,872 (▲22) | 🟢 Mature | 97 | Rust | The Solana validator client. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [risc0](https://github.com/risc0/risc0) | 2,175 (▲3) | 🟢 Mature | 60 | C++ | General-purpose zkVM. |
| [sp1](https://github.com/succinctlabs/sp1) | 1,723 (▲5) | 🟢 Mature | 85 | Rust | Performant RISC-V zkVM. |
| [circom](https://github.com/iden3/circom) | 1,683 (▲2) | 🟢 Mature | 34 | WebAssembly | Circuit compiler for zk-SNARKs. |
...
| [x402scan](https://github.com/Merit-Systems/x402scan) | 368 (▲4) | 🔥 Hot | 76 | TypeScript | x402 ecosystem explorer. |
| [x402](https://github.com/coinbase/x402) | 137 (▲10) | 🟠 Declining | 35 | TypeScript | The payments-over-HTTP protocol everyone's building on. |
...
| Repo | ★ | Lifecycle | Health | Lang | Role |
|---|---|---|---|---|---|
| [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 96,073 (▲1,384) | 🟢 Mature | 73 | Python | Multi-agent LLM trading framework. |
| [OpenBB](https://github.com/OpenBB-finance/OpenBB) | 71,556 (▲497) | 🔵 Classic | 69 | Python | Financial data platform 'for analysts, quants & AI agents'. |
| [AI-Trader](https://github.com/HKUDS/AI-Trader) | 21,195 (▲144) | 🔥 Hot | 53 | Python | Fully-automated agent-native trading. |
| [eliza](https://github.com/elizaOS/eliza) | 18,927 (▲112) | 🟢 Mature | 84 | TypeScript | Crypto-native agent OS (wallet/chain plugins). |
