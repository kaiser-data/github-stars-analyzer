...
| **[JetBrains/lets-plot](https://github.com/JetBrains/lets-plot)** | 1,781 (▼1) | Same grammar from Python and Kotlin/JVM; genuinely good geospatial support; renders in Jupyter, Datalore, and Kotlin notebooks; actively developed by a funded team. | Much smaller community than ggplot2/matplotlib; Kotlin-first documentation in places; fewer third-party extensions; another rendering stack to learn. | JVM/Kotlin data teams, and Python users who want ggplot without the R baggage. |

### Python plotting

| Tool | ★ | ✅ Advantages | ⚠️ Disadvantages | 🎯 Best for |
|---|---|---|---|---|
| **[matplotlib/matplotlib](https://github.com/matplotlib/matplotlib)** | 23,261 (▲19) | Can draw literally anything; the publication standard for scientific figures; vector output (PDF/SVG/EPS); enormous documentation and 20 years of StackOverflow answers; PSF-style licence. | Two competing APIs (pyplot state machine vs. object-oriented) confuse newcomers; verbose for anything non-trivial; dated defaults; no real interactivity; slow on large datasets. | Publication figures and any plot that must be exactly right. |
| **[bokeh/bokeh](https://github.com/bokeh/bokeh)** | 20,460 (▲4) | Python callbacks can run server-side (no JS required) via `bokeh serve`; strong streaming and large-data story (with Datashader); composable widgets; BSD-3. | Heavier concepts than Plotly for simple charts; the server model adds deployment burden; smaller community and slower momentum than Plotly/Altair. | Streaming/live Python dashboards that need server-side callbacks. |
| **[plotly/plotly.py](https://github.com/plotly/plotly.py)** | 18,804 (▲8) | Interactivity (hover/zoom/select) for free in notebooks and web; Plotly Express is genuinely concise; 3D and statistical chart types; the same figure object powers Dash. | Large output payloads bloat notebooks and slow rendering; styling defaults are hard to override cleanly; the free/enterprise boundary around Dash causes confusion. | Interactive exploration in notebooks, and any chart destined for a Dash app. |
| **[Kanaries/pygwalker](https://github.com/Kanaries/pygwalker)** | 15,983 (▲9) | `pyg.walk(df)` and you have pivot + chart exploration; no chart code at all; works in Jupyter/Streamlit/Colab; exports the resulting spec. | Exploration tool, not a production chart library; struggles on very large frames without a compute backend; the free tier nudges toward the commercial Kanaries cloud. | Fast visual EDA on a DataFrame before writing any chart code. |
| **[holoviz/panel](https://github.com/holoviz/panel)** | 5,777 (▲2) | Backend-agnostic: embeds matplotlib, Plotly, Bokeh, Altair, Vega, and DataFrames alike; works inside notebooks *and* as a served app; mature templating. | Large API surface with several overlapping ways to do things; documentation sprawl; smaller community than Streamlit; more concepts before the first app runs. | Python dashboards that must mix plotting libraries rather than commit to one. |
| **[man-group/dtale](https://github.com/man-group/dtale)** | 5,222 | Deep pandas-specific tooling (correlations, missing-value analysis, code export); shows the pandas code for each operation; runs from notebook, CLI, or Flask. | Purely an inspection/EDA tool; heavy Flask app for what is often a quick look; not embeddable as a component; pandas-centric. | Interrogating an unfamiliar DataFrame in depth. |
...
| **[core-plot/core-plot](https://github.com/core-plot/core-plot)** | 2,758 | Genuinely native rendering (no JS bridge); fine-grained drawing control; BSD licence; long track record. | Dated API from the pre-Swift era; slow maintenance; steep learning curve; largely superseded by Apple's Swift Charts for new work. | Legacy Apple codebases already using it. |
...
|---|---|---|---|---|---|---|---|---|---|---|
| [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | Diagrams & AI charts | TypeScript | MIT | 132,866 (▲287) | Classic | 60 | very active | 0d ago | 6.7y | 16 |
| [d3/d3](https://github.com/d3/d3) | Low-level / high-performance | Shell | ISC | 113,763 (▲13) | Mature | 30 | slowing | 4mo ago | 16.0y | 0 |
| [grafana/grafana](https://github.com/grafana/grafana) | BI & dashboard platform | TypeScript | AGPL-3.0 | 76,905 (▲70) | Classic | 99 | very active | 0d ago | 12.8y | 56 |
| [apache/superset](https://github.com/apache/superset) | BI & dashboard platform | Python | Apache-2.0 | 74,914 (▲48) | Classic | 95 | very active | 0d ago | 11.2y | 33 |
| [chartjs/Chart.js](https://github.com/chartjs/Chart.js) | Web charting library | JavaScript | MIT | 67,720 (▲16) | Classic | 53 | active | 11d ago | 13.5y | 4 |
| [apache/echarts](https://github.com/apache/echarts) | Web charting library | TypeScript | Apache-2.0 | 67,393 (▲29) | Classic | 65 | active | 9d ago | 13.5y | 4 |
| [jgraph/drawio-desktop](https://github.com/jgraph/drawio-desktop) | Diagrams & AI charts | JavaScript | GPL-3.0 | 63,272 (▲57) | Classic | 80 | very active | 1d ago | 9.3y | 3 |
| [metabase/metabase](https://github.com/metabase/metabase) | BI & dashboard platform | Clojure | NOASSERTION | 49,415 (▲63) | Classic | 99 | very active | 0d ago | 11.7y | 36 |
| [streamlit/streamlit](https://github.com/streamlit/streamlit) | Data-app framework | Python | Apache-2.0 | 45,832 (▲27) | Classic | 83 | very active | 0d ago | 7.1y | 8 |
| [gradio-app/gradio](https://github.com/gradio-app/gradio) | Data-app framework | Python | Apache-2.0 | 43,621 (▲31) | Classic | 85 | very active | 0d ago | 7.8y | 6 |
| [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) | BI & dashboard platform | JavaScript | AGPL-3.0 | 40,992 (▲42) | Classic | 89 | very active | 0d ago | 5.5y | 13 |
| [reflex-dev/reflex](https://github.com/reflex-dev/reflex) | Data-app framework | Python | Apache-2.0 | 28,915 (▲20) | Classic | 89 | very active | 0d ago | 3.9y | 15 |
| [getredash/redash](https://github.com/getredash/redash) | BI & dashboard platform | Python | BSD-2-Clause | 28,809 (▲3) | Classic | 59 | very active | 1d ago | 12.9y | 8 |
| [recharts/recharts](https://github.com/recharts/recharts) | React charting library | TypeScript | MIT | 27,589 (▲15) | Classic | 79 | very active | 0d ago | 11.1y | 8 |
| [plotly/dash](https://github.com/plotly/dash) | Data-app framework | Python | MIT | 24,428 (▲7) | Classic | 78 | very active | 1d ago | 11.5y | 7 |
| [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) | Python plotting | Python | — | 23,261 (▲19) | Classic | 89 | very active | 0d ago | 15.6y | 15 |
| [openobserve/openobserve](https://github.com/openobserve/openobserve) | BI & dashboard platform | TypeScript | AGPL-3.0 | 22,123 (▲67) | Classic | 94 | very active | 0d ago | 3.6y | 23 |
| [elastic/kibana](https://github.com/elastic/kibana) | BI & dashboard platform | TypeScript | NOASSERTION | 21,301 (▲8) | Classic | 99 | very active | 0d ago | 13.7y | 78 |
| [airbnb/visx](https://github.com/airbnb/visx) | React charting library | TypeScript | MIT | 21,060 (▲4) | Mature | 33 | slowing | 3mo ago | 9.5y | 0 |
| [bokeh/bokeh](https://github.com/bokeh/bokeh) | Python plotting | TypeScript | BSD-3-Clause | 20,460 (▲4) | Classic | 64 | very active | 1d ago | 14.5y | 20 |
| [Avaiga/taipy](https://github.com/Avaiga/taipy) | Data-app framework | Python | Apache-2.0 | 19,432 (▼3) | Mature | 49 | active | 1mo ago | 4.6y | 0 |
| [plotly/plotly.py](https://github.com/plotly/plotly.py) | Python plotting | Python | MIT | 18,804 (▲8) | Classic | 78 | very active | 0d ago | 12.9y | 13 |
| [plotly/plotly.js](https://github.com/plotly/plotly.js) | Web charting library | JavaScript | MIT | 18,342 (▲5) | Classic | 78 | very active | 0d ago | 10.9y | 7 |
| [Canner/WrenAI](https://github.com/Canner/WrenAI) | BI & dashboard platform | Python | NOASSERTION | 17,746 (▲41) | Mature | 86 | very active | 1d ago | 2.5y | 20 |
| [tradingview/lightweight-charts](https://github.com/tradingview/lightweight-charts) | Low-level / high-performance | TypeScript | Apache-2.0 | 17,349 (▲27) | Classic | 74 | very active | 4d ago | 7.3y | 3 |
| [Kanaries/pygwalker](https://github.com/Kanaries/pygwalker) | Python plotting | Python | Apache-2.0 | 15,983 (▲9) | Mature | 48 | active | 20d ago | 3.6y | 1 |
| [apexcharts/apexcharts.js](https://github.com/apexcharts/apexcharts.js) | Web charting library | JavaScript | NOASSERTION | 15,163 (▲5) | Classic | 79 | very active | 1d ago | 8.2y | 9 |
| [frappe/charts](https://github.com/frappe/charts) | Web charting library | JavaScript | MIT | 15,085 (▲3) | Abandoned | 5 | stale | 1.2y ago | 8.9y | 0 |
| [visgl/deck.gl](https://github.com/visgl/deck.gl) | Low-level / high-performance | TypeScript | MIT | 14,612 (▲9) | Classic | 84 | very active | 0d ago | 10.8y | 13 |
| [plouc/nivo](https://github.com/plouc/nivo) | React charting library | TypeScript | MIT | 14,103 (▲3) | Mature | 46 | slowing | 2mo ago | 10.4y | 3 |
| [antvis/G2](https://github.com/antvis/G2) | Web charting library | TypeScript | MIT | 12,617 (▲6) | Mature | 70 | active | 1d ago | 10.3y | 4 |
| [highcharts/highcharts](https://github.com/highcharts/highcharts) | Web charting library | TypeScript | NOASSERTION | 12,492 (▲1) | Classic | 70 | very active | 0d ago | 16.3y | 13 |
| [keplergl/kepler.gl](https://github.com/keplergl/kepler.gl) | Low-level / high-performance | TypeScript | MIT | 12,025 (▲3) | Classic | 77 | very active | 0d ago | 8.6y | 6 |
| [vega/vega](https://github.com/vega/vega) | Grammar of graphics | JavaScript | BSD-3-Clause | 11,998 (▲4) | Classic | 71 | very active | 14d ago | 13.6y | 13 |
| [perspective-dev/perspective](https://github.com/perspective-dev/perspective) | Low-level / high-performance | Rust | Apache-2.0 | 11,250 (▲12) | Classic | 79 | very active | 0d ago | 8.9y | 3 |
| [lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid) | Diagrams & AI charts | TypeScript | MIT | 11,143 (▲20) | Declining | 33 | slowing | 4mo ago | 8mo | 0 |
| [leeoniya/uPlot](https://github.com/leeoniya/uPlot) | Low-level / high-performance | JavaScript | MIT | 10,513 (▲5) | Mature | 61 | very active | 0d ago | 7.0y | 1 |
| [vega/altair](https://github.com/vega/altair) | Grammar of graphics | Python | BSD-3-Clause | 10,485 (▲6) | Classic | 74 | very active | 3d ago | 11.0y | 13 |
| [c3js/c3](https://github.com/c3js/c3) | Web charting library | JavaScript | MIT | 9,351 | Classic | 50 | active | 11d ago | 13.2y | 2 |
| [evidence-dev/evidence](https://github.com/evidence-dev/evidence) | BI & dashboard platform | TypeScript | MIT | 6,959 (▲9) | Classic | 75 | very active | 1d ago | 5.3y | 4 |
| [ScottPlot/ScottPlot](https://github.com/ScottPlot/ScottPlot) | Native / systems charting | C# | MIT | 6,758 (▲5) | Mature | 51 | active | 1mo ago | 8.7y | 2 |
| [holoviz/panel](https://github.com/holoviz/panel) | Python plotting | Python | BSD-3-Clause | 5,777 (▲2) | Classic | 81 | very active | 1d ago | 8.1y | 20 |
| [vega/vega-lite](https://github.com/vega/vega-lite) | Grammar of graphics | TypeScript | BSD-3-Clause | 5,497 (▲3) | Classic | 60 | very active | 1d ago | 11.9y | 6 |
| [observablehq/plot](https://github.com/observablehq/plot) | Web charting library | HTML | ISC | 5,388 (▲2) | Mature | 42 | active | 24d ago | 5.9y | 1 |
| [man-group/dtale](https://github.com/man-group/dtale) | Python plotting | TypeScript | LGPL-2.1 | 5,222 | Mature | 40 | slowing | 2mo ago | 7.2y | 0 |
| [alandefreitas/matplotplusplus](https://github.com/alandefreitas/matplotplusplus) | Native / systems charting | C++ | MIT | 4,933 (▲4) | Mature | 20 | slowing | 5mo ago | 6.1y | 0 |
...
| [tremorlabs/tremor](https://github.com/tremorlabs/tremor) | React charting library | TypeScript | Apache-2.0 | 3,632 (▲7) | Declining | 8 | stale | 11mo ago | 2.5y | 0 |
| [gonum/plot](https://github.com/gonum/plot) | Native / systems charting | Go | BSD-3-Clause | 2,968 | Mature | 25 | slowing | 5mo ago | 13.2y | 0 |
| [rilldata/rill](https://github.com/rilldata/rill) | BI & dashboard platform | Go | Apache-2.0 | 2,914 (▲5) | Classic | 84 | very active | 0d ago | 4.8y | 12 |
| [holoviz/holoviews](https://github.com/holoviz/holoviews) | Python plotting | Python | BSD-3-Clause | 2,910 | Classic | 71 | very active | 2d ago | 12.4y | 7 |
| [posit-dev/great-tables](https://github.com/posit-dev/great-tables) | Python plotting | Python | MIT | 2,866 (▲19) | Classic | 74 | very active | 0d ago | 4.4y | 2 |
| [core-plot/core-plot](https://github.com/core-plot/core-plot) | Native / systems charting | Objective-C | BSD-3-Clause | 2,758 | Mature | 27 | slowing | 4mo ago | 12.8y | 0 |
| [weaveworks/grafanalib](https://github.com/weaveworks/grafanalib) | Dashboards as code | Python | Apache-2.0 | 1,976 | Declining | 12 | stale | 9mo ago | 9.8y | 0 |
| [reflex-dev/xy](https://github.com/reflex-dev/xy) | Python plotting | Python | Apache-2.0 | 1,852 (▲3) | Hot | 79 | very active | 3d ago | 2mo | 11 |
| [JetBrains/lets-plot](https://github.com/JetBrains/lets-plot) | Grammar of graphics | Kotlin | MIT | 1,781 (▼1) | Mature | 61 | slowing | 2mo ago | 7.5y | 3 |
| [K-Phoen/grabana](https://github.com/K-Phoen/grabana) | Dashboards as code | Go | MIT | 729 (▲1) | Abandoned | 6 | stale | 1.4y ago | 6.7y | 0 |
| [hustcc/mcp-mermaid](https://github.com/hustcc/mcp-mermaid) | Diagrams & AI charts | TypeScript | MIT | 638 (▲2) | Declining | 34 | slowing | 4mo ago | 1.4y | 0 |
| [grafana/grafana-foundation-sdk](https://github.com/grafana/grafana-foundation-sdk) | Dashboards as code | PHP | Apache-2.0 | 260 | Mature | 60 | very active | 0d ago | 2.8y | 4 |
