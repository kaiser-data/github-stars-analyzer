...
> Derived from **kaiser-data**'s 1,857 starred repos (snapshot `2026-08-29T15:31:31.780Z`), cross-referenced with the repo-similarity graph (1,857 nodes / 6,041 edges, 37 communities). The advantages/disadvantages column is editorial judgement grounded in the dataset's own health metrics plus external comparisons — see Methodology.
>
...
- **61 charting and visualization tools** in your stars (**1,330,955★** combined), grouped into 10 layers:
...
| Tool | ★ | ✅ Advantages | ⚠️ Disadvantages | 🎯 Best for |
|---|---|---|---|---|
| **[recharts/recharts](https://github.com/recharts/recharts)** | 27,523 (▲4) | Idiomatic React composition (`<LineChart><XAxis/><Tooltip/>`); declarative and easy to reason about; responsive container built in; MIT; the most-recommended React default. | SVG-only — struggles well before 10k points; animation and layout bugs surface in complex compositions; customisation beyond the component props gets awkward fast. | The default choice for typical React dashboards with modest data volumes. |
...
| Tool | ★ | ✅ Advantages | ⚠️ Disadvantages | 🎯 Best for |
|---|---|---|---|---|
| **[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw)** | 130,749 (▲89) | Effortless, genuinely fast sketching; hand-drawn style reads as 'draft' which encourages iteration; local-first with an open file format; embeddable library; huge adoption. | Not a data-charting tool — no data binding whatsoever; the sketch aesthetic is wrong for formal documentation; collaboration/storage features push toward Excalidraw+. | Architecture sketches, whiteboarding, and diagrams-in-docs. |
| **[jgraph/drawio-desktop](https://github.com/jgraph/drawio-desktop)** | 62,839 (▲10) | Exhaustive shape libraries (AWS/Azure/GCP/UML/BPMN/network); fully offline and local-file based; no account required; stable and battle-tested. | Dated Electron UI; XML file format is unpleasant to diff; no data binding — diagrams are drawn, not generated from data; manual layout work. | Formal architecture, network, and process diagrams that must follow a notation. |
| **[lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid)** | 10,987 (▲7) | Text-defined diagrams mean git-diffable, LLM-generatable output; substantially better looking than stock Mermaid; drops into docs pipelines. | Bound to Mermaid's syntax and layout engine (auto-layout is often mediocre); **declining maintenance signal** in this snapshot; presentation layer only. | Diagrams in docs and READMEs that should look designed. |
...
|---|---|---|---|---|---|---|---|---|---|---|
| [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | Diagrams & AI charts | TypeScript | MIT | 130,749 (▲89) | Classic | 60 | very active | 1d ago | 6.7y | 18 |
| [d3/d3](https://github.com/d3/d3) | Low-level / high-performance | Shell | ISC | 113,576 (▲4) | Mature | 32 | slowing | 3mo ago | 15.9y | 0 |
| [grafana/grafana](https://github.com/grafana/grafana) | BI & dashboard platform | TypeScript | AGPL-3.0 | 76,471 (▲13) | Classic | 99 | very active | 0d ago | 12.7y | 54 |
| [apache/superset](https://github.com/apache/superset) | BI & dashboard platform | Python | Apache-2.0 | 74,531 (▲40) | Classic | 90 | very active | 0d ago | 11.1y | 34 |
| [chartjs/Chart.js](https://github.com/chartjs/Chart.js) | Web charting library | JavaScript | MIT | 67,671 (▲3) | Mature | 34 | slowing | 3mo ago | 13.5y | 0 |
| [apache/echarts](https://github.com/apache/echarts) | Web charting library | TypeScript | Apache-2.0 | 67,176 (▲10) | Classic | 61 | active | 25d ago | 13.4y | 3 |
| [jgraph/drawio-desktop](https://github.com/jgraph/drawio-desktop) | Diagrams & AI charts | JavaScript | Apache-2.0 | 62,839 (▲10) | Classic | 77 | very active | 3d ago | 9.3y | 3 |
| [metabase/metabase](https://github.com/metabase/metabase) | BI & dashboard platform | Clojure | NOASSERTION | 48,986 (▲19) | Classic | 99 | very active | 0d ago | 11.6y | 36 |
| [streamlit/streamlit](https://github.com/streamlit/streamlit) | Data-app framework | Python | Apache-2.0 | 45,635 (▲11) | Classic | 83 | very active | 0d ago | 7.0y | 8 |
| [gradio-app/gradio](https://github.com/gradio-app/gradio) | Data-app framework | Python | Apache-2.0 | 43,438 (▲6) | Classic | 85 | very active | 1d ago | 7.7y | 5 |
| [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) | BI & dashboard platform | JavaScript | AGPL-3.0 | 40,790 (▲5) | Classic | 84 | very active | 0d ago | 5.4y | 15 |
| [reflex-dev/reflex](https://github.com/reflex-dev/reflex) | Data-app framework | Python | Apache-2.0 | 28,858 | Classic | 84 | very active | 1d ago | 3.8y | 11 |
...
| [recharts/recharts](https://github.com/recharts/recharts) | React charting library | TypeScript | MIT | 27,523 (▲4) | Classic | 79 | very active | 1d ago | 11.1y | 17 |
| [plotly/dash](https://github.com/plotly/dash) | Data-app framework | Python | MIT | 24,389 (▲1) | Classic | 78 | very active | 1d ago | 11.4y | 10 |
| [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) | Python plotting | Python | — | 23,121 (▲4) | Classic | 94 | very active | 0d ago | 15.5y | 27 |
| [openobserve/openobserve](https://github.com/openobserve/openobserve) | BI & dashboard platform | TypeScript | AGPL-3.0 | 21,552 (▲40) | Classic | 89 | very active | 0d ago | 3.6y | 22 |
| [elastic/kibana](https://github.com/elastic/kibana) | BI & dashboard platform | TypeScript | NOASSERTION | 21,270 (▲5) | Classic | 99 | very active | 0d ago | 13.6y | 62 |
...
| [bokeh/bokeh](https://github.com/bokeh/bokeh) | Python plotting | Python | BSD-3-Clause | 20,437 (▲1) | Classic | 68 | very active | 1d ago | 14.4y | 19 |
| [Avaiga/taipy](https://github.com/Avaiga/taipy) | Data-app framework | Python | Apache-2.0 | 19,436 (▲2) | Mature | 52 | active | 20d ago | 4.5y | 0 |
| [plotly/plotly.py](https://github.com/plotly/plotly.py) | Python plotting | Python | MIT | 18,759 (▲4) | Classic | 78 | very active | 2d ago | 12.8y | 8 |
| [plotly/plotly.js](https://github.com/plotly/plotly.js) | Web charting library | JavaScript | MIT | 18,304 (▲1) | Classic | 78 | very active | 2d ago | 10.8y | 3 |
| [Canner/WrenAI](https://github.com/Canner/WrenAI) | BI & dashboard platform | Python | NOASSERTION | 17,422 (▲13) | Mature | 81 | very active | 1d ago | 2.5y | 13 |
| [tradingview/lightweight-charts](https://github.com/tradingview/lightweight-charts) | Low-level / high-performance | TypeScript | Apache-2.0 | 17,116 (▲19) | Classic | 68 | very active | 8d ago | 7.3y | 8 |
| [Kanaries/pygwalker](https://github.com/Kanaries/pygwalker) | Python plotting | Python | Apache-2.0 | 15,950 (▲1) | Classic | 63 | very active | 19d ago | 3.5y | 2 |
| [apexcharts/apexcharts.js](https://github.com/apexcharts/apexcharts.js) | Web charting library | JavaScript | NOASSERTION | 15,143 (▲3) | Classic | 79 | very active | 1d ago | 8.1y | 2 |
...
| [visgl/deck.gl](https://github.com/visgl/deck.gl) | Low-level / high-performance | TypeScript | MIT | 14,531 (▲1) | Classic | 83 | very active | 0d ago | 10.7y | 12 |
| [plouc/nivo](https://github.com/plouc/nivo) | React charting library | TypeScript | MIT | 14,092 | Classic | 49 | active | 1mo ago | 10.4y | 4 |
| [antvis/G2](https://github.com/antvis/G2) | Web charting library | TypeScript | MIT | 12,598 (▲2) | Mature | 58 | active | 1mo ago | 10.3y | 2 |
| [highcharts/highcharts](https://github.com/highcharts/highcharts) | Web charting library | TypeScript | NOASSERTION | 12,482 (▲1) | Classic | 70 | very active | 1d ago | 16.2y | 9 |
| [keplergl/kepler.gl](https://github.com/keplergl/kepler.gl) | Low-level / high-performance | TypeScript | MIT | 11,989 | Classic | 77 | very active | 0d ago | 8.5y | 4 |
| [vega/vega](https://github.com/vega/vega) | Grammar of graphics | JavaScript | BSD-3-Clause | 11,979 (▲2) | Classic | 71 | very active | 7d ago | 13.6y | 13 |
| [perspective-dev/perspective](https://github.com/perspective-dev/perspective) | Low-level / high-performance | Rust | Apache-2.0 | 11,143 (▲7) | Classic | 77 | very active | 3d ago | 8.8y | 3 |
| [lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid) | Diagrams & AI charts | TypeScript | MIT | 10,987 (▲7) | Declining | 35 | slowing | 3mo ago | 7mo | 0 |
...
| [leeoniya/uPlot](https://github.com/leeoniya/uPlot) | Low-level / high-performance | JavaScript | MIT | 10,459 (▲5) | Mature | 28 | slowing | 4mo ago | 6.9y | 0 |
| [c3js/c3](https://github.com/c3js/c3) | Web charting library | JavaScript | MIT | 9,349 | Classic | 49 | active | 24d ago | 13.1y | 2 |
| [evidence-dev/evidence](https://github.com/evidence-dev/evidence) | BI & dashboard platform | TypeScript | MIT | 6,894 (▲8) | Classic | 71 | very active | 3d ago | 5.3y | 4 |
| [ScottPlot/ScottPlot](https://github.com/ScottPlot/ScottPlot) | Native / systems charting | C# | MIT | 6,724 (▲4) | Classic | 62 | very active | 14d ago | 8.7y | 8 |
| [holoviz/panel](https://github.com/holoviz/panel) | Python plotting | Python | BSD-3-Clause | 5,763 | Classic | 85 | very active | 0d ago | 8.0y | 19 |
| [vega/vega-lite](https://github.com/vega/vega-lite) | Grammar of graphics | TypeScript | BSD-3-Clause | 5,464 (▲1) | Classic | 66 | very active | 5d ago | 11.8y | 7 |
| [observablehq/plot](https://github.com/observablehq/plot) | Web charting library | HTML | ISC | 5,362 (▲1) | Mature | 34 | active | 1mo ago | 5.8y | 0 |
...
| [tremorlabs/tremor](https://github.com/tremorlabs/tremor) | React charting library | TypeScript | Apache-2.0 | 3,586 (▲3) | Declining | 10 | stale | 10mo ago | 2.4y | 0 |
| [gonum/plot](https://github.com/gonum/plot) | Native / systems charting | Go | BSD-3-Clause | 2,966 | Mature | 27 | slowing | 4mo ago | 13.1y | 0 |
| [holoviz/holoviews](https://github.com/holoviz/holoviews) | Python plotting | Python | BSD-3-Clause | 2,907 | Classic | 70 | very active | 0d ago | 12.3y | 12 |
| [rilldata/rill](https://github.com/rilldata/rill) | BI & dashboard platform | Go | Apache-2.0 | 2,851 (▲3) | Classic | 84 | very active | 1d ago | 4.7y | 12 |
...
| [posit-dev/great-tables](https://github.com/posit-dev/great-tables) | Python plotting | Python | MIT | 2,724 (▲1) | Classic | 74 | very active | 5d ago | 4.3y | 2 |
...
| [reflex-dev/xy](https://github.com/reflex-dev/xy) | Python plotting | Python | Apache-2.0 | 1,803 (▲11) | Hot | 74 | very active | 2d ago | 1mo | 11 |
...
| [grafana/grafana-foundation-sdk](https://github.com/grafana/grafana-foundation-sdk) | Dashboards as code | PHP | Apache-2.0 | 255 | Mature | 59 | very active | 0d ago | 2.8y | 6 |
...
- **[chartjs/Chart.js](https://github.com/chartjs/Chart.js)** · 67,671★ · JavaScript · Mature  
...
- **[apache/echarts](https://github.com/apache/echarts)** · 67,176★ · TypeScript · Classic  
...
- **[plotly/plotly.js](https://github.com/plotly/plotly.js)** · 18,304★ · JavaScript · Classic  
...
- **[apexcharts/apexcharts.js](https://github.com/apexcharts/apexcharts.js)** · 15,143★ · JavaScript · Classic  
...
- **[highcharts/highcharts](https://github.com/highcharts/highcharts)** · 12,482★ · TypeScript · Classic  
...
- **[recharts/recharts](https://github.com/recharts/recharts)** · 27,523★ · TypeScript · Classic  
...
- **[tremorlabs/tremor](https://github.com/tremorlabs/tremor)** · 3,586★ · TypeScript · Declining  
...
- **[d3/d3](https://github.com/d3/d3)** · 113,576★ · Shell · Mature  
...
- **[tradingview/lightweight-charts](https://github.com/tradingview/lightweight-charts)** · 17,116★ · TypeScript · Classic  
...
- **[visgl/deck.gl](https://github.com/visgl/deck.gl)** · 14,531★ · TypeScript · Classic  
...
- **[perspective-dev/perspective](https://github.com/perspective-dev/perspective)** · 11,143★ · Rust · Classic  
...
- **[leeoniya/uPlot](https://github.com/leeoniya/uPlot)** · 10,459★ · JavaScript · Mature  
...
- **[vega/altair](https://github.com/vega/altair)** · 10,460★ · Python · Classic  
  ...
  <sub>topics: —</sub>
- **[vega/vega-lite](https://github.com/vega/vega-lite)** · 5,464★ · TypeScript · Classic  
...
- **[matplotlib/matplotlib](https://github.com/matplotlib/matplotlib)** · 23,121★ · Python · Classic  
...
- **[bokeh/bokeh](https://github.com/bokeh/bokeh)** · 20,437★ · Python · Classic  
...
- **[plotly/plotly.py](https://github.com/plotly/plotly.py)** · 18,759★ · Python · Classic  
...
- **[Kanaries/pygwalker](https://github.com/Kanaries/pygwalker)** · 15,950★ · Python · Classic  
...
- **[reflex-dev/xy](https://github.com/reflex-dev/xy)** · 1,803★ · Python · Hot  
...
- **[grafana/grafana](https://github.com/grafana/grafana)** · 76,471★ · TypeScript · Classic  
...
- **[apache/superset](https://github.com/apache/superset)** · 74,531★ · Python · Classic  
...
- **[metabase/metabase](https://github.com/metabase/metabase)** · 48,986★ · Clojure · Classic  
...
- **[ToolJet/ToolJet](https://github.com/ToolJet/ToolJet)** · 40,790★ · JavaScript · Classic  
...
- **[openobserve/openobserve](https://github.com/openobserve/openobserve)** · 21,552★ · TypeScript · Classic  
...
- **[elastic/kibana](https://github.com/elastic/kibana)** · 21,270★ · TypeScript · Classic  
...
- **[Canner/WrenAI](https://github.com/Canner/WrenAI)** · 17,422★ · Python · Mature  
...
- **[evidence-dev/evidence](https://github.com/evidence-dev/evidence)** · 6,894★ · TypeScript · Classic  
...
- **[rilldata/rill](https://github.com/rilldata/rill)** · 2,851★ · Go · Classic  
...
- **[streamlit/streamlit](https://github.com/streamlit/streamlit)** · 45,635★ · Python · Classic  
...
- **[gradio-app/gradio](https://github.com/gradio-app/gradio)** · 43,438★ · Python · Classic  
...
- **[plotly/dash](https://github.com/plotly/dash)** · 24,389★ · Python · Classic  
...
- **[Avaiga/taipy](https://github.com/Avaiga/taipy)** · 19,436★ · Python · Mature  
...
- **[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw)** · 130,749★ · TypeScript · Classic  
...
- **[jgraph/drawio-desktop](https://github.com/jgraph/drawio-desktop)** · 62,839★ · JavaScript · Classic  
...
- **[lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid)** · 10,987★ · TypeScript · Declining  
...
- **[ScottPlot/ScottPlot](https://github.com/ScottPlot/ScottPlot)** · 6,724★ · C# · Classic  
...
- **Community 14** (22): `plotly/plotly.js`, `apexcharts/apexcharts.js`, `observablehq/plot`, `airbnb/visx`, `d3/d3`, `leeoniya/uPlot`, `has2k1/plotnine`, `matplotlib/matplotlib`, `plotly/plotly.py`, `bokeh/bokeh`, `holoviz/holoviews`, `holoviz/panel`, `man-group/dtale`, `reflex-dev/xy`, `streamlit/streamlit`, `gradio-app/gradio`, `plotly/dash`, `reflex-dev/reflex`, `Avaiga/taipy`, `ScottPlot/ScottPlot`, `AAChartModel/AAChartKit`, `alandefreitas/matplotplusplus`
- **Community 3** (13): `apache/echarts`, `chartjs/Chart.js`, `c3js/c3`, `frappe/charts`, `plouc/nivo`, `tradingview/lightweight-charts`, `vega/vega-lite`, `vega/vega`, `vega/altair`, `apache/superset`, `ToolJet/ToolJet`, `deliveryhero/grafyaml`, `gonum/plot`
- **Community 5** (8): `grafana/grafana`, `metabase/metabase`, `elastic/kibana`, `openobserve/openobserve`, `evidence-dev/evidence`, `rilldata/rill`, `grafana/grafana-foundation-sdk`, `lukilabs/beautiful-mermaid`
- **Community 4** (7): `highcharts/highcharts`, `antvis/G2`, `perspective-dev/perspective`, `visgl/deck.gl`, `keplergl/kepler.gl`, `JetBrains/lets-plot`, `excalidraw/excalidraw`
- **Community 8** (3): `getredash/redash`, `Canner/WrenAI`, `jgraph/drawio-desktop`
- **Community 22** (2): `recharts/recharts`, `tremorlabs/tremor`
- **Community 10** (2): `Kanaries/pygwalker`, `posit-dev/great-tables`

**Centrality (PageRank in the full 1,857-repo graph)** — most 'hub-like' visualization tools in your ecosystem:

- `c3js/c3` — PageRank 0.0018
- `apache/echarts` — PageRank 0.0017
- `streamlit/streamlit` — PageRank 0.0015
- `antvis/G2` — PageRank 0.0014
- `reflex-dev/xy` — PageRank 0.0012
- `keplergl/kepler.gl` — PageRank 0.0012
...
- `holoviz/panel` ⇄ `holoviz/holoviews` (w=1.267) — topics: holoviz, holoviews; authors: philippjfr, hoxbro, Kkkakania
...
| metabase/metabase | 99 | Classic | very active | 7 | 10% | 827 |
| elastic/kibana | 99 | Classic | very active | 16 | 12% | 262 |
| matplotlib/matplotlib | 94 | Classic | very active | 4 | 19% | 102 |
| apache/superset | 90 | Classic | very active | 3 | 30% | 267 |
| openobserve/openobserve | 89 | Classic | very active | 3 | 25% | 219 |
| holoviz/panel | 85 | Classic | very active | 3 | 30% | 102 |
| gradio-app/gradio | 85 | Classic | very active | 2 | 40% | 5095 |
| rilldata/rill | 84 | Classic | very active | 2 | 39% | 330 |
| ToolJet/ToolJet | 84 | Classic | very active | 2 | 46% | 602 |
| reflex-dev/reflex | 84 | Classic | very active | 2 | 39% | 264 |
| visgl/deck.gl | 83 | Classic | very active | 2 | 30% | 309 |
| streamlit/streamlit | 83 | Classic | very active | 2 | 47% | 126 |
| Canner/WrenAI | 81 | Mature | very active | 2 | 39% | 193 |
...
| plotly/dash | 78 | Classic | very active | 1 | 55% | 109 |
| perspective-dev/perspective | 77 | Classic | very active | 1 | 95% | 63 |
| keplergl/kepler.gl | 77 | Classic | very active | 1 | 71% | 58 |
...
- **prometheus/prometheus** (65,884★) — a time-series *database* and the data source behind most Grafana panels — storage, not charting
- **plausible/analytics** (28,792★) — a fixed-purpose web-analytics product; its dashboard isn't reusable for your own data
- **bluewave-labs/Checkmate** (10,763★) — uptime/infrastructure monitoring with built-in status charts — a monitoring product, not a charting tool
- **voxel51/fiftyone** (11,048★) — visualizes *datasets and model predictions* for computer vision — a data-curation app, not a chart library
- **jessevig/bertviz** (8,162★) — visualizes transformer attention specifically — a model-interpretability tool
- **OpenSpace/OpenSpace** (1,236★) — astrovisualization of space data — scientific rendering, not general charting
- **originalankur/maptoposter** (14,051★) — turns city maps into poster art — cartographic design, not data visualization
- **unhappychoice/gitlogue** (4,943★) — animated replay of git history in the terminal — a novelty visualizer
- **patoles/agent-flow** (1,609★) — real-time visualization of agent orchestration — see the *Agent orchestration* report
...
- **GraphiteEditor/Graphite** (26,966★) — a 2D vector graphics editor — design tooling, not data charting
- **mosra/magnum** (5,196★) — C++ graphics middleware used *for* visualization, but a rendering engine at heart
...
- **jakevdp/PythonDataScienceHandbook** (49,731★) — a book (notebooks) that teaches matplotlib — learning material, not a tool
...
<sub>Tools covered: 61 · Snapshot: 2026-08-29T15:31:31.780Z</sub>
