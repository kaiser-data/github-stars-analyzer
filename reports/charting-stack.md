...
> Derived from **kaiser-data**'s 2,022 starred repos (snapshot `2026-09-06T08:24:34.321Z`), cross-referenced with the repo-similarity graph (2,022 nodes / 6,605 edges, 38 communities). The advantages/disadvantages column is editorial judgement grounded in the dataset's own health metrics plus external comparisons — see Methodology.
>
> Generated 2026-09-06 by `scripts/reports/charting_stack.py` (regenerate any time — no API cost).
...
- **61 charting and visualization tools** in your stars (**1,332,962★** combined), grouped into 10 layers:
...
| **[core-plot/core-plot](https://github.com/core-plot/core-plot)** | 2,760 (▼2) | Genuinely native rendering (no JS bridge); fine-grained drawing control; BSD licence; long track record. | Dated API from the pre-Swift era; slow maintenance; steep learning curve; largely superseded by Apple's Swift Charts for new work. | Legacy Apple codebases already using it. |
...
|---|---|---|---|---|---|---|---|---|---|---|
| [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | Diagrams & AI charts | TypeScript | MIT | 131,226 (▲373) | Classic | 59 | very active | 2d ago | 6.7y | 18 |
| [d3/d3](https://github.com/d3/d3) | Low-level / high-performance | Shell | ISC | 113,651 (▲67) | Mature | 32 | slowing | 3mo ago | 16.0y | 0 |
| [grafana/grafana](https://github.com/grafana/grafana) | BI & dashboard platform | TypeScript | AGPL-3.0 | 76,616 (▲85) | Classic | 99 | very active | 0d ago | 12.7y | 55 |
| [apache/superset](https://github.com/apache/superset) | BI & dashboard platform | Python | Apache-2.0 | 74,662 (▲104) | Classic | 85 | very active | 0d ago | 11.1y | 26 |
| [chartjs/Chart.js](https://github.com/chartjs/Chart.js) | Web charting library | JavaScript | MIT | 67,682 (▲6) | Mature | 33 | slowing | 3mo ago | 13.5y | 0 |
| [apache/echarts](https://github.com/apache/echarts) | Web charting library | TypeScript | Apache-2.0 | 67,251 (▲48) | Classic | 64 | active | 2d ago | 13.4y | 3 |
| [jgraph/drawio-desktop](https://github.com/jgraph/drawio-desktop) | Diagrams & AI charts | JavaScript | Apache-2.0 | 62,955 (▲86) | Classic | 78 | very active | 4d ago | 9.3y | 3 |
| [metabase/metabase](https://github.com/metabase/metabase) | BI & dashboard platform | Clojure | NOASSERTION | 49,102 (▲90) | Classic | 99 | very active | 0d ago | 11.6y | 34 |
| [streamlit/streamlit](https://github.com/streamlit/streamlit) | Data-app framework | Python | Apache-2.0 | 45,699 (▲48) | Classic | 83 | very active | 0d ago | 7.0y | 8 |
| [gradio-app/gradio](https://github.com/gradio-app/gradio) | Data-app framework | Python | Apache-2.0 | 43,481 (▲41) | Classic | 85 | very active | 1d ago | 7.7y | 5 |
| [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) | BI & dashboard platform | JavaScript | AGPL-3.0 | 40,849 (▲47) | Classic | 84 | very active | 0d ago | 5.4y | 18 |
| [reflex-dev/reflex](https://github.com/reflex-dev/reflex) | Data-app framework | Python | Apache-2.0 | 28,880 (▲17) | Classic | 84 | very active | 0d ago | 3.9y | 12 |
| [getredash/redash](https://github.com/getredash/redash) | BI & dashboard platform | Python | BSD-2-Clause | 28,781 (▲10) | Classic | 64 | active | 3d ago | 12.9y | 9 |
| [recharts/recharts](https://github.com/recharts/recharts) | React charting library | TypeScript | MIT | 27,545 (▲17) | Classic | 84 | very active | 0d ago | 11.1y | 20 |
| [plotly/dash](https://github.com/plotly/dash) | Data-app framework | Python | MIT | 24,399 (▲11) | Classic | 78 | very active | 2d ago | 11.4y | 8 |
| [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) | Python plotting | Python | — | 23,169 (▲38) | Classic | 93 | very active | 0d ago | 15.6y | 23 |
| [openobserve/openobserve](https://github.com/openobserve/openobserve) | BI & dashboard platform | TypeScript | AGPL-3.0 | 21,660 (▲78) | Classic | 89 | very active | 0d ago | 3.6y | 24 |
| [elastic/kibana](https://github.com/elastic/kibana) | BI & dashboard platform | TypeScript | NOASSERTION | 21,283 (▲7) | Classic | 99 | very active | 0d ago | 13.6y | 60 |
| [airbnb/visx](https://github.com/airbnb/visx) | React charting library | TypeScript | MIT | 21,034 (▲6) | Classic | 53 | slowing | 2mo ago | 9.5y | 3 |
| [bokeh/bokeh](https://github.com/bokeh/bokeh) | Python plotting | Python | BSD-3-Clause | 20,445 (▲9) | Classic | 69 | very active | 0d ago | 14.5y | 17 |
| [Avaiga/taipy](https://github.com/Avaiga/taipy) | Data-app framework | Python | Apache-2.0 | 19,434 (▼4) | Mature | 51 | active | 27d ago | 4.6y | 0 |
| [plotly/plotly.py](https://github.com/plotly/plotly.py) | Python plotting | Python | MIT | 18,765 (▲2) | Classic | 78 | very active | 2d ago | 12.8y | 8 |
| [plotly/plotly.js](https://github.com/plotly/plotly.js) | Web charting library | JavaScript | MIT | 18,317 (▲7) | Classic | 78 | very active | 1d ago | 10.8y | 6 |
| [Canner/WrenAI](https://github.com/Canner/WrenAI) | BI & dashboard platform | Python | NOASSERTION | 17,507 (▲77) | Mature | 81 | very active | 2d ago | 2.5y | 16 |
| [tradingview/lightweight-charts](https://github.com/tradingview/lightweight-charts) | Low-level / high-performance | TypeScript | Apache-2.0 | 17,186 (▲54) | Classic | 73 | very active | 2d ago | 7.3y | 7 |
| [Kanaries/pygwalker](https://github.com/Kanaries/pygwalker) | Python plotting | Python | Apache-2.0 | 15,957 (▲4) | Classic | 65 | very active | 1d ago | 3.6y | 2 |
| [apexcharts/apexcharts.js](https://github.com/apexcharts/apexcharts.js) | Web charting library | JavaScript | NOASSERTION | 15,149 (▲3) | Classic | 79 | very active | 0d ago | 8.1y | 2 |
| [frappe/charts](https://github.com/frappe/charts) | Web charting library | JavaScript | MIT | 15,077 (▼4) | Abandoned | 5 | stale | 1.2y ago | 8.9y | 0 |
| [visgl/deck.gl](https://github.com/visgl/deck.gl) | Low-level / high-performance | TypeScript | MIT | 14,558 (▲19) | Classic | 84 | very active | 0d ago | 10.7y | 12 |
| [plouc/nivo](https://github.com/plouc/nivo) | React charting library | TypeScript | MIT | 14,091 | Classic | 49 | active | 1mo ago | 10.4y | 4 |
| [antvis/G2](https://github.com/antvis/G2) | Web charting library | TypeScript | MIT | 12,604 (▲6) | Mature | 62 | active | 3d ago | 10.3y | 2 |
| [highcharts/highcharts](https://github.com/highcharts/highcharts) | Web charting library | TypeScript | NOASSERTION | 12,487 (▲4) | Classic | 70 | very active | 1d ago | 16.2y | 9 |
| [keplergl/kepler.gl](https://github.com/keplergl/kepler.gl) | Low-level / high-performance | TypeScript | MIT | 11,996 (▲2) | Classic | 77 | very active | 0d ago | 8.5y | 5 |
| [vega/vega](https://github.com/vega/vega) | Grammar of graphics | JavaScript | BSD-3-Clause | 11,982 (▲3) | Classic | 72 | very active | 3d ago | 13.6y | 14 |
| [perspective-dev/perspective](https://github.com/perspective-dev/perspective) | Low-level / high-performance | Rust | Apache-2.0 | 11,169 (▲21) | Classic | 78 | very active | 1d ago | 8.8y | 4 |
| [lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid) | Diagrams & AI charts | TypeScript | MIT | 11,038 (▲40) | Declining | 35 | slowing | 4mo ago | 7mo | 0 |
| [leeoniya/uPlot](https://github.com/leeoniya/uPlot) | Low-level / high-performance | JavaScript | MIT | 10,475 (▲14) | Mature | 27 | slowing | 4mo ago | 6.9y | 0 |
| [vega/altair](https://github.com/vega/altair) | Grammar of graphics | Python | BSD-3-Clause | 10,468 (▲7) | Classic | 71 | very active | 1d ago | 11.0y | 13 |
| [c3js/c3](https://github.com/c3js/c3) | Web charting library | JavaScript | MIT | 9,349 (▼1) | Classic | 48 | active | 1mo ago | 13.1y | 2 |
| [evidence-dev/evidence](https://github.com/evidence-dev/evidence) | BI & dashboard platform | TypeScript | MIT | 6,911 (▲15) | Classic | 77 | very active | 2d ago | 5.3y | 4 |
| [ScottPlot/ScottPlot](https://github.com/ScottPlot/ScottPlot) | Native / systems charting | C# | MIT | 6,731 (▲5) | Classic | 62 | very active | 21d ago | 8.7y | 8 |
| [holoviz/panel](https://github.com/holoviz/panel) | Python plotting | Python | BSD-3-Clause | 5,769 (▲4) | Classic | 79 | very active | 1d ago | 8.0y | 18 |
| [vega/vega-lite](https://github.com/vega/vega-lite) | Grammar of graphics | TypeScript | BSD-3-Clause | 5,476 (▲10) | Classic | 66 | very active | 3d ago | 11.8y | 6 |
| [observablehq/plot](https://github.com/observablehq/plot) | Web charting library | HTML | ISC | 5,366 (▲4) | Mature | 44 | active | 5d ago | 5.9y | 1 |
| [man-group/dtale](https://github.com/man-group/dtale) | Python plotting | TypeScript | LGPL-2.1 | 5,218 (▲3) | Mature | 41 | active | 1mo ago | 7.2y | 0 |
| [alandefreitas/matplotplusplus](https://github.com/alandefreitas/matplotplusplus) | Native / systems charting | C++ | MIT | 4,924 | Mature | 22 | slowing | 5mo ago | 6.0y | 0 |
| [AAChartModel/AAChartKit](https://github.com/AAChartModel/AAChartKit) | Native / systems charting | Objective-C | MIT | 4,767 | Mature | 30 | slowing | 3mo ago | 9.5y | 0 |
| [has2k1/plotnine](https://github.com/has2k1/plotnine) | Grammar of graphics | Python | MIT | 4,758 (▲1) | Mature | 79 | very active | 2d ago | 9.4y | 1 |
| [tremorlabs/tremor](https://github.com/tremorlabs/tremor) | React charting library | TypeScript | Apache-2.0 | 3,599 (▲9) | Declining | 9 | stale | 11mo ago | 2.4y | 0 |
| [gonum/plot](https://github.com/gonum/plot) | Native / systems charting | Go | BSD-3-Clause | 2,968 (▲1) | Mature | 26 | slowing | 4mo ago | 13.1y | 0 |
| [holoviz/holoviews](https://github.com/holoviz/holoviews) | Python plotting | Python | BSD-3-Clause | 2,909 (▲2) | Classic | 70 | very active | 2d ago | 12.3y | 8 |
| [rilldata/rill](https://github.com/rilldata/rill) | BI & dashboard platform | Go | Apache-2.0 | 2,867 (▲14) | Classic | 84 | very active | 1d ago | 4.7y | 12 |
| [core-plot/core-plot](https://github.com/core-plot/core-plot) | Native / systems charting | Objective-C | BSD-3-Clause | 2,760 (▼2) | Mature | 28 | slowing | 4mo ago | 12.7y | 0 |
| [posit-dev/great-tables](https://github.com/posit-dev/great-tables) | Python plotting | Python | MIT | 2,726 (▲2) | Classic | 73 | very active | 13d ago | 4.3y | 2 |
| [weaveworks/grafanalib](https://github.com/weaveworks/grafanalib) | Dashboards as code | Python | Apache-2.0 | 1,973 (▲1) | Declining | 14 | stale | 9mo ago | 9.8y | 0 |
| [reflex-dev/xy](https://github.com/reflex-dev/xy) | Python plotting | Python | Apache-2.0 | 1,825 (▲18) | Hot | 74 | very active | 3d ago | 1mo | 11 |
| [JetBrains/lets-plot](https://github.com/JetBrains/lets-plot) | Grammar of graphics | Kotlin | MIT | 1,779 (▲1) | Classic | 70 | slowing | 2mo ago | 7.5y | 5 |
| [K-Phoen/grabana](https://github.com/K-Phoen/grabana) | Dashboards as code | Go | MIT | 728 | Abandoned | 6 | stale | 1.3y ago | 6.6y | 0 |
| [hustcc/mcp-mermaid](https://github.com/hustcc/mcp-mermaid) | Diagrams & AI charts | TypeScript | MIT | 629 (▲3) | Declining | 40 | slowing | 3mo ago | 1.3y | 0 |
| [grafana/grafana-foundation-sdk](https://github.com/grafana/grafana-foundation-sdk) | Dashboards as code | PHP | Apache-2.0 | 256 | Mature | 56 | very active | 0d ago | 2.8y | 5 |
| [deliveryhero/grafyaml](https://github.com/deliveryhero/grafyaml) | Dashboards as code | Python | Apache-2.0 | 44 | Mature | 50 | active | 20d ago | 6.1y | 3 |
...
- **[chartjs/Chart.js](https://github.com/chartjs/Chart.js)** · 67,682★ · JavaScript · Mature  
...
- **[apache/echarts](https://github.com/apache/echarts)** · 67,251★ · TypeScript · Classic  
...
- **[plotly/plotly.js](https://github.com/plotly/plotly.js)** · 18,317★ · JavaScript · Classic  
...
- **[apexcharts/apexcharts.js](https://github.com/apexcharts/apexcharts.js)** · 15,149★ · JavaScript · Classic  
...
- **[frappe/charts](https://github.com/frappe/charts)** · 15,077★ · JavaScript · Abandoned  
...
- **[antvis/G2](https://github.com/antvis/G2)** · 12,604★ · TypeScript · Mature  
...
- **[highcharts/highcharts](https://github.com/highcharts/highcharts)** · 12,487★ · TypeScript · Classic  
...
- **[observablehq/plot](https://github.com/observablehq/plot)** · 5,366★ · HTML · Mature  
...
- **[recharts/recharts](https://github.com/recharts/recharts)** · 27,545★ · TypeScript · Classic  
...
- **[airbnb/visx](https://github.com/airbnb/visx)** · 21,034★ · TypeScript · Classic  
...
- **[plouc/nivo](https://github.com/plouc/nivo)** · 14,091★ · TypeScript · Classic  
...
- **[tremorlabs/tremor](https://github.com/tremorlabs/tremor)** · 3,599★ · TypeScript · Declining  
...
- **[d3/d3](https://github.com/d3/d3)** · 113,651★ · Shell · Mature  
...
- **[tradingview/lightweight-charts](https://github.com/tradingview/lightweight-charts)** · 17,186★ · TypeScript · Classic  
...
- **[visgl/deck.gl](https://github.com/visgl/deck.gl)** · 14,558★ · TypeScript · Classic  
...
- **[keplergl/kepler.gl](https://github.com/keplergl/kepler.gl)** · 11,996★ · TypeScript · Classic  
...
- **[perspective-dev/perspective](https://github.com/perspective-dev/perspective)** · 11,169★ · Rust · Classic  
...
- **[leeoniya/uPlot](https://github.com/leeoniya/uPlot)** · 10,475★ · JavaScript · Mature  
...
- **[vega/vega](https://github.com/vega/vega)** · 11,982★ · JavaScript · Classic  
...
- **[vega/altair](https://github.com/vega/altair)** · 10,468★ · Python · Classic  
  The Python API over Vega-Lite — statistical charts as method chains on a DataFrame.  
  <sub>topics: —</sub>
- **[vega/vega-lite](https://github.com/vega/vega-lite)** · 5,476★ · TypeScript · Classic  
...
- **[has2k1/plotnine](https://github.com/has2k1/plotnine)** · 4,758★ · Python · Mature  
...
- **[matplotlib/matplotlib](https://github.com/matplotlib/matplotlib)** · 23,169★ · Python · Classic  
...
- **[bokeh/bokeh](https://github.com/bokeh/bokeh)** · 20,445★ · Python · Classic  
...
- **[plotly/plotly.py](https://github.com/plotly/plotly.py)** · 18,765★ · Python · Classic  
...
- **[Kanaries/pygwalker](https://github.com/Kanaries/pygwalker)** · 15,957★ · Python · Classic  
...
- **[holoviz/panel](https://github.com/holoviz/panel)** · 5,769★ · Python · Classic  
...
- **[man-group/dtale](https://github.com/man-group/dtale)** · 5,218★ · TypeScript · Mature  
...
- **[holoviz/holoviews](https://github.com/holoviz/holoviews)** · 2,909★ · Python · Classic  
...
- **[posit-dev/great-tables](https://github.com/posit-dev/great-tables)** · 2,726★ · Python · Classic  
...
- **[reflex-dev/xy](https://github.com/reflex-dev/xy)** · 1,825★ · Python · Hot  
...
- **[grafana/grafana](https://github.com/grafana/grafana)** · 76,616★ · TypeScript · Classic  
...
- **[apache/superset](https://github.com/apache/superset)** · 74,662★ · Python · Classic  
...
- **[metabase/metabase](https://github.com/metabase/metabase)** · 49,102★ · Clojure · Classic  
...
- **[ToolJet/ToolJet](https://github.com/ToolJet/ToolJet)** · 40,849★ · JavaScript · Classic  
...
- **[getredash/redash](https://github.com/getredash/redash)** · 28,781★ · Python · Classic  
...
- **[openobserve/openobserve](https://github.com/openobserve/openobserve)** · 21,660★ · TypeScript · Classic  
...
- **[elastic/kibana](https://github.com/elastic/kibana)** · 21,283★ · TypeScript · Classic  
...
- **[Canner/WrenAI](https://github.com/Canner/WrenAI)** · 17,507★ · Python · Mature  
...
- **[evidence-dev/evidence](https://github.com/evidence-dev/evidence)** · 6,911★ · TypeScript · Classic  
...
- **[rilldata/rill](https://github.com/rilldata/rill)** · 2,867★ · Go · Classic  
...
- **[streamlit/streamlit](https://github.com/streamlit/streamlit)** · 45,699★ · Python · Classic  
...
- **[gradio-app/gradio](https://github.com/gradio-app/gradio)** · 43,481★ · Python · Classic  
...
- **[reflex-dev/reflex](https://github.com/reflex-dev/reflex)** · 28,880★ · Python · Classic  
...
- **[plotly/dash](https://github.com/plotly/dash)** · 24,399★ · Python · Classic  
...
- **[weaveworks/grafanalib](https://github.com/weaveworks/grafanalib)** · 1,973★ · Python · Declining  
...
- **[grafana/grafana-foundation-sdk](https://github.com/grafana/grafana-foundation-sdk)** · 256★ · PHP · Mature  
...
- **[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw)** · 131,226★ · TypeScript · Classic  
...
- **[jgraph/drawio-desktop](https://github.com/jgraph/drawio-desktop)** · 62,955★ · JavaScript · Classic  
...
- **[lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid)** · 11,038★ · TypeScript · Declining  
  A polished renderer for Mermaid diagrams — Mermaid's text-to-diagram syntax with far better typography and theming.  
  <sub>topics: —</sub>
- **[hustcc/mcp-mermaid](https://github.com/hustcc/mcp-mermaid)** · 629★ · TypeScript · Declining  
...
- **[ScottPlot/ScottPlot](https://github.com/ScottPlot/ScottPlot)** · 6,731★ · C# · Classic  
...
- **[alandefreitas/matplotplusplus](https://github.com/alandefreitas/matplotplusplus)** · 4,924★ · C++ · Mature  
...
- **[gonum/plot](https://github.com/gonum/plot)** · 2,968★ · Go · Mature  
  ...
  <sub>topics: —</sub>
- **[core-plot/core-plot](https://github.com/core-plot/core-plot)** · 2,760★ · Objective-C · Mature  
...
**Community clustering.** These 61 tools span **10 of the graph's 38 communities** — a wide spread, because charting cuts across the frontend, Python-data, and observability clusters rather than forming one of its own.

- **Community 1** (23): `plotly/plotly.js`, `apexcharts/apexcharts.js`, `observablehq/plot`, `airbnb/visx`, `d3/d3`, `leeoniya/uPlot`, `has2k1/plotnine`, `matplotlib/matplotlib`, `plotly/plotly.py`, `bokeh/bokeh`, `holoviz/holoviews`, `holoviz/panel`, `Kanaries/pygwalker`, `man-group/dtale`, `reflex-dev/xy`, `streamlit/streamlit`, `gradio-app/gradio`, `plotly/dash`, `reflex-dev/reflex`, `Avaiga/taipy`, `ScottPlot/ScottPlot`, `AAChartModel/AAChartKit`, `alandefreitas/matplotplusplus`
- **Community 0** (12): `apache/echarts`, `chartjs/Chart.js`, `c3js/c3`, `frappe/charts`, `plouc/nivo`, `tradingview/lightweight-charts`, `vega/vega-lite`, `vega/vega`, `vega/altair`, `apache/superset`, `ToolJet/ToolJet`, `deliveryhero/grafyaml`
- **Community 8** (8): `highcharts/highcharts`, `antvis/G2`, `perspective-dev/perspective`, `visgl/deck.gl`, `keplergl/kepler.gl`, `JetBrains/lets-plot`, `excalidraw/excalidraw`, `core-plot/core-plot`
- **Community 22** (7): `grafana/grafana`, `elastic/kibana`, `openobserve/openobserve`, `evidence-dev/evidence`, `grafana/grafana-foundation-sdk`, `weaveworks/grafanalib`, `K-Phoen/grabana`
- **Community 10** (5): `metabase/metabase`, `getredash/redash`, `rilldata/rill`, `Canner/WrenAI`, `jgraph/drawio-desktop`
- **Community 24** (2): `recharts/recharts`, `tremorlabs/tremor`

**Centrality (PageRank in the full 2,022-repo graph)** — most 'hub-like' visualization tools in your ecosystem:

- `c3js/c3` — PageRank 0.0016
- `streamlit/streamlit` — PageRank 0.0014
- `apache/echarts` — PageRank 0.0013
- `reflex-dev/xy` — PageRank 0.0011
- `antvis/G2` — PageRank 0.0011
- `observablehq/plot` — PageRank 0.0009
- `plotly/plotly.js` — PageRank 0.0008
- `plotly/dash` — PageRank 0.0008
- `d3/d3` — PageRank 0.0008
...
- `reflex-dev/xy` ⇄ `reflex-dev/reflex` (w=1.564) — topics: data-analysis, data-science, data-visualization, python; authors: Alek99, masenf, FarhanAliRaza
...
- `holoviz/panel` ⇄ `holoviz/holoviews` (w=1.047) — topics: holoviz, holoviews; authors: hoxbro, Kkkakania, Azaya89
- `plotly/dash` ⇄ `plotly/plotly.js` (w=0.958) — topics: plotly, data-visualization, plotly-dash; authors: camdecoster, dependabot[bot]
- `observablehq/plot` ⇄ `d3/d3` (w=0.833) — topics: visualization, data-visualization, charts, d3
- `plotly/dash` ⇄ `plotly/plotly.py` (w=0.787) — topics: plotly, python, plotly-dash; authors: camdecoster
- `vega/altair` ⇄ `vega/vega-lite` (w=0.735) — authors: joelostblom, dependabot[bot]
- `apache/superset` ⇄ `apache/echarts` (w=0.696) — topics: apache, data-visualization, data-viz; authors: dependabot[bot]
- `vega/altair` ⇄ `vega/vega` (w=0.660) — authors: joelostblom, dependabot[bot]
- `grafana/grafana-foundation-sdk` ⇄ `grafana/grafana` (w=0.639) — topics: grafana, metrics; authors: github-actions[bot]
...
- `plotly/plotly.js` ⇄ `apache/echarts` (w=0.536) — topics: data-visualization, charting-library, charts, visualization; authors: dependabot[bot]
- `keplergl/kepler.gl` ⇄ `visgl/deck.gl` (w=0.517) — topics: data-visualization, visualization; authors: dependabot[bot], ibgreen
- …and 92 more.
...
|---|---|---|---|---|---|---|
| grafana/grafana | 99 | Classic | very active | 14 | 11% | 644 |
| metabase/metabase | 99 | Classic | very active | 9 | 12% | 833 |
| elastic/kibana | 99 | Classic | very active | 13 | 11% | 265 |
| matplotlib/matplotlib | 93 | Classic | very active | 4 | 20% | 102 |
| openobserve/openobserve | 89 | Classic | very active | 3 | 23% | 220 |
| apache/superset | 85 | Classic | very active | 2 | 41% | 268 |
| gradio-app/gradio | 85 | Classic | very active | 2 | 44% | 5095 |
| recharts/recharts | 84 | Classic | very active | 2 | 46% | 93 |
| visgl/deck.gl | 84 | Classic | very active | 2 | 38% | 313 |
| rilldata/rill | 84 | Classic | very active | 2 | 34% | 331 |
| ToolJet/ToolJet | 84 | Classic | very active | 2 | 43% | 611 |
| reflex-dev/reflex | 84 | Classic | very active | 2 | 46% | 270 |
| streamlit/streamlit | 83 | Classic | very active | 2 | 47% | 127 |
| Canner/WrenAI | 81 | Mature | very active | 2 | 32% | 200 |
| apexcharts/apexcharts.js | 79 | Classic | very active | 1 | 95% | 156 |
| has2k1/plotnine | 79 | Mature | very active | 1 | 100% | 40 |
| holoviz/panel | 79 | Classic | very active | 2 | 32% | 102 |
| plotly/plotly.js | 78 | Classic | very active | 1 | 63% | 278 |
| perspective-dev/perspective | 78 | Classic | very active | 1 | 96% | 64 |
| plotly/plotly.py | 78 | Classic | very active | 1 | 51% | 108 |
| plotly/dash | 78 | Classic | very active | 1 | 70% | 109 |
| jgraph/drawio-desktop | 78 | Classic | very active | 1 | 78% | 190 |
| keplergl/kepler.gl | 77 | Classic | very active | 1 | 83% | 60 |
| evidence-dev/evidence | 77 | Classic | very active | 2 | 48% | 949 |
| reflex-dev/xy | 74 | Hot | very active | 1 | 52% | 15 |
| tradingview/lightweight-charts | 73 | Classic | very active | 2 | 42% | 48 |
| posit-dev/great-tables | 73 | Classic | very active | 1 | 99% | 36 |
| vega/vega | 72 | Classic | very active | 1 | 50% | 154 |
| vega/altair | 71 | Classic | very active | 2 | 48% | 36 |
| highcharts/highcharts | 70 | Classic | very active | 2 | 36% | 0 |
| JetBrains/lets-plot | 70 | Classic | slowing | 2 | 34% | 109 |
| holoviz/holoviews | 70 | Classic | very active | 1 | 57% | 90 |
| bokeh/bokeh | 69 | Classic | very active | 2 | 46% | 0 |
| vega/vega-lite | 66 | Classic | very active | 1 | 54% | 214 |
| Kanaries/pygwalker | 65 | Classic | very active | 1 | 98% | 66 |
| apache/echarts | 64 | Classic | active | 2 | 47% | 125 |
| getredash/redash | 64 | Classic | active | 3 | 27% | 101 |
| antvis/G2 | 62 | Mature | active | 1 | 50% | 155 |
| ScottPlot/ScottPlot | 62 | Classic | very active | 1 | 59% | 179 |
| excalidraw/excalidraw | 59 | Classic | very active | 1 | 51% | 15 |
| grafana/grafana-foundation-sdk | 56 | Mature | very active | 1 | 67% | 0 |
| airbnb/visx | 53 | Classic | slowing | 1 | 50% | 107 |
| Avaiga/taipy | 51 | Mature | active | 0 | 0% | 127 |
| deliveryhero/grafyaml | 50 | Mature | active | 1 | 50% | 8 |
| plouc/nivo | 49 | Classic | active | 1 | 50% | 65 |
| c3js/c3 | 48 | Classic | active | 1 | 67% | 94 |
| observablehq/plot | 44 | Mature | active | 1 | 100% | 39 |
| man-group/dtale | 41 | Mature | active | 0 | 0% | 183 |
| hustcc/mcp-mermaid | 40 | Declining | slowing | 0 | 0% | 6 |
| lukilabs/beautiful-mermaid | 35 | Declining | slowing | 0 | 0% | 6 |
| chartjs/Chart.js | 33 | Mature | slowing | 0 | 0% | 117 |
| d3/d3 | 32 | Mature | slowing | 0 | 0% | 194 |
| AAChartModel/AAChartKit | 30 | Mature | slowing | 0 | 0% | 18 |
| core-plot/core-plot | 28 | Mature | slowing | 0 | 0% | 19 |
| leeoniya/uPlot | 27 | Mature | slowing | 0 | 0% | 63 |
| gonum/plot | 26 | Mature | slowing | 0 | 0% | 8 |
| alandefreitas/matplotplusplus | 22 | Mature | slowing | 0 | 0% | 6 |
| weaveworks/grafanalib | 14 | Declining | stale | 0 | 0% | 16 |
...
- **prometheus/prometheus** (65,960★) — a time-series *database* and the data source behind most Grafana panels — storage, not charting
- **plausible/analytics** (28,900★) — a fixed-purpose web-analytics product; its dashboard isn't reusable for your own data
- **bluewave-labs/Checkmate** (10,795★) — uptime/infrastructure monitoring with built-in status charts — a monitoring product, not a charting tool
- **voxel51/fiftyone** (11,059★) — visualizes *datasets and model predictions* for computer vision — a data-curation app, not a chart library
- **jessevig/bertviz** (8,170★) — visualizes transformer attention specifically — a model-interpretability tool
- **OpenSpace/OpenSpace** (1,246★) — astrovisualization of space data — scientific rendering, not general charting
- **originalankur/maptoposter** (14,083★) — turns city maps into poster art — cartographic design, not data visualization
- **unhappychoice/gitlogue** (4,962★) — animated replay of git history in the terminal — a novelty visualizer
- **patoles/agent-flow** (1,625★) — real-time visualization of agent orchestration — see the *Agent orchestration* report
- **vivekchand/clawmetry** (406★) — agent-runtime observability dashboards — routed to the agent reports
- **williamngan/pts** (5,341★) — creative-coding and generative visuals rather than charts; reads as abandoned in this snapshot
- **GraphiteEditor/Graphite** (27,134★) — a 2D vector graphics editor — design tooling, not data charting
- **mosra/magnum** (5,205★) — C++ graphics middleware used *for* visualization, but a rendering engine at heart
...
<sub>Tools covered: 61 · Snapshot: 2026-09-06T08:24:34.321Z</sub>
