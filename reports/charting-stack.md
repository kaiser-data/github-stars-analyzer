...
> Derived from **kaiser-data**'s 1,596 starred repos (snapshot `2026-08-11T18:59:16.380Z`), cross-referenced with the repo-similarity graph (1,596 nodes / 5,170 edges, 31 communities). The advantages/disadvantages column is editorial judgement grounded in the dataset's own health metrics plus external comparisons — see Methodology.
>
> Generated 2026-08-11 by `scripts/reports/charting_stack.py` (regenerate any time — no API cost).
...
- **61 charting and visualization tools** in your stars (**1,322,435★** combined), grouped into 10 layers:
  ...
  - **BI & dashboard platform** (10): `grafana`, `superset`, `metabase`, `ToolJet`, `redash`, `kibana`, `openobserve`, `WrenAI`, `evidence`, `rill`
...
|---|---|---|---|---|---|---|---|---|---|---|
| [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | Diagrams & AI charts | TypeScript | MIT | 129,346 | Classic | 60 | very active | 0d ago | 6.6y | 17 |
| [d3/d3](https://github.com/d3/d3) | Low-level / high-performance | Shell | ISC | 113,436 | Mature | 40 | slowing | 2mo ago | 15.9y | 1 |
| [grafana/grafana](https://github.com/grafana/grafana) | BI & dashboard platform | TypeScript | AGPL-3.0 | 76,153 | Classic | 99 | very active | 4d ago | 12.7y | 54 |
| [apache/superset](https://github.com/apache/superset) | BI & dashboard platform | Python | Apache-2.0 | 74,220 | Classic | 85 | very active | 0d ago | 11.1y | 33 |
| [chartjs/Chart.js](https://github.com/chartjs/Chart.js) | Web charting library | JavaScript | MIT | 67,634 | Mature | 41 | slowing | 2mo ago | 13.4y | 1 |
| [apache/echarts](https://github.com/apache/echarts) | Web charting library | TypeScript | Apache-2.0 | 67,048 | Classic | 65 | active | 7d ago | 13.4y | 5 |
| [jgraph/drawio-desktop](https://github.com/jgraph/drawio-desktop) | Diagrams & AI charts | JavaScript | Apache-2.0 | 62,495 | Classic | 78 | very active | 4d ago | 9.2y | 3 |
| [metabase/metabase](https://github.com/metabase/metabase) | BI & dashboard platform | Clojure | NOASSERTION | 48,666 | Classic | 99 | very active | 0d ago | 11.5y | 31 |
| [streamlit/streamlit](https://github.com/streamlit/streamlit) | Data-app framework | Python | Apache-2.0 | 45,512 | Classic | 83 | very active | 4d ago | 7.0y | 9 |
| [gradio-app/gradio](https://github.com/gradio-app/gradio) | Data-app framework | Python | Apache-2.0 | 43,311 | Classic | 84 | very active | 4d ago | 7.6y | 7 |
| [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) | BI & dashboard platform | JavaScript | AGPL-3.0 | 38,304 | Classic | 94 | very active | 4d ago | 5.4y | 19 |
| [reflex-dev/reflex](https://github.com/reflex-dev/reflex) | Data-app framework | Python | Apache-2.0 | 28,791 | Classic | 94 | very active | 4d ago | 3.8y | 15 |
| [getredash/redash](https://github.com/getredash/redash) | BI & dashboard platform | Python | BSD-2-Clause | 28,739 | Classic | 63 | active | 1d ago | 12.8y | 7 |
| [recharts/recharts](https://github.com/recharts/recharts) | React charting library | TypeScript | MIT | 27,490 | Classic | 84 | very active | 1d ago | 11.0y | 21 |
| [plotly/dash](https://github.com/plotly/dash) | Data-app framework | Python | MIT | 24,373 | Classic | 78 | very active | 0d ago | 11.3y | 7 |
| [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) | Python plotting | Python | — | 23,073 | Classic | 89 | very active | 1d ago | 15.5y | 27 |
| [elastic/kibana](https://github.com/elastic/kibana) | BI & dashboard platform | TypeScript | NOASSERTION | 21,230 | Classic | 98 | very active | 4d ago | 13.6y | 64 |
| [airbnb/visx](https://github.com/airbnb/visx) | React charting library | TypeScript | MIT | 21,000 | Classic | 55 | active | 1mo ago | 9.4y | 3 |
| [openobserve/openobserve](https://github.com/openobserve/openobserve) | BI & dashboard platform | TypeScript | AGPL-3.0 | 20,592 | Classic | 98 | very active | 4d ago | 3.5y | 18 |
| [bokeh/bokeh](https://github.com/bokeh/bokeh) | Python plotting | TypeScript | BSD-3-Clause | 20,428 | Classic | 73 | very active | 0d ago | 14.4y | 18 |
| [Avaiga/taipy](https://github.com/Avaiga/taipy) | Data-app framework | Python | Apache-2.0 | 19,397 | Mature | 53 | active | 6d ago | 4.5y | 0 |
| [plotly/plotly.py](https://github.com/plotly/plotly.py) | Python plotting | Python | MIT | 18,731 | Classic | 81 | very active | 4d ago | 12.7y | 13 |
| [plotly/plotly.js](https://github.com/plotly/plotly.js) | Web charting library | JavaScript | MIT | 18,282 | Classic | 78 | very active | 2d ago | 10.8y | 13 |
| [Canner/WrenAI](https://github.com/Canner/WrenAI) | BI & dashboard platform | Python | NOASSERTION | 17,179 | Mature | 80 | very active | 4d ago | 2.4y | 11 |
| [tradingview/lightweight-charts](https://github.com/tradingview/lightweight-charts) | Low-level / high-performance | TypeScript | Apache-2.0 | 16,931 | Classic | 62 | very active | 6d ago | 7.2y | 7 |
| [Kanaries/pygwalker](https://github.com/Kanaries/pygwalker) | Python plotting | Python | Apache-2.0 | 15,932 | Classic | 65 | very active | 1d ago | 3.5y | 2 |
| [apexcharts/apexcharts.js](https://github.com/apexcharts/apexcharts.js) | Web charting library | JavaScript | NOASSERTION | 15,123 | Classic | 79 | very active | 1d ago | 8.1y | 7 |
| [frappe/charts](https://github.com/frappe/charts) | Web charting library | JavaScript | MIT | 15,088 | Abandoned | 5 | stale | 1.1y ago | 8.8y | 0 |
| [visgl/deck.gl](https://github.com/visgl/deck.gl) | Low-level / high-performance | TypeScript | MIT | 14,364 | Classic | 88 | very active | 0d ago | 10.7y | 17 |
| [plouc/nivo](https://github.com/plouc/nivo) | React charting library | TypeScript | MIT | 14,082 | Classic | 51 | active | 22d ago | 10.3y | 4 |
| [antvis/G2](https://github.com/antvis/G2) | Web charting library | TypeScript | MIT | 12,581 | Mature | 62 | active | 28d ago | 10.2y | 3 |
| [highcharts/highcharts](https://github.com/highcharts/highcharts) | Web charting library | TypeScript | NOASSERTION | 12,479 | Classic | 70 | very active | 0d ago | 16.2y | 6 |
| [keplergl/kepler.gl](https://github.com/keplergl/kepler.gl) | Low-level / high-performance | TypeScript | MIT | 11,959 | Classic | 82 | very active | 0d ago | 8.5y | 5 |
| [vega/vega](https://github.com/vega/vega) | Grammar of graphics | JavaScript | BSD-3-Clause | 11,953 | Classic | 69 | very active | 1d ago | 13.5y | 10 |
| [perspective-dev/perspective](https://github.com/perspective-dev/perspective) | Low-level / high-performance | Rust | Apache-2.0 | 11,099 | Classic | 76 | very active | 1d ago | 8.8y | 2 |
| [lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid) | Diagrams & AI charts | TypeScript | MIT | 10,809 | Declining | 37 | slowing | 3mo ago | 6mo | 0 |
| [vega/altair](https://github.com/vega/altair) | Grammar of graphics | Python | BSD-3-Clause | 10,450 | Classic | 71 | very active | 2d ago | 10.9y | 15 |
| [leeoniya/uPlot](https://github.com/leeoniya/uPlot) | Low-level / high-performance | JavaScript | MIT | 10,400 | Mature | 29 | slowing | 3mo ago | 6.9y | 0 |
| [c3js/c3](https://github.com/c3js/c3) | Web charting library | JavaScript | MIT | 9,347 | Classic | 51 | active | 6d ago | 13.1y | 2 |
| [evidence-dev/evidence](https://github.com/evidence-dev/evidence) | BI & dashboard platform | JavaScript | MIT | 6,838 | Mature | 38 | slowing | 5mo ago | 5.2y | 0 |
| [ScottPlot/ScottPlot](https://github.com/ScottPlot/ScottPlot) | Native / systems charting | C# | MIT | 6,696 | Classic | 61 | active | 1mo ago | 8.6y | 8 |
| [holoviz/panel](https://github.com/holoviz/panel) | Python plotting | Python | BSD-3-Clause | 5,731 | Classic | 80 | very active | 0d ago | 8.0y | 16 |
| [vega/vega-lite](https://github.com/vega/vega-lite) | Grammar of graphics | TypeScript | BSD-3-Clause | 5,444 | Classic | 66 | very active | 2d ago | 11.7y | 7 |
| [observablehq/plot](https://github.com/observablehq/plot) | Web charting library | HTML | ISC | 5,348 | Mature | 42 | active | 29d ago | 5.8y | 1 |
| [man-group/dtale](https://github.com/man-group/dtale) | Python plotting | TypeScript | LGPL-2.1 | 5,213 | Mature | 43 | active | 19d ago | 7.1y | 0 |
| [alandefreitas/matplotplusplus](https://github.com/alandefreitas/matplotplusplus) | Native / systems charting | C++ | MIT | 4,914 | Mature | 24 | slowing | 4mo ago | 6.0y | 0 |
| [AAChartModel/AAChartKit](https://github.com/AAChartModel/AAChartKit) | Native / systems charting | Objective-C | MIT | 4,766 | Mature | 32 | slowing | 3mo ago | 9.4y | 0 |
| [has2k1/plotnine](https://github.com/has2k1/plotnine) | Grammar of graphics | Python | MIT | 4,753 | Classic | 75 | very active | 27d ago | 9.3y | 7 |
| [tremorlabs/tremor](https://github.com/tremorlabs/tremor) | React charting library | TypeScript | Apache-2.0 | 3,560 | Declining | 12 | stale | 10mo ago | 2.4y | 0 |
| [gonum/plot](https://github.com/gonum/plot) | Native / systems charting | Go | BSD-3-Clause | 2,963 | Mature | 29 | slowing | 3mo ago | 13.1y | 0 |
| [holoviz/holoviews](https://github.com/holoviz/holoviews) | Python plotting | Python | BSD-3-Clause | 2,901 | Classic | 68 | very active | 0d ago | 12.3y | 13 |
| [rilldata/rill](https://github.com/rilldata/rill) | BI & dashboard platform | Go | Apache-2.0 | 2,803 | Classic | 84 | very active | 0d ago | 4.7y | 11 |
| [core-plot/core-plot](https://github.com/core-plot/core-plot) | Native / systems charting | Objective-C | BSD-3-Clause | 2,762 | Mature | 31 | slowing | 3mo ago | 12.6y | 0 |
| [posit-dev/great-tables](https://github.com/posit-dev/great-tables) | Python plotting | Python | MIT | 2,714 | Classic | 72 | very active | 6d ago | 4.3y | 2 |
| [weaveworks/grafanalib](https://github.com/weaveworks/grafanalib) | Dashboards as code | Python | Apache-2.0 | 1,971 | Declining | 16 | stale | 8mo ago | 9.7y | 0 |
| [JetBrains/lets-plot](https://github.com/JetBrains/lets-plot) | Grammar of graphics | Kotlin | MIT | 1,779 | Classic | 77 | active | 1mo ago | 7.4y | 6 |
| [reflex-dev/xy](https://github.com/reflex-dev/xy) | Python plotting | Python | Apache-2.0 | 1,610 | Hot | 74 | very active | 4d ago | 1mo | 10 |
| [K-Phoen/grabana](https://github.com/K-Phoen/grabana) | Dashboards as code | Go | MIT | 729 | Abandoned | 6 | stale | 1.2y ago | 6.5y | 0 |
| [hustcc/mcp-mermaid](https://github.com/hustcc/mcp-mermaid) | Diagrams & AI charts | TypeScript | MIT | 621 | Declining | 49 | slowing | 2mo ago | 1.2y | 1 |
| [grafana/grafana-foundation-sdk](https://github.com/grafana/grafana-foundation-sdk) | Dashboards as code | PHP | Apache-2.0 | 248 | Mature | 65 | very active | 4d ago | 2.7y | 5 |
| [deliveryhero/grafyaml](https://github.com/deliveryhero/grafyaml) | Dashboards as code | Python | Apache-2.0 | 44 | Mature | 47 | active | 1mo ago | 6.0y | 3 |
...
- **[chartjs/Chart.js](https://github.com/chartjs/Chart.js)** · 67,634★ · JavaScript · Mature  
...
- **[apache/echarts](https://github.com/apache/echarts)** · 67,048★ · TypeScript · Classic  
...
- **[plotly/plotly.js](https://github.com/plotly/plotly.js)** · 18,282★ · JavaScript · Classic  
...
- **[apexcharts/apexcharts.js](https://github.com/apexcharts/apexcharts.js)** · 15,123★ · JavaScript · Classic  
...
- **[frappe/charts](https://github.com/frappe/charts)** · 15,088★ · JavaScript · Abandoned  
...
- **[antvis/G2](https://github.com/antvis/G2)** · 12,581★ · TypeScript · Mature  
...
- **[highcharts/highcharts](https://github.com/highcharts/highcharts)** · 12,479★ · TypeScript · Classic  
  ...
  <sub>topics: —</sub>
- **[c3js/c3](https://github.com/c3js/c3)** · 9,347★ · JavaScript · Classic  
...
- **[observablehq/plot](https://github.com/observablehq/plot)** · 5,348★ · HTML · Mature  
...
- **[recharts/recharts](https://github.com/recharts/recharts)** · 27,490★ · TypeScript · Classic  
...
- **[airbnb/visx](https://github.com/airbnb/visx)** · 21,000★ · TypeScript · Classic  
...
- **[plouc/nivo](https://github.com/plouc/nivo)** · 14,082★ · TypeScript · Classic  
...
- **[tremorlabs/tremor](https://github.com/tremorlabs/tremor)** · 3,560★ · TypeScript · Declining  
...
- **[d3/d3](https://github.com/d3/d3)** · 113,436★ · Shell · Mature  
...
- **[tradingview/lightweight-charts](https://github.com/tradingview/lightweight-charts)** · 16,931★ · TypeScript · Classic  
...
- **[visgl/deck.gl](https://github.com/visgl/deck.gl)** · 14,364★ · TypeScript · Classic  
...
- **[keplergl/kepler.gl](https://github.com/keplergl/kepler.gl)** · 11,959★ · TypeScript · Classic  
...
- **[perspective-dev/perspective](https://github.com/perspective-dev/perspective)** · 11,099★ · Rust · Classic  
...
- **[leeoniya/uPlot](https://github.com/leeoniya/uPlot)** · 10,400★ · JavaScript · Mature  
...
- **[vega/vega](https://github.com/vega/vega)** · 11,953★ · JavaScript · Classic  
...
- **[vega/altair](https://github.com/vega/altair)** · 10,450★ · Python · Classic  
  The Python API over Vega-Lite — statistical charts as method chains on a DataFrame.  
  <sub>topics: —</sub>
- **[vega/vega-lite](https://github.com/vega/vega-lite)** · 5,444★ · TypeScript · Classic  
...
- **[has2k1/plotnine](https://github.com/has2k1/plotnine)** · 4,753★ · Python · Classic  
...
- **[JetBrains/lets-plot](https://github.com/JetBrains/lets-plot)** · 1,779★ · Kotlin · Classic  
...
- **[matplotlib/matplotlib](https://github.com/matplotlib/matplotlib)** · 23,073★ · Python · Classic  
...
- **[bokeh/bokeh](https://github.com/bokeh/bokeh)** · 20,428★ · TypeScript · Classic  
...
- **[plotly/plotly.py](https://github.com/plotly/plotly.py)** · 18,731★ · Python · Classic  
...
- **[Kanaries/pygwalker](https://github.com/Kanaries/pygwalker)** · 15,932★ · Python · Classic  
...
- **[holoviz/panel](https://github.com/holoviz/panel)** · 5,731★ · Python · Classic  
...
- **[man-group/dtale](https://github.com/man-group/dtale)** · 5,213★ · TypeScript · Mature  
...
- **[holoviz/holoviews](https://github.com/holoviz/holoviews)** · 2,901★ · Python · Classic  
...
- **[posit-dev/great-tables](https://github.com/posit-dev/great-tables)** · 2,714★ · Python · Classic  
...
- **[reflex-dev/xy](https://github.com/reflex-dev/xy)** · 1,610★ · Python · Hot  
...
- **[grafana/grafana](https://github.com/grafana/grafana)** · 76,153★ · TypeScript · Classic  
...
- **[apache/superset](https://github.com/apache/superset)** · 74,220★ · Python · Classic  
...
- **[metabase/metabase](https://github.com/metabase/metabase)** · 48,666★ · Clojure · Classic  
...
- **[ToolJet/ToolJet](https://github.com/ToolJet/ToolJet)** · 38,304★ · JavaScript · Classic  
...
- **[getredash/redash](https://github.com/getredash/redash)** · 28,739★ · Python · Classic  
...
- **[elastic/kibana](https://github.com/elastic/kibana)** · 21,230★ · TypeScript · Classic  
...
- **[openobserve/openobserve](https://github.com/openobserve/openobserve)** · 20,592★ · TypeScript · Classic  
...
- **[Canner/WrenAI](https://github.com/Canner/WrenAI)** · 17,179★ · Python · Mature  
...
- **[evidence-dev/evidence](https://github.com/evidence-dev/evidence)** · 6,838★ · JavaScript · Mature  
...
- **[rilldata/rill](https://github.com/rilldata/rill)** · 2,803★ · Go · Classic  
...
- **[streamlit/streamlit](https://github.com/streamlit/streamlit)** · 45,512★ · Python · Classic  
...
- **[gradio-app/gradio](https://github.com/gradio-app/gradio)** · 43,311★ · Python · Classic  
...
- **[reflex-dev/reflex](https://github.com/reflex-dev/reflex)** · 28,791★ · Python · Classic  
...
- **[plotly/dash](https://github.com/plotly/dash)** · 24,373★ · Python · Classic  
...
- **[Avaiga/taipy](https://github.com/Avaiga/taipy)** · 19,397★ · Python · Mature  
...
- **[K-Phoen/grabana](https://github.com/K-Phoen/grabana)** · 729★ · Go · Abandoned  
...
- **[grafana/grafana-foundation-sdk](https://github.com/grafana/grafana-foundation-sdk)** · 248★ · PHP · Mature  
...
- **[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw)** · 129,346★ · TypeScript · Classic  
...
- **[jgraph/drawio-desktop](https://github.com/jgraph/drawio-desktop)** · 62,495★ · JavaScript · Classic  
...
- **[lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid)** · 10,809★ · TypeScript · Declining  
...
- **[ScottPlot/ScottPlot](https://github.com/ScottPlot/ScottPlot)** · 6,696★ · C# · Classic  
...
- **[alandefreitas/matplotplusplus](https://github.com/alandefreitas/matplotplusplus)** · 4,914★ · C++ · Mature  
...
- **[AAChartModel/AAChartKit](https://github.com/AAChartModel/AAChartKit)** · 4,766★ · Objective-C · Mature  
...
- **[gonum/plot](https://github.com/gonum/plot)** · 2,963★ · Go · Mature  
...
**Community clustering.** These 61 tools span **10 of the graph's 31 communities** — a wide spread, because charting cuts across the frontend, Python-data, and observability clusters rather than forming one of its own.

- **Community 0** (31): `apache/echarts`, `chartjs/Chart.js`, `plotly/plotly.js`, `apexcharts/apexcharts.js`, `antvis/G2`, `frappe/charts`, `observablehq/plot`, `recharts/recharts`, `plouc/nivo`, `airbnb/visx`, `tremorlabs/tremor`, `d3/d3`, `leeoniya/uPlot`, `tradingview/lightweight-charts`, `visgl/deck.gl`, `keplergl/kepler.gl`, `vega/vega-lite`, `vega/vega`, `vega/altair`, `plotly/plotly.py`, `bokeh/bokeh`, `holoviz/holoviews`, `holoviz/panel`, `evidence-dev/evidence`, `plotly/dash`, `excalidraw/excalidraw`, `lukilabs/beautiful-mermaid`, `ScottPlot/ScottPlot`, `AAChartModel/AAChartKit`, `core-plot/core-plot`, `alandefreitas/matplotplusplus`
- **Community 1** (8): `Kanaries/pygwalker`, `man-group/dtale`, `posit-dev/great-tables`, `apache/superset`, `metabase/metabase`, `getredash/redash`, `rilldata/rill`, `gonum/plot`
- **Community 3** (7): `has2k1/plotnine`, `matplotlib/matplotlib`, `reflex-dev/xy`, `streamlit/streamlit`, `gradio-app/gradio`, `reflex-dev/reflex`, `Avaiga/taipy`
- **Community 19** (4): `grafana/grafana`, `elastic/kibana`, `openobserve/openobserve`, `weaveworks/grafanalib`
- **Community 13** (3): `c3js/c3`, `deliveryhero/grafyaml`, `K-Phoen/grabana`
- **Community 14** (3): `Canner/WrenAI`, `grafana/grafana-foundation-sdk`, `jgraph/drawio-desktop`
- **Community 2** (2): `perspective-dev/perspective`, `JetBrains/lets-plot`

**Centrality (PageRank in the full 1,596-repo graph)** — most 'hub-like' visualization tools in your ecosystem:

- `apache/superset` — PageRank 0.0063
- `posit-dev/great-tables` — PageRank 0.0058
- `Kanaries/pygwalker` — PageRank 0.0057
- `getredash/redash` — PageRank 0.0051
- `c3js/c3` — PageRank 0.0034
- `tremorlabs/tremor` — PageRank 0.0030
- `keplergl/kepler.gl` — PageRank 0.0029
- `plouc/nivo` — PageRank 0.0025
- `excalidraw/excalidraw` — PageRank 0.0025
- `streamlit/streamlit` — PageRank 0.0019

**Direct links between charting tools** (top similarity edges where both endpoints are in this report):

- `vega/vega-lite` ⇄ `vega/vega` (w=1.606) — topics: visualization-grammar, visualization, vega; authors: domoritz, dependabot[bot], joelostblom
- `reflex-dev/xy` ⇄ `reflex-dev/reflex` (w=1.358) — topics: data-analysis, data-science, data-visualization, python; authors: Alek99, masenf, FarhanAliRaza
- `holoviz/panel` ⇄ `holoviz/holoviews` (w=1.205) — topics: holoviz, holoviews; authors: philippjfr, hoxbro, Kkkakania
- `plotly/plotly.py` ⇄ `plotly/plotly.js` (w=1.114) — topics: d3, plotly, webgl, visualization; authors: emilykl, camdecoster, 91409429+hanu-14@users.noreply.github.com
- `observablehq/plot` ⇄ `d3/d3` (w=0.833) — topics: visualization, data-visualization, charts, d3
- `vega/altair` ⇄ `vega/vega-lite` (w=0.816) — authors: joelostblom, dependabot[bot], jonathanzong
- `vega/altair` ⇄ `vega/vega` (w=0.773) — authors: joelostblom, dependabot[bot], jonathanzong
- `apache/superset` ⇄ `apache/echarts` (w=0.679) — topics: apache, data-visualization, data-viz; authors: dependabot[bot]
- `plotly/dash` ⇄ `plotly/plotly.py` (w=0.653) — topics: plotly, python, plotly-dash
- `plotly/dash` ⇄ `plotly/plotly.js` (w=0.625) — topics: plotly, data-visualization, plotly-dash
- `airbnb/visx` ⇄ `d3/d3` (w=0.556) — topics: d3, visualization, chart, svg
- `apexcharts/apexcharts.js` ⇄ `apache/echarts` (w=0.515) — topics: charts, svg, data-visualization, visualization; authors: dependabot[bot]
- `observablehq/plot` ⇄ `apexcharts/apexcharts.js` (w=0.500) — topics: visualization, data-visualization, charts, svg
- `grafana/grafana-foundation-sdk` ⇄ `grafana/grafana` (w=0.500)
- `streamlit/streamlit` ⇄ `reflex-dev/reflex` (w=0.494) — topics: python, data-science, data-visualization, data-analysis; authors: github-actions[bot]
- …and 108 more.
...
|---|---|---|---|---|---|---|
| grafana/grafana | 99 | Classic | very active | 12 | 14% | 635 |
| metabase/metabase | 99 | Classic | very active | 8 | 9% | 816 |
| elastic/kibana | 98 | Classic | very active | 18 | 9% | 258 |
| openobserve/openobserve | 98 | Classic | very active | 5 | 16% | 216 |
| ToolJet/ToolJet | 94 | Classic | very active | 4 | 18% | 587 |
| reflex-dev/reflex | 94 | Classic | very active | 4 | 22% | 220 |
| matplotlib/matplotlib | 89 | Classic | very active | 3 | 26% | 102 |
| visgl/deck.gl | 88 | Classic | very active | 3 | 24% | 307 |
| apache/superset | 85 | Classic | very active | 2 | 41% | 266 |
| recharts/recharts | 84 | Classic | very active | 2 | 39% | 92 |
| rilldata/rill | 84 | Classic | very active | 2 | 47% | 327 |
| gradio-app/gradio | 84 | Classic | very active | 2 | 36% | 5075 |
| streamlit/streamlit | 83 | Classic | very active | 2 | 38% | 125 |
| keplergl/kepler.gl | 82 | Classic | very active | 2 | 49% | 56 |
| plotly/plotly.py | 81 | Classic | very active | 2 | 41% | 107 |
| holoviz/panel | 80 | Classic | very active | 2 | 41% | 101 |
| Canner/WrenAI | 80 | Mature | very active | 2 | 41% | 187 |
| apexcharts/apexcharts.js | 79 | Classic | very active | 1 | 89% | 152 |
| plotly/plotly.js | 78 | Classic | very active | 1 | 64% | 277 |
| plotly/dash | 78 | Classic | very active | 1 | 75% | 109 |
| jgraph/drawio-desktop | 78 | Classic | very active | 1 | 79% | 187 |
| JetBrains/lets-plot | 77 | Classic | active | 2 | 32% | 109 |
| perspective-dev/perspective | 76 | Classic | very active | 1 | 98% | 62 |
| has2k1/plotnine | 75 | Classic | very active | 1 | 93% | 39 |
| reflex-dev/xy | 74 | Hot | very active | 1 | 61% | 11 |
| bokeh/bokeh | 73 | Classic | very active | 3 | 25% | 0 |
| posit-dev/great-tables | 72 | Classic | very active | 1 | 99% | 35 |
| vega/altair | 71 | Classic | very active | 1 | 67% | 37 |
| highcharts/highcharts | 70 | Classic | very active | 2 | 46% | 0 |
| vega/vega | 69 | Classic | very active | 1 | 60% | 153 |
| holoviz/holoviews | 68 | Classic | very active | 1 | 51% | 89 |
| vega/vega-lite | 66 | Classic | very active | 1 | 50% | 214 |
| apache/echarts | 65 | Classic | active | 2 | 32% | 125 |
| Kanaries/pygwalker | 65 | Classic | very active | 1 | 98% | 66 |
| grafana/grafana-foundation-sdk | 65 | Mature | very active | 2 | 43% | 0 |
| getredash/redash | 63 | Classic | active | 3 | 31% | 101 |
| antvis/G2 | 62 | Mature | active | 1 | 50% | 155 |
| tradingview/lightweight-charts | 62 | Classic | very active | 1 | 70% | 47 |
| ScottPlot/ScottPlot | 61 | Classic | active | 1 | 63% | 179 |
| excalidraw/excalidraw | 60 | Classic | very active | 1 | 53% | 15 |
| airbnb/visx | 55 | Classic | active | 1 | 50% | 107 |
| Avaiga/taipy | 53 | Mature | active | 0 | 0% | 127 |
| c3js/c3 | 51 | Classic | active | 1 | 67% | 94 |
| plouc/nivo | 51 | Classic | active | 1 | 50% | 65 |
| hustcc/mcp-mermaid | 49 | Declining | slowing | 1 | 100% | 6 |
| deliveryhero/grafyaml | 47 | Mature | active | 1 | 50% | 8 |
| man-group/dtale | 43 | Mature | active | 0 | 0% | 183 |
| observablehq/plot | 42 | Mature | active | 1 | 100% | 39 |
| chartjs/Chart.js | 41 | Mature | slowing | 1 | 100% | 117 |
| d3/d3 | 40 | Mature | slowing | 1 | 100% | 194 |
| evidence-dev/evidence | 38 | Mature | slowing | 0 | 0% | 949 |
| lukilabs/beautiful-mermaid | 37 | Declining | slowing | 0 | 0% | 6 |
| AAChartModel/AAChartKit | 32 | Mature | slowing | 0 | 0% | 18 |
| core-plot/core-plot | 31 | Mature | slowing | 0 | 0% | 19 |
| leeoniya/uPlot | 29 | Mature | slowing | 0 | 0% | 63 |
| gonum/plot | 29 | Mature | slowing | 0 | 0% | 8 |
| alandefreitas/matplotplusplus | 24 | Mature | slowing | 0 | 0% | 6 |
| weaveworks/grafanalib | 16 | Declining | stale | 0 | 0% | 16 |
| tremorlabs/tremor | 12 | Declining | stale | 0 | 0% | 0 |
...
- **prometheus/prometheus** (65,615★) — a time-series *database* and the data source behind most Grafana panels — storage, not charting
- **plausible/analytics** (28,411★) — a fixed-purpose web-analytics product; its dashboard isn't reusable for your own data
- **bluewave-labs/Checkmate** (10,430★) — uptime/infrastructure monitoring with built-in status charts — a monitoring product, not a charting tool
- **voxel51/fiftyone** (10,990★) — visualizes *datasets and model predictions* for computer vision — a data-curation app, not a chart library
- **jessevig/bertviz** (8,147★) — visualizes transformer attention specifically — a model-interpretability tool
- **OpenSpace/OpenSpace** (1,225★) — astrovisualization of space data — scientific rendering, not general charting
- **originalankur/maptoposter** (13,896★) — turns city maps into poster art — cartographic design, not data visualization
- **unhappychoice/gitlogue** (4,900★) — animated replay of git history in the terminal — a novelty visualizer
- **patoles/agent-flow** (1,457★) — real-time visualization of agent orchestration — see the *Agent orchestration* report
- **vivekchand/clawmetry** (392★) — agent-runtime observability dashboards — routed to the agent reports
- **williamngan/pts** (5,339★) — creative-coding and generative visuals rather than charts; reads as abandoned in this snapshot
- **GraphiteEditor/Graphite** (26,780★) — a 2D vector graphics editor — design tooling, not data charting
- **mosra/magnum** (5,182★) — C++ graphics middleware used *for* visualization, but a rendering engine at heart
- **deliveryhero/helm-charts** (565★) — name collision — Kubernetes Helm charts, nothing to do with data charts
- **ultraworkers/hermes-agent-helm-chart** (126★) — same collision: a Helm chart, not a data chart
- **jakevdp/PythonDataScienceHandbook** (49,553★) — a book (notebooks) that teaches matplotlib — learning material, not a tool
- **GeostatsGuy/DataScienceInteractivePython** (2,579★) — teaching notebooks with interactive dashboards — course material
...
<sub>Tools covered: 61 · Snapshot: 2026-08-11T18:59:16.380Z</sub>
