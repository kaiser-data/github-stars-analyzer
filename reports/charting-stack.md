...
| Tool | ★ | ✅ Advantages | ⚠️ Disadvantages | 🎯 Best for |
|---|---|---|---|---|
| **[matplotlib/matplotlib](https://github.com/matplotlib/matplotlib)** | 23,169 | Can draw literally anything; the publication standard for scientific figures; vector output (PDF/SVG/EPS); enormous documentation and 20 years of StackOverflow answers; PSF-style licence. | Two competing APIs (pyplot state machine vs. object-oriented) confuse newcomers; verbose for anything non-trivial; dated defaults; no real interactivity; slow on large datasets. | Publication figures and any plot that must be exactly right. |
...
| **[rilldata/rill](https://github.com/rilldata/rill)** | 2,867 | Genuinely fast exploratory slicing (embedded DuckDB); dashboards-as-YAML; local-first development loop; deliberately designed to be driven by agents as well as humans. | Young project with a narrower feature set than Superset/Metabase; opinionated metrics-layer model; open-source core alongside a commercial cloud. | Fast metric exploration for teams comfortable defining dashboards in code. |

### Data-app framework

| Tool | ★ | ✅ Advantages | ⚠️ Disadvantages | 🎯 Best for |
|---|---|---|---|---|
| **[streamlit/streamlit](https://github.com/streamlit/streamlit)** | 45,699 | Lowest possible friction (a script becomes an app); enormous component ecosystem; free Community Cloud hosting; renders matplotlib/Plotly/Altair/Vega directly. | The rerun-on-every-interaction model becomes a correctness and performance problem as apps grow; state management is bolted on; limited layout control; not built for high traffic or multi-user production. | Internal prototypes and demos that will stay simple. |
| **[gradio-app/gradio](https://github.com/gradio-app/gradio)** | 43,481 | Purpose-built for model demos (image/audio/chat components are excellent); instant public share links; deep Hugging Face Spaces integration; auto-generated REST API. | Charting is an afterthought compared to Streamlit; not designed for traffic or complex multi-page apps; layout control is limited; app structure gets messy past a few screens. | ML model demos, chat UIs, and Hugging Face Spaces. |
| **[reflex-dev/reflex](https://github.com/reflex-dev/reflex)** | 28,880 | Real web-app architecture (components, routing, state) without writing JS; compiles to React/Next.js so the output is a normal SPA; excellent health/activity in this dataset. | Much larger conceptual surface than Streamlit; the Python→React compilation leaks when you need custom JS; younger ecosystem; debugging spans two runtimes. | Python teams shipping a real web app, not a script with widgets. |
| **[plotly/dash](https://github.com/plotly/dash)** | 24,399 | Explicit callback graph scales to genuinely complex apps; runs on Flask so it deploys like any WSGI app; the most 'production' of the Python options; mature enterprise story. | Far more boilerplate than Streamlit; callback chains get hard to reason about; tied to Plotly for charting; the good enterprise features (auth, scaling) are commercial. | Production Python dashboards that outgrew Streamlit. |
...
| Tool | ★ | ✅ Advantages | ⚠️ Disadvantages | 🎯 Best for |
|---|---|---|---|---|
| **[weaveworks/grafanalib](https://github.com/weaveworks/grafanalib)** | 1,973 | Pythonic dashboard construction with reusable functions; large body of existing examples; simple to integrate into Python CI. | **Declining in this dataset** — Weaveworks shut down and maintenance has stalled; lags current Grafana panel schemas; superseded by grafana-foundation-sdk. | Legacy Python dashboard pipelines — migrate new work to the Foundation SDK. |
...
|---|---|---|---|---|---|---|---|---|---|---|
| [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | Diagrams & AI charts | TypeScript | MIT | 131,226 | Classic | 59 | very active | 8d ago | 6.7y | 18 |
| [d3/d3](https://github.com/d3/d3) | Low-level / high-performance | Shell | ISC | 113,651 | Mature | 31 | slowing | 3mo ago | 16.0y | 0 |
| [grafana/grafana](https://github.com/grafana/grafana) | BI & dashboard platform | TypeScript | AGPL-3.0 | 76,616 | Classic | 99 | very active | 7d ago | 12.8y | 55 |
| [apache/superset](https://github.com/apache/superset) | BI & dashboard platform | Python | Apache-2.0 | 74,662 | Classic | 84 | very active | 6d ago | 11.2y | 26 |
| [chartjs/Chart.js](https://github.com/chartjs/Chart.js) | Web charting library | JavaScript | MIT | 67,682 | Mature | 32 | slowing | 3mo ago | 13.5y | 0 |
| [apache/echarts](https://github.com/apache/echarts) | Web charting library | TypeScript | Apache-2.0 | 67,251 | Classic | 64 | active | 9d ago | 13.5y | 3 |
| [jgraph/drawio-desktop](https://github.com/jgraph/drawio-desktop) | Diagrams & AI charts | JavaScript | Apache-2.0 | 62,955 | Classic | 77 | very active | 10d ago | 9.3y | 3 |
| [metabase/metabase](https://github.com/metabase/metabase) | BI & dashboard platform | Clojure | NOASSERTION | 49,102 | Classic | 98 | very active | 6d ago | 11.6y | 34 |
| [streamlit/streamlit](https://github.com/streamlit/streamlit) | Data-app framework | Python | Apache-2.0 | 45,699 | Classic | 83 | very active | 6d ago | 7.1y | 8 |
| [gradio-app/gradio](https://github.com/gradio-app/gradio) | Data-app framework | Python | Apache-2.0 | 43,481 | Classic | 84 | very active | 8d ago | 7.7y | 5 |
| [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) | BI & dashboard platform | JavaScript | AGPL-3.0 | 40,849 | Classic | 83 | very active | 7d ago | 5.5y | 18 |
| [reflex-dev/reflex](https://github.com/reflex-dev/reflex) | Data-app framework | Python | Apache-2.0 | 28,880 | Classic | 83 | very active | 6d ago | 3.9y | 12 |
| [getredash/redash](https://github.com/getredash/redash) | BI & dashboard platform | Python | BSD-2-Clause | 28,781 | Classic | 63 | active | 9d ago | 12.9y | 9 |
...
| [plotly/dash](https://github.com/plotly/dash) | Data-app framework | Python | MIT | 24,399 | Classic | 77 | very active | 8d ago | 11.4y | 8 |
| [matplotlib/matplotlib](https://github.com/matplotlib/matplotlib) | Python plotting | Python | — | 23,169 | Classic | 93 | very active | 7d ago | 15.6y | 23 |
| [openobserve/openobserve](https://github.com/openobserve/openobserve) | BI & dashboard platform | TypeScript | AGPL-3.0 | 21,660 | Classic | 88 | very active | 6d ago | 3.6y | 24 |
| [elastic/kibana](https://github.com/elastic/kibana) | BI & dashboard platform | TypeScript | NOASSERTION | 21,283 | Classic | 98 | very active | 6d ago | 13.6y | 60 |
| [airbnb/visx](https://github.com/airbnb/visx) | React charting library | TypeScript | MIT | 21,034 | Classic | 52 | slowing | 2mo ago | 9.5y | 3 |
...
| [Avaiga/taipy](https://github.com/Avaiga/taipy) | Data-app framework | Python | Apache-2.0 | 19,434 | Mature | 50 | active | 1mo ago | 4.6y | 0 |
...
| [plotly/plotly.js](https://github.com/plotly/plotly.js) | Web charting library | JavaScript | MIT | 18,317 | Classic | 78 | very active | 8d ago | 10.9y | 6 |
| [Canner/WrenAI](https://github.com/Canner/WrenAI) | BI & dashboard platform | Python | NOASSERTION | 17,507 | Mature | 80 | very active | 8d ago | 2.5y | 16 |
| [tradingview/lightweight-charts](https://github.com/tradingview/lightweight-charts) | Low-level / high-performance | TypeScript | Apache-2.0 | 17,186 | Classic | 72 | very active | 8d ago | 7.3y | 7 |
...
| [visgl/deck.gl](https://github.com/visgl/deck.gl) | Low-level / high-performance | TypeScript | MIT | 14,558 | Classic | 83 | very active | 7d ago | 10.8y | 12 |
| [plouc/nivo](https://github.com/plouc/nivo) | React charting library | TypeScript | MIT | 14,091 | Classic | 48 | active | 1mo ago | 10.4y | 4 |
| [antvis/G2](https://github.com/antvis/G2) | Web charting library | TypeScript | MIT | 12,604 | Mature | 61 | active | 9d ago | 10.3y | 2 |
| [highcharts/highcharts](https://github.com/highcharts/highcharts) | Web charting library | TypeScript | NOASSERTION | 12,487 | Classic | 69 | very active | 7d ago | 16.3y | 9 |
| [keplergl/kepler.gl](https://github.com/keplergl/kepler.gl) | Low-level / high-performance | TypeScript | MIT | 11,996 | Classic | 76 | very active | 7d ago | 8.5y | 5 |
| [vega/vega](https://github.com/vega/vega) | Grammar of graphics | JavaScript | BSD-3-Clause | 11,982 | Classic | 72 | very active | 10d ago | 13.6y | 14 |
| [perspective-dev/perspective](https://github.com/perspective-dev/perspective) | Low-level / high-performance | Rust | Apache-2.0 | 11,169 | Classic | 77 | very active | 7d ago | 8.9y | 4 |
| [lukilabs/beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid) | Diagrams & AI charts | TypeScript | MIT | 11,038 | Declining | 34 | slowing | 4mo ago | 7mo | 0 |
| [leeoniya/uPlot](https://github.com/leeoniya/uPlot) | Low-level / high-performance | JavaScript | MIT | 10,475 | Mature | 27 | slowing | 4mo ago | 7.0y | 0 |
| [vega/altair](https://github.com/vega/altair) | Grammar of graphics | Python | BSD-3-Clause | 10,468 | Classic | 70 | very active | 8d ago | 11.0y | 13 |
...
| [ScottPlot/ScottPlot](https://github.com/ScottPlot/ScottPlot) | Native / systems charting | C# | MIT | 6,731 | Classic | 61 | very active | 28d ago | 8.7y | 8 |
...
| [vega/vega-lite](https://github.com/vega/vega-lite) | Grammar of graphics | TypeScript | BSD-3-Clause | 5,476 | Classic | 64 | very active | 10d ago | 11.8y | 6 |
| [observablehq/plot](https://github.com/observablehq/plot) | Web charting library | HTML | ISC | 5,366 | Mature | 43 | active | 11d ago | 5.9y | 1 |
...
| [tremorlabs/tremor](https://github.com/tremorlabs/tremor) | React charting library | TypeScript | Apache-2.0 | 3,599 | Declining | 9 | stale | 11mo ago | 2.5y | 0 |
...
| [rilldata/rill](https://github.com/rilldata/rill) | BI & dashboard platform | Go | Apache-2.0 | 2,867 | Classic | 84 | very active | 7d ago | 4.8y | 12 |
...
| [weaveworks/grafanalib](https://github.com/weaveworks/grafanalib) | Dashboards as code | Python | Apache-2.0 | 1,973 | Declining | 13 | stale | 9mo ago | 9.8y | 0 |
| [reflex-dev/xy](https://github.com/reflex-dev/xy) | Python plotting | Python | Apache-2.0 | 1,825 | Hot | 74 | very active | 9d ago | 2mo | 11 |
...
| [hustcc/mcp-mermaid](https://github.com/hustcc/mcp-mermaid) | Diagrams & AI charts | TypeScript | MIT | 629 | Declining | 40 | slowing | 4mo ago | 1.3y | 0 |
