...
**Community clustering.** These 58 tools span **16 of the graph's 32 communities** — the Claude-Code ecosystem is spread across agent-framework, memory, retrieval, and observability neighborhoods rather than forming one tidy cluster.

- **Community 19** (14): `NousResearch/hermes-agent`, `Yeachan-Heo/oh-my-claudecode`, `affaan-m/ECC`, `ComposioHQ/awesome-claude-skills`, `sickn33/antigravity-awesome-skills`, `wshobson/agents`, `centminmod/my-claude-code-setup`, `davila7/claude-code-templates`, `luongnv89/claude-howto`, `Piebald-AI/claude-code-system-prompts`, `thedotmack/claude-mem`, `JuliusBrussee/caveman`, `rtk-ai/rtk`, `getagentseal/codeburn`
- **Community 17** (8): `earendil-works/pi`, `K-Dense-AI/scientific-agent-skills`, `farion1231/cc-switch`, `hesreallyhim/awesome-claude-code`, `code-yeongyu/oh-my-openagent`, `safishamsi/graphify`, `colbymchenry/codegraph`, `Egonex-AI/Understand-Anything`
- **Community 7** (5): `openclaw/openclaw`, `cline/cline`, `ruvnet/ruflo`, `abhigyanpatwari/GitNexus`, `DeusData/codebase-memory-mcp`
...
- **Community 13** (5): `bytedance/deer-flow`, `mem0ai/mem0`, `memvid/memvid`, `memodb-io/Acontext`, `chopratejas/headroom`
- **Community 11** (5): `toon-format/toon`, `langfuse/langfuse`, `comet-ml/opik`, `Arize-ai/phoenix`, `BerriAI/litellm`
...
- **Community 3** (2): `multica-ai/andrej-karpathy-skills`, `shanraisshan/claude-code-best-practice`
