...
> Derived from **kaiser-data**'s 2,159 starred repos (snapshot `2026-09-14T11:08:08.535Z`), cross-referenced with the repo-similarity graph (2,159 nodes / 7,086 edges, 37 communities). Task rankings are additionally backed by external benchmarks (OmniDocBench, opendataloader-bench) — see Methodology.
>
> Generated 2026-09-14 by `scripts/reports/document_extraction.py` (regenerate any time — no API cost).
...
- **26 document-extraction tools** in your stars (**706,856★** combined), organized along the extraction pipeline:
...
|---|---|---|---|---|---|---|---|---|---|---|
| [microsoft/markitdown](https://github.com/microsoft/markitdown) | Conversion framework | Python | MIT | 183,827 (▲5,429) | Hot | 90 | very active | 2d ago | 1.8y | 52 |
| [PaddlePaddle/PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) | OCR / layout model | Python | Apache-2.0 | 89,488 (▲547) | Mature | 65 | active | 1mo ago | 6.4y | 4 |
| [opendatalab/MinerU](https://github.com/opendatalab/MinerU) | Conversion framework | Python | NOASSERTION | 79,887 (▲593) | Mature | 75 | very active | 1d ago | 2.5y | 2 |
| [tesseract-ocr/tesseract](https://github.com/tesseract-ocr/tesseract) | OCR / layout model | C++ | Apache-2.0 | 76,480 (▲127) | Classic | 67 | very active | 3d ago | 12.1y | 14 |
| [docling-project/docling](https://github.com/docling-project/docling) | Conversion framework | Python | MIT | 66,384 (▲335) | Mature | 96 | very active | 0d ago | 2.2y | 42 |
| [datalab-to/marker](https://github.com/datalab-to/marker) | Conversion framework | Python | Apache-2.0 | 39,730 (▲193) | Mature | 61 | very active | 1d ago | 2.9y | 2 |
| [google/langextract](https://github.com/google/langextract) | Structured field extraction | Python | Apache-2.0 | 38,579 (▲35) | Mature | 66 | active | 1d ago | 1.2y | 3 |
| [deepseek-ai/DeepSeek-OCR](https://github.com/deepseek-ai/DeepSeek-OCR) | VLM document parser | Python | MIT | 23,883 (▲13) | Declining | 12 | stale | 7mo ago | 11mo | 0 |
| [allenai/olmocr](https://github.com/allenai/olmocr) | VLM document parser | Python | Apache-2.0 | 19,468 (▲27) | Declining | 39 | slowing | 5mo ago | 2.0y | 0 |
| [Unstructured-IO/unstructured](https://github.com/Unstructured-IO/unstructured) | Conversion framework | HTML | Apache-2.0 | 15,425 (▲26) | Classic | 80 | very active | 4d ago | 4.0y | 13 |
| [getomni-ai/zerox](https://github.com/getomni-ai/zerox) | VLM document parser | TypeScript | MIT | 12,265 (▼1) | Abandoned | 3 | stale | 1.3y ago | 2.2y | 0 |
| [facebookresearch/nougat](https://github.com/facebookresearch/nougat) | VLM document parser | Python | MIT | 10,078 (▲7) | Abandoned | 5 | stale | 1.6y ago | 3.3y | 0 |
| [xberg-io/xberg](https://github.com/xberg-io/xberg) | Conversion framework | Rust | MIT | 9,302 (▲31) | Hot | 80 | very active | 0d ago | 1.6y | 4 |
| [studio-dots-ai/dots.ocr](https://github.com/studio-dots-ai/dots.ocr) | VLM document parser | Python | MIT | 9,109 (▲3) | Declining | 20 | slowing | 5mo ago | 1.1y | 0 |
| [bytedance/Dolphin](https://github.com/bytedance/Dolphin) | VLM document parser | Python | NOASSERTION | 9,044 (▼6) | Declining | 21 | slowing | 5mo ago | 1.3y | 0 |
| [Yuliang-Liu/MonkeyOCR](https://github.com/Yuliang-Liu/MonkeyOCR) | VLM document parser | Python | Apache-2.0 | 6,640 (▲3) | Declining | 44 | active | 1mo ago | 1.3y | 1 |
| [python-openxml/python-docx](https://github.com/python-openxml/python-docx) | Format-specific / serving | Python | MIT | 5,717 (▲7) | Mature | 33 | active | 1mo ago | 12.9y | 0 |
| [deepseek-ai/DeepSeek-OCR-2](https://github.com/deepseek-ai/DeepSeek-OCR-2) | VLM document parser | Python | Apache-2.0 | 3,403 (▲7) | Declining | 12 | stale | 7mo ago | 7mo | 0 |
| [opendatalab/DocLayout-YOLO](https://github.com/opendatalab/DocLayout-YOLO) | OCR / layout model | Python | AGPL-3.0 | 2,262 (▼1) | Abandoned | 7 | stale | 1.4y ago | 1.9y | 0 |
| [run-llama/semtools](https://github.com/run-llama/semtools) | Conversion framework | Rust | MIT | 1,867 (▲2) | Declining | 36 | stale | 6mo ago | 1.1y | 0 |
| [landing-ai/ade-python](https://github.com/landing-ai/ade-python) | Structured field extraction | Python | Apache-2.0 | 1,033 (▲1) | Hot | 75 | very active | 0d ago | 12mo | 5 |
| [adithya-s-k/marker-api](https://github.com/adithya-s-k/marker-api) | Format-specific / serving | Python | GPL-3.0 | 983 (▼1) | Abandoned | 2 | stale | 1.9y ago | 2.3y | 0 |
...
| [docling-project/docling-mcp](https://github.com/docling-project/docling-mcp) | Format-specific / serving | Python | MIT | 740 (▲8) | Mature | 73 | very active | 7d ago | 1.5y | 6 |
| [AstraBert/PdfItDown](https://github.com/AstraBert/PdfItDown) | Format-specific / serving | Rust | MIT | 249 | Mature | 71 | slowing | 2mo ago | 1.7y | 1 |
...
- **[datalab-to/marker](https://github.com/datalab-to/marker)** · 39,730★ · Python · Mature  
...
- **[xberg-io/xberg](https://github.com/xberg-io/xberg)** · 9,302★ · Rust · Hot  
...
- **[run-llama/semtools](https://github.com/run-llama/semtools)** · 1,867★ · Rust · Declining  
...
- **[tesseract-ocr/tesseract](https://github.com/tesseract-ocr/tesseract)** · 76,480★ · C++ · Classic  
...
- **[opendatalab/DocLayout-YOLO](https://github.com/opendatalab/DocLayout-YOLO)** · 2,262★ · Python · Abandoned  
...
- **[Yuliang-Liu/MonkeyOCR](https://github.com/Yuliang-Liu/MonkeyOCR)** · 6,640★ · Python · Declining  
  Lightweight structure-recognition-relation model; MonkeyOCR-pro-3B beat Gemini/GPT-4o-class models on OmniDocBench.  
  <sub>topics: —</sub>
- **[deepseek-ai/DeepSeek-OCR-2](https://github.com/deepseek-ai/DeepSeek-OCR-2)** · 3,403★ · Python · Declining  
...
- **[google/langextract](https://github.com/google/langextract)** · 38,579★ · Python · Mature  
...
- **[landing-ai/ade-python](https://github.com/landing-ai/ade-python)** · 1,033★ · Python · Hot  
...
- **[python-openxml/python-docx](https://github.com/python-openxml/python-docx)** · 5,717★ · Python · Mature  
  The standard library for reading and writing Word .docx programmatically.  
  <sub>topics: —</sub>
- **[adithya-s-k/marker-api](https://github.com/adithya-s-k/marker-api)** · 983★ · Python · Abandoned  
...
- **[docling-project/docling-mcp](https://github.com/docling-project/docling-mcp)** · 740★ · Python · Mature  
...
**Community clustering.** These 26 tools span **12 of the graph's 37 communities**.

- **Community 23** (7): `opendatalab/MinerU`, `PaddlePaddle/PaddleOCR`, `opendatalab/DocLayout-YOLO`, `getomni-ai/zerox`, `bytedance/Dolphin`, `landing-ai/ade-python`, `adithya-s-k/marker-api`
...
- **Community 4** (2): `microsoft/markitdown`, `tesseract-ocr/tesseract`
- **Community 10** (2): `docling-project/docling`, `docling-project/docling-mcp`
- **Community 6** (2): `Unstructured-IO/unstructured`, `facebookresearch/nougat`
- **Community 33** (2): `deepseek-ai/DeepSeek-OCR`, `deepseek-ai/DeepSeek-OCR-2`

**Centrality (PageRank in the full 2,159-repo graph)** — most 'hub-like' extraction tools in your ecosystem:
...
- `567-labs/instructor-js` — PageRank 0.0004
- `microsoft/markitdown` — PageRank 0.0004

**Direct links between extraction tools** (top similarity edges where both endpoints are in this report):

- `docling-project/docling-mcp` ⇄ `docling-project/docling` (w=0.637) — authors: ceberam, github-actions[bot]
...
- `xberg-io/xberg` ⇄ `tesseract-ocr/tesseract` (w=0.156) — topics: tesseract; authors: y1lan
...
| xberg-io/xberg | 80 | Hot | very active | 1 | 97% | 106 |
| opendatalab/MinerU | 75 | Mature | very active | 1 | 98% | 186 |
| landing-ai/ade-python | 75 | Hot | very active | 2 | 42% | 61 |
| docling-project/docling-mcp | 73 | Mature | very active | 2 | 48% | 22 |
| AstraBert/PdfItDown | 71 | Mature | slowing | 1 | 100% | 36 |
| tesseract-ocr/tesseract | 67 | Classic | very active | 1 | 73% | 36 |
| google/langextract | 66 | Mature | active | 1 | 88% | 19 |
| PaddlePaddle/PaddleOCR | 65 | Mature | active | 2 | 40% | 33 |
| datalab-to/marker | 61 | Mature | very active | 1 | 75% | 72 |
| Yuliang-Liu/MonkeyOCR | 44 | Declining | active | 1 | 100% | 0 |
| allenai/olmocr | 39 | Declining | slowing | 0 | 0% | 44 |
| run-llama/semtools | 36 | Declining | stale | 0 | 0% | 17 |
| python-openxml/python-docx | 33 | Mature | active | 0 | 0% | 0 |
| bytedance/Dolphin | 21 | Declining | slowing | 0 | 0% | 0 |
| studio-dots-ai/dots.ocr | 20 | Declining | slowing | 0 | 0% | 0 |
...
- **Stirling-Tools/Stirling-PDF** (92,003★) — PDF *manipulation* app (edit/merge/sign, OCR jobs via OCRmyPDF) — a toolbox, not an extraction framework
- **run-llama/llama_index** (52,155★) — positions itself as a 'document agent and OCR platform', but it's covered in the *RAG tooling* report
- **firecrawl/firecrawl** (180,189★) — extraction for the *web* (scraping/crawling), not documents
- **microsoft/OmniParser** (25,388★) — parses GUI *screenshots* for computer-use agents, not documents
- **VectifyAI/PageIndex** (35,643★) — document *retrieval* (vectorless RAG) — see the RAG tooling report
...
<sub>Tools covered: 26 · Snapshot: 2026-09-14T11:08:08.535Z</sub>
