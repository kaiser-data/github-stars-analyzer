...
> Derived from **kaiser-data**'s 1,900 starred repos (snapshot `2026-08-31T12:10:08.018Z`), cross-referenced with the repo-similarity graph (1,900 nodes / 6,181 edges, 37 communities). Task rankings are additionally backed by external benchmarks (OmniDocBench, opendataloader-bench) — see Methodology.
>
> Generated 2026-08-31 by `scripts/reports/document_extraction.py` (regenerate any time — no API cost).
...
- **26 document-extraction tools** in your stars (**696,900★** combined), organized along the extraction pipeline:
...
|---|---|---|---|---|---|---|---|---|---|---|
| [microsoft/markitdown](https://github.com/microsoft/markitdown) | Conversion framework | Python | MIT | 177,309 (▲645) | Mature | 63 | active | 12d ago | 1.8y | 6 |
| [PaddlePaddle/PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) | OCR / layout model | Python | Apache-2.0 | 88,529 (▲170) | Classic | 78 | active | 1mo ago | 6.3y | 11 |
| [opendatalab/MinerU](https://github.com/opendatalab/MinerU) | Conversion framework | Python | NOASSERTION | 78,858 (▲223) | Mature | 80 | very active | 0d ago | 2.5y | 2 |
| [tesseract-ocr/tesseract](https://github.com/tesseract-ocr/tesseract) | OCR / layout model | C++ | Apache-2.0 | 76,277 (▲60) | Classic | 67 | very active | 6d ago | 12.1y | 12 |
| [docling-project/docling](https://github.com/docling-project/docling) | Conversion framework | Python | MIT | 65,791 (▲129) | Mature | 95 | very active | 0d ago | 2.1y | 37 |
| [datalab-to/marker](https://github.com/datalab-to/marker) | Conversion framework | Python | Apache-2.0 | 39,425 (▲92) | Mature | 67 | very active | 4d ago | 2.8y | 2 |
| [google/langextract](https://github.com/google/langextract) | Structured field extraction | Python | Apache-2.0 | 38,513 (▲16) | Mature | 64 | active | 4d ago | 1.1y | 2 |
| [deepseek-ai/DeepSeek-OCR](https://github.com/deepseek-ai/DeepSeek-OCR) | VLM document parser | Python | MIT | 23,859 (▲4) | Declining | 13 | stale | 7mo ago | 10mo | 0 |
| [allenai/olmocr](https://github.com/allenai/olmocr) | VLM document parser | Python | Apache-2.0 | 19,407 (▲11) | Declining | 40 | slowing | 5mo ago | 2.0y | 0 |
| [Unstructured-IO/unstructured](https://github.com/Unstructured-IO/unstructured) | Conversion framework | HTML | Apache-2.0 | 15,366 (▲12) | Classic | 75 | very active | 3d ago | 3.9y | 10 |
...
| [facebookresearch/nougat](https://github.com/facebookresearch/nougat) | VLM document parser | Python | MIT | 10,068 (▲2) | Abandoned | 5 | stale | 1.5y ago | 3.2y | 0 |
| [xberg-io/xberg](https://github.com/xberg-io/xberg) | Conversion framework | Rust | MIT | 9,239 (▲11) | Mature | 80 | very active | 0d ago | 1.6y | 1 |
| [studio-dots-ai/dots.ocr](https://github.com/studio-dots-ai/dots.ocr) | VLM document parser | Python | MIT | 9,095 (▲3) | Declining | 21 | slowing | 5mo ago | 1.1y | 0 |
| [bytedance/Dolphin](https://github.com/bytedance/Dolphin) | VLM document parser | Python | NOASSERTION | 9,049 | Declining | 22 | slowing | 5mo ago | 1.3y | 0 |
| [Yuliang-Liu/MonkeyOCR](https://github.com/Yuliang-Liu/MonkeyOCR) | VLM document parser | Python | Apache-2.0 | 6,637 (▲2) | Declining | 45 | active | 1mo ago | 1.2y | 1 |
| [python-openxml/python-docx](https://github.com/python-openxml/python-docx) | Format-specific / serving | Python | MIT | 5,700 (▲4) | Mature | 35 | active | 1mo ago | 12.9y | 0 |
...
| [opendatalab/DocLayout-YOLO](https://github.com/opendatalab/DocLayout-YOLO) | OCR / layout model | Python | AGPL-3.0 | 2,261 (▲3) | Abandoned | 7 | stale | 1.4y ago | 1.9y | 0 |
...
| [landing-ai/ade-python](https://github.com/landing-ai/ade-python) | Structured field extraction | Python | Apache-2.0 | 1,032 (▲4) | Hot | 74 | very active | 3d ago | 11mo | 5 |
...
| [docling-project/docling-mcp](https://github.com/docling-project/docling-mcp) | Format-specific / serving | Python | MIT | 727 (▲5) | Mature | 72 | very active | 7d ago | 1.5y | 6 |
...
- **[datalab-to/marker](https://github.com/datalab-to/marker)** · 39,425★ · Python · Mature  
...
- **[xberg-io/xberg](https://github.com/xberg-io/xberg)** · 9,239★ · Rust · Mature  
...
- **[tesseract-ocr/tesseract](https://github.com/tesseract-ocr/tesseract)** · 76,277★ · C++ · Classic  
...
- **[opendatalab/DocLayout-YOLO](https://github.com/opendatalab/DocLayout-YOLO)** · 2,261★ · Python · Abandoned  
...
- **[deepseek-ai/DeepSeek-OCR](https://github.com/deepseek-ai/DeepSeek-OCR)** · 23,859★ · Python · Declining  
  Contexts optical compression — ~10× fewer vision tokens per page at ≥90% decoding accuracy; built for LLM-scale corpora.  
  <sub>topics: —</sub>
- **[allenai/olmocr](https://github.com/allenai/olmocr)** · 19,407★ · Python · Declining  
...
- **[facebookresearch/nougat](https://github.com/facebookresearch/nougat)** · 10,068★ · Python · Abandoned  
  Meta's neural OCR for academic PDFs (math → LaTeX) — historically important, now effectively unmaintained.  
  <sub>topics: —</sub>
- **[studio-dots-ai/dots.ocr](https://github.com/studio-dots-ai/dots.ocr)** · 9,095★ · Python · Declining  
...
- **[Yuliang-Liu/MonkeyOCR](https://github.com/Yuliang-Liu/MonkeyOCR)** · 6,637★ · Python · Declining  
...
- **[google/langextract](https://github.com/google/langextract)** · 38,513★ · Python · Mature  
...
- **[docling-project/docling-mcp](https://github.com/docling-project/docling-mcp)** · 727★ · Python · Mature  
...
- **Community 4** (8): `docling-project/docling`, `Unstructured-IO/unstructured`, `allenai/olmocr`, `studio-dots-ai/dots.ocr`, `Yuliang-Liu/MonkeyOCR`, `python-openxml/python-docx`, `JoshData/pdf-redactor`, `docling-project/docling-mcp`
- **Community 13** (7): `opendatalab/MinerU`, `PaddlePaddle/PaddleOCR`, `opendatalab/DocLayout-YOLO`, `getomni-ai/zerox`, `bytedance/Dolphin`, `landing-ai/ade-python`, `adithya-s-k/marker-api`
- **Community 14** (2): `microsoft/markitdown`, `tesseract-ocr/tesseract`
- **Community 2** (2): `datalab-to/marker`, `run-llama/semtools`
- **Community 23** (2): `deepseek-ai/DeepSeek-OCR`, `deepseek-ai/DeepSeek-OCR-2`

**Centrality (PageRank in the full 1,900-repo graph)** — most 'hub-like' extraction tools in your ecosystem:

- `docling-project/docling` — PageRank 0.0012
- `docling-project/docling-mcp` — PageRank 0.0011
...
- `bytedance/Dolphin` — PageRank 0.0006
...
- `docling-project/docling-mcp` ⇄ `docling-project/docling` (w=0.700) — authors: ceberam, github-actions[bot], pablopupo
...
| datalab-to/marker | 67 | Mature | very active | 1 | 78% | 72 |
...
- **Stirling-Tools/Stirling-PDF** (91,033★) — PDF *manipulation* app (edit/merge/sign, OCR jobs via OCRmyPDF) — a toolbox, not an extraction framework
- **run-llama/llama_index** (51,936★) — positions itself as a 'document agent and OCR platform', but it's covered in the *RAG tooling* report
- **firecrawl/firecrawl** (174,638★) — extraction for the *web* (scraping/crawling), not documents
- **microsoft/OmniParser** (25,350★) — parses GUI *screenshots* for computer-use agents, not documents
- **VectifyAI/PageIndex** (35,446★) — document *retrieval* (vectorless RAG) — see the RAG tooling report
...
<sub>Tools covered: 26 · Snapshot: 2026-08-31T12:10:08.018Z</sub>
