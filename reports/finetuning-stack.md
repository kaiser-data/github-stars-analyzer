...
> Derived from **kaiser-data**'s 2,140 starred repos (snapshot `2026-09-12T16:25:05.965Z`), cross-referenced with the repo-similarity graph (2,140 nodes / 7,036 edges, 41 communities). Task rankings are additionally backed by external 2026 framework comparisons and agent-RL surveys — see Methodology.
>
> Generated 2026-09-13 by `scripts/reports/finetuning_stack.py` (regenerate any time — no API cost).
...
- **27 fine-tuning / post-training tools** in your stars (**783,105★** combined), organized along the training ladder:
...
|---|---|---|---|---|---|---|---|---|---|---|
| [huggingface/transformers](https://github.com/huggingface/transformers) | Full-stack fine-tuning framework | Python | Apache-2.0 | 164,856 (▼84) | Classic | 99 | very active | 7d ago | 7.9y | 39 |
| [rasbt/LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch) | Learn-by-building | Jupyter Notebook | NOASSERTION | 104,416 (▼90) | Classic | 52 | active | 11d ago | 3.1y | 6 |
| [unslothai/unsloth](https://github.com/unslothai/unsloth) | Full-stack fine-tuning framework | Python | Apache-2.0 | 75,696 (▼53) | Mature | 77 | very active | 6d ago | 2.8y | 19 |
| [hiyouga/LlamaFactory](https://github.com/hiyouga/LlamaFactory) | Full-stack fine-tuning framework | Python | Apache-2.0 | 74,599 (▼17) | Classic | 83 | very active | 8d ago | 3.3y | 30 |
| [labmlai/annotated_deep_learning_paper_implementations](https://github.com/labmlai/annotated_deep_learning_paper_implementations) | Learn-by-building | Python | MIT | 67,394 (▼3) | Declining | 19 | stale | 7mo ago | 6.1y | 0 |
| [karpathy/nanoGPT](https://github.com/karpathy/nanoGPT) | Learn-by-building | Python | MIT | 62,840 (▼35) | Declining | 8 | stale | 10mo ago | 3.7y | 0 |
| [AlexsJones/llmfit](https://github.com/AlexsJones/llmfit) | Hardware fit & serving | Rust | MIT | 34,945 (▼51) | Hot | 93 | very active | 9d ago | 6mo | 43 |
| [lyogavin/airllm](https://github.com/lyogavin/airllm) | Hardware fit & serving | Jupyter Notebook | Apache-2.0 | 33,755 (▼50) | Mature | 70 | very active | 6d ago | 3.3y | 1 |
| [Lightning-AI/pytorch-lightning](https://github.com/Lightning-AI/pytorch-lightning) | Full-stack fine-tuning framework | Python | Apache-2.0 | 31,318 (▼4) | Classic | 66 | very active | 11d ago | 7.5y | 10 |
| [huggingface/peft](https://github.com/huggingface/peft) | PEFT & alignment library | Python | Apache-2.0 | 21,635 (▼6) | Classic | 94 | very active | 8d ago | 3.8y | 41 |
| [huggingface/trl](https://github.com/huggingface/trl) | PEFT & alignment library | Python | Apache-2.0 | 19,231 (▼7) | Classic | 79 | very active | 6d ago | 6.5y | 9 |
| [PaddlePaddle/PaddleNLP](https://github.com/PaddlePaddle/PaddleNLP) | Full-stack fine-tuning framework | Python | Apache-2.0 | 12,966 (▼3) | Mature | 30 | slowing | 3mo ago | 5.6y | 0 |
| [axolotl-ai-cloud/axolotl](https://github.com/axolotl-ai-cloud/axolotl) | Full-stack fine-tuning framework | Python | Apache-2.0 | 12,443 (▼2) | Classic | 88 | very active | 8d ago | 3.4y | 15 |
| [OpenPipe/ART](https://github.com/OpenPipe/ART) | RL post-training for agents | Python | Apache-2.0 | 10,700 (▼5) | Hot | 74 | very active | 7d ago | 1.5y | 5 |
| [roboflow/rf-detr](https://github.com/roboflow/rf-detr) | Domain & on-device tuning | Python | Apache-2.0 | 9,203 (▼127) | Hot | 83 | very active | 7d ago | 1.5y | 13 |
| [yandexdataschool/Practical_RL](https://github.com/yandexdataschool/Practical_RL) | Learn-by-building | Jupyter Notebook | Unlicense | 6,567 (▼2) | Mature | 24 | slowing | 5mo ago | 9.6y | 0 |
| [Gen-Verse/OpenClaw-RL](https://github.com/Gen-Verse/OpenClaw-RL) | RL post-training for agents | Python | Apache-2.0 | 5,668 (▼1) | Declining | 23 | slowing | 3mo ago | 6mo | 0 |
| [unslothai/notebooks](https://github.com/unslothai/notebooks) | Learn-by-building | Jupyter Notebook | LGPL-3.0 | 5,658 (▼1) | Hot | 54 | very active | 9d ago | 1.8y | 4 |
| [Blaizzy/mlx-vlm](https://github.com/Blaizzy/mlx-vlm) | Domain & on-device tuning | Python | MIT | 5,474 (▼3) | Mature | 83 | very active | 6d ago | 2.4y | 12 |
| [transformerlab/transformerlab-app](https://github.com/transformerlab/transformerlab-app) | Hardware fit & serving | Python | AGPL-3.0 | 5,184 (▼2) | Mature | 79 | very active | 8d ago | 2.7y | 3 |
| [SylphAI-Inc/LLM-engineer-handbook](https://github.com/SylphAI-Inc/LLM-engineer-handbook) | Learn-by-building | — | MIT | 5,028 (▼1) | Abandoned | 5 | stale | 1.1y ago | 1.9y | 0 |
| [huggingface/distil-whisper](https://github.com/huggingface/distil-whisper) | Domain & on-device tuning | Python | MIT | 4,116 (▲1) | Abandoned | 4 | stale | 1.7y ago | 2.9y | 0 |
| [predibase/lorax](https://github.com/predibase/lorax) | Hardware fit & serving | Python | Apache-2.0 | 3,829 (▲1) | Mature | 26 | slowing | 3mo ago | 2.9y | 0 |
| [Memento-Teams/Memento](https://github.com/Memento-Teams/Memento) | RL post-training for agents | Python | MIT | 2,570 (▲1) | Declining | 7 | stale | 11mo ago | 1.2y | 0 |
| [huggingface/OpenEnv](https://github.com/huggingface/OpenEnv) | RL post-training for agents | Python | BSD-3-Clause | 2,545 (▼5) | Hot | 74 | very active | 7d ago | 11mo | 8 |
...
- **[huggingface/transformers](https://github.com/huggingface/transformers)** · 164,856★ · Python · Classic  
...
- **[unslothai/unsloth](https://github.com/unslothai/unsloth)** · 75,696★ · Python · Mature  
...
- **[hiyouga/LlamaFactory](https://github.com/hiyouga/LlamaFactory)** · 74,599★ · Python · Classic  
...
- **[Lightning-AI/pytorch-lightning](https://github.com/Lightning-AI/pytorch-lightning)** · 31,318★ · Python · Classic  
...
- **[PaddlePaddle/PaddleNLP](https://github.com/PaddlePaddle/PaddleNLP)** · 12,966★ · Python · Mature  
...
- **[axolotl-ai-cloud/axolotl](https://github.com/axolotl-ai-cloud/axolotl)** · 12,443★ · Python · Classic  
...
- **[huggingface/peft](https://github.com/huggingface/peft)** · 21,635★ · Python · Classic  
...
- **[huggingface/trl](https://github.com/huggingface/trl)** · 19,231★ · Python · Classic  
...
- **[OpenPipe/ART](https://github.com/OpenPipe/ART)** · 10,700★ · Python · Hot  
...
- **[Gen-Verse/OpenClaw-RL](https://github.com/Gen-Verse/OpenClaw-RL)** · 5,668★ · Python · Declining  
...
- **[Memento-Teams/Memento](https://github.com/Memento-Teams/Memento)** · 2,570★ · Python · Declining  
  The counterpoint: fine-tune LLM *agents* without fine-tuning LLMs — case-based memory instead of weight updates.  
  <sub>topics: —</sub>
- **[huggingface/OpenEnv](https://github.com/huggingface/OpenEnv)** · 2,545★ · Python · Hot  
...
- **[rasbt/LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch)** · 104,416★ · Jupyter Notebook · Classic  
...
- **[labmlai/annotated_deep_learning_paper_implementations](https://github.com/labmlai/annotated_deep_learning_paper_implementations)** · 67,394★ · Python · Declining  
...
- **[karpathy/nanoGPT](https://github.com/karpathy/nanoGPT)** · 62,840★ · Python · Declining  
...
- **[unslothai/notebooks](https://github.com/unslothai/notebooks)** · 5,658★ · Jupyter Notebook · Hot  
  250+ ready-to-run fine-tuning & RL notebooks (text, vision, audio, TTS, embeddings) — the recipe box.  
  <sub>topics: unsloth</sub>
- **[SylphAI-Inc/LLM-engineer-handbook](https://github.com/SylphAI-Inc/LLM-engineer-handbook)** · 5,028★ · — · Abandoned  
...
- **[roboflow/rf-detr](https://github.com/roboflow/rf-detr)** · 9,203★ · Python · Hot  
...
- **[Blaizzy/mlx-vlm](https://github.com/Blaizzy/mlx-vlm)** · 5,474★ · Python · Mature  
...
- **[AlexsJones/llmfit](https://github.com/AlexsJones/llmfit)** · 34,945★ · Rust · Hot  
...
- **[lyogavin/airllm](https://github.com/lyogavin/airllm)** · 33,755★ · Jupyter Notebook · Mature  
...
- **[transformerlab/transformerlab-app](https://github.com/transformerlab/transformerlab-app)** · 5,184★ · Python · Mature  
...
- **[predibase/lorax](https://github.com/predibase/lorax)** · 3,829★ · Python · Mature  
...
**Community clustering.** These 27 tools span **11 of the graph's 41 communities**.

- **Community 6** (10): `hiyouga/LlamaFactory`, `axolotl-ai-cloud/axolotl`, `huggingface/transformers`, `huggingface/peft`, `huggingface/trl`, `huggingface/OpenEnv`, `Blaizzy/mlx-vlm`, `huggingface/distil-whisper`, `lyogavin/airllm`, `predibase/lorax`
- **Community 7** (4): `Lightning-AI/pytorch-lightning`, `labmlai/annotated_deep_learning_paper_implementations`, `yandexdataschool/Practical_RL`, `roboflow/rf-detr`
- **Community 5** (2): `unslothai/unsloth`, `unslothai/notebooks`
- **Community 10** (2): `Gen-Verse/OpenClaw-RL`, `AlexsJones/llmfit`
- **Community 2** (2): `Memento-Teams/Memento`, `pico-lm/pico-train`
- **Community 16** (2): `rasbt/LLMs-from-scratch`, `SylphAI-Inc/LLM-engineer-handbook`

**Centrality (PageRank in the full 2,140-repo graph)** — most 'hub-like' training tools in your ecosystem:

- `Lightning-AI/pytorch-lightning` — PageRank 0.0017
- `axolotl-ai-cloud/axolotl` — PageRank 0.0010
- `huggingface/peft` — PageRank 0.0010
...
- `unslothai/notebooks` ⇄ `unslothai/unsloth` (w=0.971) — topics: unsloth; authors: danielhanchen, Etherll, Imagineer99
- `huggingface/trl` ⇄ `huggingface/OpenEnv` (w=0.817) — authors: dependabot[bot], sergiopaniego
...
- `huggingface/trl` ⇄ `huggingface/transformers` (w=0.637) — authors: qgallouedec, verma8076
...
- `Blaizzy/mlx-vlm` ⇄ `axolotl-ai-cloud/axolotl` (w=0.198) — topics: llm; authors: Anai-Guo
- `AlexsJones/llmfit` ⇄ `axolotl-ai-cloud/axolotl` (w=0.178) — topics: llm; authors: dependabot[bot]
...
|---|---|---|---|---|---|---|
| huggingface/transformers | 99 | Classic | very active | 8 | 9% | 272 |
| huggingface/peft | 94 | Classic | very active | 6 | 21% | 33 |
| AlexsJones/llmfit | 93 | Hot | very active | 4 | 20% | 132 |
| axolotl-ai-cloud/axolotl | 88 | Classic | very active | 3 | 26% | 32 |
| hiyouga/LlamaFactory | 83 | Classic | very active | 7 | 10% | 36 |
| Blaizzy/mlx-vlm | 83 | Mature | very active | 2 | 40% | 81 |
| roboflow/rf-detr | 83 | Hot | very active | 2 | 48% | 29 |
| huggingface/trl | 79 | Classic | very active | 1 | 53% | 95 |
| transformerlab/transformerlab-app | 79 | Mature | very active | 1 | 83% | 114 |
| unslothai/unsloth | 77 | Mature | very active | 1 | 57% | 60 |
| OpenPipe/ART | 74 | Hot | very active | 1 | 76% | 59 |
| huggingface/OpenEnv | 74 | Hot | very active | 1 | 54% | 7 |
| lyogavin/airllm | 70 | Mature | very active | 1 | 100% | 6 |
| Lightning-AI/pytorch-lightning | 66 | Classic | very active | 1 | 53% | 174 |
| unslothai/notebooks | 54 | Hot | very active | 1 | 86% | 0 |
...
| predibase/lorax | 26 | Mature | slowing | 0 | 0% | 21 |
| yandexdataschool/Practical_RL | 24 | Mature | slowing | 0 | 0% | 2 |
| Gen-Verse/OpenClaw-RL | 23 | Declining | slowing | 0 | 0% | 0 |
| pico-lm/pico-train | 20 | Declining | stale | 0 | 0% | 1 |
| labmlai/annotated_deep_learning_paper_implementations | 19 | Declining | stale | 0 | 0% | 0 |
...
- **vllm-project/vllm** (91,060★) — the serving standard for *finished* models — covered in the local-vs-infra-stack report
- **ollama/ollama** (180,266★) — local inference runtime, not a trainer — see local-vs-infra-stack
- **flyteorg/flyte** (7,407★) — general ML/data orchestration — schedules training, doesn't implement it
- **beam-cloud/beta9** (1,768★) — serverless GPU substrate *where* you train, not *how*
- **zai-org/GLM-V** (2,380★) — open model weights trained with scalable RL — a result of this stack, not a tool in it
- **openai/CLIP** (34,263★) — landmark pretraining research, effectively frozen — read it, don't build on the repo
- **NVIDIA/physicsnemo** (3,223★) — training framework for physics/simulation models, out of LLM post-training scope
- **facebookresearch/BenchMARL** (656★) — multi-agent RL *benchmarking* research, not LLM post-training
- **microsoft/generative-ai-for-beginners** (119,235★) — general GenAI curriculum — broader than training
...
<sub>Tools covered: 27 · Snapshot: 2026-09-12T16:25:05.965Z</sub>
