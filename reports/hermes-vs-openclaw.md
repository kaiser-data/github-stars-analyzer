...
>
> Generated 2026-08-30 by `scripts/reports/hermes_vs_openclaw.py` (regenerate any time — no API cost).
...
| Health score | 79 | 85 🏆 |
| Momentum (est. ★/30d) | 104,421 🏆 | 37,538 |
...
- **Communities:** OpenClaw is in community 24, Hermes in 19 (different clusters). PageRank — OpenClaw 0.0007 vs Hermes 0.0008.
...
|---|---|---|---|---|---|---|
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | 387,846 | TypeScript | 79 | Hot | 104,421 | **this comparison** — the hub |
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 237,338 | Python | 85 | Hot | 37,538 | **this comparison** — Python challenger |
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | 81,018 | Python | 84 | Hot | 10,763 | long-horizon SuperAgent harness |
| [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | 68,449 | TypeScript | 78 | Hot | 19,019 | agent harness (ex oh-my-opencode) |
| [HKUDS/nanobot](https://github.com/HKUDS/nanobot) | 47,471 | Python | 78 | Hot | 16,979 | lightweight agent |
| [zeroclaw-labs/zeroclaw](https://github.com/zeroclaw-labs/zeroclaw) | 32,667 | Rust | 88 | Hot | 12,397 | healthiest alternative (Rust) |
| [nanocoai/nanoclaw](https://github.com/nanocoai/nanoclaw) | 30,626 | TypeScript | 80 | Hot | 10,920 | containerized secure OpenClaw alt |
| [elizaOS/eliza](https://github.com/elizaOS/eliza) | 19,190 | TypeScript | 89 | Mature | 1,289 | agentic OS, always-on agents |
| [RightNow-AI/openfang](https://github.com/RightNow-AI/openfang) | 18,139 | Rust | 49 | Declining | 2,925 | open Agent-OS (Rust) |
| [nearai/ironclaw](https://github.com/nearai/ironclaw) | 12,603 | Rust | 80 | Hot | 4,551 | privacy/security Agent-OS (Rust) |
...
<sub>Snapshot: 2026-08-29T23:54:34.573Z · regenerate via scripts/reports/hermes_vs_openclaw.py</sub>
