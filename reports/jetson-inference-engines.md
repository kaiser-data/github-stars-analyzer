...
> Engine roster derived from **kaiser-data**'s 2,159 starred repos (snapshot `2026-09-14T11:08:08.535Z`), cross-referenced with the repo-similarity graph (2,159 nodes / 7,086 edges, 37 communities).
>
...
>
> Generated 2026-09-14 by `scripts/reports/jetson_inference.py` (regenerate any time — no API cost).
...
|---|---|---|---|---|---|---|---|---|---|
| [ollama/ollama](https://github.com/ollama/ollama) | Edge-viable LLM runtime | Go | MIT | 180,877 (▲611) | Classic | 83 | very active | 0d ago | 10 |
| [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) | Edge-viable LLM runtime | C++ | MIT | 128,171 (▲972) | Classic | 99 | very active | 0d ago | 49 |
| [vllm-project/vllm](https://github.com/vllm-project/vllm) | Datacenter-oriented runtime | Python | Apache  2.0 | 91,712 (▲652) | Classic | 99 | very active | 0d ago | 61 |
| [nomic-ai/gpt4all](https://github.com/nomic-ai/gpt4all) | Edge-viable LLM runtime | C++ | MIT | 77,394 (▲15) | Abandoned | 7 | stale | 1.3y ago | 0 |
| [ggml-org/whisper.cpp](https://github.com/ggml-org/whisper.cpp) | Speech & non-LLM runtime | C++ | MIT | 53,654 (▲181) | Classic | 99 | very active | 0d ago | 57 |
| [exo-explore/exo](https://github.com/exo-explore/exo) | Sizing & fit | Python | Apache  2.0 | 47,415 (▲143) | Mature | 65 | active | 20d ago | 3 |
| [microsoft/BitNet](https://github.com/microsoft/BitNet) | Format & quantization | C++ | MIT | 40,233 (▲5) | Mature | 43 | active | 1mo ago | 3 |
| [AlexsJones/llmfit](https://github.com/AlexsJones/llmfit) | Sizing & fit | Rust | MIT | 36,497 (▲1,552) | Hot | 98 | very active | 0d ago | 54 |
| [sgl-project/sglang](https://github.com/sgl-project/sglang) | Datacenter-oriented runtime | Python | Apache  2.0 | 35,937 (▲418) | Mature | 99 | very active | 0d ago | 58 |
| [lyogavin/airllm](https://github.com/lyogavin/airllm) | Sizing & fit | Jupyter Notebook | Apache  2.0 | 34,303 (▲548) | Mature | 71 | very active | 0d ago | 1 |
| [mozilla-ai/llamafile](https://github.com/mozilla-ai/llamafile) | Edge-viable LLM runtime | C++ | Other | 25,964 (▲84) | Classic | 66 | very active | 0d ago | 8 |
| [SYSTRAN/faster-whisper](https://github.com/SYSTRAN/faster-whisper) | Speech & non-LLM runtime | Python | MIT | 25,391 (▲132) | Declining | 14 | stale | 9mo ago | 0 |
| [mlc-ai/mlc-llm](https://github.com/mlc-ai/mlc-llm) | Edge-viable LLM runtime | Python | Apache  2.0 | 23,153 (▲16) | Mature | 52 | active | 28d ago | 3 |
| [microsoft/onnxruntime](https://github.com/microsoft/onnxruntime) | Compiler & substrate | C++ | MIT | 21,847 (▲78) | Classic | 99 | very active | 0d ago | 45 |
| [onnx/onnx](https://github.com/onnx/onnx) | Format & quantization | Python | Apache  2.0 | 21,484 (▲65) | Classic | 94 | very active | 2d ago | 31 |
| [ggml-org/ggml](https://github.com/ggml-org/ggml) | Compiler & substrate | C++ | MIT | 15,348 (▲53) | Classic | 94 | very active | 1d ago | 61 |
| [k2-fsa/sherpa-onnx](https://github.com/k2-fsa/sherpa-onnx) | Speech & non-LLM runtime | C++ | Apache  2.0 | 14,757 (▲130) | Classic | 76 | very active | 0d ago | 30 |
| [NVIDIA/TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM) | NVIDIA / Jetson path | Python | Other | 14,615 (▲59) | Classic | 99 | very active | 0d ago | 55 |
| [apache/tvm](https://github.com/apache/tvm) | Compiler & substrate | Python | Apache  2.0 | 13,744 (▲26) | Classic | 95 | very active | 0d ago | 31 |
| [NVIDIA/TensorRT](https://github.com/NVIDIA/TensorRT) | NVIDIA / Jetson path | C++ | Apache  2.0 | 13,344 (▲23) | Mature | 66 | active | 4d ago | 3 |
| [LostRuins/koboldcpp](https://github.com/LostRuins/koboldcpp) | Edge-viable LLM runtime | C++ | GNU Affero General Public  v3.0 | 11,696 (▲77) | Classic | 97 | very active | 0d ago | 48 |
| [InternLM/lmdeploy](https://github.com/InternLM/lmdeploy) | Datacenter-oriented runtime | Python | Apache  2.0 | 8,069 (▲25) | Classic | 88 | very active | 0d ago | 25 |
| [dusty-nv/jetson-containers](https://github.com/dusty-nv/jetson-containers) | NVIDIA / Jetson path | Jupyter Notebook | Other | 4,857 (▲12) | Mature | 43 | active | 1mo ago | 1 |
| [OpenNMT/CTranslate2](https://github.com/OpenNMT/CTranslate2) | Speech & non-LLM runtime | C++ | MIT | 4,672 (▲9) | Classic | 65 | active | 14d ago | 7 |

**Edge-viable LLM runtime**

- **ollama/ollama** (180,877★) — A management layer over llama.cpp: model pulls, keep-alive, an HTTP API, and quantized KV cache. Costs a little throughput for a lot of operational convenience.
- **ggml-org/llama.cpp** (128,171★) — The engine that actually matters on this box — GGUF, CUDA on SM 8.7, aggressive quantization, and a memory model that degrades gracefully instead of aborting.
- **nomic-ai/gpt4all** (77,394★) — Desktop-oriented local runtime; Declining upstream and adds nothing llama.cpp doesn't already do here.
- **mozilla-ai/llamafile** (25,964★) — Single-file distribution of llama.cpp — useful for shipping a fixed model to a device, less so for a box you already administer.
- **mlc-ai/mlc-llm** (23,153★) — TVM-compiled, arch-specialized kernels with INT4 — the one engine with a credible claim to beating llama.cpp on Orin Nano, and the NVIDIA-quoted path for Jetson LLM figures.
- **LostRuins/koboldcpp** (11,696★) — A llama.cpp distribution with a wider sampler and format range in one binary; occasionally ships Jetson-relevant fixes earlier.

**NVIDIA / Jetson path**

- **NVIDIA/TensorRT-LLM** (14,615★) — The fastest NVIDIA LLM path on supported hardware — but Jetson support lives in a separate branch aimed at AGX Orin, not this SKU. See the verdict table.
- **NVIDIA/TensorRT** (13,344★) — The core inference compiler. On Jetson this is the reliable big win for vision models, and the base of the TensorRT Edge-LLM path that does reach Orin Nano.
- **dusty-nv/jetson-containers** (4,857★) — The single most Jetson-relevant repo in your stars: prebuilt ARM64/CUDA container images that solve the dependency problem which otherwise dominates a JetPack install.

**Compiler & substrate**

- **microsoft/onnxruntime** (21,847★) — The actual runtime behind the ONNX format you already star, with CUDA and TensorRT execution providers. Everything small on this box — STT, TTS, embeddings — can run here.
- **ggml-org/ggml** (15,348★) — The tensor library underneath llama.cpp and whisper.cpp, both of which you star. Where quantization formats and CUDA kernels actually land.
- **apache/tvm** (13,744★) — The compiler MLC-LLM is built on — relevant if you want to understand or tune what MLC produces for SM 8.7.

**Datacenter-oriented runtime**

- **vllm-project/vllm** (91,712★) — PagedAttention and continuous batching win when VRAM is plentiful and concurrency is high — the opposite of this box's profile.
- **sgl-project/sglang** (35,937★) — RadixAttention and structured generation at serving scale; same headroom assumptions as vLLM.
- **InternLM/lmdeploy** (8,069★) — TurboMind engine with strong quantized serving, but targets discrete datacenter GPUs.

**Speech & non-LLM runtime**

- **ggml-org/whisper.cpp** (53,654★) — GGML Whisper — the STT half of an edge pipeline, and a direct competitor for the same unified memory.
- **SYSTRAN/faster-whisper** (25,391★) — Whisper on CTranslate2; typically faster than whisper.cpp on CUDA, at the cost of a heavier Python dependency chain.
- **k2-fsa/sherpa-onnx** (14,757★) — ONNX Runtime STT/TTS with genuinely small footprints — the right shape for a box where every 300 MB is contested.
- **OpenNMT/CTranslate2** (4,672★) — The engine underneath `faster-whisper`, which you already star — quantized transformer inference with a small footprint.

**Format & quantization**

- **microsoft/BitNet** (40,233★) — 1-bit LLM inference. The most interesting long-shot for 8 GB: if a useful model fits in ternary weights, the memory constraint changes shape entirely.
- **onnx/onnx** (21,484★) — The interchange format underneath the ONNX Runtime path; a format, not an engine.

**Sizing & fit**

- **exo-explore/exo** (47,415★) — Cluster several devices into one pool — the escape hatch when 8 GB is simply the wrong number.
- **AlexsJones/llmfit** (36,497★) — 'One command to find what runs on your hardware' — the fit question this report exists to answer, as a tool.
- **lyogavin/airllm** (34,303★) — Layer-streaming to run 70B on 4 GB. Technically remarkable, and far too slow to be a serving answer here.
...
**Community clustering.** These 24 engines span **11 of the graph's 37 communities**.

- **Community 12** (5): `ggml-org/llama.cpp`, `ggml-org/whisper.cpp`, `SYSTRAN/faster-whisper`, `LostRuins/koboldcpp`, `ggml-org/ggml`
- **Community 23** (3): `ollama/ollama`, `vllm-project/vllm`, `sgl-project/sglang`
- **Community 24** (3): `nomic-ai/gpt4all`, `InternLM/lmdeploy`, `mlc-ai/mlc-llm`
- **Community 6** (3): `dusty-nv/jetson-containers`, `onnx/onnx`, `exo-explore/exo`
- **Community 3** (2): `mozilla-ai/llamafile`, `OpenNMT/CTranslate2`
- **Community 2** (2): `NVIDIA/TensorRT-LLM`, `NVIDIA/TensorRT`
- **Community 4** (2): `microsoft/BitNet`, `microsoft/onnxruntime`

**Centrality (PageRank in the full 2,159-repo graph)**:
...
- `ggml-org/ggml` ⇄ `ggml-org/whisper.cpp` (w=1.697)
- `ggml-org/ggml` ⇄ `ggml-org/llama.cpp` (w=1.108)
- `ggml-org/whisper.cpp` ⇄ `ggml-org/llama.cpp` (w=0.830)
...
- `microsoft/onnxruntime` ⇄ `onnx/onnx` (w=0.486) — topics: deep-learning, onnx, machine-learning, pytorch
- `LostRuins/koboldcpp` ⇄ `ggml-org/llama.cpp` (w=0.460) — topics: ggml
- `vllm-project/vllm` ⇄ `sgl-project/sglang` (w=0.407) — topics: llm, transformer, inference, llama
- `LostRuins/koboldcpp` ⇄ `ggml-org/whisper.cpp` (w=0.383)
- `LostRuins/koboldcpp` ⇄ `ggml-org/ggml` (w=0.321)
...
|---|---|---|---|---|---|---|
| ggml-org/llama.cpp | 99 | Classic | very active | 9 | 11% | 7189 |
| vllm-project/vllm | 99 | Classic | very active | 14 | 9% | 105 |
| sgl-project/sglang | 99 | Mature | very active | 11 | 8% | 60 |
| NVIDIA/TensorRT-LLM | 99 | Classic | very active | 12 | 12% | 89 |
| ggml-org/whisper.cpp | 99 | Classic | very active | 12 | 11% | 43 |
| microsoft/onnxruntime | 99 | Classic | very active | 7 | 12% | 82 |
| AlexsJones/llmfit | 98 | Hot | very active | 7 | 16% | 133 |
| LostRuins/koboldcpp | 97 | Classic | very active | 6 | 15% | 133 |
| apache/tvm | 95 | Classic | very active | 4 | 22% | 31 |
| onnx/onnx | 94 | Classic | very active | 5 | 14% | 38 |
| ggml-org/ggml | 94 | Classic | very active | 14 | 14% | 35 |
| InternLM/lmdeploy | 88 | Classic | very active | 3 | 24% | 70 |
...
| mozilla-ai/llamafile | 66 | Classic | very active | 1 | 65% | 42 |
| NVIDIA/TensorRT | 66 | Mature | active | 2 | 33% | 71 |
| exo-explore/exo | 65 | Mature | active | 2 | 33% | 16 |
| OpenNMT/CTranslate2 | 65 | Classic | active | 1 | 57% | 131 |
| mlc-ai/mlc-llm | 52 | Mature | active | 2 | 43% | 1 |
| dusty-nv/jetson-containers | 43 | Mature | active | 1 | 100% | 0 |
| microsoft/BitNet | 43 | Mature | active | 1 | 79% | 0 |
...
- **huggingface/transformers** (165,783★) — The reference implementation, not a serving engine — too heavy to serve from on 8 GB.
- **deepspeedai/DeepSpeed** (43,105★) — Training-scale optimization; irrelevant to single-board inference.
- **openvinotoolkit/openvino** (10,848★) — Excellent engine, wrong vendor — Intel CPU/GPU/NPU, not Tegra CUDA.
- **ultralytics/yolov5** (58,008★) — A model family, not an engine; it is however the classic TensorRT-on-Jetson workload.
- **hiyouga/LlamaFactory** (74,762★) — Fine-tuning — see the `finetuning-stack` report.
- **BerriAI/litellm** (58,685★) — A gateway in front of engines, covered by `ai-engineer-stack`.
...
<sub>Engines covered: 24 · Missing catalogued: 4 · Measurements: 2026-08-23 · Snapshot: 2026-09-14T11:08:08.535Z</sub>
