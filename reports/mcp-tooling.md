...
| [oraios/serena](https://github.com/oraios/serena) | Server · code intelligence | Python | MIT | 28,545 | Hot | 78 | very active | 10d ago | 1.4y | 20 |
...
| [modelcontextprotocol/typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | SDK / framework | TypeScript | NOASSERTION | 13,262 | Hot | 75 | very active | 3d ago | 1.9y | 12 |
...
| [modelcontextprotocol/inspector](https://github.com/modelcontextprotocol/inspector) | Client / host | TypeScript | — | 10,769 | Mature | 79 | very active | 2d ago | 1.9y | 1 |
...
| [oomol-lab/open-connector](https://github.com/oomol-lab/open-connector) | Gateway / control plane | TypeScript | Apache-2.0 | 5,362 | Hot | 89 | very active | 3d ago | 2mo | 21 |
...
| [bytebase/dbhub](https://github.com/bytebase/dbhub) | Server · database/data | TypeScript | MIT | 3,417 | Hot | 76 | very active | 9d ago | 1.5y | 10 |
...
| [brightdata/brightdata-mcp](https://github.com/brightdata/brightdata-mcp) | Server · browser/web | JavaScript | MIT | 2,614 | Mature | 67 | very active | 18d ago | 1.4y | 4 |
...
| [storybookjs/mcp](https://github.com/storybookjs/mcp) | Server · dev-tooling | TypeScript | MIT | 269 | Hot | 74 | very active | 9d ago | 1.0y | 8 |
...
- **Community 13** (16): `PrefectHQ/fastmcp`, `tadata-org/fastapi_mcp`, `brightdata/brightdata-mcp`, `github/github-mcp-server`, `getsentry/sentry-mcp`, `upstash/context7`, `shaneholloman/mcp-knowledge-graph`, `modelcontextprotocol/servers`, `modelcontextprotocol/typescript-sdk`, `modelcontextprotocol/inspector`, `hustcc/mcp-mermaid`, `Coding-Solo/godot-mcp`, `hi-godot/godot-ai`, `youichi-uda/godot-mcp-pro`, `tugcantopaloglu/godot-mcp`, `punkpeye/awesome-mcp-servers`
- **Community 9** (4): `mcp-use/mcp-use`, `ravitemer/mcphub.nvim`, `oomol-lab/open-connector`, `mksglu/context-mode`
- **Community 12** (3): `Kochava-Studios/witsy`, `yvgude/lean-ctx`, `CoderGamester/mcp-unity`
- **Community 10** (3): `Klavis-AI/klavis`, `aipotheosis-labs/gate22`, `SonarSource/sonarqube-mcp-server`
- **Community 7** (3): `googleapis/mcp-toolbox`, `bytebase/dbhub`, `neo4j/mcp`
- **Community 5** (3): `microsoft/playwright-mcp`, `czlonkowski/n8n-mcp`, `microsoft/mcp-for-beginners`
...
| modelcontextprotocol/inspector | 79 | Mature | very active | 1 | 100% | 62 |
...
| modelcontextprotocol/typescript-sdk | 75 | Hot | very active | 1 | 65% | 159 |
