...
- Combined reach: **433,595★**. The space is overwhelmingly **Python** (10/22 projects).
...
|---|---|---|---|---|---|---|---|---|---|---|
| [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) | Coding-agent memory | JavaScript | Apache-2.0 | 92,556 (▲276) | Rising | 80 | very active | 0d ago | 12mo | 2 |
| [mem0ai/mem0](https://github.com/mem0ai/mem0) | General memory layer | Python | Apache-2.0 | 64,309 (▲106) | Classic | 79 | very active | 1d ago | 3.2y | 25 |
| [MemPalace/mempalace](https://github.com/MemPalace/mempalace) | General memory layer | Python | MIT | 58,721 (▲36) | Hot | 76 | very active | 1d ago | 4mo | 18 |
| [getzep/graphiti](https://github.com/getzep/graphiti) | General memory layer | Python | Apache-2.0 | 30,397 (▲40) | Mature | 74 | very active | 0d ago | 2.1y | 23 |
| [topoteretes/cognee](https://github.com/topoteretes/cognee) | General memory layer | Python | Apache-2.0 | 30,335 (▲36) | Classic | 78 | very active | 0d ago | 3.0y | 7 |
| [gastownhall/beads](https://github.com/gastownhall/beads) | Coding-agent memory | Go | MIT | 26,699 (▲45) | Hot | 87 | very active | 0d ago | 10mo | 17 |
| [TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory) | General memory layer | TypeScript | NOASSERTION | 25,126 (▲254) | Rising | 71 | very active | 2d ago | 4mo | 9 |
| [letta-ai/letta](https://github.com/letta-ai/letta) | General memory layer | — | Apache-2.0 | 24,484 (▲14) | Mature | 66 | active | 6d ago | 2.9y | 2 |
...
| [MemoriLabs/Memori](https://github.com/MemoriLabs/Memori) | General memory layer | Python | NOASSERTION | 16,262 (▲8) | Mature | 74 | very active | 8d ago | 1.1y | 7 |
| [andrewyng/context-hub](https://github.com/andrewyng/context-hub) | Coding-agent memory | JavaScript | MIT | 13,950 (▲3) | Rising | 47 | slowing | 3mo ago | 10mo | 1 |
| [semantica-agi/semantica](https://github.com/semantica-agi/semantica) | Knowledge-graph memory | Python | MIT | 11,208 (▲165) | Hot | 84 | very active | 0d ago | 1.2y | 23 |
| [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | General memory layer | Python | AGPL-3.0 | 6,915 (▲27) | Mature | 76 | very active | 1d ago | 3.0y | 23 |
| [campfirein/byterover-cli](https://github.com/campfirein/byterover-cli) | Coding-agent memory | TypeScript | NOASSERTION | 4,950 | Mature | 59 | slowing | 2mo ago | 1.2y | 2 |
| [memodb-io/Acontext](https://github.com/memodb-io/Acontext) | General memory layer | JavaScript | Apache-2.0 | 3,679 (▲3) | Declining | 49 | active | 1mo ago | 1.1y | 0 |
...
| [trustgraph-ai/trustgraph](https://github.com/trustgraph-ai/trustgraph) | Knowledge-graph memory | Python | Apache-2.0 | 2,637 (▲17) | Mature | 63 | very active | 2d ago | 2.1y | 11 |
...
- **[gastownhall/beads](https://github.com/gastownhall/beads)** · 26,699★ · Go · Hot  
  Distributed graph issue-tracker as durable agent memory (Dolt-backed).  
  <sub>topics: agents, claude-code, coding</sub>
- **[andrewyng/context-hub](https://github.com/andrewyng/context-hub)** · 13,950★ · JavaScript · Rising  
...
- **Community 7** (7): `mem0ai/mem0`, `topoteretes/cognee`, `MemoriLabs/Memori`, `memvid/memvid`, `plastic-labs/honcho`, `trustgraph-ai/trustgraph`, `semantica-agi/semantica`
- **Community 9** (6): `letta-ai/letta`, `getzep/graphiti`, `TencentCloud/TencentDB-Agent-Memory`, `memodb-io/Acontext`, `MemPalace/mempalace`, `zmedelis/bosquet`
...
| semantica-agi/semantica | 84 | Hot | very active | 2 | 44% | 22 |
...
|---|---|---|---|
| [redis/redis](https://github.com/redis/redis) | 76,139 (▲14) | C | In-memory data store; common KV/vector backing for memory layers. |
| [facebookresearch/faiss](https://github.com/facebookresearch/faiss) | 40,818 (▲6) | C++ | Dense-vector similarity search library; embedding index substrate. |
| [chroma-core/chroma](https://github.com/chroma-core/chroma) | 29,180 (▲14) | Rust | AI-native search/vector DB used as memory storage. |
| [alibaba/zvec](https://github.com/alibaba/zvec) | 15,534 (▲6) | C++ | Lightweight in-process vector database. |
| [FalkorDB/FalkorDB](https://github.com/FalkorDB/FalkorDB) | 5,692 (▲26) | Rust | Fast graph database (GraphBLAS) for graph-shaped memory. |
...
<sub>Frameworks covered: 22 · Snapshot: 2026-08-29T15:31:31.780Z</sub>
