...
>
> Generated 2026-08-31 by `scripts/reports/memory_frameworks.py` (regenerate any time — no API cost).
...
- Combined reach: **434,653★**. The space is overwhelmingly **Python** (10/22 projects).
...
|---|---|---|---|---|---|---|---|---|---|---|
| [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) | Coding-agent memory | JavaScript | Apache-2.0 | 92,714 (▲434) | Hot | 80 | very active | 0d ago | 1.0y | 3 |
| [mem0ai/mem0](https://github.com/mem0ai/mem0) | General memory layer | Python | Apache-2.0 | 64,420 (▲217) | Classic | 79 | very active | 0d ago | 3.2y | 25 |
| [MemPalace/mempalace](https://github.com/MemPalace/mempalace) | General memory layer | Python | MIT | 58,747 (▲62) | Hot | 76 | very active | 0d ago | 4mo | 10 |
| [getzep/graphiti](https://github.com/getzep/graphiti) | General memory layer | Python | Apache-2.0 | 30,454 (▲97) | Mature | 74 | very active | 1d ago | 2.1y | 23 |
| [topoteretes/cognee](https://github.com/topoteretes/cognee) | General memory layer | Python | Apache-2.0 | 30,367 (▲68) | Classic | 78 | very active | 0d ago | 3.0y | 8 |
| [gastownhall/beads](https://github.com/gastownhall/beads) | Coding-agent memory | Go | MIT | 26,751 (▲97) | Hot | 87 | very active | 0d ago | 10mo | 17 |
| [TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory) | General memory layer | TypeScript | NOASSERTION | 25,363 (▲491) | Rising | 71 | very active | 0d ago | 4mo | 9 |
| [letta-ai/letta](https://github.com/letta-ai/letta) | General memory layer | — | Apache-2.0 | 24,506 (▲36) | Mature | 66 | active | 8d ago | 2.9y | 2 |
| [memvid/memvid](https://github.com/memvid/memvid) | General memory layer | Rust | Apache-2.0 | 16,455 (▼1) | Declining | 57 | active | 1mo ago | 1.3y | 1 |
| [MemoriLabs/Memori](https://github.com/MemoriLabs/Memori) | General memory layer | Python | NOASSERTION | 16,293 (▲39) | Mature | 73 | active | 10d ago | 1.1y | 6 |
| [andrewyng/context-hub](https://github.com/andrewyng/context-hub) | Coding-agent memory | JavaScript | MIT | 13,956 (▲9) | Declining | 29 | slowing | 3mo ago | 10mo | 0 |
| [semantica-agi/semantica](https://github.com/semantica-agi/semantica) | Knowledge-graph memory | Python | MIT | 11,476 (▲433) | Hot | 89 | very active | 0d ago | 1.2y | 24 |
| [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | General memory layer | Python | AGPL-3.0 | 6,959 (▲71) | Mature | 76 | very active | 2d ago | 3.0y | 23 |
| [campfirein/byterover-cli](https://github.com/campfirein/byterover-cli) | Coding-agent memory | TypeScript | NOASSERTION | 4,954 (▲4) | Declining | 56 | slowing | 2mo ago | 1.2y | 1 |
| [memodb-io/Acontext](https://github.com/memodb-io/Acontext) | General memory layer | JavaScript | Apache-2.0 | 3,678 (▲2) | Declining | 49 | active | 1mo ago | 1.1y | 0 |
| [Einsia/OpenChronicle](https://github.com/Einsia/OpenChronicle) | General memory layer | Python | MIT | 2,669 (▼1) | Declining | 23 | slowing | 3mo ago | 4mo | 0 |
| [trustgraph-ai/trustgraph](https://github.com/trustgraph-ai/trustgraph) | Knowledge-graph memory | Python | Apache-2.0 | 2,649 (▲29) | Mature | 63 | very active | 3d ago | 2.1y | 11 |
...
| [supermemoryai/openclaw-supermemory](https://github.com/supermemoryai/openclaw-supermemory) | General memory layer | TypeScript | — | 799 (▲1) | Mature | 48 | slowing | 2mo ago | 7mo | 6 |
...
- **[gastownhall/beads](https://github.com/gastownhall/beads)** · 26,751★ · Go · Hot  
  Distributed graph issue-tracker as durable agent memory (Dolt-backed).  
  <sub>topics: agents, claude-code, coding</sub>
- **[andrewyng/context-hub](https://github.com/andrewyng/context-hub)** · 13,956★ · JavaScript · Declining  
...
**Community clustering.** The 22 frameworks fall into **9 of the graph's 37 communities** — meaning memory tooling does *not* form one tight cluster but is spread across the AI-infra landscape (each tends to cluster with its neighbors: vector DBs, agent frameworks, or MCP tooling).

- **Community 7** (10): `mem0ai/mem0`, `letta-ai/letta`, `topoteretes/cognee`, `getzep/graphiti`, `MemoriLabs/Memori`, `plastic-labs/honcho`, `memodb-io/Acontext`, `MemPalace/mempalace`, `andrewyng/context-hub`, `zmedelis/bosquet`
- **Community 16** (3): `memvid/memvid`, `trustgraph-ai/trustgraph`, `semantica-agi/semantica`
- **Community 2** (2): `TencentCloud/TencentDB-Agent-Memory`, `gastownhall/beads`
- **Community 18** (2): `shaneholloman/mcp-knowledge-graph`, `needle-ai/needle-mcp`
...
- `gastownhall/beads` — PageRank 0.0006
...
|---|---|---|---|---|---|---|
| semantica-agi/semantica | 89 | Hot | very active | 3 | 41% | 22 |
| gastownhall/beads | 87 | Hot | very active | 3 | 25% | 98 |
...
| MemoriLabs/Memori | 73 | Mature | active | 2 | 37% | 38 |
| TencentCloud/TencentDB-Agent-Memory | 71 | Rising | very active | 2 | 31% | 14 |
...
|---|---|---|---|
| [redis/redis](https://github.com/redis/redis) | 76,154 (▲29) | C | In-memory data store; common KV/vector backing for memory layers. |
| [facebookresearch/faiss](https://github.com/facebookresearch/faiss) | 40,829 (▲17) | C++ | Dense-vector similarity search library; embedding index substrate. |
| [chroma-core/chroma](https://github.com/chroma-core/chroma) | 29,191 (▲25) | Rust | AI-native search/vector DB used as memory storage. |
| [alibaba/zvec](https://github.com/alibaba/zvec) | 15,544 (▲16) | C++ | Lightweight in-process vector database. |
| [FalkorDB/FalkorDB](https://github.com/FalkorDB/FalkorDB) | 5,729 (▲63) | Rust | Fast graph database (GraphBLAS) for graph-shaped memory. |
...
<sub>Frameworks covered: 22 · Snapshot: 2026-08-31T12:10:08.018Z</sub>
