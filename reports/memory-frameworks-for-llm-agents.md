...
**Community clustering.** The 21 frameworks fall into **9 of the graph's 26 communities** — meaning memory tooling does *not* form one tight cluster but is spread across the AI-infra landscape (each tends to cluster with its neighbors: vector DBs, agent frameworks, or MCP tooling).
...
- **Community 10** (3): `ActiveMemory/ctx`, `trustgraph-ai/trustgraph`, `semantica-agi/semantica`
- **Community 8** (2): `thedotmack/claude-mem`, `campfirein/byterover-cli`
