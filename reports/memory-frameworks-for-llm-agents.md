...
>
> Generated 2026-09-14 by `scripts/reports/memory_frameworks.py` (regenerate any time — no API cost).
...
- Combined reach: **441,844★**. The space is overwhelmingly **Python** (10/22 projects).
...
|---|---|---|---|---|---|---|---|---|---|---|
| [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) | Coding-agent memory | TypeScript | Apache-2.0 | 93,826 (▲517) | Hot | 80 | very active | 1d ago | 1.0y | 19 |
| [mem0ai/mem0](https://github.com/mem0ai/mem0) | General memory layer | Python | Apache-2.0 | 65,265 (▲502) | Classic | 79 | very active | 0d ago | 3.2y | 24 |
| [MemPalace/mempalace](https://github.com/MemPalace/mempalace) | General memory layer | Python | MIT | 59,043 (▲178) | Hot | 76 | very active | 0d ago | 5mo | 23 |
| [getzep/graphiti](https://github.com/getzep/graphiti) | General memory layer | Python | Apache-2.0 | 30,865 (▲241) | Mature | 73 | very active | 3d ago | 2.1y | 27 |
| [topoteretes/cognee](https://github.com/topoteretes/cognee) | General memory layer | Python | Apache-2.0 | 30,674 (▲172) | Classic | 78 | very active | 0d ago | 3.1y | 9 |
| [gastownhall/beads](https://github.com/gastownhall/beads) | Coding-agent memory | Go | MIT | 27,138 (▲201) | Hot | 87 | very active | 0d ago | 11mo | 19 |
| [TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory) | General memory layer | TypeScript | NOASSERTION | 26,642 (▲659) | Hot | 77 | very active | 3d ago | 5mo | 15 |
| [letta-ai/letta](https://github.com/letta-ai/letta) | General memory layer | — | Apache-2.0 | 24,732 (▲106) | Mature | 67 | active | 4d ago | 2.9y | 2 |
| [MemoriLabs/Memori](https://github.com/MemoriLabs/Memori) | General memory layer | Python | NOASSERTION | 16,702 (▲259) | Declining | 62 | active | 11d ago | 1.1y | 1 |
| [memvid/memvid](https://github.com/memvid/memvid) | General memory layer | Rust | Apache-2.0 | 16,539 (▲50) | Declining | 56 | slowing | 2mo ago | 1.3y | 1 |
| [andrewyng/context-hub](https://github.com/andrewyng/context-hub) | Coding-agent memory | JavaScript | MIT | 13,975 (▲14) | Declining | 28 | slowing | 3mo ago | 10mo | 0 |
| [semantica-agi/semantica](https://github.com/semantica-agi/semantica) | Knowledge-graph memory | Python | MIT | 12,855 (▲729) | Hot | 94 | very active | 0d ago | 1.2y | 27 |
| [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | General memory layer | Python | AGPL-3.0 | 7,156 (▲120) | Classic | 71 | very active | 3d ago | 3.0y | 20 |
| [campfirein/byterover-cli](https://github.com/campfirein/byterover-cli) | Coding-agent memory | TypeScript | NOASSERTION | 4,957 (▲1) | Declining | 54 | slowing | 2mo ago | 1.2y | 1 |
| [memodb-io/Acontext](https://github.com/memodb-io/Acontext) | General memory layer | JavaScript | Apache-2.0 | 3,692 (▲8) | Declining | 48 | slowing | 2mo ago | 1.2y | 0 |
| [Einsia/OpenChronicle](https://github.com/Einsia/OpenChronicle) | General memory layer | Python | MIT | 2,828 (▲158) | Declining | 22 | slowing | 4mo ago | 4mo | 0 |
| [trustgraph-ai/trustgraph](https://github.com/trustgraph-ai/trustgraph) | Knowledge-graph memory | Python | Apache-2.0 | 2,712 (▲35) | Mature | 64 | very active | 11d ago | 2.2y | 11 |
| [shaneholloman/mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph) | Knowledge-graph memory | JavaScript | MIT | 888 (▼1) | Declining | 42 | slowing | 3mo ago | 1.8y | 0 |
| [supermemoryai/openclaw-supermemory](https://github.com/supermemoryai/openclaw-supermemory) | General memory layer | TypeScript | — | 798 (▼1) | Mature | 47 | active | 5d ago | 7mo | 2 |
...
| [ActiveMemory/ctx](https://github.com/ActiveMemory/ctx) | General memory layer | HTML | NOASSERTION | 76 | Hot | 77 | very active | 0d ago | 7mo | 6 |
...
- **[Einsia/OpenChronicle](https://github.com/Einsia/OpenChronicle)** · 2,828★ · Python · Declining  
...
- **[gastownhall/beads](https://github.com/gastownhall/beads)** · 27,138★ · Go · Hot  
  Distributed graph issue-tracker as durable agent memory (Dolt-backed).  
  <sub>topics: agents, claude-code, coding</sub>
- **[andrewyng/context-hub](https://github.com/andrewyng/context-hub)** · 13,975★ · JavaScript · Declining  
...
**Community clustering.** The 22 frameworks fall into **11 of the graph's 37 communities** — meaning memory tooling does *not* form one tight cluster but is spread across the AI-infra landscape (each tends to cluster with its neighbors: vector DBs, agent frameworks, or MCP tooling).

- **Community 3** (6): `letta-ai/letta`, `getzep/graphiti`, `TencentCloud/TencentDB-Agent-Memory`, `memodb-io/Acontext`, `MemPalace/mempalace`, `needle-ai/needle-mcp`
- **Community 14** (5): `mem0ai/mem0`, `MemoriLabs/Memori`, `memvid/memvid`, `plastic-labs/honcho`, `semantica-agi/semantica`
- **Community 10** (2): `ActiveMemory/ctx`, `trustgraph-ai/trustgraph`
- **Community 16** (2): `thedotmack/claude-mem`, `zmedelis/bosquet`
...
|---|---|---|---|---|---|---|
| semantica-agi/semantica | 94 | Hot | very active | 4 | 35% | 23 |
| gastownhall/beads | 87 | Hot | very active | 3 | 23% | 99 |
...
| TencentCloud/TencentDB-Agent-Memory | 77 | Hot | very active | 3 | 26% | 16 |
...
| plastic-labs/honcho | 71 | Classic | very active | 3 | 20% | 0 |
| letta-ai/letta | 67 | Mature | active | 1 | 60% | 177 |
| trustgraph-ai/trustgraph | 64 | Mature | very active | 1 | 64% | 1 |
| MemoriLabs/Memori | 62 | Declining | active | 1 | 100% | 38 |
...
| supermemoryai/openclaw-supermemory | 47 | Mature | active | 1 | 50% | 0 |
| shaneholloman/mcp-knowledge-graph | 42 | Declining | slowing | 0 | 0% | 8 |
| zmedelis/bosquet | 32 | Mature | slowing | 0 | 0% | 14 |
| andrewyng/context-hub | 28 | Declining | slowing | 0 | 0% | 1 |
...
|---|---|---|---|
| [redis/redis](https://github.com/redis/redis) | 76,357 (▲131) | C | In-memory data store; common KV/vector backing for memory layers. |
| [facebookresearch/faiss](https://github.com/facebookresearch/faiss) | 40,903 (▲44) | C++ | Dense-vector similarity search library; embedding index substrate. |
| [chroma-core/chroma](https://github.com/chroma-core/chroma) | 29,294 (▲58) | Rust | AI-native search/vector DB used as memory storage. |
| [alibaba/zvec](https://github.com/alibaba/zvec) | 15,915 (▲115) | C++ | Lightweight in-process vector database. |
| [FalkorDB/FalkorDB](https://github.com/FalkorDB/FalkorDB) | 6,092 (▲188) | Rust | Fast graph database (GraphBLAS) for graph-shaped memory. |
...
<sub>Frameworks covered: 22 · Snapshot: 2026-09-14T11:08:08.535Z</sub>
