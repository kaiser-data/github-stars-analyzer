...
>
> Generated 2026-06-11 by `scripts/reports/memory_frameworks.py` (regenerate any time — no API cost).
...
**Community clustering.** The 21 frameworks fall into **10 of the graph's 31 communities** — meaning memory tooling does *not* form one tight cluster but is spread across the AI-infra landscape (each tends to cluster with its neighbors: vector DBs, agent frameworks, or MCP tooling).

- **Community 7** (6): `mem0ai/mem0`, `topoteretes/cognee`, `MemoriLabs/Memori`, `plastic-labs/honcho`, `memodb-io/Acontext`, `trustgraph-ai/trustgraph`
- **Community 1** (4): `letta-ai/letta`, `MemPalace/mempalace`, `needle-ai/needle-mcp`, `zmedelis/bosquet`
- **Community 8** (3): `getzep/graphiti`, `ActiveMemory/ctx`, `semantica-agi/semantica`
- **Community 18** (2): `thedotmack/claude-mem`, `gastownhall/beads`
