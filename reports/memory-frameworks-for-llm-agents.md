...
>
> Generated 2026-08-30 by `scripts/reports/memory_frameworks.py` (regenerate any time — no API cost).
...
| [TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory) | General memory layer | TypeScript | NOASSERTION | 24,872 | Rising | 71 | very active | 3d ago | 4mo | 9 |
...
**Community clustering.** The 22 frameworks fall into **10 of the graph's 37 communities** — meaning memory tooling does *not* form one tight cluster but is spread across the AI-infra landscape (each tends to cluster with its neighbors: vector DBs, agent frameworks, or MCP tooling).

- **Community 19** (6): `mem0ai/mem0`, `topoteretes/cognee`, `MemoriLabs/Memori`, `plastic-labs/honcho`, `memodb-io/Acontext`, `MemPalace/mempalace`
- **Community 10** (4): `letta-ai/letta`, `getzep/graphiti`, `TencentCloud/TencentDB-Agent-Memory`, `zmedelis/bosquet`
- **Community 8** (3): `memvid/memvid`, `trustgraph-ai/trustgraph`, `semantica-agi/semantica`
- **Community 1** (2): `Einsia/OpenChronicle`, `andrewyng/context-hub`
- **Community 13** (2): `shaneholloman/mcp-knowledge-graph`, `needle-ai/needle-mcp`
...
<sub>Frameworks covered: 22 · Snapshot: 2026-08-29T23:54:34.573Z</sub>
