...
>
> Generated 2026-07-22 by `scripts/reports/memory_frameworks.py` (regenerate any time — no API cost).
...
- Combined reach: **391,427★**. The space is overwhelmingly **Python** (10/22 projects).
...
|---|---|---|---|---|---|---|---|---|---|---|
| [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) | Coding-agent memory | JavaScript | Apache-2.0 | 87,912 (▲46) | Rising | 79 | very active | 1d ago | 10mo | 1 |
| [mem0ai/mem0](https://github.com/mem0ai/mem0) | General memory layer | TypeScript | Apache-2.0 | 61,274 (▲67) | Classic | 89 | very active | 0d ago | 3.1y | 39 |
| [MemPalace/mempalace](https://github.com/MemPalace/mempalace) | General memory layer | Python | MIT | 57,493 (▲13) | Hot | 76 | very active | 3d ago | 3mo | 19 |
| [getzep/graphiti](https://github.com/getzep/graphiti) | General memory layer | Python | Apache-2.0 | 28,947 (▲26) | Hot | 76 | very active | 2d ago | 1.9y | 10 |
| [topoteretes/cognee](https://github.com/topoteretes/cognee) | General memory layer | Python | Apache-2.0 | 28,551 (▲60) | Mature | 77 | very active | 0d ago | 2.9y | 10 |
| [gastownhall/beads](https://github.com/gastownhall/beads) | Coding-agent memory | Go | MIT | 25,440 (▲5) | Hot | 83 | very active | 0d ago | 9mo | 8 |
| [letta-ai/letta](https://github.com/letta-ai/letta) | General memory layer | Python | Apache-2.0 | 23,874 (▲6) | Mature | 63 | active | 17d ago | 2.8y | 2 |
| [memvid/memvid](https://github.com/memvid/memvid) | General memory layer | Rust | Apache-2.0 | 16,009 (▲4) | Mature | 64 | active | 6d ago | 1.1y | 2 |
| [MemoriLabs/Memori](https://github.com/MemoriLabs/Memori) | General memory layer | Python | NOASSERTION | 15,634 (▲6) | Hot | 81 | active | 1mo ago | 12mo | 13 |
| [andrewyng/context-hub](https://github.com/andrewyng/context-hub) | Coding-agent memory | JavaScript | MIT | 13,809 (▲2) | Hot | 55 | active | 1mo ago | 8mo | 8 |
| [TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory) | General memory layer | TypeScript | NOASSERTION | 9,149 (▲23) | Hot | 80 | very active | 1d ago | 3mo | 21 |
| [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | General memory layer | Python | AGPL-3.0 | 6,071 (▲12) | Mature | 73 | very active | 3d ago | 2.9y | 26 |
| [campfirein/byterover-cli](https://github.com/campfirein/byterover-cli) | Coding-agent memory | TypeScript | NOASSERTION | 4,925 | Hot | 82 | very active | 25d ago | 1.1y | 8 |
| [memodb-io/Acontext](https://github.com/memodb-io/Acontext) | General memory layer | JavaScript | Apache-2.0 | 3,583 (▲1) | Declining | 59 | active | 6d ago | 1.0y | 1 |
| [Einsia/OpenChronicle](https://github.com/Einsia/OpenChronicle) | General memory layer | Python | MIT | 2,798 | Hot | 50 | slowing | 2mo ago | 3mo | 9 |
| [trustgraph-ai/trustgraph](https://github.com/trustgraph-ai/trustgraph) | Knowledge-graph memory | Python | Apache-2.0 | 2,330 (▲2) | Mature | 63 | very active | 3d ago | 2.0y | 9 |
| [semantica-agi/semantica](https://github.com/semantica-agi/semantica) | Knowledge-graph memory | Python | MIT | 1,416 (▲1) | Hot | 80 | very active | 1d ago | 1.1y | 4 |
| [shaneholloman/mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph) | Knowledge-graph memory | JavaScript | MIT | 877 | Declining | 59 | active | 1mo ago | 1.6y | 1 |
| [supermemoryai/openclaw-supermemory](https://github.com/supermemoryai/openclaw-supermemory) | General memory layer | TypeScript | — | 791 | Rising | 60 | very active | 29d ago | 5mo | 7 |
| [zmedelis/bosquet](https://github.com/zmedelis/bosquet) | LLM framework w/ memory | Clojure | EPL-1.0 | 375 | Mature | 44 | active | 1mo ago | 3.6y | 2 |
...
- **[letta-ai/letta](https://github.com/letta-ai/letta)** · 23,874★ · Python · Mature  
...
- **[MemoriLabs/Memori](https://github.com/MemoriLabs/Memori)** · 15,634★ · Python · Hot  
...
- **[TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory)** · 9,149★ · TypeScript · Hot  
...
- **[plastic-labs/honcho](https://github.com/plastic-labs/honcho)** · 6,071★ · Python · Mature  
...
- **[gastownhall/beads](https://github.com/gastownhall/beads)** · 25,440★ · Go · Hot  
  Distributed graph issue-tracker as durable agent memory (Dolt-backed).  
  <sub>topics: agents, claude-code, coding</sub>
- **[andrewyng/context-hub](https://github.com/andrewyng/context-hub)** · 13,809★ · JavaScript · Hot  
...
- **[trustgraph-ai/trustgraph](https://github.com/trustgraph-ai/trustgraph)** · 2,330★ · Python · Mature  
...
- **[semantica-agi/semantica](https://github.com/semantica-agi/semantica)** · 1,416★ · Python · Hot  
...
**Community clustering.** The 22 frameworks fall into **6 of the graph's 28 communities** — meaning memory tooling does *not* form one tight cluster but is spread across the AI-infra landscape (each tends to cluster with its neighbors: vector DBs, agent frameworks, or MCP tooling).

- **Community 5** (13): `mem0ai/mem0`, `letta-ai/letta`, `getzep/graphiti`, `MemoriLabs/Memori`, `plastic-labs/honcho`, `TencentCloud/TencentDB-Agent-Memory`, `memodb-io/Acontext`, `MemPalace/mempalace`, `Einsia/OpenChronicle`, `andrewyng/context-hub`, `shaneholloman/mcp-knowledge-graph`, `needle-ai/needle-mcp`, `zmedelis/bosquet`
- **Community 14** (4): `topoteretes/cognee`, `ActiveMemory/ctx`, `trustgraph-ai/trustgraph`, `semantica-agi/semantica`
- **Community 1** (2): `thedotmack/claude-mem`, `campfirein/byterover-cli`
...
|---|---|---|---|
| [redis/redis](https://github.com/redis/redis) | 75,592 (▲1) | C | In-memory data store; common KV/vector backing for memory layers. |
| [facebookresearch/faiss](https://github.com/facebookresearch/faiss) | 40,544 (▲3) | C++ | Dense-vector similarity search library; embedding index substrate. |
| [chroma-core/chroma](https://github.com/chroma-core/chroma) | 28,833 (▲5) | Rust | AI-native search/vector DB used as memory storage. |
| [alibaba/zvec](https://github.com/alibaba/zvec) | 15,166 (▲22) | C++ | Lightweight in-process vector database. |
| [FalkorDB/FalkorDB](https://github.com/FalkorDB/FalkorDB) | 4,805 (▲2) | C | Fast graph database (GraphBLAS) for graph-shaped memory. |
...
<sub>Frameworks covered: 22 · Snapshot: 2026-07-20T08:33:57.852Z</sub>
