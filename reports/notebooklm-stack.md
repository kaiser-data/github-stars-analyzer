...
>
> Generated 2026-08-31 by `scripts/reports/notebooklm_stack.py` (regenerate any time — no API cost).
...
- **Goal**: everything needed to build (and demo) your own NotebookLM — a source-grounded notebook with cited answers, an *Audio Overview* podcast generator, live voice interaction, and a mind-map view — from **34 repos already in your stars** (**1,390,607★** combined).
...
|---|---|---|---|---|---|---|---|---|---|---|
| [yt-dlp/yt-dlp](https://github.com/yt-dlp/yt-dlp) | Source ingestion & parsing | Python | Unlicense | 188,072 (▲686) | Classic | 83 | very active | 1d ago | 5.8y | 24 |
| [microsoft/markitdown](https://github.com/microsoft/markitdown) | Source ingestion & parsing | Python | MIT | 177,309 (▲645) | Mature | 63 | active | 12d ago | 1.8y | 6 |
| [openai/whisper](https://github.com/openai/whisper) | Audio/video understanding (STT) | Python | MIT | 108,190 (▲159) | Mature | 40 | active | 1mo ago | 4.0y | 2 |
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | Wow-factor add-on | Python | MIT | 81,168 (▲150) | Hot | 84 | very active | 0d ago | 1.3y | 51 |
| [opendatalab/MinerU](https://github.com/opendatalab/MinerU) | Source ingestion & parsing | Python | NOASSERTION | 78,858 (▲223) | Mature | 80 | very active | 0d ago | 2.5y | 2 |
| [docling-project/docling](https://github.com/docling-project/docling) | Source ingestion & parsing | Python | MIT | 65,791 (▲129) | Mature | 95 | very active | 0d ago | 2.1y | 37 |
| [Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm) | Clone / reference app | JavaScript | MIT | 65,422 (▲117) | Classic | 79 | very active | 2d ago | 3.2y | 21 |
| [run-llama/llama_index](https://github.com/run-llama/llama_index) | Grounded retrieval & citations | Python | MIT | 51,936 (▲42) | Classic | 98 | very active | 2d ago | 3.8y | 59 |
| [coqui-ai/TTS](https://github.com/coqui-ai/TTS) | Audio Overview (TTS / podcast) | Python | MPL-2.0 | 45,972 (▲9) | Abandoned | 10 | stale | 2.0y ago | 6.3y | 0 |
| [HKUDS/LightRAG](https://github.com/HKUDS/LightRAG) | Grounded retrieval & citations | Python | MIT | 39,287 (▲52) | Mature | 79 | very active | 0d ago | 1.9y | 2 |
| [HKUDS/DeepTutor](https://github.com/HKUDS/DeepTutor) | Clone / reference app | Python | Apache-2.0 | 38,004 (▲287) | Hot | 78 | very active | 0d ago | 8mo | 6 |
| [lfnovo/open-notebook](https://github.com/lfnovo/open-notebook) | Clone / reference app | TypeScript | MIT | 37,974 (▲208) | Hot | 77 | very active | 15d ago | 1.9y | 9 |
| [OpenBMB/VoxCPM](https://github.com/OpenBMB/VoxCPM) | Audio Overview (TTS / podcast) | Python | Apache-2.0 | 36,360 (▲173) | Rising | 72 | active | 5d ago | 11mo | 7 |
| [microsoft/graphrag](https://github.com/microsoft/graphrag) | Mind map / knowledge graph | Python | MIT | 35,755 (▲48) | Mature | 71 | very active | 0d ago | 2.4y | 4 |
| [VectifyAI/PageIndex](https://github.com/VectifyAI/PageIndex) | Grounded retrieval & citations | Python | MIT | 35,446 (▲102) | Hot | 76 | very active | 0d ago | 1.4y | 9 |
| [getzep/graphiti](https://github.com/getzep/graphiti) | Mind map / knowledge graph | Python | Apache-2.0 | 30,454 (▲97) | Mature | 74 | very active | 1d ago | 2.1y | 23 |
| [topoteretes/cognee](https://github.com/topoteretes/cognee) | Mind map / knowledge graph | Python | Apache-2.0 | 30,367 (▲68) | Classic | 78 | very active | 0d ago | 3.0y | 8 |
| [resemble-ai/chatterbox](https://github.com/resemble-ai/chatterbox) | Audio Overview (TTS / podcast) | Python | MIT | 26,213 (▲43) | Declining | 36 | active | 1mo ago | 1.4y | 2 |
| [SYSTRAN/faster-whisper](https://github.com/SYSTRAN/faster-whisper) | Audio/video understanding (STT) | Python | MIT | 25,159 (▲42) | Declining | 15 | stale | 9mo ago | 3.6y | 0 |
| [m-bain/whisperX](https://github.com/m-bain/whisperX) | Audio/video understanding (STT) | Python | BSD-2-Clause | 23,823 (▲42) | Mature | 68 | active | 1d ago | 3.7y | 4 |
| [screenpipe/screenpipe](https://github.com/screenpipe/screenpipe) | Wow-factor add-on | Rust | NOASSERTION | 21,323 (▲56) | Mature | 80 | very active | 0d ago | 2.2y | 5 |
| [teng-lin/notebooklm-py](https://github.com/teng-lin/notebooklm-py) | Clone / reference app | Python | MIT | 19,029 (▲64) | Hot | 80 | very active | 0d ago | 7mo | 4 |
| [Unstructured-IO/unstructured](https://github.com/Unstructured-IO/unstructured) | Source ingestion & parsing | HTML | Apache-2.0 | 15,366 (▲12) | Classic | 75 | very active | 3d ago | 3.9y | 10 |
| [pipecat-ai/pipecat](https://github.com/pipecat-ai/pipecat) | Interactive voice mode | Python | BSD-2-Clause | 15,012 (▲184) | Mature | 79 | very active | 0d ago | 2.7y | 6 |
| [livekit/agents](https://github.com/livekit/agents) | Interactive voice mode | Python | Apache-2.0 | 13,903 (▲710) | Mature | 99 | very active | 0d ago | 2.9y | 47 |
| [supertone-inc/supertonic](https://github.com/supertone-inc/supertonic) | Audio Overview (TTS / podcast) | Swift | MIT | 13,743 (▲7) | Declining | 42 | active | 1mo ago | 9mo | 2 |
| [QwenLM/Qwen3-TTS](https://github.com/QwenLM/Qwen3-TTS) | Audio Overview (TTS / podcast) | Python | Apache-2.0 | 13,209 (▲80) | Declining | 25 | slowing | 5mo ago | 7mo | 0 |
| [StarTrail-org/LEANN](https://github.com/StarTrail-org/LEANN) | Grounded retrieval & citations | Python | MIT | 12,860 (▲21) | Hot | 75 | very active | 1d ago | 1.2y | 16 |
| [jina-ai/reader](https://github.com/jina-ai/reader) | Source ingestion & parsing | TypeScript | Apache-2.0 | 11,935 (▲16) | Mature | 31 | slowing | 3mo ago | 2.4y | 0 |
| [lancedb/lancedb](https://github.com/lancedb/lancedb) | Grounded retrieval & citations | Rust | Apache-2.0 | 11,318 (▲20) | Classic | 87 | very active | 0d ago | 3.5y | 12 |
| [KoljaB/RealtimeSTT](https://github.com/KoljaB/RealtimeSTT) | Interactive voice mode | Python | MIT | 10,099 (▲18) | Classic | 68 | very active | 1d ago | 3.0y | 4 |
| [feyninc/chonkie](https://github.com/feyninc/chonkie) | Grounded retrieval & citations | Python | MIT | 4,713 (▲7) | Hot | 76 | very active | 5d ago | 1.4y | 5 |
| [gradio-app/fastrtc](https://github.com/gradio-app/fastrtc) | Interactive voice mode | JavaScript | MIT | 4,625 (▲4) | Declining | 24 | stale | 7mo ago | 1.9y | 0 |
| [alexpinel/Dot](https://github.com/alexpinel/Dot) | Clone / reference app | JavaScript | GPL-3.0 | 1,912 (▲1) | Abandoned | 1 | stale | 1.7y ago | 2.5y | 0 |
...
- **[Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm)** · 65,422★ · JavaScript · Classic  
...
- **[HKUDS/DeepTutor](https://github.com/HKUDS/DeepTutor)** · 38,004★ · Python · Hot  
...
- **[lfnovo/open-notebook](https://github.com/lfnovo/open-notebook)** · 37,974★ · TypeScript · Hot  
...
- **[teng-lin/notebooklm-py](https://github.com/teng-lin/notebooklm-py)** · 19,029★ · Python · Hot  
...
- **[yt-dlp/yt-dlp](https://github.com/yt-dlp/yt-dlp)** · 188,072★ · Python · Classic  
...
- **[microsoft/markitdown](https://github.com/microsoft/markitdown)** · 177,309★ · Python · Mature  
...
- **[opendatalab/MinerU](https://github.com/opendatalab/MinerU)** · 78,858★ · Python · Mature  
...
- **[docling-project/docling](https://github.com/docling-project/docling)** · 65,791★ · Python · Mature  
...
- **[jina-ai/reader](https://github.com/jina-ai/reader)** · 11,935★ · TypeScript · Mature  
...
**Community clustering.** These 34 tools span **14 of the graph's 37 communities**.

- **Community 16** (5): `Mintplex-Labs/anything-llm`, `alexpinel/Dot`, `VectifyAI/PageIndex`, `StarTrail-org/LEANN`, `lancedb/lancedb`
- **Community 7** (5): `pipecat-ai/pipecat`, `livekit/agents`, `getzep/graphiti`, `topoteretes/cognee`, `screenpipe/screenpipe`
- **Community 11** (4): `feyninc/chonkie`, `OpenBMB/VoxCPM`, `coqui-ai/TTS`, `gradio-app/fastrtc`
- **Community 4** (3): `docling-project/docling`, `Unstructured-IO/unstructured`, `resemble-ai/chatterbox`
- **Community 6** (3): `jina-ai/reader`, `SYSTRAN/faster-whisper`, `m-bain/whisperX`
- **Community 21** (2): `HKUDS/DeepTutor`, `HKUDS/LightRAG`
- **Community 14** (2): `microsoft/markitdown`, `microsoft/graphrag`
- **Community 13** (2): `opendatalab/MinerU`, `bytedance/deer-flow`
- **Community 2** (2): `yt-dlp/yt-dlp`, `run-llama/llama_index`
- **Community 17** (2): `openai/whisper`, `KoljaB/RealtimeSTT`

**Centrality (PageRank in the full 1,900-repo graph)** — most 'hub-like' picks in your ecosystem:

- `VectifyAI/PageIndex` — PageRank 0.0014
- `m-bain/whisperX` — PageRank 0.0012
- `docling-project/docling` — PageRank 0.0012
...
| teng-lin/notebooklm-py | 80 | Hot | very active | 1 | 95% | 28 |
...
| HKUDS/DeepTutor | 78 | Hot | very active | 1 | 72% | 74 |
| topoteretes/cognee | 78 | Classic | very active | 1 | 75% | 146 |
...
| getzep/graphiti | 74 | Mature | very active | 1 | 58% | 197 |
...
| microsoft/markitdown | 63 | Mature | active | 3 | 29% | 20 |
...
- **infiniflow/ragflow** (89,732★) — batteries-included RAG *engine* — covered in the RAG-tooling report; too opinionated to embed in your own app shell
- **open-webui/open-webui** (150,483★) — general chat UI over Ollama/OpenAI — a chat product, not a source-grounded notebook
- **qdrant/qdrant** (34,290★) — excellent vector DB, but a server to operate — `lancedb` keeps the demo self-contained (see RAG report for the full DB landscape)
- **jamiepine/voicebox** (51,931★) — voice *studio* app — covered in the voice-agents report
- **Zackriya-Solutions/meetily** (30,138★) — meeting assistant — covered in the meeting-transcription report
- **suno-ai/bark** (39,260★) — generative audio pioneer, now largely superseded by the TTS picks above
- **NirDiamant/RAG_Techniques** (29,286★) — tutorial collection — great study material, not a dependency
...
<sub>Tools covered: 34 · Snapshot: 2026-08-31T12:10:08.018Z</sub>
