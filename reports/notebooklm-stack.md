...
>
> Generated 2026-09-21 by `scripts/reports/notebooklm_stack.py` (regenerate any time — no API cost).
...
- **Goal**: everything needed to build (and demo) your own NotebookLM — a source-grounded notebook with cited answers, an *Audio Overview* podcast generator, live voice interaction, and a mind-map view — from **33 repos already in your stars** (**1,408,102★** combined).
...
|---|---|---|---|---|---|---|---|---|---|---|
| [yt-dlp/yt-dlp](https://github.com/yt-dlp/yt-dlp) | Source ingestion & parsing | Python | Unlicense | 192,447 (▲1,406) | Classic | 82 | very active | 5d ago | 5.9y | 25 |
| [microsoft/markitdown](https://github.com/microsoft/markitdown) | Source ingestion & parsing | Python | MIT | 186,077 (▲2,250) | Hot | 92 | very active | 5d ago | 1.9y | 52 |
| [openai/whisper](https://github.com/openai/whisper) | Audio/video understanding (STT) | Python | MIT | 109,424 (▲355) | Mature | 47 | active | 21d ago | 4.0y | 3 |
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | Wow-factor add-on | Python | MIT | 82,794 (▲386) | Hot | 84 | very active | 0d ago | 1.4y | 46 |
| [opendatalab/MinerU](https://github.com/opendatalab/MinerU) | Source ingestion & parsing | Python | NOASSERTION | 80,377 (▲490) | Mature | 80 | very active | 0d ago | 2.6y | 3 |
| [docling-project/docling](https://github.com/docling-project/docling) | Source ingestion & parsing | Python | MIT | 67,491 (▲1,107) | Mature | 96 | very active | 0d ago | 2.2y | 44 |
| [Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm) | Clone / reference app | JavaScript | MIT | 66,294 (▲291) | Classic | 84 | very active | 2d ago | 3.3y | 22 |
| [run-llama/llama_index](https://github.com/run-llama/llama_index) | Grounded retrieval & citations | Python | MIT | 52,257 (▲102) | Classic | 98 | very active | 2d ago | 3.9y | 62 |
| [coqui-ai/TTS](https://github.com/coqui-ai/TTS) | Audio Overview (TTS / podcast) | Python | MPL-2.0 | 46,037 (▲29) | Abandoned | 10 | stale | 2.1y ago | 6.3y | 0 |
| [HKUDS/DeepTutor](https://github.com/HKUDS/DeepTutor) | Clone / reference app | Python | Apache-2.0 | 40,112 (▲537) | Hot | 78 | very active | 0d ago | 8mo | 16 |
| [HKUDS/LightRAG](https://github.com/HKUDS/LightRAG) | Grounded retrieval & citations | Python | MIT | 39,796 (▲163) | Hot | 79 | very active | 0d ago | 2.0y | 9 |
| [lfnovo/open-notebook](https://github.com/lfnovo/open-notebook) | Clone / reference app | TypeScript | MIT | 39,313 (▲551) | Hot | 78 | very active | 1d ago | 1.9y | 21 |
| [OpenBMB/VoxCPM](https://github.com/OpenBMB/VoxCPM) | Audio Overview (TTS / podcast) | Python | Apache-2.0 | 37,839 (▲645) | Mature | 70 | very active | 19d ago | 1.0y | 6 |
| [microsoft/graphrag](https://github.com/microsoft/graphrag) | Mind map / knowledge graph | Python | MIT | 36,050 (▲78) | Mature | 71 | very active | 0d ago | 2.5y | 4 |
| [VectifyAI/PageIndex](https://github.com/VectifyAI/PageIndex) | Grounded retrieval & citations | Python | MIT | 35,787 (▲144) | Hot | 77 | very active | 0d ago | 1.5y | 4 |
| [getzep/graphiti](https://github.com/getzep/graphiti) | Mind map / knowledge graph | Python | Apache-2.0 | 31,047 (▲182) | Mature | 73 | very active | 0d ago | 2.1y | 27 |
| [topoteretes/cognee](https://github.com/topoteretes/cognee) | Mind map / knowledge graph | Python | Apache-2.0 | 30,880 (▲206) | Classic | 78 | very active | 0d ago | 3.1y | 6 |
| [resemble-ai/chatterbox](https://github.com/resemble-ai/chatterbox) | Audio Overview (TTS / podcast) | Python | MIT | 26,501 (▲91) | Declining | 33 | slowing | 2mo ago | 1.4y | 1 |
| [SYSTRAN/faster-whisper](https://github.com/SYSTRAN/faster-whisper) | Audio/video understanding (STT) | Python | MIT | 25,496 (▲105) | Declining | 13 | stale | 10mo ago | 3.6y | 0 |
| [m-bain/whisperX](https://github.com/m-bain/whisperX) | Audio/video understanding (STT) | Python | BSD-2-Clause | 24,162 (▲134) | Mature | 59 | active | 22d ago | 3.8y | 2 |
| [screenpipe/screenpipe](https://github.com/screenpipe/screenpipe) | Wow-factor add-on | Rust | NOASSERTION | 21,650 (▲83) | Mature | 80 | very active | 0d ago | 2.3y | 5 |
| [teng-lin/notebooklm-py](https://github.com/teng-lin/notebooklm-py) | Clone / reference app | Python | MIT | 19,409 (▲103) | Hot | 80 | very active | 1d ago | 8mo | 3 |
| [pipecat-ai/pipecat](https://github.com/pipecat-ai/pipecat) | Interactive voice mode | Python | BSD-2-Clause | 15,722 (▲196) | Mature | 84 | very active | 0d ago | 2.7y | 7 |
| [Unstructured-IO/unstructured](https://github.com/Unstructured-IO/unstructured) | Source ingestion & parsing | HTML | Apache-2.0 | 15,462 (▲37) | Classic | 86 | very active | 0d ago | 4.0y | 14 |
| [livekit/agents](https://github.com/livekit/agents) | Interactive voice mode | Python | Apache-2.0 | 14,296 (▲109) | Mature | 99 | very active | 0d ago | 2.9y | 44 |
| [QwenLM/Qwen3-TTS](https://github.com/QwenLM/Qwen3-TTS) | Audio Overview (TTS / podcast) | Python | Apache-2.0 | 13,481 (▲97) | Declining | 23 | stale | 6mo ago | 8mo | 0 |
| [StarTrail-org/LEANN](https://github.com/StarTrail-org/LEANN) | Grounded retrieval & citations | Python | MIT | 12,947 (▲12) | Hot | 75 | very active | 2d ago | 1.3y | 16 |
| [jina-ai/reader](https://github.com/jina-ai/reader) | Source ingestion & parsing | TypeScript | Apache-2.0 | 12,026 (▲41) | Mature | 29 | slowing | 4mo ago | 2.4y | 0 |
| [lancedb/lancedb](https://github.com/lancedb/lancedb) | Grounded retrieval & citations | Rust | Apache-2.0 | 11,485 (▲66) | Classic | 92 | very active | 0d ago | 3.6y | 20 |
| [KoljaB/RealtimeSTT](https://github.com/KoljaB/RealtimeSTT) | Interactive voice mode | Python | MIT | 10,138 (▲11) | Classic | 68 | very active | 4d ago | 3.1y | 3 |
| [feyninc/chonkie](https://github.com/feyninc/chonkie) | Grounded retrieval & citations | Python | MIT | 4,765 (▲21) | Hot | 73 | very active | 3d ago | 1.5y | 4 |
| [gradio-app/fastrtc](https://github.com/gradio-app/fastrtc) | Interactive voice mode | JavaScript | MIT | 4,626 (▲3) | Declining | 18 | stale | 8mo ago | 2.0y | 0 |
| [alexpinel/Dot](https://github.com/alexpinel/Dot) | Clone / reference app | JavaScript | GPL-3.0 | 1,914 (▲1) | Abandoned | 1 | stale | 1.8y ago | 2.5y | 0 |
...
- **[Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm)** · 66,294★ · JavaScript · Classic  
...
- **[HKUDS/DeepTutor](https://github.com/HKUDS/DeepTutor)** · 40,112★ · Python · Hot  
...
- **[lfnovo/open-notebook](https://github.com/lfnovo/open-notebook)** · 39,313★ · TypeScript · Hot  
...
- **[teng-lin/notebooklm-py](https://github.com/teng-lin/notebooklm-py)** · 19,409★ · Python · Hot  
...
- **[yt-dlp/yt-dlp](https://github.com/yt-dlp/yt-dlp)** · 192,447★ · Python · Classic  
...
- **[jina-ai/reader](https://github.com/jina-ai/reader)** · 12,026★ · TypeScript · Mature  
...
**Community clustering.** These 33 tools span **16 of the graph's 35 communities**.

- **Community 11** (7): `VectifyAI/PageIndex`, `StarTrail-org/LEANN`, `pipecat-ai/pipecat`, `livekit/agents`, `getzep/graphiti`, `topoteretes/cognee`, `bytedance/deer-flow`
- **Community 2** (4): `feyninc/chonkie`, `OpenBMB/VoxCPM`, `coqui-ai/TTS`, `gradio-app/fastrtc`
- **Community 10** (3): `lfnovo/open-notebook`, `openai/whisper`, `KoljaB/RealtimeSTT`
- **Community 4** (3): `Mintplex-Labs/anything-llm`, `docling-project/docling`, `Unstructured-IO/unstructured`
- **Community 18** (2): `HKUDS/DeepTutor`, `HKUDS/LightRAG`
- **Community 27** (2): `alexpinel/Dot`, `QwenLM/Qwen3-TTS`
- **Community 16** (2): `microsoft/markitdown`, `microsoft/graphrag`
- **Community 17** (2): `SYSTRAN/faster-whisper`, `m-bain/whisperX`

**Centrality (PageRank in the full 2,211-repo graph)** — most 'hub-like' picks in your ecosystem:
...
- `jina-ai/reader` — PageRank 0.0007
...
- `feyninc/chonkie` — PageRank 0.0005
...
| Mintplex-Labs/anything-llm | 84 | Classic | very active | 2 | 34% | 35 |
...
| teng-lin/notebooklm-py | 80 | Hot | very active | 1 | 98% | 29 |
...
| HKUDS/DeepTutor | 78 | Hot | very active | 1 | 57% | 81 |
...
- **infiniflow/ragflow** (91,092★) — batteries-included RAG *engine* — covered in the RAG-tooling report; too opinionated to embed in your own app shell
- **open-webui/open-webui** (152,686★) — general chat UI over Ollama/OpenAI — a chat product, not a source-grounded notebook
- **qdrant/qdrant** (34,726★) — excellent vector DB, but a server to operate — `lancedb` keeps the demo self-contained (see RAG report for the full DB landscape)
- **jamiepine/voicebox** (55,333★) — voice *studio* app — covered in the voice-agents report
- **Zackriya-Solutions/meetily** (30,992★) — meeting assistant — covered in the meeting-transcription report
- **suno-ai/bark** (39,272★) — generative audio pioneer, now largely superseded by the TTS picks above
- **NirDiamant/RAG_Techniques** (29,564★) — tutorial collection — great study material, not a dependency
...
<sub>Tools covered: 33 · Snapshot: 2026-09-21T11:17:33.969Z</sub>
