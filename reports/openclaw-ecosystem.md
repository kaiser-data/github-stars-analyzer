...
>
> Generated 2026-07-13 by `scripts/reports/openclaw_ecosystem.py` (regenerate any time — no API cost).
...
- **Community 9** (8): `HKUDS/nanobot`, `NousResearch/hermes-agent`, `BlockRunAI/ClawRouter`, `iOfficeAI/AionUi`, `HKUDS/DeepTutor`, `HKUDS/ClawWork`, `Gen-Verse/OpenClaw-RL`, `hydro13/tandem-browser`
- **Community 22** (5): `openclaw/openclaw`, `openclaw/clawhub`, `hesamsheikh/awesome-openclaw-usecases`, `supermemoryai/openclaw-supermemory`, `comet-ml/opik-openclaw`
- **Community 5** (5): `nanocoai/nanoclaw`, `vivekchand/clawmetry`, `farion1231/cc-switch`, `CherryHQ/cherry-studio`, `SafeRL-Lab/cheetahclaws`
- **Community 10** (3): `NVIDIA/NemoClaw`, `abhi1693/openclaw-mission-control`, `crshdn/mission-control`
