...
>
> Generated 2026-09-25 by `scripts/reports/token_savings.py` (regenerate any time — no API cost).
...
- **15 token-savings tools** in your stars (**470,006★**), organized by workload:
...
- **The one integration-free win:** `rtk` (a CLI proxy) claims 60–90% with no per-agent setup — and it's the most-starred here (81,687★).
...
- **[JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman)** · 107,770★ · Go · Hot · health 78 · _Prompt-style skill_ · **~65%**  
...
- **[rtk-ai/rtk](https://github.com/rtk-ai/rtk)** · 81,687★ · Rust · Hot · health 75 · _Wire-level proxy_ · **60–90% on dev cmds**  
...
- **[colbymchenry/codegraph](https://github.com/colbymchenry/codegraph)** · 72,059★ · C · Hot · health 77 · _Code index/graph_ · **~70%**  
  Pre-indexed code knowledge graph for Claude Code/Codex/Cursor/OpenCode/Hermes — query instead of read.  
  <sub>topics: —</sub>
- **[mksglu/context-mode](https://github.com/mksglu/context-mode)** · 24,051★ · TypeScript · Rising · health 77 · _Tool-output sandbox_ · **98% on tool output**  
...
- **[getagentseal/codeburn](https://github.com/getagentseal/codeburn)** · 11,228★ · TypeScript · Hot · health 79 · _Measurement / observability_ · **— (measures)**  
...
- **[MinishLab/semble](https://github.com/MinishLab/semble)** · 6,142★ · Python · Hot · health 73 · _Semantic code search_ · **~98% vs grep+read**  
...
- **[yvgude/lean-ctx](https://github.com/yvgude/lean-ctx)** · 3,834★ · Rust · Hot · health 80 · _Context layer_ · **qualitative**  
...
- **[HKUDS/FastCode](https://github.com/HKUDS/FastCode)** · 2,292★ · Python · Declining · health 38 · _Code understanding_ · **qualitative**  
...
- **[toon-format/toon](https://github.com/toon-format/toon)** · 25,421★ · TypeScript · Hot · health 78 · _Compact data format_ · **~30–50% on structured data**  
...
- **[deepseek-ai/DeepSeek-OCR](https://github.com/deepseek-ai/DeepSeek-OCR)** · 23,911★ · Python · Declining · health 11 · _Optical context compression_ · **research**  
  'Contexts Optical Compression' — renders document context to images to fit more in window; low health & stale.  
  <sub>topics: —</sub>
- **[bytebase/dbhub](https://github.com/bytebase/dbhub)** · 3,565★ · TypeScript · Hot · health 77 · _Token-efficient DB access_ · **qualitative**  
...
- **[iternal-technologies-partners/blockify-agentic-data-optimization](https://github.com/iternal-technologies-partners/blockify-agentic-data-optimization)** · 314★ · Python · Declining · health 22 · _Data optimization (RAG)_ · **qualitative**  
...
- **[thedotmack/claude-mem](https://github.com/thedotmack/claude-mem)** · 94,658★ · TypeScript · Hot · health 80 · _Session compression_ · **qualitative**  
...
- **[vllm-project/llm-compressor](https://github.com/vllm-project/llm-compressor)** · 3,821★ · Python · Mature · health 90 · _Model weight compression_ · **n/a (inference, not prompt)**  
...
- **[jasontang-ai/Context-Engineering](https://github.com/jasontang-ai/Context-Engineering)** · 9,253★ · Python · Declining · health 20 · _Methodology / guide_ · **— (educational)**  
...
1. `rtk-ai/rtk` — best general, integration-free reduction (60–90%, 81,687★, health 75).
...
|---|---|---|---|---|
| [deepseek-ai/DeepSeek-OCR](https://github.com/deepseek-ai/DeepSeek-OCR) | Retrieval, RAG & documents | 11 | Declining | 8mo ago |
| [jasontang-ai/Context-Engineering](https://github.com/jasontang-ai/Context-Engineering) | Methodology / cross-cutting | 20 | Declining | 7mo ago |
...
| [HKUDS/FastCode](https://github.com/HKUDS/FastCode) | Coding agents & codebases | 38 | Declining | 2mo ago |

## Graph analysis — how they relate

**Community clustering.** These 15 tools span **12 of the graph's 35 communities** — token-savings is a cross-cutting concern, not a single cluster.

- **Community 24** (2): `rtk-ai/rtk`, `yvgude/lean-ctx`
- **Community 14** (2): `mksglu/context-mode`, `JuliusBrussee/caveman`
...
- `JuliusBrussee/caveman` — PageRank 0.0004
...
<sub>Tools covered: 15 across 6 workloads · Snapshot: 2026-09-25T10:37:19.717Z</sub>
