...
**Community clustering.** These 14 tools span **8 of the graph's 26 communities** — token-savings is a cross-cutting concern, not a single cluster.

- **Community 8** (5): `rtk-ai/rtk`, `getagentseal/codeburn`, `yvgude/lean-ctx`, `JuliusBrussee/caveman`, `thedotmack/claude-mem`
- **Community 16** (2): `colbymchenry/codegraph`, `mksglu/context-mode`
- **Community 20** (2): `toon-format/toon`, `vllm-project/llm-compressor`
