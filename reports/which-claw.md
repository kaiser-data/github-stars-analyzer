...
> Derived from **kaiser-data**'s 1,900 starred repos (snapshot `2026-08-31T12:10:08.018Z`), cross-referenced with the repo-similarity graph.
>
> Generated 2026-08-31 by `scripts/reports/which_claw.py` (regenerate any time — no API cost).
...
- **Maximum stability/quality →** [`zeroclaw-labs/zeroclaw`](https://github.com/zeroclaw-labs/zeroclaw) (health 93).
...
|---|---|---|---|---|---|---|---|---|---|
| 🥇 | [zeroclaw-labs/zeroclaw](https://github.com/zeroclaw-labs/zeroclaw) | General assistant | **0.855** | 32,682 (▲15) | 93 | 12,309 | 0d ago | 4 | Rust |
| 🥈 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) † | General assistant | **0.766** | 238,749 (▲1,411) | 80 | 37,620 | 0d ago | 2 | Python |
| 🥉 | [openclaw/openclaw](https://github.com/openclaw/openclaw) | General assistant | **0.759** | 388,189 (▲343) | 79 | 103,950 | 0d ago | 1 | TypeScript |
| 4 | [HKUDS/nanobot](https://github.com/HKUDS/nanobot) † | General assistant | **0.712** | 47,567 (▲96) | 84 | 16,891 | 0d ago | 2 | Python |
| 5 | [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) † | Coding agent | **0.701** | 68,547 (▲98) | 78 | 18,940 | 0d ago | 1 | TypeScript |
| 6 | [sipeed/picoclaw](https://github.com/sipeed/picoclaw) | General assistant | **0.694** | 29,917 (▲3) | 84 | 10,788 | 4d ago | 2 | Go |
| 7 | [nearai/ironclaw](https://github.com/nearai/ironclaw) | Secure runtime | **0.673** | 12,602 (▼1) | 80 | 4,518 | 0d ago | 2 | Rust |
| 8 | [nanocoai/nanoclaw](https://github.com/nanocoai/nanoclaw) | Secure runtime | **0.673** | 30,652 (▲26) | 80 | 10,852 | 0d ago | 2 | TypeScript |
| 9 | [NVIDIA/NemoClaw](https://github.com/NVIDIA/NemoClaw) | Secure runtime | **0.663** | 22,324 (▲28) | 74 | 9,919 | 0d ago | 3 | TypeScript |
| 10 | [elizaOS/eliza](https://github.com/elizaOS/eliza) † | General assistant | **0.636** | 19,219 (▲29) | 79 | 1,288 | 0d ago | 1 | TypeScript |
| 11 | [ultraworkers/claw-code](https://github.com/ultraworkers/claw-code) | Coding agent | **0.602** | 195,161 (▲27) | 64 | 61,174 | 15d ago | 1 | Rust |
| 12 | [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) | General assistant | **0.557** | 8,055 (▲5) | 67 | 1,235 | 1mo ago | 1 | Zig |
| 13 | [RightNow-AI/openfang](https://github.com/RightNow-AI/openfang) | General assistant | **0.507** | 18,151 (▲12) | 49 | 2,904 | 2mo ago | 0 | Rust |

**Where's Hermes?** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) lands **#2** (composite 0.766) — the **strongest functional claw** and it leads OpenClaw (#3). Health 80, bus factor 2 (vs OpenClaw's 1 — more resilient), 238,749★, very active.
It sits just behind [`zeroclaw-labs/zeroclaw`](https://github.com/zeroclaw-labs/zeroclaw), which edges it on health (93 vs 80) and resilience (bus 4 vs 2). 
...
Other functional claws (†): `nanobot` #4, `oh-my-openagent` #5, `eliza` #10.
...
|---|---|---|---|---|---|---|
| zeroclaw-labs/zeroclaw | 0.93 | 0.81 | 1.00 | 0.65 | 0.82 | **0.855** |
| NousResearch/hermes-agent | 0.80 | 0.96 | 0.50 | 0.59 | 0.91 | **0.766** |
| openclaw/openclaw | 0.79 | 1.00 | 0.25 | 0.75 | 1.00 | **0.759** |
| HKUDS/nanobot | 0.84 | 0.84 | 0.50 | 0.44 | 0.84 | **0.712** |
| code-yeongyu/oh-my-openagent | 0.78 | 0.87 | 0.25 | 0.75 | 0.85 | **0.701** |
...
| hermes-agent † | 2 | 3 | 2 | 2 | 2 | 2 | 2.2 | #2–#3 |
| openclaw | 3 | 2 | 3 | **1** | 7 | **1** | 2.8 | #1–#7 |
| nanobot † | 4 | 5 | 4 | 5 | 3 | 5 | 4.3 | #3–#5 |
| oh-my-openagent † | 5 | 4 | 7 | 4 | 9 | 4 | 5.5 | #4–#9 |
| picoclaw | 6 | 6 | 5 | 7 | 6 | 7 | 6.2 | #5–#7 |
| ironclaw | 7 | 7 | 6 | 9 | 5 | 10 | 7.3 | #5–#10 |
| nanoclaw | 8 | 8 | 8 | 8 | 8 | 8 | 8.0 | #8–#8 |
| NemoClaw | 9 | 9 | 10 | 10 | 4 | 9 | 8.5 | #4–#10 |
| claw-code | 11 | 11 | 12 | 6 | 12 | 3 | 9.2 | #3–#12 |
...
**Pareto-optimal (9):** `zeroclaw`, `hermes-agent`, `openclaw`, `nanobot`, `oh-my-openagent`, `picoclaw`, `claw-code`, `nullclaw`, `openfang`.
...
| `nanoclaw` | `zeroclaw`, `hermes-agent`, `nanobot` | containerised chat-app connectors |
| `NemoClaw` | `zeroclaw` | managed inference on NVIDIA infra |
| `eliza` | `openclaw`, `zeroclaw`, `picoclaw`, `hermes-agent`, `nanobot` | autonomous social/web3 swarm bots |
...
In the repo-similarity graph (1,138 nodes / 6,181 edges), the claws **don't form one cluster** — they scatter across **9 of 25 communities**. There is no single 'claw' neighbourhood; these are genuinely different projects that happen to share a role.

- **Centrality (PageRank).** Most hub-like claws: `hermes-agent` (0.0007), `oh-my-openagent` (0.0007), `openclaw` (0.0007). Note PageRank tracks *similarity* connectivity, not quality — a claw is central when many neighbours resemble it.
...
- **The honest network-effect caveat.** The similarity graph measures shared topics/authors, **not** 'plugs-into' dependency — so it does *not* by itself prove OpenClaw lock-in. The one direct graph signal that does is **`openclaw` ⇄ `clawhub` (its official skill directory) at w=0.67** — the strongest accessory tie of any claw. The broader lock-in argument below rests on real-world integration, which the graph under-counts, not over-counts.
...
| **Code quality / least bus-factor risk** | [`zeroclaw-labs/zeroclaw`](https://github.com/zeroclaw-labs/zeroclaw) | highest bus factor (4) — most resilient to a maintainer leaving |
| **Best health score** | [`zeroclaw-labs/zeroclaw`](https://github.com/zeroclaw-labs/zeroclaw) | health 93 — cleanest maintenance signals |
| **Fastest-growing right now** | [`openclaw/openclaw`](https://github.com/openclaw/openclaw) | ~103,950 est. stars/30d |
...
| **Most-adopted / most battle-tested** | [`openclaw/openclaw`](https://github.com/openclaw/openclaw) | 388,189★ |
...
- **RightNow-AI/openfang** — health 49; 60d since last push; bus factor 0 (single-maintainer risk).
...
<sub>Claws ranked: 13 · Snapshot: 2026-08-31T12:10:08.018Z · regenerate via scripts/reports/which_claw.py</sub>
