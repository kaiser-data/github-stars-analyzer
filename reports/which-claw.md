...
>
> Generated 2026-07-13 by `scripts/reports/which_claw.py` (regenerate any time — no API cost).
...
In the repo-similarity graph (1,138 nodes / 4,302 edges), the claws **don't form one cluster** — they scatter across **10 of 25 communities**. There is no single 'claw' neighbourhood; these are genuinely different projects that happen to share a role.
